...
from eerily.version import __version__
...
PACKAGE_DESCRIPTION = "Time seRies plAYground (eerily) is a playground for time series"
PACKAGE_LONG_DESCRIPTION = PACKAGE_LONG_DESCRIPTION
PACKAGE_URL = "https://github.com/emptymalei/eerily"

...
def align_text(left_text, right_text, filler='.'):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            align_text("A", "B", filler='*')
            # >> "A*****************************B"

    """
    cleaned_left_text = remove_ascii_color_codes(remove_tags(left_text))
    cleaned_right_text = remove_ascii_color_codes(remove_tags(right_text))
    padding_length = pawn.console.width - len(cleaned_left_text) - len(cleaned_right_text) - 2

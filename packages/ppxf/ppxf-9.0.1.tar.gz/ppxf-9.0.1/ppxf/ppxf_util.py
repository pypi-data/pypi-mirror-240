...
def gaussian_filter1d(spec, sig, mode='constant'):
    """
    This function is deprecated: one should use `ppxf_util.varsmooth` instead, 
    which is superior in every situation.
...
def varsmooth(x, y, sig_x, xout=None, oversample=1):
    """    
    Fast and acccurate convolution with a Gaussian of variable width.
    ...
    transform of the Gaussian function, like to the pPXF method. This allows

...
class User(BaseConfig):
    ...
    def add_user(self, username: str, password: str, privilege: int = 1):
        ...
        """
        command = f'username {username} password {password} privilege {privilege}'
    ...
    def delete_user(self, username: str):
        ...
        """
        self._execute_config_command(f'no username {username}', success_message=f"User {username} deleted.")

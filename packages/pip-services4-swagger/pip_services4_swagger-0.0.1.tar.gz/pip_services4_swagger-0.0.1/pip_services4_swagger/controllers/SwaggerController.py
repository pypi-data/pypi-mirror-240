...
import bottle
from pip_services4_http.controller import RestController, ISwaggerController


class SwaggerController(RestController, ISwaggerController):

    def __init__(self):
        super(SwaggerController, self).__init__()
        self._base_route = 'swagger'
        self.__routes = {}

    def __calculate_file_path(self, file_name: str) -> str:
        return str(pathlib.Path(__file__).parent) + '/../../pip_services4_swagger/swagger-ui/' + file_name

/*! For license information please see da581ae0.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[39267],{89194:function(e,t,i){i(48175),i(65660),i(70019);var r=i(9672),n=i(50856);(0,r.k)({_template:n.d`
    <style>
      :host {
...
`;!function(e,t,i,r){var n=l();if(r)for(var o=0;o<r.length;o++)n=r[o](n);var s=t((function(e){n.initializeInstanceElements(e,a.elements)}),i),a=n.decorateClass(function(e){for(var t=[],i=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},r=0;r<e.length;r++){var n,o=e[r];if("method"===o.kind&&(n=t.find(i)))if(h(o.descriptor)||h(n.descriptor)){if(u(o)||u(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(u(o)){if(u(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}d(o,n)}else t.push(o)}return t}(s.d.map(c)),e);n.initializeClassElements(s.F,a.elements),n.runClassFinishers(s.F,a.finishers)}([(0,s.Mo)("ha-dialog")],(function(e,t){class i extends t{constructor(...t){super(...t),e(this)}}return{F:i,d:[{kind:"field",key:a.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var i;null===(i=this.contentElement)||void 0===i||i.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading"> ${y(v(i.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"field",static:!0,key:"styles",value(){return[n.W,o.iv`
    ...
    `}},{kind:"method",key:"_unsupportedDialog",value:async function(){await(0,p.Ys)(this,{title:this.hass.localize("ui.dialogs.unsupported.title"),text:r.dy`${this.hass.localize("ui.dialogs.unsupported.description")}
        <br /><br />
        <ul>
          ${this._resolutionInfo.unsupported.map((e=>r.dy`
              <li>
                <a
                  href=${(0,m.R)(this.hass,S[e]||`/more-info/unsupported/${e}`)}
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            `))}
        </ul>`})}},{kind:"method",key:"_unhealthyDialog",value:async function(){await(0,p.Ys)(this,{title:this.hass.localize("ui.dialogs.unhealthy.title"),text:r.dy`${this.hass.localize("ui.dialogs.unhealthy.description")}
        <br /><br />
        <ul>
          ${this._resolutionInfo.unhealthy.map((e=>r.dy`
              <li>
                <a
                  href=${(0,m.R)(this.hass,D[e]||`/more-info/unhealthy/${e}`)}
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            `))}
        </ul>`})}},{kind:"method",key:"_getSections",value:function(){const e=[];if(this._systemInfo){const t=Object.keys(this._systemInfo).sort($);for(const i of t){const t=this._systemInfo[i],n=[];for(const e of Object.keys(t.info)){let o;if(t.info[e]&&"object"==typeof t.info[e]){const i=t.info[e];"pending"===i.type?o=r.dy`
                <ha-circular-progress active size="tiny"></ha-circular-progress>
              `:"failed"===i.type?o=r.dy`
                <span class="error">${i.error}</span>${i.more_info?r.dy`
                    ...
                    `:""}
              `:"date"===i.type&&(o=(0,s.o0)(new Date(i.value),this.hass.locale))}else o=t.info[e];n.push(r.dy`
            <tr>
              <td>
          ...
          `)}"homeassistant"!==i&&e.push(r.dy`
              <div class="card-header">
                <h3>${(0,h.Lh)(this.hass.localize,i)}</h3>
                ${t.manage_url?r.dy`
        ...
        `);return e}},{kind:"method",key:"_copyInfo",value:async function(){let e;const t=[];for(const i of Object.keys(this._systemInfo).sort($)){const r=this._systemInfo[i];let n=!0;const o=[""+("homeassistant"!==i?`<details><summary>${(0,h.Lh)(this.hass.localize,i)}</summary>\n`:"")];for(const e of Object.keys(r.info)){let t;if(r.info[e]&&"object"==typeof r.info[e]){const i=r.info[e];"pending"===i.type?t="pending":"failed"===i.type?t=`failed to load: ${i.error}`:"date"===i.type&&(t=(0,s.o0)(new Date(i.value),this.hass.locale))}else t=r.info[e];n?(o.push(`${e} | ${t}\n-- | --`),n=!1):o.push(`${e} | ${t}`)}"homeassistant"===i?e=o.join("\n"):(t.push(o.join("\n")),"homeassistant"!==i&&t.push("</details>"))}await(0,l.v)(`## System Information\n${e}\n\n${t.join("\n\n")}`),(0,y.C)(this,{message:this.hass.localize("ui.common.copied_clipboard")})}},{kind:"field",static:!0,key:"styles",value(){return[f.yu,r.iv`
      ha-alert {
        margin-bottom: 16px;
        display: block;
      }
    ...
    `]}}]}}),r.oi)},27322:function(e,t,i){i.d(t,{D:function(){return n},R:function(){return r}});const r=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`,n=e=>`https://github.com/nixe64/the-next-generation${e}`}}]);
//# sourceMappingURL=da581ae0.js.map
    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const u=(0,v.jL)(f,this.hass),m=this._integrations(f,this.entries),y=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(y),b=this._batteryEntity(y),w=this._batteryChargingEntity(y),k=b?this.hass.states[b.entity_id]:void 0,E=k&&"binary_sensor"===(0,c.N)(k),_=w?this.hass.states[w.entity_id]:void 0,P=this._computeArea(this.areas,f),x=[],D=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&D.push(...this._diagnosticDownloadLinks),this._deleteButtons&&D.push(...this._deleteButtons),D.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const $=D.shift();f.disabled_by&&x.push(r.dy`
          ...
          ${"user"===f.disabled_by?r.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(f,m,x);const A=(0,a.p)(this.hass,"automation")?r.dy`
          <ha-card outlined>
            ...
            ${null!==(e=this._related)&&void 0!==e&&null!==(t=e.automation)&&void 0!==t&&t.length?r.dy`
                  <div class="items">
        ...
        `:"",z=(0,a.p)(this.hass,"scene")&&y.length?r.dy`
            <ha-card outlined>
              <h1 class="card-header">
              ...
              ${null!==(i=this._related)&&void 0!==i&&null!==(n=i.scene)&&void 0!==n&&n.length?r.dy`
                    <div class="items">
          ...
          <ha-card outlined>
            ...
            ${null!==(s=this._related)&&void 0!==s&&null!==(l=s.script)&&void 0!==l&&l.length?r.dy`
                  <div class="items">
      ...
      >
        ...
        <div class="container">
          <div class="header fullwidth">
            ${P?r.dy`<div class="header-name">
                ...
                <div class="header-right">
                  ...
                  ${m.length?r.dy`
                          <img
                            src=${(0,C.X1)({domain:m[0].domain,type:"logo",darkOptimized:null===(h=this.hass.themes)||void 0===h?void 0:h.darkMode})}
          ...
          <div class="column">
              ${null!==(p=this._deviceAlerts)&&void 0!==p&&p.length?r.dy`
                      <div>
                ...
                ${$||D.length?r.dy`
                        <div class="card-actions" slot="actions">
                          <div>
                            <a
                              href=${(0,o.o)($.href)}
                              rel=${(0,o.o)($.target?"noreferrer":void 0)}
                              target=${(0,o.o)($.target)}
                            >
                              <mwc-button
                                class=${(0,o.o)($.classes)}
          ...
          <div class="column">
            ${["control","sensor","config","diagnostic"].map((e=>g[e].length>0||0===y.length&&"control"===e?r.dy`

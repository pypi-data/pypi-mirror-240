/*! For license information please see c3390c8b.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[20392],{14166:(e,t,r)=>{r.d(t,{W:()=>c});var i=function(){return i=Object.assign||function(e){for(var t,r=1,i=arguments.length;r<i;r++)for(var n in t=arguments[r])Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e},i.apply(this,arguments)},n=1e3,o=60,a=60*o,s=24*a,l=7*s;function c(e,t,r){void 0===t&&(t=Date.now()),void 0===r&&(r={});var c=i(i({},d),r||{}),h=(+e-+t)/n;if(Math.abs(h)<c.second)return{value:Math.round(h),unit:"second"};var p=h/o;if(Math.abs(p)<c.minute)return{value:Math.round(p),unit:"minute"};var u=h/a;if(Math.abs(u)<c.hour)return{value:Math.round(u),unit:"hour"};var f=h/s;if(Math.abs(f)<c.day)return{value:Math.round(f),unit:"day"};var m=new Date(e),v=new Date(t),y=m.getFullYear()-v.getFullYear();if(Math.round(Math.abs(y))>0)return{value:Math.round(y),unit:"year"};var g=12*y+m.getMonth()-v.getMonth();if(Math.round(Math.abs(g))>0)return{value:Math.round(g),unit:"month"};var b=h/l;return{value:Math.round(b),unit:"week"}}var d={second:45,minute:45,hour:22,day:5}},27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
      <style>
        :host {
          display: block;
          /**
    ...
    `}},{kind:"method",key:"updated",value:function(e){_(M(r.prototype),"updated",this).call(this,e),!this._tip&&e.has("hass")&&(this._tip=F(this.hass,this.narrow))}},{kind:"field",key:"_filterUpdateEntitiesWithInstall",value:()=>(0,a.Z)((e=>{const t=(0,c.Fj)(e);return{updates:t.slice(0,3===t.length?t.length:2),total:t.length}}))},{kind:"method",key:"_showQuickBar",value:function(){(0,d.H)(this,{commandMode:!0,hint:this.hass.localize("ui.dialogs.quick-bar.key_c_hint")})}},{kind:"method",key:"_handleMenuAction",value:async function(e){if(0===e.detail.index)(0,c.M$)(this,this.hass)}},{kind:"get",static:!0,key:"styles",value:function(){return[p.Qx,n.iv`
        ha-card:last-child {
  ...
  `}]}}),i.oi)}}]);
//# sourceMappingURL=c3390c8b.js.map
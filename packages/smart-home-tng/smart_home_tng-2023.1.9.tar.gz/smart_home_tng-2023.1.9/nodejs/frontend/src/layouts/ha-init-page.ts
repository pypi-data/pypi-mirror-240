...
class HaInitPage extends LitElement {
  ...
  protected render() {
    return this.error
      ? html`
          <p>Unable to connect to Smart Home - The Next Generation.</p>
          <p class="retry-text">
          ...
          ? html`
                <p>
                  ...
                  Smart Home Controller is not currently connected. You can ask it to
      ...
      : html`
          ...
          <div id="loading-text">Zugriff gewährt. Daten werden geladen...</div>
        `;
  }

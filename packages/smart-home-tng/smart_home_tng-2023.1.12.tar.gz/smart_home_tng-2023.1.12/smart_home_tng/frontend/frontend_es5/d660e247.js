...
`;!function(e,t,r,i){var n=l();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var a=t((function(e){n.initializeInstanceElements(e,s.elements)}),r),s=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(f(o.descriptor)||f(n.descriptor)){if(p(o)||p(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(p(o)){if(p(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}d(o,n)}else t.push(o)}return t}(a.d.map(c)),e);n.initializeClassElements(a.F,s.elements),n.runClassFinishers(a.F,s.finishers)}([(0,a.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"field",key:s.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading"> ${y(v(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"field",static:!0,key:"styles",value(){return[n.W,o.iv`
    ...
    `:i.dy``}},{kind:"method",key:"_valueChanged",value:function(e){const t=e.target,r=t.configValue;this._error=void 0,this[`_${r}`]=t.value}},{kind:"method",key:"_updateEntry",value:async function(){let e;this._submitting=!0;try{const t={name:this._name.trim()};e=this._params.entry?await this._params.updateEntry(t):await this._params.createEntry(t,this._id),this.closeDialog()}catch(t){this._error=t?t.message:"Unknown error"}finally{this._submitting=!1}return e}},{kind:"method",key:"_updateWriteEntry",value:async function(){var e;const t=null===(e=this._params)||void 0===e?void 0:e.openWrite,r=await this._updateEntry();r&&t&&t(r)}},{kind:"method",key:"_deleteEntry",value:async function(){this._submitting=!0;try{await this._params.removeEntry()&&(this._params=void 0)}finally{this._submitting=!1}}},{kind:"method",key:"_generateQR",value:async function(){const e=await r.e(51970).then(r.t.bind(r,51970,19)),t=await e.toCanvas(`https://www.home-assistant.io/tag/${this._params.entry.id}`,{width:180,errorCorrectionLevel:"Q",color:{light:"#fff"}}),n=t.getContext("2d"),o=new Image;o.src="/static/icons/favicon-192x192.png",await new Promise((e=>{o.onload=e})),n.drawImage(o,t.width/3,t.height/3,t.width/3,t.height/3),this._qrCode=i.dy`<img src=${t.toDataURL()}></img>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=d660e247.js.map
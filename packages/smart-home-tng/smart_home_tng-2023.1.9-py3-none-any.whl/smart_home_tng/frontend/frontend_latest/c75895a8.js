/*! For license information please see c75895a8.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[19356,86603],{14166:(t,e,i)=>{i.d(e,{W:()=>p});var n=function(){return n=Object.assign||function(t){for(var e,i=1,n=arguments.length;i<n;i++)for(var a in e=arguments[i])Object.prototype.hasOwnProperty.call(e,a)&&(t[a]=e[a]);return t},n.apply(this,arguments)},a=1e3,o=60,s=60*o,r=24*s,l=7*r;function p(t,e,i){void 0===e&&(e=Date.now()),void 0===i&&(i={});var p=n(n({},h),i||{}),u=(+t-+e)/a;if(Math.abs(u)<p.second)return{value:Math.round(u),unit:"second"};var c=u/o;if(Math.abs(c)<p.minute)return{value:Math.round(c),unit:"minute"};var m=u/s;if(Math.abs(m)<p.hour)return{value:Math.round(m),unit:"hour"};var d=u/r;if(Math.abs(d)<p.day)return{value:Math.round(d),unit:"day"};var y=new Date(t),f=new Date(e),g=y.getFullYear()-f.getFullYear();if(Math.round(Math.abs(g))>0)return{value:Math.round(g),unit:"year"};var v=12*g+y.getMonth()-f.getMonth();if(Math.round(Math.abs(v))>0)return{value:Math.round(v),unit:"month"};var _=u/l;return{value:Math.round(_),unit:"week"}}var h={second:45,minute:45,hour:22,day:5}},63207:(t,e,i)=>{i(65660),i(15112);var n=i(9672),a=i(87156),o=i(50856),s=i(48175);(0,n.k)({_template:o.d`
    <style>
      :host {
        @apply --layout-inline;

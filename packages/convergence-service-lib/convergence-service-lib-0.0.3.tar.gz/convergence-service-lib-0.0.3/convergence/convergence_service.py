...
class ConvergenceService(abc.ABC):
    ...
    def initialize(self):
        ...
        self.__initialize_authorization()
    ...
    def __register_class_service_authority(self, service_authorities_handler):
        ...
        #
        # if len(authorities) > 0:
        #     infrastructure_service = InfrastructureMicroService( # noqa
        #         self,
        #         self.get_configuration('application.discovery_server_url'), None) # noqa
...
\____/\____/_/ /_/|___/\___/_/   \__, /\___/_/ /_/\___/\___/ 
    ...
    def get_endpoint_info(url: str, method: str):
        ...
        for info in ConvergenceService.__endpoints_info:
            if info.method == method and ConvergenceService.__match_url_to_endpoint(url, info.url):
                result = info
                break
    ...
    def __initialize_authorization(self):

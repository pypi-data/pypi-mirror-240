...
class TableBlueprint:
    ...
    def add_operation_dates(self, created_at=True, updated_at=True, deleted_at=True):
        ...
        if updated_at:
            self.columns.append(TableColumnBlueprint('updated_at', 'timestamp', default_value='CURRENT_TIMESTAMP'))
        if deleted_at:
            self.columns.append(TableColumnBlueprint('deleted_at', 'timestamp', default_value='CURRENT_TIMESTAMP'))

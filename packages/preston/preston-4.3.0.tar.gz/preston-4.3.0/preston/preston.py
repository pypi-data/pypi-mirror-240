...
@dataclass
class PageData:
    """Wrapper for data resulting from querying an ESI endpoint.

    Contains the endpoint's returned data, the requested
    page, the total numbers of pages, and the ETag.
    """

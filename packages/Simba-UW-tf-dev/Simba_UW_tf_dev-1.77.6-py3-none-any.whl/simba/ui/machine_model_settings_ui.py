...
from simba.utils.enums import Options, Formats, Keys, Links, TagNames
...
class MachineModelSettingsPopUp(PopUpMixin, ConfigReader):
    ...
    def __init__(self,
        ...
        self.select_config_file = FileSelect(load_meta_data_frm, 'CONFIG PATH:', file_types=[('CSV', '*.csv')])
    ...
    def load_config(self):
        ...
        try:
            ...
            raise InvalidHyperparametersFileError(msg='SIMBA ERROR: {} is not a valid SimBA meta hyper-parameters file.'.format(config_name), source=self.__class__.__name__)
        self.meta = {}

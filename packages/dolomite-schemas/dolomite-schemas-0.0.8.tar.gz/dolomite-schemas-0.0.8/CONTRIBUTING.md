...
Welcome to `dolomite-schemas` contributor's guide.
...
If you experience bugs or general issues with `dolomite-schemas`, please have a look
...
You can help improve `dolomite-schemas` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-schemas` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-schemas`'s files. While this mechanism can
...
```
conda create -n dolomite-schemas python=3 six virtualenv pytest pytest-cov
conda activate dolomite-schemas
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-schemas.git
   cd dolomite-schemas
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-schemas` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-schemas
[issue tracker]: https://github.com/<USERNAME>/dolomite-schemas/issues

...
class AthenaSourceV1(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["aws_authentication", b"aws_authentication", "date_partition_columns", b"date_partition_columns", "time_fragmented_partition_columns", b"time_fragmented_partition_columns", "time_partition_columns", b"time_partition_columns"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aws_authentication", b"aws_authentication", "aws_region", b"aws_region", "date_partition_columns", b"date_partition_columns", "s3_output_location", b"s3_output_location", "time_fragmented_partition_columns", b"time_fragmented_partition_columns", "time_partition_columns", b"time_partition_columns"]) -> None: ...

...
def feature_set(
    *,
    ...
    :param entity: The name of the entity for which the feature set is being created. An entity typically represents a
                   unique object or concept, like 'user', 'product', etc.
...
class StreamingFeatureSet(BaseFeatureSet):
    timestamp_column_name: str
    online_trigger_interval: int
    offline_scheduling_policy: str
    transformation: StreamingTransformation
    offline_cluster_template: ClusterTemplate
    online_cluster_template: ClusterTemplate
    metadata: Metadata

...
'''
def load_model(model_name, verbose=False, fa2=False):
	...
	model = auto_class.from_pretrained(model_name,  use_flash_attention_2=fa2)       #  Loads the model from HuggingFace Model Hub

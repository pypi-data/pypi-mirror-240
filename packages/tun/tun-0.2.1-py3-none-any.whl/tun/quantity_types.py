...
class Acceleration(QuantityType[unit_types.AccelerationUnit]):
    ...
    internal_units: units_type = unit_collections.Acceleration.m_per_s2
    default_display_units: units_type = unit_collections.Acceleration.m_per_s2
...
class Angle(QuantityType[unit_types.AngleUnit]):
    ...
    internal_units: units_type = unit_collections.Angle.rad
    default_display_units: units_type = unit_collections.Angle.deg
...
class Area(QuantityType[unit_types.AreaUnit]):
    ...
    internal_units: units_type = unit_collections.Area.m2
    default_display_units: units_type = unit_collections.Area.m2
...
class Currency(QuantityType[unit_types.CurrencyUnit]):
    ...
    internal_units: units_type = unit_collections.Currency.EUR
    default_display_units: units_type = unit_collections.Currency.EUR
...
class Current(QuantityType[unit_types.CurrentUnit]):
    ...
    internal_units: units_type = unit_collections.Current.A
    default_display_units: units_type = unit_collections.Current.A
...
class Density(QuantityType[unit_types.DensityUnit]):
    ...
    internal_units: units_type = unit_collections.Density.kg_per_m3
    default_display_units: units_type = unit_collections.Density.kg_per_m3
...
class DurationShare(QuantityType[unit_types.NoUnit]):
    ...
    internal_units: units_type = unit_collections.DurationShare.h_per_a
    default_display_units: units_type = unit_collections.DurationShare.h_per_a
...
class DynamicViscosity(QuantityType[unit_types.DynamicViscosityUnit]):
    ...
    internal_units: units_type = unit_collections.DynamicViscosity.Pa_s
    default_display_units: units_type = unit_collections.DynamicViscosity.Pa_s
...
class Energy(QuantityType[unit_types.EnergyUnit]):
    ...
    internal_units: units_type = unit_collections.Energy.J
    default_display_units: units_type = unit_collections.Energy.MWh
...
class EnergyCosts(QuantityType[unit_types.EnergyCostsUnit]):
    ...
    internal_units: units_type = unit_collections.EnergyCosts.EUR_per_MWh
    default_display_units: units_type = unit_collections.EnergyCosts.EUR_per_MWh
...
class EnergyInDuration(QuantityType[unit_types.PowerUnit]):
    ...
    internal_units: units_type = unit_collections.EnergyInDuration.MWh_per_a
    default_display_units: units_type = unit_collections.EnergyInDuration.MWh_per_a
...
class Frequency(QuantityType[unit_types.FrequencyUnit]):
    ...
    internal_units: units_type = unit_collections.Frequency.Hz
    default_display_units: units_type = unit_collections.Frequency.Hz
...
class GeothermalProdIndex(QuantityType[unit_types.GeothermalProdIndexUnit]):
    ...
    internal_units: units_type = unit_collections.GeothermalProdIndex.m3_per_s_Pa
    default_display_units: units_type = unit_collections.GeothermalProdIndex.m3_per_s_Pa
...
class HeatCapacityRate(QuantityType[unit_types.HeatCapacityRateUnit]):
    ...
    internal_units: units_type = unit_collections.HeatCapacityRate.W_per_K
    default_display_units: units_type = unit_collections.HeatCapacityRate.W_per_K
...
class HeatTransferCoefficient(QuantityType[unit_types.HeatTransferCoefficientUnit]):
    ...
    internal_units: units_type = unit_collections.HeatTransferCoefficient.W_per_m2_K
    default_display_units: units_type = unit_collections.HeatTransferCoefficient.W_per_m2_K
...
class HourlyCosts(QuantityType[unit_types.HourlyCostsUnit]):
    ...
    internal_units: units_type = unit_collections.HourlyCosts.EUR_per_h
    default_display_units: units_type = unit_collections.HourlyCosts.EUR_per_h
...
class Irradiance(QuantityType[unit_types.HeatTransferCoefficientUnit]):
    units_type: Type[unit_types.HeatTransferCoefficientUnit] = unit_types.HeatTransferCoefficientUnit
    internal_units: units_type = unit_collections.QuadraticHeatTransferCoefficient.W_per_m2_K2
    default_display_units: units_type = unit_collections.QuadraticHeatTransferCoefficient.W_per_m2_K2
...
class KinematicViscosity(QuantityType[unit_types.KinematicViscosityUnit]):
    ...
    internal_units: units_type = unit_collections.KinematicViscosity.m2_per_s
    default_display_units: units_type = unit_collections.KinematicViscosity.m2_per_s
...
class Length(QuantityType[unit_types.LengthUnit]):
    ...
    internal_units: units_type = unit_collections.Length.m
    default_display_units: units_type = unit_collections.Length.m
...
class LinearPressure(QuantityType[unit_types.PressureUnit]):
    ...
    internal_units: units_type = unit_collections.LinearPressure.Pa_s_per_l
    default_display_units: units_type = unit_collections.LinearPressure.Pa_s_per_l
...
class Mass(QuantityType[unit_types.MassUnit]):
    ...
    internal_units: units_type = unit_collections.Mass.kg
    default_display_units: units_type = unit_collections.Mass.kg
...
class NoUnit(QuantityType[unit_types.NoUnit]):
    units_type: Type[unit_types.NoUnit] = unit_types.NoUnit
    internal_units: units_type = unit_collections.NoUnit.No
    default_display_units: units_type = unit_collections.NoUnit.No
...
class Power(QuantityType[unit_types.PowerUnit]):
    units_type: Type[unit_types.PowerUnit] = unit_types.PowerUnit
    internal_units: units_type = unit_collections.Power.W
    default_display_units: units_type = unit_collections.Power.kW
...
class PowerAreaRatio(QuantityType[unit_types.PowerAreaRatioUnit]):
    ...
    internal_units: units_type = unit_collections.PowerAreaRatio.W_per_m2
    default_display_units: units_type = unit_collections.PowerAreaRatio.W_per_m2
...
class Pressure(QuantityType[unit_types.PressureUnit]):
    units_type: Type[unit_types.PressureUnit] = unit_types.PressureUnit
    internal_units: units_type = unit_collections.Pressure.Pa
    default_display_units: units_type = unit_collections.Pressure.bar
...
class QuadraticPressure(QuantityType[unit_types.PressureUnit]):
    units_type: Type[unit_types.PressureUnit] = unit_types.PressureUnit
    internal_units: units_type = unit_collections.QuadraticPressure.Pa_s2_per_l2
    default_display_units: units_type = unit_collections.QuadraticPressure.Pa_s2_per_l2
...
class ShareInPeriod(QuantityType[unit_types.FrequencyUnit]):
    units_type: Type[unit_types.FrequencyUnit] = unit_types.FrequencyUnit
    internal_units: units_type = unit_collections.ShareInPeriod.share_per_a
    default_display_units: units_type = unit_collections.ShareInPeriod.share_per_a
...
class SpecificHeatCapacity(QuantityType[unit_types.SpecificHeatCapacityUnit]):
    ...
    internal_units: units_type = unit_collections.SpecificHeatCapacity.J_per_kg_K
    default_display_units: units_type = unit_collections.SpecificHeatCapacity.J_per_kg_K
...
class Temperature(QuantityType[unit_types.TemperatureUnit]):
    ...
    internal_units: units_type = unit_collections.Temperature.K
    default_display_units: units_type = unit_collections.Temperature.deg_C
...
class TemperatureCorrection(QuantityType[unit_types.TemperatureCorrectionUnit]):
    ...
    internal_units: units_type = unit_collections.TemperatureCorrection.inverse_K
    default_display_units: units_type = unit_collections.TemperatureCorrection.inverse_K
...
class TemperatureDifference(QuantityType[unit_types.TemperatureDifferenceUnit]):
    ...
    internal_units: units_type = unit_collections.TemperatureDifference.delta_deg_C
    default_display_units: units_type = unit_collections.TemperatureDifference.delta_deg_C
...
class ThermalConductivity(QuantityType[unit_types.ThermalConductivityUnit]):
    ...
    internal_units: units_type = unit_collections.ThermalConductivity.W_per_m_K
    default_display_units: units_type = unit_collections.ThermalConductivity.W_per_m_K
...
class Time(QuantityType[unit_types.TimeUnit]):
    ...
    internal_units: units_type = unit_collections.Time.s
    default_display_units: units_type = unit_collections.Time.h
...
class Velocity(QuantityType[unit_types.VelocityUnit]):
    ...
    internal_units: units_type = unit_collections.Velocity.m_per_s
    default_display_units: units_type = unit_collections.Velocity.m_per_s
...
class Volume(QuantityType[unit_types.VolumeUnit]):
    ...
    internal_units: units_type = unit_collections.Volume.m3
    default_display_units: units_type = unit_collections.Volume.m3
...
class VolumeFlow(QuantityType[unit_types.VolumeFlowUnit]):
    ...
    internal_units: units_type = unit_collections.VolumeFlow.m3_per_h
    default_display_units: units_type = unit_collections.VolumeFlow.l_per_min

...
class Quaternion:
    ...
    def exp_ddot(q):
        ...
        ddfwdxdx = -frac_cos_sin*x*x - frac_sin_theta_half
        ddfwdydx = -frac_cos_sin*x*y 
        ddfwdzdx = -frac_cos_sin*x*z
        
        ddfwdydy = -frac_cos_sin*y*y - frac_sin_theta_half
        ddfwdzdy = -frac_cos_sin*y*z
        
        ddfwdzdz = -frac_cos_sin*z*z - frac_sin_theta_half

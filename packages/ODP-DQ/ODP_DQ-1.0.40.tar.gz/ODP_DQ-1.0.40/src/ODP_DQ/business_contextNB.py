...
class BusinessContext:
    ...
    def business_contextFN(self,df):
        ...
        prompt = """Understand the given dataset and generate the business context of the data.
            ...
            """
        agent = create_pandas_dataframe_agent(llm, df, verbose=False, max_iterations=10,handle_parsing_errors=True)
    ...
    def dq_rulesFN(self,df):
        ...
        dq_rules=self.spark.createDataFrame([(dq_rules,)],['Data_Quality_Rules'])
        return dq_rules
...
class JwtProvider(betterproto.Message):
    ...
    seconds: 300 [#next-free-field: 17]
    """
    ...
    code-block:: yaml   claim_to_headers:     - name: x-jwt-claim-nested-claim
    claim: claim.nested.key This header is only reserved for jwt claim; any
    other value will be overwrite.
    """

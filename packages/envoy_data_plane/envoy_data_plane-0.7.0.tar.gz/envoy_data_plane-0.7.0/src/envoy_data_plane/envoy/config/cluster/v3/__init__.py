...
class Filter(betterproto.Message):
    ...
    not valid upstream filters. Only one of typed_config or config_discovery
    can be used.
    """
...
class OutlierDetection(betterproto.Message):
    ...
    more information on outlier detection. [#next-free-field: 24]
    """
    ...
    successful_active_health_check_uneject_host: Optional[
        bool

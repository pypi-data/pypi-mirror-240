...
class QuicProtocolOptions(betterproto.Message):
    ...
    the address family the client initially connects with, and only if the
    client is also QUICHE-based. If not specified, Envoy will not advertise any
    server's preferred address. [#extension-category:
...
class Listener(betterproto.Message):
    ...
    max_connections_to_accept_per_socket_event: Optional[
        int

...
def get_algorithm_choice():
    ...
    parser.add_argument(
        "algorithm_number",
        type=int,
        choices=range(1, len(algorithms) + 1),
        help="Select an algorithm by entering its number"
    )
    args = parser.parse_args()
    return algorithms[args.algorithm_number - 1]

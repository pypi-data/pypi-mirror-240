...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("paguro")
...
ipython_execlines = ["import paguro"]
...
#     member for member in dir(paguro.Array) if inspect.isdatadescriptor(getattr(type(paguro.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(paguro._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(paguro._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(paguro.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(paguro._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(paguro.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(paguro.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(paguro._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(paguro._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(paguro._domains._meta.ArrayMeta, p)
#     delattr(paguro._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(paguro.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(paguro._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(paguro._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)

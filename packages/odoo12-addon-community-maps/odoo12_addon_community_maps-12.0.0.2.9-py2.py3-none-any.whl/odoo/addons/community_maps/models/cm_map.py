...
class CmMap(models.Model):
  ...
  noresults_msg = fields.Text(string=_("No-Results filter message for popup."),translate=True)
  ...
  proposal_cta_title = fields.Char(string=_("Proposal cta title"),translate=True)
  proposal_form_title = fields.Char(string=_("Proposal form title"),translate=True)
  proposal_form_subtitle_step_category = fields.Char(string=_("Proposal form subtitle (category selection)"),translate=True)
  proposal_form_subtitle_step_address = fields.Char(string=_("Proposal form subtitle (address selection)"),translate=True)
  proposal_form_subtitle_step_form = fields.Char(string=_("Proposal form subtitle (form selection)"),translate=True)
  proposal_form_model_id = fields.Many2one('cm.form.model',string=_("Proposal submission form"))
  categories_filter_title = fields.Char(string=_('"Category" filter title'),translate=True)
  ...
  external_link_cta_txt = fields.Char(
    ...
    help=_('It will be used when place interaction method is set to "External link"'),
    translate=True
  )
  # Initial center

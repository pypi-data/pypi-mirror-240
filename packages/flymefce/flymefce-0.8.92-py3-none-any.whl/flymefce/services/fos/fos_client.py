...
DEFAULT_FOS_DOMAIN_SUFFIX = b'bcebos.com'
...
class FosClient(FceBaseClient):
    ...
    def generate_pre_signed_url(self,
        ...
        :param is_official_domain: default use not official domain,example: bucket.szfos.flyme.com
        ...
        params[http_headers.AUTHORIZATION.lower()] = fce_v1_signer.sign(
            config.credentials,
            httpmethod,
            path,
            headers,
    ...
    def _prepare_object_headers(
        ...
        if customer_key is not None:
            headers[http_headers.FOS_SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY] = \
                utils.convert_to_standard_string(customer_key)

        if customer_key_md5 is not None:
            headers[http_headers.FOS_SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5] = \
    ...
    def _get_user_header(headers, user_headers, is_copy=False):
        ...
        if not is_copy:
            ...
            user_headers_set = set([http_headers.FCE_COPY_SOURCE_IF_NONE_MATCH,

...
def _get_connection(protocol, host, port, connection_timeout_in_millis):
    """
    :param protocol
    :type protocol: flymebce.protocol.Protocol
...
def send_request(
    ...
    """
    Send request to FCE services.

    :param config
    :type config: flymefce.FceClientConfiguration
    ...
    :param request:
    :type request: flymefce.internal.InternalRequest

    :return:
    :rtype: flymefce.FceResponse
    """

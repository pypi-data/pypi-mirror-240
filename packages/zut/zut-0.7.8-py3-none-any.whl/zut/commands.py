...
class CommandManager:
    def __init__(self, main_module: ModuleType|str = None, *, prog: str = None, add_arguments: Callable[[ArgumentParser]] = None, default_handle: Callable = None, runner: Callable = None, doc: str = None):
        self._registered_resources: dict[str,CommandResource] = {}
        self._used_resources: list[CommandResource] = []
        self._args: dict[str,Any] = None

        if main_module or prog or add_arguments or default_handle or runner or doc:
            self._prepare(main_module, prog, add_arguments, default_handle, runner=runner, doc=doc)


    def _prepare(self, main_module: ModuleType|str, prog: str, add_arguments: Callable[[ArgumentParser]], default_handle: Callable, runner: Callable, doc: str = None):
        """
        ...
        self.root_module = import_module(".", package=main_module.__package__)
    ...
    def main(self, main_module: ModuleType|str = None, prog: str = None, add_arguments: Callable[[ArgumentParser]] = None, default_handle: Callable = None, runner: Callable = None, doc: str = None):
        """
        ...
        """
        if not hasattr(self, 'main_module') or main_module or prog or add_arguments or default_handle or runner or doc:
            self._prepare(main_module, prog, add_arguments, default_handle, runner=runner, doc=doc)
        ...
        args = vars(namespace)
        func = args.pop('func', self.default_handle)
    ...
    def create_django_command(self, main_module: ModuleType|str = None, *, prog: str = None, add_arguments: Callable[[ArgumentParser]] = None, default_handle: Callable = None, runner: Callable = None, doc: str = None):
        """
        ...
        class Command(BaseCommand):
            ...
            def handle(self2, func=None, **args):
                ...
                if func is None and self.default_handle:
                    func = self.default_handle

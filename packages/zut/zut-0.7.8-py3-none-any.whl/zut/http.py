...
class JSONApiClient:
    ...
    def get(self, endpoint: str = None, *, params: dict = None):
        return self.request(endpoint, method='GET', params=params)


    def post(self, endpoint: str = None, data = None, *, params: dict = None):
        return self.request(endpoint, data, method='POST', params=params)
    

    def request(self, endpoint: str = None, data = None, *, method = None, params: dict = None):

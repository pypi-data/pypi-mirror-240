...
class _Action:
    ...
    def __init__(self, app, action_key: str):
        ...
        if self.pset:
            self.act.GetDefault(self.pset.HSet)
    ...
    def get_pset(self):
        ...
        self.App.api.HAction.GetDefault(self.action_key, pset.HSet)
        return pset
...
class _Actions:
    ...
    def __getattr__(self, action_key):
        return lambda: self._app.create_action(action_key)

    def __dir__(self):
        return [key for key in _action_info.keys()]

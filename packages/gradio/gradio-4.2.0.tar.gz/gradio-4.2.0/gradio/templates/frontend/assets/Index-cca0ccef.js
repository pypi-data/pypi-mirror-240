import { I as ImageUploader, S as StaticImage } from './ImageUploader-39142af8.js';
export { W as Webcam } from './ImageUploader-39142af8.js';
import { B as Block } from './Button-d01a5784.js';
import { E as Empty } from './Empty-ca3c438c.js';
import { S as Static } from './Index-de80f18c.js';
import { I as Image } from './Image-6cbf81d1.js';
import { U as UploadText } from './UploadText-2891d2eb.js';
import { n as normalise_file } from './index-2bc2a342.js';
export { default as BaseExample } from './Example-33748a47.js';
import './utils-8f25e669.js';
import './BlockLabel-36c0a266.js';
import './IconButton-2ecdc45b.js';
import './ShareButton-4ea4671a.js';
import './Download-ea83bae3.js';
import './DropdownArrow-c2bc54a9.js';
import './Upload-bda8547d.js';
/* empty css                                                     */import './Clear-9760deed.js';
import './svelte/svelte.js';
import './file-url-0617e0cd.js';
/* empty css                                                */
...
function create_else_block(ctx) {
	...
	block = new Block({
			props: {
				...
				variant: /*_value*/ ctx[24] === null ? "dashed" : "solid",
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_value*/ 16777216) block_changes.variant = /*_value*/ ctx[24] === null ? "dashed" : "solid";
			...
			if (dirty[0] & /*_selectable, root, sources, label, show_label, pending, streaming, mirror_webcam, gradio, active_tool, value, dragging, loading_status*/ 16583011 | dirty[1] & /*$$scope*/ 1024) {
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_value, label, show_label, show_download_button, _selectable, show_share_button, gradio, loading_status*/ 18909410 | dirty[1] & /*$$scope*/ 1024) {
				block_changes.$$scope = { dirty, ctx };
			}
...
// (129:3) {#if sources.includes("upload")}
...
// (132:4) <Empty unpadded_box={true} size="large">
...
// (82:1) <Block   {visible}   variant={_value === null ? "dashed" : "solid"}   border_mode={dragging ? "focus" : "base"}   padding={false}   {elem_id}   {elem_classes}   height={height || undefined}   {width}   allow_overflow={false}   {container}   {scale}   {min_width}  >
function create_default_slot_1(ctx) {
	...
	function imageuploader_active_tool_binding(value) {
		/*imageuploader_active_tool_binding*/ ctx[29](value);
	}

	function imageuploader_value_binding(value) {
		/*imageuploader_value_binding*/ ctx[30](value);
	}
	...
	imageuploader.$on("edit", /*edit_handler*/ ctx[31]);
	imageuploader.$on("clear", /*clear_handler*/ ctx[32]);
	imageuploader.$on("stream", /*stream_handler*/ ctx[33]);
	imageuploader.$on("drag", /*drag_handler*/ ctx[34]);
	imageuploader.$on("upload", /*upload_handler*/ ctx[35]);
	imageuploader.$on("select", /*select_handler_1*/ ctx[36]);
	imageuploader.$on("share", /*share_handler_1*/ ctx[37]);
	imageuploader.$on("error", /*error_handler_2*/ ctx[38]);
	imageuploader.$on("click", /*click_handler*/ ctx[39]);
	imageuploader.$on("error", /*error_handler*/ ctx[40]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*gradio, sources*/ 2162688 | dirty[1] & /*$$scope*/ 1024) {
...
// (49:1) <Block   {visible}   variant={"solid"}   border_mode={dragging ? "focus" : "base"}   padding={false}   {elem_id}   {elem_classes}   height={height || undefined}   {width}   allow_overflow={false}   {container}   {scale}   {min_width}  >
function create_default_slot(ctx) {
	...
	staticimage.$on("select", /*select_handler*/ ctx[26]);
	staticimage.$on("share", /*share_handler*/ ctx[27]);
	staticimage.$on("error", /*error_handler_1*/ ctx[28]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_value*/ 16777216) staticimage_changes.value = /*_value*/ ctx[24];
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*value, root, proxy_url*/ 33554689) {
			$$invalidate(24, _value = normalise_file(value, root, proxy_url));
		}
...
//# sourceMappingURL=Index-cca0ccef.js.map

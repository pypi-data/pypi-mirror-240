...
const ENTRY_CSS = "./assets/index-f1cc783a.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-de80f18c.js').then(n => n.I),true?["./Index-de80f18c.js","./Index-c3a731c8.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-2bc2a342.js.map

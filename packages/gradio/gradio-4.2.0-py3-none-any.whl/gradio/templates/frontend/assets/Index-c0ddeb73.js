...
import { S as ShareButton } from './ShareButton-4ea4671a.js';
import { S as Static } from './Index-de80f18c.js';
import './Index.svelte_svelte_type_style_lang-4d097eeb.js';
import { M as MarkdownCode } from './Example.svelte_svelte_type_style_lang-82824053.js';
import { g as get_fetchable_url_or_file, n as normalise_file } from './index-2bc2a342.js';
import { C as Copy, a as Check } from './Copy-e5864b80.js';
import { B as BlockLabel } from './BlockLabel-36c0a266.js';
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			div3.innerHTML = `<span class="sr-only">Loading content</span> <div class="dot-flashing svelte-1ofy3w8"></div>
	 
	<div class="dot-flashing svelte-1ofy3w8"></div>
	 
	<div class="dot-flashing svelte-1ofy3w8"></div>`;

			attr$2(div3, "class", "message pending svelte-1ofy3w8");
...
function create_if_block$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*value, layout, avatar_images, bubble_full_width, show_copy_button, handle_like, likeable, render_markdown, rtl, selectable, handle_select, latex_delimiters, sanitize_html, line_breaks, scroll, pending_message, root, proxy_url*/ 1933279) {
...
// (95:5) {#if message !== null || pending_message}
function create_if_block_1$1(ctx) {
	...
	function select_block_type(ctx, dirty) {
		...
		if (/*pending_message*/ ctx[2] && /*j*/ ctx[42] === 1) return 5;
		return -1;
	}
	...
	let if_block2 = (/*likeable*/ ctx[4] && /*j*/ ctx[42] !== 0 || /*show_copy_button*/ ctx[7] && /*message*/ ctx[40] && typeof /*message*/ ctx[40] === "string") && create_if_block_2(ctx);
...
// (191:7) {#if (likeable && j !== 0) || (show_copy_button && message && typeof message === "string")}
function create_if_block_2(ctx) {
	let div_1;
	let t;
	let div_1_class_value;
	let current;
	let if_block0 = /*likeable*/ ctx[4] && /*j*/ ctx[42] == 1 && create_if_block_4(ctx);
	let if_block1 = /*show_copy_button*/ ctx[7] && /*message*/ ctx[40] && typeof /*message*/ ctx[40] === "string" && create_if_block_3(ctx);
...
// (211:9) {#if show_copy_button && message && typeof message === "string"}
...
function create_each_block_1(ctx) {
	let if_block_anchor;
	let current;
	let if_block = (/*message*/ ctx[40] !== null || /*pending_message*/ ctx[2]) && create_if_block_1$1(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			if (/*message*/ ctx[40] !== null || /*pending_message*/ ctx[2]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty[0] & /*value, pending_message*/ 5) {
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*layout, avatar_images, bubble_full_width, value, show_copy_button, handle_like, likeable, render_markdown, rtl, selectable, handle_select, latex_delimiters, sanitize_html, line_breaks, scroll, pending_message, root, proxy_url*/ 1933279) {
...
//# sourceMappingURL=Index-c0ddeb73.js.map

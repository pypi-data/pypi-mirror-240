...
const ENTRY_CSS = "./assets/index-a7ca4fc2.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-f53dcca6.js').then(n => n.I),true?["./Index-f53dcca6.js","./Index-2ba9aa2c.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-9547cefe.js.map

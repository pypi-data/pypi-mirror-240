...
class TeamMentalClient:
    ...
    def get_team(self, name: str) -> api_types.Team:
        res = self.request('GET', self._base_api_prefix + f'team/{name}')
    ...
    def add_user_to_team(self, team_id: int, user_id: int) -> None:
        json_payload = api_types.AddUserPayload(user_id).to_dict()
    ...
    def get_user(self, user_id: int) -> api_types.User:
        res = self.request('GET', self._base_api_prefix + f'user/{user_id}')
        return api_types.User.from_dict(res)

    def delete_user(self, user_id: int) -> None:
        self.request('DELETE', self._base_api_prefix + f'user/{user_id}')

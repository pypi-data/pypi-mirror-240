...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("arpoon")
...
html_title = "arpoon"
# html_favicon = "../logo/arpoon-favicon-color.png"
# html_logo = "../logo/arpoon-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://arpoon.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/arpoon",
    "repo_name": "bernardodionisi/arpoon",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/arpoon",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/arpoon/",
        },
    ],
    "edit_uri": "",
...
ipython_execlines = ["import arpoon"]
...
#     member for member in dir(arpoon.Array) if inspect.isdatadescriptor(getattr(type(arpoon.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(arpoon._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(arpoon._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(arpoon.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(arpoon._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(arpoon.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(arpoon.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(arpoon._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(arpoon._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(arpoon._domains._meta.ArrayMeta, p)
#     delattr(arpoon._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(arpoon.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(arpoon._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(arpoon._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)

...
The latest released version of :obj:`arpoon` can be installed from `PyPI <https://pypi.org/project/arpoon/>`_ using `pip`.
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/arpoon.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/arpoon.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import arpoon`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/arpoon.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e arpoon/
...
.. code-block:: console
   ...
   $ python3 -m pip install arpoon[dev]

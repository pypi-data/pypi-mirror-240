...
def bake(
    ...
    ''' Bake all selected objects location/scale/rotation animation to an action :File: `startup/bl_operators/anim.py\:268 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L268>`__

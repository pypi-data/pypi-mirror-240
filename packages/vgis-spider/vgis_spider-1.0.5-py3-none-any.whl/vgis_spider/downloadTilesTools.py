        ...
        try:
            ...
            if not os.path.exists(os.path.join(self.out_image_path, self.merge_pic_name)):
                if self.image_service_type == "wms":
                    ...
                    # city_air_datas_list = pool.map(spider_city_air_quality_realtime_data, city_list)
                    #    结束多线程
                    # pool.close()
                    # pool.join()
...
if __name__ == '__main__':
    ...
    try:
        ...
        # # image_service_info["service_url"] = "http://192.168.3.77:8085/geoserver/ttxm/wms?"

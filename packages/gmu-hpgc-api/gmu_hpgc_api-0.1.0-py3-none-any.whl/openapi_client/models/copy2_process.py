...
from openapi_client.models.copy2_input_description import InputDescription
...
from openapi_client.models.copy2_output_description import OutputDescription
...
class Process2(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Process:
        ...
        if not isinstance(obj, dict):
            return Process2.parse_obj(obj)

        _obj = Process2.parse_obj({
            "title": obj.get("title"),

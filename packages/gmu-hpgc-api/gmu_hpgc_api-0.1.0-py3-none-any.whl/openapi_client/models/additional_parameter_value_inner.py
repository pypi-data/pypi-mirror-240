...
class AdditionalParameterValueInner(BaseModel):
    ...
    oneof_schema_2_validator: Optional[StrictFloat] = None
    # data type: int
    oneof_schema_3_validator: Optional[StrictInt] = None
    # data type: List[object]
    oneof_schema_4_validator: Optional[conlist(Any)] = None
    # data type: object
    oneof_schema_5_validator: Optional[Dict[str, Any]] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(ADDITIONALPARAMETERVALUEINNER_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = AdditionalParameterValueInner.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalParameterValueInner:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> AdditionalParameterValueInner:

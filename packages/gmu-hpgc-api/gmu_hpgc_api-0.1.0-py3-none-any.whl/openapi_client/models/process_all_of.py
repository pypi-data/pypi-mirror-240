...
class ProcessAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProcessAllOf:
        """Create an instance of ProcessAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProcessAllOf:
        """Create an instance of ProcessAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProcessAllOf.parse_obj(obj)

        _obj = ProcessAllOf.parse_obj({
            "inputs": dict(

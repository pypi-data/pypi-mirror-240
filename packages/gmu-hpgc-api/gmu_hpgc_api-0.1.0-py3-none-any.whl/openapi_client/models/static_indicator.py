...
class StaticIndicator(BaseModel):
    ...
    __properties = ["title", "description", "keywords", "metadata", "additionalParameters", "id", "version", "jobControlOptions", "outputTransmission", "links", "mutable"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StaticIndicator:
        """Create an instance of StaticIndicator from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StaticIndicator:
        """Create an instance of StaticIndicator from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StaticIndicator.parse_obj(obj)

        _obj = StaticIndicator.parse_obj({
            "title": obj.get("title"),

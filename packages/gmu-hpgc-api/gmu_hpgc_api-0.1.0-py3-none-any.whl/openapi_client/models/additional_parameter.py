...
class AdditionalParameter(BaseModel):
    ...
    value: conlist(AdditionalParameterValueInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalParameter:
        """Create an instance of AdditionalParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdditionalParameter.parse_obj(obj)

        _obj = AdditionalParameter.parse_obj({
            "name": obj.get("name"),
            "value": [AdditionalParameterValueInner.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None
        })
        return _obj

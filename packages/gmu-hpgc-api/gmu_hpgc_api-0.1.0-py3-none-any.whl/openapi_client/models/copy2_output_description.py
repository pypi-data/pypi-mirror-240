...
class OutputDescription(BaseModel):
    ...
    __properties = ["title", "description", "keywords", "metadata", "additionalParameters", "schema"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutputDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutputDescription:
        """Create an instance of OutputDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutputDescription.parse_obj(obj)

        _obj = OutputDescription.parse_obj({
            "title": obj.get("title"),

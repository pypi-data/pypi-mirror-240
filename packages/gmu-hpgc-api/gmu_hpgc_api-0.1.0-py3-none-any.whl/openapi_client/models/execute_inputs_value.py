...
class ExecuteInputsValue(BaseModel):
    ...
    oneof_schema_2_validator: Optional[conlist(InlineOrRefData)] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(EXECUTEINPUTSVALUE_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ExecuteInputsValue.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExecuteInputsValue:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ExecuteInputsValue:

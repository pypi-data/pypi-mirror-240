...
class DRUApi(object):
    ...
    @validate_arguments
    def replace(self, process_id : str, ogcapppkg : Annotated[Ogcapppkg, Field(..., description="An OGC Application Package used to deploy a new process.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def replace_with_http_info(self, process_id : str, ogcapppkg : Annotated[Ogcapppkg, Field(..., description="An OGC Application Package used to deploy a new process.")], **kwargs) -> ApiResponse:  # noqa: E501
        """replace a process.  # noqa: E501
    ...
    @validate_arguments
    def undeploy(self, process_id : str, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def undeploy_with_http_info(self, process_id : str, **kwargs) -> ApiResponse:  # noqa: E501
        """undeploy a process.  # noqa: E501

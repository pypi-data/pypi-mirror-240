...
if __name__ == "__main__":
    ...
    if openai_api_host:
        ...
        openai.api_key = ""
        gpt_model = "llama-13b"
        row_embeddings_path = "./conv_anal/bin/db_bert_embeddings_row.bin"
        fine_embeddings_path = "./conv_anal/bin/db_bert_embeddings.bin"
    else:
    ...
    row_embeddings = calculate_embeddings(row_summaries)
    row_embeddings.to_pickle(row_embeddings_path, compression="infer")
    
    fine_embeddings = calculate_embeddings(fine_summaries)

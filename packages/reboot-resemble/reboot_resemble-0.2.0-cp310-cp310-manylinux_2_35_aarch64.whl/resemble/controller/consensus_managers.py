...
class LocalConsensusManager(ConsensusManager):
    ...
    async def _set_consensus(
        ...
        async def launch():
            ...
            if len(subprocess_serviceables) != 0:
                print("subprocess_serviceables not null")
                ...
                print("in_process_serviceables not null")
    ...
    async def _launch_subprocess_consensus(
        ...
        print("before launchedConsensus construct")
        print(launch_local_envoy)
        cons = LaunchedConsensus(
            consensus=consensus,
            serviceables=serviceables,
            addresses=addresses,
            local_envoy=await
        ...
        print("after launchedConsensus construct")
        return cons
    ...
    async def _launch_local_envoy(
        ...
        print("before local envoy construct")
        ...
        print("before local envoy start")
        await local_envoy.start()
        print("after local envoy start")
        return local_envoy

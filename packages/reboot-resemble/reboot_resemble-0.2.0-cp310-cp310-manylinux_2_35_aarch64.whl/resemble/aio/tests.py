...
class Resemble:
    ...
    async def up(
        ...
        *,
        ...
        state.
        """
        print("before initialize_once")
        await self._initialize_once()
        print("after initialize_once")
        ...
        if len(serviceables) > 0:
            ...
            print("before register_serviceables")
            ...
            print("after register_serviceables")

            config = self._config_extractor.config_from_serviceables(
                serviceables
            )
            print("after config_from_serviceables")
        ...
        # up the new plan.
        print("before wait_for_service_names")
        await self._resolver.wait_for_service_names(config.service_names)
        print("after wait_for_service_names")
        return config

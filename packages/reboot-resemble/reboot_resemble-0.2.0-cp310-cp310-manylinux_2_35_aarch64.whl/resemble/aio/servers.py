...
class _ServiceServer(Server):
    ...
    def __init__(
        ...
        self._channel_manager = _ChannelManager(actor_resolver)
        ...
        print("before react add_to_server")
        ...
        print("before tasksservicer add_to_server")
        ...
        print("before state_manager add_to_server")
    ...
    async def start(self):
        ...
        workflow = Workflow(
            ...
            channel_manager=_ChannelManager(
                StaticResolver(self._listen_address)
            ),
        )

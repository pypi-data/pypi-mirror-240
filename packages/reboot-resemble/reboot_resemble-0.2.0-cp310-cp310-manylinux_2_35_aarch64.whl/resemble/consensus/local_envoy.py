...
class LocalEnvoy:
    ...
    async def _async_check_output(*args, **kwargs) -> str:
        ...
        print("before communicate local envoy")
        stdout_data, _ = await process.communicate()
        print("after communicate local envoy")
    ...
    async def _docker_run_envoy(tmp_envoy_file_name: str) -> str:
        ...
        print("docker envoy pathes checked")
        ...
        print("docker envoy run container id")

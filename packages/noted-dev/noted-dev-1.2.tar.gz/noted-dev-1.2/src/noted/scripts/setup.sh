...
MAIN_DIR="$HOME/noted/src/noted"
LOGS_DIR="$HOME/noted/src/noted/logs"
QUERY_DIR="$HOME/noted/src/noted/query"
SENSE_DIR="$HOME/noted/src/noted/sense-o"
CONFIG_DIR="$HOME/noted/src/noted/config"
PARAMS_DIR="$HOME/noted/src/noted/params"
TRANSFERS_DIR="$HOME/noted/src/noted/transfers"

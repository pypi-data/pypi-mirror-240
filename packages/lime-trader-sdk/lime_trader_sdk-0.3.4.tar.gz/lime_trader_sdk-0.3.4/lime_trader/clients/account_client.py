...
from lime_trader.models.accounts import (AccountDetails, AccountPosition, AccountTrade, AccountTransaction,
                                         AccountTransactionsPage, AccountTradesPage)
...
from lime_trader.constants.urls import (ACCOUNTS_GET_ACCOUNTS_BALANCES, ACCOUNTS_GET_ACCOUNT_POSITIONS,
                                        ...
                                        ACCOUNTS_GET_ACCOUNT_TRANSACTIONS, ACCOUNTS_STREAMING_FEED)
...
class AccountClient:
    ...
    def get_positions(self, account_number: str, date: datetime.date | None = None) -> list[AccountPosition]:
        """
        Gets account positions for specified date, or today if date is not supplied

        Args:
            account_number: Account number
            date: Date for account positions. If not specified, returns current intraday positions

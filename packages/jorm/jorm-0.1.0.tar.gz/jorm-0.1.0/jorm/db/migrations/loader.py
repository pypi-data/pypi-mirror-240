...
from jorm.db.migrations.graph import MigrationGraph
from jorm.db.migrations.recorder import MigrationRecorder
...
class MigrationLoader:
    ...
    inherit from jorm.db.migrations.Migration. See
    jorm.db.migrations.migration for what that looks like.

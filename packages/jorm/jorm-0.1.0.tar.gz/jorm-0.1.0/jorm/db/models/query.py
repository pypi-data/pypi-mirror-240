...
from jorm.core import exceptions
from jorm.db import (
...
from jorm.db.models import AutoField, DateField, DateTimeField, Field, sql
from jorm.db.models.constants import LOOKUP_SEP, OnConflict
from jorm.db.models.deletion import Collector
from jorm.db.models.expressions import Case, F, Value, When
from jorm.db.models.functions import Cast, Trunc
from jorm.db.models.query_utils import FilteredRelation, Q
from jorm.db.models.sql.constants import CURSOR, GET_ITERATOR_CHUNK_SIZE
from jorm.db.models.utils import (
    AltersData,
    create_namedtuple_class,
    resolve_callables,
)
from jorm.utils import timezone
from jorm.utils.deprecation import RemovedInDjango60Warning
from jorm.utils.functional import cached_property, partition
...
class QuerySet(AltersData):
    ...
    def __getstate__(self):
        ...
        self._fetch_all()
        return {**self.__dict__, JORM_version_PICKLE_KEY: jorm.__version__}

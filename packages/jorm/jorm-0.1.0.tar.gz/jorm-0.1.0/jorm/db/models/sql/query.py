...
from jorm.core.exceptions import FieldDoesNotExist, FieldError
from jorm.db import DEFAULT_DB_ALIAS, NotSupportedError, connections
from jorm.db.models.aggregates import Count
...
from jorm.db.models.fields import Field
from jorm.db.models.fields.related_lookups import MultiColSource
from jorm.db.models.lookups import Lookup
from jorm.db.models.query_utils import (
    Q,
    check_rel_lookup_compatibility,
    refs_expression,
)
from jorm.db.models.sql.constants import INNER, LOUTER, ORDER_DIR, SINGLE
from jorm.db.models.sql.datastructures import BaseTable, Empty, Join, MultiJoin
from jorm.db.models.sql.where import AND, OR, ExtraWhere, NothingNode, WhereNode
from jorm.utils.functional import cached_property
from jorm.utils.regex_helper import _lazy_re_compile
from jorm.utils.tree import Node
...
class Query(BaseExpression):
    ...
    def get_aggregation(self, using, aggregate_exprs):
        ...
        if (
            ...
            from jorm.db.models.sql.subqueries import AggregateQuery

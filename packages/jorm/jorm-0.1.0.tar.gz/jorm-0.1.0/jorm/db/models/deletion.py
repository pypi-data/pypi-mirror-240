...
from jorm.db import IntegrityError, connections, models, transaction
from jorm.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("jorm.db.models.SET", (value,), {})

...
from jorm.utils.autoreload import autoreload_started, file_changed
from jorm.utils.functional import lazy
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from jorm.utils.translation import trans_real as trans
            from jorm.utils.translation.reloader import (
            ...
            from jorm.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from jorm.conf.locale import LANG_INFO

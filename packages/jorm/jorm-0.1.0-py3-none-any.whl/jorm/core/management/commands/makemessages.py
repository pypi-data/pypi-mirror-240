...
from jorm.core.files.temp import NamedTemporaryFile
...
from jorm.utils.jslex import prepare_js_for_gettext
from jorm.utils.regex_helper import _lazy_re_compile
from jorm.utils.text import get_text_list
from jorm.utils.translation import templatize
...
class Command(BaseCommand):
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        django_dir = os.path.normpath(os.path.join(os.path.dirname(jorm.__file__)))
        if self.domain == "djangojs":

...
from jorm.core.cache.backends.base import DEFAULT_TIMEOUT, BaseCache
from jorm.db import DatabaseError, connections, models, router, transaction
from jorm.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a jorm model _meta class.

...
from jorm.core import checks
from jorm.core.exceptions import (
    NON_FIELD_ERRORS,
    FieldDoesNotExist,
    FieldError,
...
from jorm.db.models import NOT_PROVIDED, ExpressionWrapper, IntegerField, Max, Value
from jorm.db.models.constants import LOOKUP_SEP
from jorm.db.models.constraints import CheckConstraint, UniqueConstraint
from jorm.db.models.deletion import CASCADE, Collector
from jorm.db.models.expressions import RawSQL
from jorm.db.models.fields.related import (
    ForeignObjectRel,
    OneToOneField,
    lazy_related_operation,
    resolve_relation,
)
from jorm.db.models.functions import Coalesce
from jorm.db.models.manager import Manager
from jorm.db.models.options import Options
from jorm.db.models.query import F, Q
from jorm.db.models.signals import (
    class_prepared,
    post_init,
    post_save,
    pre_init,
...
from jorm.db.models.utils import AltersData, make_model_tuple
from jorm.utils.encoding import force_str
from jorm.utils.hashable import make_hashable
from jorm.utils.text import capfirst, get_text_list
...
class Model(AltersData, metaclass=ModelBase):
    ...
    def __reduce__(self):
        ...
        data[JORM_version_PICKLE_KEY] = jorm.__version__
    ...
    def __setstate__(self, state):
        pickled_version = state.get(JORM_version_PICKLE_KEY)
        if pickled_version:
            if pickled_version != jorm.__version__:
                warnings.warn(
                    "Pickled model instance's Django version %s does not "
                    "match the current version %s."
                    % (pickled_version, jorm.__version__),
                    RuntimeWarning,
                    stacklevel=2,
                )
        else:
            ...
            return [
                checks.Warning(
                    ...
                    hint=(
                        ...
                        f"of AutoField, e.g. 'jorm.db.models.BigAutoField'."
                    ),
                    obj=cls,
                    id="models.W042",
                ),

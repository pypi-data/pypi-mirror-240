...
from jorm.core.exceptions import EmptyResultSet, FullResultSet
from jorm.db.backends.base.operations import BaseDatabaseOperations
from jorm.db.models.expressions import Case, Expression, Func, Value, When
from jorm.db.models.fields import (
    BooleanField,
    CharField,
    DateTimeField,
    Field,
...
from jorm.db.models.query_utils import RegisterLookupMixin
from jorm.utils.datastructures import OrderedSet
...
class Lookup(Expression):
    ...
    def __init__(self, lhs, rhs):
        ...
        if bilateral_transforms:
            ...
            from jorm.db.models.sql.query import Query  # avoid circular import
...
class YearLookup(Lookup):
    def year_lookup_bounds(self, connection, year):
        from jorm.db.models.functions import ExtractIsoYear
...
class UUIDTextMixin:
    ...
    def process_rhs(self, qn, connection):
        if not connection.features.has_native_uuid_field:
            from jorm.db.models.functions import Replace

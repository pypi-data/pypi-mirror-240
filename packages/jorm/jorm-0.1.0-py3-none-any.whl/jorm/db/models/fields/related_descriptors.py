...
from jorm.db.models import Q, Window, signals
from jorm.db.models.functions import RowNumber
from jorm.db.models.lookups import GreaterThan, LessThanOrEqual
from jorm.db.models.query import QuerySet
from jorm.db.models.query_utils import DeferredAttribute
from jorm.db.models.utils import AltersData, resolve_callables
...
def create_forward_many_to_many_manager(superclass, rel, reverse):
    ...
    class ManyRelatedManager(superclass, AltersData):
        ...
        def _get_target_ids(self, target_field_name, objs):
            ...
            """
            from jorm.db.models import Model

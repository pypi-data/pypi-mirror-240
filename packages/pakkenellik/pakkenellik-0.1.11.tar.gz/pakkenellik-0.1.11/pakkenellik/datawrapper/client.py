# type: ignore
"""Awaiting an update from the Datawrapper repo,
this is copied from th original package. So ignoring type errors."""
...
It lets you create and edit charts, update your account information
...
class Datawrapper:
    ...
    Handles access to your Datawrapper's account, create, delete and move charts,
    tables or maps.
    ...
    def __init__(self, access_token: Optional[str] = _ACCESS_TOKEN) -> None:
    ...
    def account_info(self) -> Union[Dict[Any, Any], None, Any]:
        ...
        if account_info_response.status_code == 200:
            ...
            print(
                """Couldn't find account. Make sure your credentials (access_code)
                are correct."""
            )
            return None
    ...
    def create_chart(
        ...
        folder_id : str, optional
            ID of folder in Datawrapper.de for the chart,
            table or map to be created in, by default ""
    ...
    def publish_chart(self, chart_id: str, display: bool = True) -> Union[Any, None]:
        ...
        if publish_chart_response.status_code <= 201:
            ...
            if display:
                ...
                # iframe_width = publish_chart_info['data']['metadata']['publish']
                # ['embed-width']
                # iframe_height = publish_chart_info['data']['metadata']['publish']
                # ['embed-height']
    ...
    def chart_properties(
        ...
        if chart_properties_response.status_code == 200:
            ...
            print(
                """Make sure you have the right id and
    ...
    def export_chart(
        ...
        chart_id : str
            ID of chart, table, or map.
        unit : str, optional
            One of px, mm, inch. Defines the unit in which the borderwidth,
            height, and width will be measured in, by default "px"
        mode : str, optional
        ...
        width : int, optional
            ...
            by default None
        plain : bool, optional
            Defines if only the visualization should be exported (True),
            or if it should include header and footer as well (False), by default False
        zoom : int, optional
    ...
    def get_folders(self) -> Union[Dict[Any, Any], None, Any]:
        ...
        -------
        dict
            A dictionary containing the folders in your Datawrapper
            account and their information.
        """
        ...
        if get_folders_response.status_code == 200:
            ...
            print(
                """Couldn't retrieve folders in account. Make sure you have the rigth

...
class KafkaTopicManager:
    ...
    def create_topic(self, topic_name: str, num_partitions=1, replication_factor=2):
    ...
    def create_topics(self, topic_names: [str], num_partitions=1, replication_factor=2):

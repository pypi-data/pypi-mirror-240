...
class DedicatedBotModel(BaseBotModel):
    def __init__(self):
        ...
        self.servers: List[ActiveServer] = []
        self.state = 0
        self.source: Source | None = None
    ...
    def to_dic(self):
        ...
        result['servers'] = [ActiveServer.to_dic(server) for server in self.servers]
        return result
    ...
    def from_dic(cls, dic: dict):
        ...
        model.servers = [ActiveServer.from_dic(server) for server in dic.get("servers", [])]
        return model

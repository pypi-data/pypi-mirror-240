...
class SnowflakeStreamInfo:
    ...
    def from_dict(obj: Any) -> 'SnowflakeStreamInfo':
        ...
        stale_after = from_union([from_datetime, from_none], obj.get("stale_after"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.stale_after is not None:
            result["stale_after"] = from_union([lambda x: x.isoformat(), from_none], self.stale_after)
...
class Entity:
    ...
    def from_dict(obj: Any) -> 'Entity':
        ...
        return Entity(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, entity_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, entity_id, is_complete, is_deleted, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, source_info, structure, upstream, entity_versioned_id, custom_metadata, data_quality, description_assignment, documentation, field_associations, field_statistics, ownership_assignment, pipeline_info, schema, snowflake_stream_info, soda_data_quality, statistics, tag_assignment, unity_catalog, usage, dbt_metric, azure_data_factory_pipeline, fivetran, power_bi_dataflow, spark, dbt_model, full_name, looker_explore, looker_view, power_bi_dataset, tableau_datasource, thought_spot, hierarchy_info, system_tags, asset_likes, organization)

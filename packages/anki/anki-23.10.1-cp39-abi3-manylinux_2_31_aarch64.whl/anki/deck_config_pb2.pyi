...
class DeckConfigsForUpdate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["all_config", b"all_config", "card_state_customizer", b"card_state_customizer", "current_deck", b"current_deck", "defaults", b"defaults", "fsrs", b"fsrs", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "schema_modified", b"schema_modified"]) -> None: ...

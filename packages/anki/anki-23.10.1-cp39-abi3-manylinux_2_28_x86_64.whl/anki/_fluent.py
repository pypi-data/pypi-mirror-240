...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_complete(self, num: FluentVariable) -> str:
        r''' {$num}% complete. '''
        return self._translate(11, 23, {"num": num})
...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 29, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 32, {"cards": cards})
...
is used to immediately remove a card from learning. '''
    ...
    def deck_config_estimated_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 46, {"num": num})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_1000_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 71, {"count": count})
...
relearning.  '''
    ...
    def deck_config_reschedule_cards_on_change_tooltip(self, ) -> str:
        r''' This option controls whether the due dates of cards will be changed when you enable FSRS, or optimize
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 113, {"cards": cards, "expected": expected})
...
newly-learned card will delay the next review by 2.5x the previous delay. '''
    ...
    def deck_config_steps_too_large_for_fsrs(self, ) -> str:
        r''' When FSRS is enabled, learning steps of 1+ days are not recommended. '''
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 146, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 147, {"decks": decks})
...
you proceed. '''
    ...
    def editing_mathjax_placeholder(self, accept: str, newline: str) -> str:
        ...
        return self._translate(13, 67, {"accept": accept, "newline": newline})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_ANSWER_AGAIN = (11, 5)
    DECK_CONFIG_ANSWER_GOOD = (11, 6)
    DECK_CONFIG_ANSWER_HARD = (11, 7)
    DECK_CONFIG_AUDIO_TITLE = (11, 8)
    DECK_CONFIG_BURY_IF_NEW = (11, 9)
    DECK_CONFIG_BURY_IF_NEW_OR_REVIEW = (11, 10)
    DECK_CONFIG_BURY_IF_NEW_REVIEW_OR_INTERDAY = (11, 11)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 12)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_TOOLTIP = (11, 13)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 14)
    DECK_CONFIG_BURY_NEW_TOOLTIP = (11, 15)
    DECK_CONFIG_BURY_PRIORITY_TOOLTIP = (11, 16)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 17)
    DECK_CONFIG_BURY_REVIEW_TOOLTIP = (11, 18)
    DECK_CONFIG_BURY_SIBLINGS = (11, 19)
    DECK_CONFIG_BURY_TITLE = (11, 20)
    DECK_CONFIG_BURY_TOOLTIP = (11, 21)
    DECK_CONFIG_CLONE_GROUP = (11, 22)
    DECK_CONFIG_COMPLETE = (11, 23)
    DECK_CONFIG_COMPUTE_BUTTON = (11, 24)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION = (11, 25)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP = (11, 26)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 27)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 28)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 29)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 30)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 31)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 32)
    DECK_CONFIG_DAILY_LIMITS = (11, 33)
    DECK_CONFIG_DECK_ONLY = (11, 34)
    DECK_CONFIG_DEFAULT_NAME = (11, 35)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 36)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 37)
    DECK_CONFIG_DESIRED_RETENTION = (11, 38)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 39)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 40)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 41)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 42)
    DECK_CONFIG_DO_NOT_BURY = (11, 43)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 44)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 45)
    DECK_CONFIG_ESTIMATED_RETENTION = (11, 46)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 47)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 48)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 49)
    DECK_CONFIG_GET_PARAMS = (11, 50)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 51)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 52)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 53)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 54)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 55)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 56)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 57)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 58)
    DECK_CONFIG_LEARNING_STEPS = (11, 59)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 60)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 61)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 62)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 63)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 64)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 65)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 66)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 67)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 68)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 69)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 70)
    DECK_CONFIG_MUST_HAVE_1000_REVIEWS = (11, 71)
    DECK_CONFIG_NAME_PROMPT = (11, 72)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 73)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 74)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 75)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 76)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 77)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 78)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 79)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 80)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 81)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 82)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 83)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 84)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 85)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 86)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 87)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 88)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 89)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 90)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 91)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 92)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 93)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 94)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 95)
    DECK_CONFIG_ORDERING_TITLE = (11, 96)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 97)
    DECK_CONFIG_RELEARNING_STEPS = (11, 98)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 99)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 100)
    DECK_CONFIG_REMOVE_GROUP = (11, 101)
    DECK_CONFIG_RENAME_GROUP = (11, 102)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 103)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 104)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 105)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 106)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 107)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 108)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 109)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 110)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 111)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 112)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 113)
    DECK_CONFIG_SAVE_BUTTON = (11, 114)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 115)
    DECK_CONFIG_SHARED_PRESET = (11, 116)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 117)
    DECK_CONFIG_SHOW_REMINDER = (11, 118)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 119)
    DECK_CONFIG_SM2_RETENTION = (11, 120)
    DECK_CONFIG_SM2_RETENTION_TOOLTIP = (11, 121)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 122)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 123)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 124)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 125)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 126)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 127)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 128)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 129)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 130)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 131)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 132)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 133)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 134)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 135)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 136)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 137)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 138)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 139)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 140)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 141)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 142)
    DECK_CONFIG_TIMER_TITLE = (11, 143)
    DECK_CONFIG_TITLE = (11, 144)
    DECK_CONFIG_TODAY_ONLY = (11, 145)
    DECK_CONFIG_UPDATING_CARDS = (11, 146)
    DECK_CONFIG_USED_BY_DECKS = (11, 147)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 148)
    DECK_CONFIG_WEIGHTS = (11, 149)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 150)
    DECK_CONFIG_WHICH_DECK = (11, 151)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 152)
    ...
    DECKS_REVIEW_HEADER = (12, 30)
    DECKS_STUDY = (12, 31)
    DECKS_STUDY_DECK = (12, 32)
    DECKS_UNMOVABLE_CARDS = (12, 33)
    DECKS_CREATE_EVEN_IF_EMPTY = (12, 34)
    ...
    EDITING_IMAGE_OCCLUSION_TOGGLE_MASK_EDITOR = (13, 50)
    EDITING_IMAGE_OCCLUSION_TOGGLE_TRANSLUCENT = (13, 51)
    EDITING_IMAGE_OCCLUSION_UNGROUP = (13, 52)
    EDITING_IMAGE_OCCLUSION_ZOOM_IN = (13, 53)
    EDITING_IMAGE_OCCLUSION_ZOOM_OUT = (13, 54)
    EDITING_IMAGE_OCCLUSION_ZOOM_RESET = (13, 55)
    EDITING_IMAGE_OCCLUSION_ZOOM_TOOL = (13, 56)
    EDITING_INDENT = (13, 57)
    EDITING_ITALIC_TEXT = (13, 58)
    EDITING_JUMP_TO_TAGS_WITH_CTRLANDSHIFTANDT = (13, 59)
    EDITING_JUSTIFY = (13, 60)
    EDITING_LATEX = (13, 61)
    EDITING_LATEX_EQUATION = (13, 62)
    EDITING_LATEX_MATH_ENV = (13, 63)
    EDITING_MATHJAX_BLOCK = (13, 64)
    EDITING_MATHJAX_CHEMISTRY = (13, 65)
    EDITING_MATHJAX_INLINE = (13, 66)
    EDITING_MATHJAX_PLACEHOLDER = (13, 67)
    EDITING_MATHJAX_PREVIEW = (13, 68)
    EDITING_MEDIA = (13, 69)
    EDITING_NO_IMAGE_FOUND_ON_CLIPBOARD = (13, 70)
    EDITING_ORDERED_LIST = (13, 71)
    EDITING_OUTDENT = (13, 72)
    EDITING_PASTE = (13, 73)
    EDITING_RECORD_AUDIO = (13, 74)
    EDITING_REMOVE_FORMATTING = (13, 75)
    EDITING_RESTORE_ORIGINAL_SIZE = (13, 76)
    EDITING_SELECT_REMOVE_FORMATTING = (13, 77)
    EDITING_SHOW_DUPLICATES = (13, 78)
    EDITING_SHRINK_IMAGES = (13, 79)
    EDITING_SUBSCRIPT = (13, 80)
    EDITING_SUPERSCRIPT = (13, 81)
    EDITING_TAGS = (13, 82)
    EDITING_TAGS_ADD = (13, 83)
    EDITING_TAGS_COPY = (13, 84)
    EDITING_TAGS_REMOVE = (13, 85)
    EDITING_TAGS_SELECT_ALL = (13, 86)
    EDITING_TEXT_COLOR = (13, 87)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 88)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 89)
    EDITING_TOGGLE_HTML_EDITOR = (13, 90)
    EDITING_TOGGLE_STICKY = (13, 91)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 92)
    EDITING_UNDERLINE_TEXT = (13, 93)
    EDITING_UNORDERED_LIST = (13, 94)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (13, 95)

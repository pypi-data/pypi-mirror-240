...
from insta_private_lib_api.utils import dumps
from insta_private_lib_api.exceptions import ClientUnauthorizedError, ClientLoginRequired
from insta_private_lib_api.exceptions import ClientError, HashtagNotFound, WrongCursorError
from insta_private_lib_api.extractors import (
    extract_hashtag_gql,
    extract_hashtag_v1,
    extract_media_v1,
)
from insta_private_lib_api.types import Hashtag, Media
...
class HashtagMixin:
    ...
    def hashtag_info(self, name: str) -> Hashtag:
        ...
        try:
            ...
            # such this - https://github.com/subzeroid/insta_private_lib_api/issues/364

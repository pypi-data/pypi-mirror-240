...
from insta_private_lib_api.utils import dumps, gen_token, generate_jazoest

# from insta_private_lib_api.zones import CET
...
class LoginMixin(PreLoginFlowMixin, PostLoginFlowMixin):
    ...
    def login(
        ...
        verification_method: str
            0 - sms, 1 - e-mail, 2 - ?, 3 - authenticator
        _2fa_data: Optional[dict]
            last mobile session (not auth session)
        ...
        if _2fa_data and self.verification_code:
            data = {**_2fa_data, "verification_code": self.verification_code}
            ...
            try:
                ...
                print(e, ' : 2fa exception')
        elif not _2fa_data and not self.verification_code:
            try:

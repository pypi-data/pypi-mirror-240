...
from insta_private_lib_api.exceptions import ClientNotFoundError, StoryNotFound, UserNotFound
from insta_private_lib_api.extractors import (
    extract_story_gql,
    extract_story_v1,
    extract_user_short,
)
from insta_private_lib_api.types import Story, UserShort
...
class StoryMixin:
    ...
    def story_download_by_url(
        ...
        assert fname, (
            ...
            """Read the documentation https://subzeroid.github.io/insta_private_lib_api/usage-guide/story.html"""
        )

...
################################################################################
# IViSiT 0.60: Interactive Visual Simulation Tool
#              based on Python/Tkinter for optimizing model parameters 
# progammed from September 2017 to September 2023 by Andreas Knoblauch
# All rights reserved
#
...
Version = '0.60'
__version__ = Version
import sys, os, shutil, traceback                         # platform, args, run tools
...
(c) 1/9/2017-1/9/2023, Andreas Knoblauch.
All rights reserved.
...
0.60: 1/9/2023
     - Neue Parameter-Widget-Klasse DICTSLIDER + ITEMS
       für numerische Parameter-Dictionaries
     - bug fixes
"""
...
class IVisit:                          # mix with menu/toolbar Frame class
    ...
    def __init__(self, loadFirst='',sim=None,debuglevel=0):
        ...
        self.currfile='ivisit_default.db'
...
def IVisit_main(fname=None,sim=None,debuglevel=0,str_app_name=None,str_app_help=None,str_app_about=None):  # may be typed or clicked
    ...
    IVisitMain(loadFirst=fname,sim=sim,debuglevel=debuglevel,str_app_name=str_app_name,str_app_help=str_app_help,str_app_about=str_app_about).pack(expand=YES, fill=BOTH)
    mainloop()

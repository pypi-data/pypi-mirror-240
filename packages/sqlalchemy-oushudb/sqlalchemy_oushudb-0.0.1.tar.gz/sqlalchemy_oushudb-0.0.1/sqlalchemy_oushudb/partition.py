...
for use as the values of key 'oushudb_partition_by'.
...
def format_partition_value(type_, value):
    ...
    raise NotImplementedError(
        'unsupported type ({}) for the given value ({}) in oushudb has not been implemented'.format(
...
def partition_clause(table, partition_by):
    '''
    Create the partition clause for when a partition is defined on a OushuDB table

'''
Defines OushuDB point type for use by Sqlalchemy
'''
import re
...
class SQLAlchemyOushuDBException(Exception):
    """
    Custom exception name for OushuDB-Sqlalchemy package
    """
...
class Point(UserDefinedType):
    ...
    The Point type is available in OushuDB db and postgres DBAPI, but not in SQLAlchemy.
    """
            ...
            try:
                ...
                if val1 is None or val2 is None:
                    if val1 is not None or val2 is not None:
                        raise SQLAlchemyOushuDBException(
                ...
                raise SQLAlchemyOushuDBException('Unexpected input type for Point ({})'.format(value))
    ...
    def result_processor(self, dialect, coltype):
        ...
        def process(value):
            ...
            raise SQLAlchemyOushuDBException('Failed to get Point value from SQL ({})'.format(value))

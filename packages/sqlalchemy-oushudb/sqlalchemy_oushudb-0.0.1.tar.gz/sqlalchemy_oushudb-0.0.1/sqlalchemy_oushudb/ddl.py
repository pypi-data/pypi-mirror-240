'''
Data definition language support for OushuDB database
'''
...
class OushuDBDDLCompiler(postgresql.base.PGDDLCompiler):
    '''
    override the default postgres DDL
    '''

    def visit_create_index(self, create):
        # TODO: OushuDB indexing
    ...
    def post_create_table(self, table):
        ...
        '''
        table_opts = []
        pg_opts = table.dialect_options['oushudb']

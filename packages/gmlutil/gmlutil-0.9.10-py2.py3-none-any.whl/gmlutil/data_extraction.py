...
class data_extraction:
    ...
    def read_acv(self, fuzz_ratio=90, state_choice1=['New Mexico','New_Mexico'], state_choice2=['DC','District of Columbia']):
        ...
        """ 
        acv_df = self.read_from_s3(conf.bucket_name, conf.benchmark_acv_str)
        ...
        geo_codes = self.read_from_s3(conf.bucket_name, conf.benchmark_geo_str)
    ...
    def read_upc_df(self):
        ...
        """
        upc_df = self.read_from_s3(conf.bucket_name, conf.upc_tier_str)

...
class Router:
    ...
    def __init__(self,
                 ...
                 cache_responses: bool = False,
                 routing_strategy: Literal["random_shuffle", "least_busy"] = "random_shuffle") -> None:
    ...
    def get_healthy_deployments(self):
        return self.healthy_deployments
    ...
    def get_available_deployment(self,
        ...
        if self.routing_strategy == "least_busy":
            if len(self.healthy_deployments) > 0:
                ...
                raise Exception("No healthy deployments available")
        elif self.routing_strategy == "random_shuffle": 

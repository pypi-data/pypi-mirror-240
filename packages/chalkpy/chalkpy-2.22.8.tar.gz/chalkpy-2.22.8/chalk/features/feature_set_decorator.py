...
def _process_class(
    ...
    for name, annotation in raw_cls_annotations.items():
        if name in ("features", "namespace", "items", "is_near"):
            raise ValueError(f"Feature name '{name}' in '{namespace}' is a reserved name. Please rename this feature.")

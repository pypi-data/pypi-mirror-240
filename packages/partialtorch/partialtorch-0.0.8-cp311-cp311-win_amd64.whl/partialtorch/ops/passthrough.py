...
pixel_shuffle = torch.ops.partialtorch.pixel_shuffle
pixel_unshuffle = torch.ops.partialtorch.pixel_unshuffle
channel_shuffle = torch.ops.partialtorch.channel_shuffle
native_channel_shuffle = torch.ops.partialtorch.native_channel_shuffle

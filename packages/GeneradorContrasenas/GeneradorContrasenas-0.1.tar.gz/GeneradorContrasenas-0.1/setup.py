...
setup(
  ...
  description = 'Esta librería permite generar una o varias contraseñas personalizadas en base a los requisitos especificados por el usuario',   # Give a short description about your library
  ...
  download_url = 'https://github.com/nereabarrueta/GeneradorContrasenas/archive/refs/tags/v_03.tar.gz',    # I explain this later on

...
from polarmints.aws import read_delta_s3
...
def read_delta(*args, **kwargs):
    ...
    DEPRECATED
    """
    logger.warning('polarmints read_delta() is deprecated renamed to aws.read_delta_s3')
    return read_delta_s3(*args, **kwargs)

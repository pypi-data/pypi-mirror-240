...
class SearchCrmTasksRequestBody:
    filters: Optional[SearchCrmTasksFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filters'), 'exclude': lambda f: f is None }})

...
class Datasets:
    ...
    def rain_fixed_periods(driver, code):
        ...
        freq_box = driver.find_element(By.XPATH, "//input[@value='181']")
        freq_box.click()

        for i in code:
            freq_box = driver.find_element(By.XPATH, "//input[@value='{}']".format(i))
            freq_box.click()
    ...
    def surface_wind(driver, code):
        ...
        freq_box = driver.find_element(By.XPATH, "//input[@value='132']")
        freq_box.click()
    ...
    def max_min_temp(driver, code):
        ...
        freq_box = driver.find_element(By.XPATH, "//input[@value='{}']".format(checked))
        freq_box.click()

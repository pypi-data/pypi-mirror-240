...
class user():  
    ...
    def send_account_status_report(self):
        ...
        history_summary = history_df[['account name', 'account value', 'asset value', 'cash position', 'margin position', 'Profit/Loss', 'Gain %', 'Initial Balance', 'Created Date' ]]

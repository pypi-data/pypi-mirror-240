...
import os
import argparse
from .__about__ import __version__, __author__, __author_email__, __license__
...
def FromSource(args, file: str, output_filename: str) -> None:
    ...
    if args.verbose:
        PrintAst(ast)
    MacalCompiler(program = ast, output_path = output_filename, verbose = args.verbose).compile()

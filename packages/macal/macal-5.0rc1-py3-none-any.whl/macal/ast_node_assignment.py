...
class AstNodeAssignmentStatement(AstNodeStatement):
    def __init__(self, var_expr: AstNodeVariableExpression, op: LexToken, expr: AstNodeExpression) -> AstNodeAssignmentStatement:
        super().__init__(var_expr._token)
        self.type = AstNodetype.ASSIGNMENT_STATEMENT
        self.lhs = var_expr

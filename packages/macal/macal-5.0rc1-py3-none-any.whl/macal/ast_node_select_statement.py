...
class AstNodeSelectStatement(AstNodeStatement):
    def __init__(self, token: LexToken, fields: List[AstNodeSelectField], from_expr: AstNodeExpression, into: LexToken, merge: bool, distinct: bool, where: Optional[AstNodeExpression] = None) -> AstNodeSelectStatement:
        super().__init__(token)
        self.type = AstNodetype.SELECT_STATEMENT
    ...
    def tree(self, indent: str = '') -> None:
        ...
        print(f"{indent}    Into: {self.Into.value}")

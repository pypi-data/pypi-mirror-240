...
class AstNodeVariableFunctionCallExpression(AstNodeExpression):
    def __init__(self, variable: AstNodeVariableExpression, args: List[AstNodeExpression]) -> AstNodeVariableFunctionCallExpression:
        super().__init__(variable._token)
        self.type = AstNodetype.VARIABLE_FUNCTION_CALL_EXPRESSION

...
class AstNodeFunctionDefinition(AstNode):
    def __init__(self, var_expr: AstNodeVariableExpression, op: LexToken, parameters: List[AstNodeFunctionParameter], return_type: AstNodetype, body: AstNodeBlock) -> AstNodeFunctionDefinition:
        super().__init__()
        self.type = AstNodetype.FUNCTION_DEFINITION

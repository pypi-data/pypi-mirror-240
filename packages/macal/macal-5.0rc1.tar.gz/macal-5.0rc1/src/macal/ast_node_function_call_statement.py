...
class AstNodeFunctionCallStatement(AstNodeStatement):
    def __init__(self, ident: Union[LexToken, AstNodeIndexedVariableExpression], args: List[AstNodeExpression]) -> AstNodeFunctionCallStatement:
        ...
        self.type = AstNodetype.FUNCTION_CALL

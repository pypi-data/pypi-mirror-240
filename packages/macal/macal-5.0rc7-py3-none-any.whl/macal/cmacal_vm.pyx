        ...
        while True:
            ...
            if   opCode[0] == 9 : # PUSH
                ...
                if type1 == type2:
                    if type1 == AstNodetype.INTEGER:
                        ...
                        if type1 == AstNodetype.NIL or type2 == AstNodetype.NIL or type1 == AstNodetype.BOOLEAN or type2 == AstNodetype.BOOLEAN:
            ...
            # Need to run a sensus in more applications to optimize the order.
                ...
                if self.rax.value_type == AstNodetype.RECORD:
                    ...
                    print(self.rax.value)
                    print(self.memory[0:self.rip.value])

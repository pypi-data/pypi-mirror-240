...
class FlowExecutionCoodinator:
    ...
    def create_flow_executor_by_yaml(
        ...
        flow = FlowExecutionCoodinator._create_flow_from_yaml(yaml_file, working_dir)
    ...
    @staticmethod
    def _create_flow_from_yaml(flow_file: Path, working_dir=None):
    ...
    def exec_batch(
        ...
        self._handle_line_failures([r.run_info for r in flow_results], raise_on_line_failure)

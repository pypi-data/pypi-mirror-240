...
from promptflow._internal import OperationContext, gen_tool_by_source, set_context, update_log_path
...
from promptflow.runtime.contracts.runtime import FlowSourceType, SubmitFlowRequest
...
from promptflow.runtime.utils._flow_source_helper import fill_working_dir
...
def execute_request(config: RuntimeConfig, request: SubmitFlowRequest):
    ...
    try:
        ...
        if request.flow_source is not None:
            ...
            working_dir = Flow._resolve_working_dir(yaml_file, working_dir)

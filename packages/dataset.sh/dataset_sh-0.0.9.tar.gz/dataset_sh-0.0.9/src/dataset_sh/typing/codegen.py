...
from dataset_sh.typing.core import EnumEntry, FieldType, PydanticFieldDefinition, EnumDefinition, ClassDefinition, \
    DatasetSchema
from dataset_sh.typing.constants import SUPPORTED_TYPES
...
"""
    ...
    @staticmethod
    def generate_file_loader_code(filepath, collection_name, entry_class_name):
        entry_class_name = entry_class_name.split('.')[-1]
        code = f"""

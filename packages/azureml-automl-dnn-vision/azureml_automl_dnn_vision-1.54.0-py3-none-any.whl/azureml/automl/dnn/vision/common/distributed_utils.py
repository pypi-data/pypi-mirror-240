...
def launch_single_or_distributed_training(
    ...
    if distributed and world_size > 1:
        logger.info("Starting distributed training with world_size: {}.".format(world_size))
        ...
        if distributed:
            logger.warning("Distributed flag is {}, but is not supported as the world_size is 1. "

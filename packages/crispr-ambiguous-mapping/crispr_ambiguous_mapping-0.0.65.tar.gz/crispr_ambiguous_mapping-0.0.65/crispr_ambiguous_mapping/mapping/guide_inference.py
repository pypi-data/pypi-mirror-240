...
@typechecked
def infer_whitelist_sequence(observed_guide_reporter_sequence: Tuple[str, Optional[str], Optional[str]], 
        whitelist_guide_reporter_df: pd.DataFrame, 
        contains_surrogate:bool, 
        contains_barcode:bool, 
        contains_umi:bool, 
        encoded_whitelist_protospacer_sequences_series: npt.NDArray, 
        encoded_whitelist_surrogate_sequences_series: Optional[npt.NDArray] = None, 
        encoded_whitelist_barcode_sequences_series: Optional[npt.NDArray] = None, 
    ...
    def validate_observed_sequence(sequence_name: str, encoded_whitelist_sequence_series: npt.NDArray, missing_info_error: MissingInfoGuideCountError, unequal_length_error: UnequalLengthGuideCountError):

...
class Openbis:
    ...
    def executeCustomDSSService(
        ...
        return self._post_request_full_url(urljoin('http://localhost:8889/openbis', self.dss_v3), request)
        # resp = self._post_request(self.dss_v3, request)
        return resp


    def executeCustomDSSService2(

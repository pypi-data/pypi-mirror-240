        ...
        try:
            ...
            if len(hand_Right) > 0:
                ...
                points_hand_Right_diffX = [
                   #thumb
                    ...
                    [(hands_x[8]-hands_x[2]),    8], [(hands_x[8]-hands_x[10]),   8], 
                    [(hands_x[12]-hands_x[2]),  12], [(hands_x[12]-hands_x[6]),  12], 
                    [(hands_x[16]-hands_x[2]),  16], [(hands_x[16]-hands_x[6]),  16], 
                    [(hands_x[20]-hands_x[2]),  20], [(hands_x[20]-hands_x[6]),  20], 
                    #diff-between 
                    [(hands_x[4]-hands_x[7]),    4], [(hands_x[4]-hands_x[11]),   4], [(hands_x[4]-hands_x[15]),   4],  [(hands_x[4]-hands_x[19]),   4],
                    [(hands_x[8]-hands_x[3]),    8], [(hands_x[8]-hands_x[11]),   8], 
                    [(hands_x[12]-hands_x[3]),  12], [(hands_x[12]-hands_x[7]),  12], 
                    [(hands_x[16]-hands_x[3]),  16], [(hands_x[16]-hands_x[7]),  16], 
                    [(hands_x[20]-hands_x[3]),  20], [(hands_x[20]-hands_x[7]),  20], 
                    #diff-between 
                    [(hands_x[4]-hands_x[8]),    4], [(hands_x[4]-hands_x[12]),   4], [(hands_x[4]-hands_x[16]),   4],  [(hands_x[4]-hands_x[20]),   4],
                    [(hands_x[8]-hands_x[4]),    8], [(hands_x[8]-hands_x[12]),   8], 
                    [(hands_x[12]-hands_x[4]),  12], [(hands_x[12]-hands_x[8]),  12], 
                    [(hands_x[16]-hands_x[4]),  16], [(hands_x[16]-hands_x[8]),  16], 
                    [(hands_x[20]-hands_x[4]),  20], [(hands_x[20]-hands_x[8]),  20]
                ]
                ...
                points_hand_Right_diffY = [
                    ...
                    [(hands_y[8]-hands_y[3]),    8], [(hands_y[8]-hands_y[10]),   8], 
                    [(hands_y[12]-hands_y[2]),  12], [(hands_y[12]-hands_y[6]),  12], 
                    [(hands_y[16]-hands_y[2]),  16], [(hands_y[16]-hands_y[6]),  16], 
                    [(hands_y[20]-hands_y[2]),  20], [(hands_y[20]-hands_y[6]),  20], 
                    #diff-between 
                    [(hands_y[4]-hands_y[7]),    4], [(hands_y[4]-hands_y[11]),   4], [(hands_y[4]-hands_y[15]),   4],  [(hands_y[4]-hands_y[19]),   4],
                    [(hands_y[8]-hands_y[3]),    8], [(hands_y[8]-hands_y[11]),   8], 
                    [(hands_y[12]-hands_y[3]),  12], [(hands_y[12]-hands_y[7]),  12], 
                    [(hands_y[16]-hands_y[3]),  16], [(hands_y[16]-hands_y[7]),  16], 
                    [(hands_y[20]-hands_y[3]),  20], [(hands_y[20]-hands_y[7]),  20], 
                    #diff-between 
                    [(hands_y[4]-hands_y[8]),    4], [(hands_y[4]-hands_y[12]),   4], [(hands_y[4]-hands_y[16]),   4],  [(hands_y[4]-hands_y[20]),   4],
                    [(hands_y[8]-hands_y[4]),    8], [(hands_y[8]-hands_y[12]),   8], 
                    [(hands_y[12]-hands_y[4]),  12], [(hands_y[12]-hands_y[8]),  12], 
                    [(hands_y[16]-hands_y[4]),  16], [(hands_y[16]-hands_y[8]),  16], 
                    [(hands_y[20]-hands_y[4]),  20], [(hands_y[20]-hands_y[8]),  20]
                ]
                ...
                points_hand_Right_diffZ = [
                    ...
                    [(hands_z[8]-hands_z[3]),    8], [(hands_z[8]-hands_z[10]),   8], 
                    [(hands_z[12]-hands_z[2]),  12], [(hands_z[12]-hands_z[6]),  12], 
                    [(hands_z[16]-hands_z[2]),  16], [(hands_z[16]-hands_z[6]),  16], 
                    [(hands_z[20]-hands_z[2]),  20], [(hands_z[20]-hands_z[6]),  20], 
                    #diff-between 
                    [(hands_z[4]-hands_z[7]),    4], [(hands_z[4]-hands_z[11]),   4], [(hands_z[4]-hands_z[15]),   4],  [(hands_z[4]-hands_z[19]),   4],
                    [(hands_z[8]-hands_z[3]),    8], [(hands_z[8]-hands_z[11]),   8], 
                    [(hands_z[12]-hands_z[3]),  12], [(hands_z[12]-hands_z[7]),  12], 
                    [(hands_z[16]-hands_z[3]),  16], [(hands_z[16]-hands_z[7]),  16], 
                    [(hands_z[20]-hands_z[3]),  20], [(hands_z[20]-hands_z[7]),  20], 
                    #diff-between 
                    [(hands_z[4]-hands_z[8]),    4], [(hands_z[4]-hands_z[12]),   4], [(hands_z[4]-hands_z[16]),   4],  [(hands_z[4]-hands_z[20]),   4],
                    [(hands_z[8]-hands_z[4]),    8], [(hands_z[8]-hands_z[12]),   8], 
                    [(hands_z[12]-hands_z[4]),  12], [(hands_z[12]-hands_z[8]),  12], 
                    [(hands_z[16]-hands_z[4]),  16], [(hands_z[16]-hands_z[8]),  16], 
                    [(hands_z[20]-hands_z[4]),  20], [(hands_z[20]-hands_z[8]),  20]
                ]
            ...
            if len(hand_Left) > 0:
                ...
                points_hand_Left_diffX= [
                    ...
                    #diff-between
                    [(hands_x[4]-hands_x[6]),    4], [(hands_x[4]-hands_x[10]),   4], [(hands_x[4]-hands_x[14]),   4],  [(hands_x[4]-hands_x[18]),   4],
                    [(hands_x[8]-hands_x[3]),    8], [(hands_x[8]-hands_x[10]),   8], 
                    [(hands_x[12]-hands_x[2]),  12], [(hands_x[12]-hands_x[6]),  12], 
                    [(hands_x[16]-hands_x[2]),  16], [(hands_x[16]-hands_x[6]),  16], 
                    [(hands_x[20]-hands_x[2]),  20], [(hands_x[20]-hands_x[6]),  20], 
                    #diff-between

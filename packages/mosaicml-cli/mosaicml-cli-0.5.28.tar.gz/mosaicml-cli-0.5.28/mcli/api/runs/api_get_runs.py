...
def get_runs(
        ...
        *,
        ...
        include_interactive: Optional[bool] = None,  # TODO: deprecate
) -> List[Run]:
    ...
...
def get_runs(
    ...
    if clusters:
        warnings.warn(
            'clusters will soon be deprecated. Please use cluster_names instead.',
            DeprecationWarning,
        )
    ...
    if run_types:
        filters['runType'] = {'in': run_types}

    if include_interactive is not None:
        warnings.warn(
            'include_interactive will soon be deprecated. Please use run_types=["INTERACTIVE"] instead.',
            DeprecationWarning,
        )
        filters['runType'] = {'in': ['INTERACTIVE']}

...
from collections.abc import Coroutine, Generator, MutableMapping
from contextvars import copy_context
from dataclasses import dataclass, field
from functools import partial, total_ordering
from heapq import heappop, heappush
from inspect import iscoroutinefunction
from typing import TYPE_CHECKING as _TYPE_CHECKING, Any, ClassVar, Generic, ParamSpec, TypeVar, final, overload
...
if _TYPE_CHECKING:
    ...
    from typing import Final, Literal, Self, TypeAlias, TypeGuard
...
class BackgroundTask(Generic[T]):
    ...
    task: Task[T]
    unique_id: UUID = field(default_factory=uuid4, init=False)
    ...
    @classmethod
    def from_coroutine(cls, coroutine: CoroutineLike[T], /) -> Self:
...
class UndefinedType:
    ...
    def __hash__(self) -> Literal[0xDEADC0DE]:
        return 0xDEADC0DE

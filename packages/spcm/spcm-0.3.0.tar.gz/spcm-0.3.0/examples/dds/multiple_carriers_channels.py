"""EXAMPLE 10 - Multiple static carriers on multiple channels
...
with spcm.DDS('/dev/spcm0') as card:
    ...
    ## Setup DDS
    card.dds_reset()
    card.connections(spcm.SPCM_DDS_CONN_CORE8_11_TO_CH1 | spcm.SPCM_DDS_CONN_CORE12_15_TO_CH2 | spcm.SPCM_DDS_CONN_CORE16_19_TO_CH3)

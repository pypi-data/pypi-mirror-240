...
from xdcetl.mappers.origin_mapper import OriginMarketplaceListingMapper, OriginShopProductMapper
from xdcetl.service.origin_extractor import OriginEventExtractor

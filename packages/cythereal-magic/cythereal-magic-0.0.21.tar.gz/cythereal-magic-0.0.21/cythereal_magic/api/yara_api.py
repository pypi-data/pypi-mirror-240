...
class YaraApi(object):
    ...
    def create_yara(self, files, name, unpacked, config, include_all, max_signatures, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara(files, name, unpacked, config, include_all, max_signatures, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_yara_with_http_info(files, name, unpacked, config, include_all, max_signatures, **kwargs)  # noqa: E501
        else:
            (data) = self.create_yara_with_http_info(files, name, unpacked, config, include_all, max_signatures, **kwargs)  # noqa: E501
            return data

    def create_yara_with_http_info(self, files, name, unpacked, config, include_all, max_signatures, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara_with_http_info(files, name, unpacked, config, include_all, max_signatures, async_req=True)
        >>> result = thread.get()
        ...
        if ('max_signatures' not in params or
            ...
            raise ValueError("Missing the required parameter `max_signatures` when calling `create_yara`")  # noqa: E501

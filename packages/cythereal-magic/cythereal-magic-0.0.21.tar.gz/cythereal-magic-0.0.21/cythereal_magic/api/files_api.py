...
class FilesApi(object):
    ...
    def list_file_genomics_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'page_count', 'page_size', 'skip_count', 'read_mask', 'order_by', 'no_libs']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_file_matches(self, binary_id, **kwargs):  # noqa: E501
        ...
        :return: EnvelopedFileMatchResponseList200
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_file_matches_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EnvelopedFileMatchResponseList200',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_procedure_similarities_with_http_info(self, binary_id, rva, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'rva', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'page_count', 'page_size', 'skip_count', 'max_threshold', 'method', 'min_threshold']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upload_file_with_http_info(self, filedata, password, tags, notes, **kwargs):  # noqa: E501
        ...
        all_params = ['filedata', 'password', 'tags', 'notes', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'dryrun', 'extract', 'recursive', 'retain_wrapper', 'skip_unpack', 'b64']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

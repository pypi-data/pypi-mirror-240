...
import six
from cythereal_magic.models.mini_user import MiniUser  # noqa: F401,E501

class AllOfGroupReducedResponseMembers(MiniUser):
    ...
    if hasattr(MiniUser, "swagger_types"):
        swagger_types.update(MiniUser.swagger_types)

    attribute_map = {
    }
    if hasattr(MiniUser, "attribute_map"):
        attribute_map.update(MiniUser.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfGroupReducedResponseMembers - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        MiniUser.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfGroupReducedResponseMembers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfGroupReducedResponseMembers):
            return False

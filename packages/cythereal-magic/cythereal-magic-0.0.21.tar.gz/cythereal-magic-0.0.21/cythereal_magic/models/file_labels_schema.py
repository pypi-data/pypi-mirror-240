...
class FileLabelsSchema(object):
    ...
    """
    swagger_types = {
        'ground_truth': 'list[LabelSchema]',
        'inferred': 'list[LabelSchema]'
    }
    ...
    def __init__(self, ground_truth=None, inferred=None):  # noqa: E501
        """FileLabelsSchema - a model defined in Swagger"""  # noqa: E501
    ...
    def ground_truth(self):
        """Gets the ground_truth of this FileLabelsSchema.  # noqa: E501


        :return: The ground_truth of this FileLabelsSchema.  # noqa: E501
        :rtype: list[LabelSchema]
        """
        return self._ground_truth

    @ground_truth.setter
    def ground_truth(self, ground_truth):
        """Sets the ground_truth of this FileLabelsSchema.


        :param ground_truth: The ground_truth of this FileLabelsSchema.  # noqa: E501
        :type: list[LabelSchema]
        """
    ...
    @property
    def inferred(self):
        """Gets the inferred of this FileLabelsSchema.  # noqa: E501


        :return: The inferred of this FileLabelsSchema.  # noqa: E501
        :rtype: list[LabelSchema]
        """
    ...
    def inferred(self, inferred):
        """Sets the inferred of this FileLabelsSchema.


        :param inferred: The inferred of this FileLabelsSchema.  # noqa: E501
        :type: list[LabelSchema]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileLabelsSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileLabelsSchema):
            return False

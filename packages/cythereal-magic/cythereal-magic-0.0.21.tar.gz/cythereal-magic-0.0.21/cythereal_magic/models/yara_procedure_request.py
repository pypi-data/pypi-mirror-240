...
class YaraProcedureRequest(object):
    ...
    def __init__(self, proc_hashes=None, name=None, condition=None, include_all=None, max_signatures=None):  # noqa: E501
        """YaraProcedureRequest - a model defined in Swagger"""  # noqa: E501
        self._proc_hashes = None
        self._name = None
        self._condition = None
        self._include_all = None
        self._max_signatures = None
        self.discriminator = None
        self.proc_hashes = proc_hashes
        if name is not None:
            self.name = name
    ...
    def proc_hashes(self):
        """Gets the proc_hashes of this YaraProcedureRequest.  # noqa: E501


        :return: The proc_hashes of this YaraProcedureRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._proc_hashes

    @proc_hashes.setter
    def proc_hashes(self, proc_hashes):
        """Sets the proc_hashes of this YaraProcedureRequest.


        :param proc_hashes: The proc_hashes of this YaraProcedureRequest.  # noqa: E501
        :type: list[str]
        """
        if proc_hashes is None:
            raise ValueError("Invalid value for `proc_hashes`, must not be `None`")  # noqa: E501

        self._proc_hashes = proc_hashes

    @property
    def name(self):
        """Gets the name of this YaraProcedureRequest.  # noqa: E501


        :return: The name of this YaraProcedureRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this YaraProcedureRequest.


        :param name: The name of this YaraProcedureRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def condition(self):
        """Gets the condition of this YaraProcedureRequest.  # noqa: E501


        :return: The condition of this YaraProcedureRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def condition(self, condition):
        """Sets the condition of this YaraProcedureRequest.


        :param condition: The condition of this YaraProcedureRequest.  # noqa: E501
        :type: str
        """
    ...
    def include_all(self):
        """Gets the include_all of this YaraProcedureRequest.  # noqa: E501


        :return: The include_all of this YaraProcedureRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_all(self, include_all):
        """Sets the include_all of this YaraProcedureRequest.


        :param include_all: The include_all of this YaraProcedureRequest.  # noqa: E501
        :type: bool
        """
    ...
    def max_signatures(self):
        """Gets the max_signatures of this YaraProcedureRequest.  # noqa: E501


        :return: The max_signatures of this YaraProcedureRequest.  # noqa: E501
        :rtype: int
        """
        return self._max_signatures

    @max_signatures.setter
    def max_signatures(self, max_signatures):
        """Sets the max_signatures of this YaraProcedureRequest.


        :param max_signatures: The max_signatures of this YaraProcedureRequest.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(YaraProcedureRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, YaraProcedureRequest):
            return False

...
import six
from cythereal_magic.models.file_note import FileNote  # noqa: F401,E501

class AllOfFileMatchResponseNotes(FileNote):
    ...
    if hasattr(FileNote, "swagger_types"):
        swagger_types.update(FileNote.swagger_types)

    attribute_map = {
    }
    if hasattr(FileNote, "attribute_map"):
        attribute_map.update(FileNote.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchResponseNotes - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileNote.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileMatchResponseNotes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileMatchResponseNotes):
            return False

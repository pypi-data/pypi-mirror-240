...
import six
from cythereal_magic.models.child_response import ChildResponse  # noqa: F401,E501

class AllOfFileMatchResponseChildren(ChildResponse):
    ...
    if hasattr(ChildResponse, "swagger_types"):
        swagger_types.update(ChildResponse.swagger_types)

    attribute_map = {
    }
    if hasattr(ChildResponse, "attribute_map"):
        attribute_map.update(ChildResponse.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchResponseChildren - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        ChildResponse.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileMatchResponseChildren, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileMatchResponseChildren):
            return False

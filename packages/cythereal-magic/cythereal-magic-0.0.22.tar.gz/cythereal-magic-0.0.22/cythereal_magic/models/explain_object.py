...
class ExplainObject(object):
    ...
    def __init__(self, version=None, method=None, endpoint='/v2/swagger/', documentation='https://api.magic.unknowncyber.com/<api>/swagger/#<doc_path>', allowed_parameters=None, query_parameters=None, body_parameters=None):  # noqa: E501

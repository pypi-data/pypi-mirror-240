...
class SearchResponseData(object):
    ...
    """
    swagger_types = {
        'results': 'list[SearchResponseDataResults]'
    }
    ...
    @property
    def results(self):
        """Gets the results of this SearchResponseData.  # noqa: E501


        :return: The results of this SearchResponseData.  # noqa: E501
        :rtype: list[SearchResponseDataResults]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this SearchResponseData.


        :param results: The results of this SearchResponseData.  # noqa: E501
        :type: list[SearchResponseDataResults]
        """

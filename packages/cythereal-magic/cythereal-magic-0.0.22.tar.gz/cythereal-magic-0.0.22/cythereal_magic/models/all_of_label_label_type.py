...
import six
from cythereal_magic.models.label_type_enum import LabelTypeEnum  # noqa: F401,E501

class AllOfLabelLabelType(LabelTypeEnum):
    ...
    if hasattr(LabelTypeEnum, "swagger_types"):
        swagger_types.update(LabelTypeEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(LabelTypeEnum, "attribute_map"):
        attribute_map.update(LabelTypeEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfLabelLabelType - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        LabelTypeEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfLabelLabelType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfLabelLabelType):
            return False

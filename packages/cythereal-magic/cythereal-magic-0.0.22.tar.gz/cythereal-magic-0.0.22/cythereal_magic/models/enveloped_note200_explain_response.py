...
class EnvelopedNote200ExplainResponse(object):
    ...
    def __init__(self):  # noqa: E501
        """EnvelopedNote200ExplainResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnvelopedNote200ExplainResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnvelopedNote200ExplainResponse):
            return False

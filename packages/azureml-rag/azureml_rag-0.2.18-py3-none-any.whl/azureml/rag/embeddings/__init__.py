...
class EmbeddingsContainer:
    ...
    def mount_and_load(embeddings_cache_path: str, embeddings_model : str = None, embeddings_connection : str = None, activity_logger=None) -> "EmbeddingsContainer":
        """
        ...
        if embeddings_cache_path is not None:
            with track_activity(logger, "EmbeddingsContainer.mount_and_load") as embeddings_container_activity_logger:
                ...
                try:
                    ...
                    if embeddings_container is None and embeddings_model is not None and embeddings_connection is not None:
                        connection_args = {}

...
class Channel:
    ...
    async def write_item(self, item: xfmt.Any):
    ...
    async def read_task_loop(self):
        try:
            ...
            while self.running:
                ...
                # parser to xfmt type
                try:
                    item, used = xfmt.Any.fromBytes(data)
                except Exception as e:
                ...
                if isinstance(item, xfmt.Ret) or isinstance(item, xfmt.Err):
                    ...
                    try:
                        ...
                        from xbridge.interface import SrInterface
    ...
    async def callFunc(self, call: xfmt.Call) -> xfmt.Any:

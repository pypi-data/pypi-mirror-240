...
class RayDataFrame(pd.DataFrame):
    def __init__(self):
        raise TypeError("Cannot directly create an instance of RayDataFrame.")

    @classmethod
    def _new(cls, ray_table_url, maps_url, setup_object):
        ray_table = au._map_ray_table(ray_table_url, maps_url)
...
class RayTable:
    ...
    Attributes:
        ...
        _data (pd.DataFrame): The data of the simulation results.
    """
    ...
    def _new(cls, ray_table_url, maps_url, setup_object):
        """
        Creates a new results object based on the URL.
    ...
    def data(self):
        """
        Property to access the data of the simulation results.
        If accessed, calls get_data.

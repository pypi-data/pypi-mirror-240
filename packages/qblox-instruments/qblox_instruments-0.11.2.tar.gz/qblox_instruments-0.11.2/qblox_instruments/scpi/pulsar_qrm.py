...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.11.1 fwBuild=15/09/2023-22:44:22 fwHash=0x558D6F6C fwDirty=0 kmodVersion=0.11.1 kmodBuild=15/09/2023-22:44:22 kmodHash=0x558D6F6C kmodDirty=0 swVersion=0.11.1 swBuild=15/09/2023-22:44:22 swHash=0x558D6F6C swDirty=0 cfgManVersion=0.3.0 cfgManBuild=15/09/2023-22:44:22 cfgManHash=0x558D6F6C cfgManDirty=0"
            if build != build_ref:

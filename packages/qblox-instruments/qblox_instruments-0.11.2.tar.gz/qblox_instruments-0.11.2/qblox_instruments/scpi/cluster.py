...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.6.2 fwBuild=08/11/2023-19:53:26 fwHash=0xCBD2A738 fwDirty=0 kmodVersion=0.6.2 kmodBuild=08/11/2023-19:53:26 kmodHash=0xCBD2A738 kmodDirty=0 swVersion=0.6.2 swBuild=08/11/2023-19:53:26 swHash=0xCBD2A738 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=08/11/2023-19:53:26 cfgManHash=0xCBD2A738 cfgManDirty=0"
            if build != build_ref:
    ...
    def _get_max_out_att_0(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read("SLOT{}:AFE:ATT:OUT0:MAX?".format(slot))
    ...
    def _get_max_out_att_1(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read("SLOT{}:AFE:ATT:OUT1:MAX?".format(slot))

    ...
    def _get_required_parent_attr_names() -> List:
        ...
        for operation in ["set", "get"]:
            ...
            for idx in range(0, round(NUM_OUT/2)):
                ...
                attr_names.append("_{}_max_out_att_{}".format(operation, idx))
...
def add_qcodes_params(
    ...
    if parent.is_rf_type:
        ...
        parent.add_parameter(
            ...
            docstring="Sets/gets output attenuation in a range of 0 dB to {} dB with a resolution of 2dB per step.".format(
                parent._get_max_out_att_0()
            ),
            unit="dB",

...
class TimeSeries:
    ...
    ENABLE_FUTURE_REGRESSORS = '_enable_future_regressors'
    ALL_FORECASTING_PARAMETERS = {
        ...
        COUNTRY_OR_REGION_FOR_HOLIDAYS, SHORT_SERIES_HANDLING_CONFIG, CV_STEP_SIZE, ENABLE_FUTURE_REGRESSORS,
...
class TimeSeriesInternal:
    ...
    FUTURE_REGRESSORS_DEFAULT = False
    FEATURES_UNKNOWN_AT_FORECAST_TIME_DEFAULT = None

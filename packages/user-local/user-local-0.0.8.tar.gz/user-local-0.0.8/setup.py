...
setuptools.setup(
    name='user-local',
    version='0.0.8',  # https://pypi.org/project/user-local/
    author="Circles",
    author_email="info@circles.life",
    description="PyPI Package for Circles User Local Python",
    long_description="This is a package for sharing common functions of user CRUD used in different repositories",

...
def check_with_default(
    check: typing.Callable[[str], Status[T]], default: T
) -> typing.Callable[[str], Status[T]]:
...
def check_exists_path_with_default(
    default: pathlib.Path,
) -> typing.Callable[[str], Status[pathlib.Path]]:
...
def check_valid_path_with_default(
    default: pathlib.Path,
) -> typing.Callable[[str], Status[pathlib.Path]]:

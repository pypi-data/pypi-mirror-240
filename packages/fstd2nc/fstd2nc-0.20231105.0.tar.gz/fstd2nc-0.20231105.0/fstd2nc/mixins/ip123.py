...
# Decode ip1/ip2/ip3 ranges.
from fstd2nc.mixins import vectorize
@vectorize
def _decode_ranges (ip1_ip2_ip3):
  from rpnpy.librmn.fstd98 import DecodeIp
  import numpy as np
  dtype = np.dtype([('rp1_v1','float32'),('rp1_v2','float32'),('rp1_kind','int8'),('rp2_v1','float32'),('rp2_v2','float32'),('rp2_kind','int8'),('rp3_v1','float32'),('rp3_v2','float32'),('rp3_kind','int8')])
  out = np.maskedall(1,dtype=dtype)
  r1, r2, r3 = DecodeIp(ip1,0,0)
  out['rp1_v1'] = r1.v1
  out['rp1_v2'] = r1.v2
  out['rp1_kind'] = r1.kind
  out['rp2_v1'] = r2.v1
  out['rp2_v2'] = r2.v2
  out['rp2_kind'] = r2.kind
  out['rp3_v1'] = r3.v1
  out['rp3_v2'] = r3.v2
  out['rp3_kind'] = r3.kind
  #TODO

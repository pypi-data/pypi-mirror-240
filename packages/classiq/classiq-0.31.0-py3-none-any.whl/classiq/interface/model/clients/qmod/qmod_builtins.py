...
def repeat(
    count: QParam[int],
    iteration: QCallable[QParam[int], QArray[QBit, Literal["len(qbv)"]]],
    qbv: QArray[QBit],
) -> None:
    pass
...
def if_(
    ...
    then: QCallable[QArray[QBit, Literal["len(qbv)"]]],
    else_: QCallable[QArray[QBit, Literal["len(qbv)"]]],
    qbv: QArray[QBit],
) -> None:
    pass
...
def switch(
    selector: QParam[int],
    cases: QCallable[QArray[QBit, Literal["len(qbv)"]]],
    qbv: QArray[QBit],
) -> None:
    pass
...
@ExternalQFunc
def permute(
    functions: QCallable[QArray[QBit, Literal["len(qbv)"]]],
    qbv: QArray[QBit],
) -> None:
    pass

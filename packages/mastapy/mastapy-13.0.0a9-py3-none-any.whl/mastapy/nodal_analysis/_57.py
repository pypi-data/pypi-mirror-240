...
class DiagonalNonLinearStiffness(_0.APIBase):
    ...
    @property
    def theta_x_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    def theta_x_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.ThetaXStiffness = value

    @property
    def theta_y_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def theta_y_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.ThetaYStiffness = value

    @property
    def theta_z_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def theta_z_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.ThetaZStiffness = value

    @property
    def x_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @x_stiffness.setter
    @enforce_parameter_types
    def x_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.XStiffness = value

    @property
    def y_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @y_stiffness.setter
    @enforce_parameter_types
    def y_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.YStiffness = value

    @property
    def z_stiffness(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @z_stiffness.setter
    @enforce_parameter_types
    def z_stiffness(self: Self, value: "_1531.Vector2DListAccessor"):

...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    def value_vs_angle(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def value_vs_angle(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.ValueVsAngle = value

    @property
    def value_vs_angle_and_speed(self: Self) -> "_1562.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def value_vs_angle_and_speed(self: Self, value: "_1562.GriddedSurfaceAccessor"):
        self.wrapped.ValueVsAngleAndSpeed = value

    @property
    def value_vs_position(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_position(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.ValueVsPosition = value

    @property
    def value_vs_time(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_time(self: Self, value: "_1531.Vector2DListAccessor"):

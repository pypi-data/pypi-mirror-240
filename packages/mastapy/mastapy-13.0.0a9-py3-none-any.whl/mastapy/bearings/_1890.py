...
if TYPE_CHECKING:
    from mastapy.bearings import _1893, _1866, _1882
...
class RollingBearingDatabase(
    _1828.SQLDatabase["_1891.RollingBearingKey", "_2162.RollingBearing"]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: Self, bearing: "_2162.RollingBearing"):
    ...
    @enforce_parameter_types
    def create_bearing(
        self: Self, type_: "_1893.RollingBearingType", designation: "str" = "None"
    ...
    @enforce_parameter_types
    def remove_from_database(self: Self, bearing: "_2162.RollingBearing"):
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: Self, catalog: "_1866.BearingCatalog"
    ) -> "List[_2162.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: Self, designation: "str", catalog: "_1866.BearingCatalog"
    ) -> "_2162.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: Self,
        designation: "str",
        catalog: "_1866.BearingCatalog",
        type_: "_1893.RollingBearingType",
    ) -> "List[_2162.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1866.BearingCatalog",
        type_: "_1893.RollingBearingType",
        bore_range: "_1485.Range",
        outer_diameter_range: "_1485.Range",
        width_range: "_1485.Range",
        dynamic_capacity_range: "_1485.Range",
        number_of_rows: "int",
        material_type: "_1882.HybridSteelAll",
    ) -> "List[_2162.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]

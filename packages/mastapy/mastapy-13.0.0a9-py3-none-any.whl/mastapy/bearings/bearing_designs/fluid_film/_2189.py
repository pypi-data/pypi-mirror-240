...
class PlainJournalHousing(_0.APIBase):
    ...
    class _Cast_PlainJournalHousing:
        ...
        def cylindrical_housing_journal_bearing(
            ...
            return self._parent._cast(_2182.CylindricalHousingJournalBearing)
        ...
        def machinery_encased_journal_bearing(
            ...
            return self._parent._cast(_2183.MachineryEncasedJournalBearing)
        ...
        def pedestal_journal_bearing(
            ...
            return self._parent._cast(_2185.PedestalJournalBearing)
    ...
    @property
    def heat_emitting_area_method(self: Self) -> "_1940.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results._1940", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(self: Self, value: "_1940.DefaultOrUserInput"):

...
class CylindricalRollerBearing(_2158.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    def permissible_axial_load_default_calculation_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results._1939",
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: Self, value: "_1939.CylindricalRollerMaxAxialLoadMethod"
    ):

...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling import _2160, _2161
...
class NonBarrelRollerBearing(_2159.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self: Self) -> "_2160.RollerEndShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2160", "RollerEndShape"
        )(value)

    @roller_end_shape.setter
    @enforce_parameter_types
    def roller_end_shape(self: Self, value: "_2160.RollerEndShape"):
    ...
    @property
    def ribs(self: Self) -> "List[_2161.RollerRibDetail]":

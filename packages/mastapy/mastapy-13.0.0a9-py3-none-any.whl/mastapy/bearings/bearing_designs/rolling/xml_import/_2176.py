...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2174, _2173
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self: Self) -> "List[_2174.BearingImportFile]":
    ...
    @property
    def variables(self: Self) -> "List[_2173.AbstractXmlVariableAssignment]":

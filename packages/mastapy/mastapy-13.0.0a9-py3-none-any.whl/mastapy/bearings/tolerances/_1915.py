...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1916, _1922, _1912
...
class RoundnessSpecification(
    _1583.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    class _Cast_RoundnessSpecification:
        ...
        def independent_reportable_properties_base(
            ...
            return self._parent._cast(_1583.IndependentReportablePropertiesBase)
    ...
    @property
    def specification_type(self: Self) -> "_1916.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1916", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1916.RoundnessSpecificationType"):
    ...
    @property
    def type_of_fit(self: Self) -> "_1922.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1922", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: Self, value: "_1922.TypeOfFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def user_specified_deviation(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.UserSpecifiedDeviation = value

    @property
    def roundness_distribution(self: Self) -> "List[_1912.RaceRoundnessAtAngle]":

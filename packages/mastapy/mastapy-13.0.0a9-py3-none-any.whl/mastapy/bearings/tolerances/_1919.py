...
from mastapy.bearings.tolerances import _1907, _1920, _1906
...
class SupportTolerance(_1906.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: Self, value: "_1907.ITDesignation"):
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: Self, value: "_1920.SupportToleranceLocationDesignation"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

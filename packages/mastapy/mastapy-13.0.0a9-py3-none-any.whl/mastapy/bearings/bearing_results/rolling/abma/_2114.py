...
from mastapy.bearings.bearing_results.rolling.iso_rating_results import _2102
...
class ANSIABMAResults(_2102.ISOResults):
    """ANSIABMAResults
    ...
    class _Cast_ANSIABMAResults:
        ...
        def iso_results(self: "ANSIABMAResults._Cast_ANSIABMAResults"):
            return self._parent._cast(_2102.ISOResults)

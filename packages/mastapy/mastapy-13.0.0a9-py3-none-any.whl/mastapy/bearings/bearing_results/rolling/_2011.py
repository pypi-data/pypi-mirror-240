...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling import _1970, _2070
...
class LoadedElement(_0.APIBase):
    ...
    class _Cast_LoadedElement:
        ...
        def loaded_angular_contact_ball_bearing_element(
            ...
            return self._parent._cast(_1979.LoadedAngularContactBallBearingElement)
        ...
        def loaded_ball_bearing_element(self: "LoadedElement._Cast_LoadedElement"):
            ...
            return self._parent._cast(_1997.LoadedBallBearingElement)
        ...
        def loaded_deep_groove_ball_bearing_element(
            ...
            return self._parent._cast(_2008.LoadedDeepGrooveBallBearingElement)
        ...
        def loaded_four_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2012.LoadedFourPointContactBallBearingElement)
        ...
        def loaded_multi_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2016.LoadedMultiPointContactBallBearingElement)
        ...
        def loaded_self_aligning_ball_bearing_element(
            ...
            return self._parent._cast(_2032.LoadedSelfAligningBallBearingElement)
        ...
        def loaded_three_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2047.LoadedThreePointContactBallBearingElement)
        ...
        def loaded_thrust_ball_bearing_element(
            ...
            return self._parent._cast(_2050.LoadedThrustBallBearingElement)
    ...
    @property
    def force_from_inner_race(self: Self) -> "_1941.ElementForce":
    ...
    @property
    def operating_internal_clearance(self: Self) -> "_1970.InternalClearance":

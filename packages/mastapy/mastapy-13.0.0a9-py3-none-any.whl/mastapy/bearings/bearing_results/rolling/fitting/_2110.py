...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(
            ...
            from mastapy.bearings.bearing_results.rolling.fitting import _2107

            return self._parent._cast(_2107.InnerRingFittingThermalResults)
        ...
        def outer_ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2109.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self: Self) -> "List[_2108.InterferenceComponents]":

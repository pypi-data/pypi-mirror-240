...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: Self) -> "_2073.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: Self) -> "_2075.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: Self) -> "_2076.BearingRatingLife":
    ...
    @property
    def frequencies(self: Self) -> "_2078.Frequencies":
    ...
    @property
    def friction(self: Self) -> "_2080.Friction":
    ...
    @property
    def minimum_load(self: Self) -> "_2088.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: Self) -> "_2096.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: Self) -> "_2097.Viscosities":

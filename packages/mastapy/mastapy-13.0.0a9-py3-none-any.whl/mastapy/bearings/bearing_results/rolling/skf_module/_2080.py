...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2082, _2081
...
class Friction(_2093.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self: Self) -> "_2082.FrictionSources":
    ...
    @property
    def frictional_moment(self: Self) -> "_2081.FrictionalMoment":

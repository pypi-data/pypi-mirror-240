...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2079, _2091
...
class Frequencies(_2093.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: Self) -> "_2079.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: Self) -> "_2091.RotationalFrequency":

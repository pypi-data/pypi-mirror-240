...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1969, _2072
...
class LoadedBallBearingResults(_2030.LoadedRollingBearingResults):
    """LoadedBallBearingResults
    ...
    @property
    def track_truncation(self: Self) -> "_2072.TrackTruncationSafetyFactorResults":

...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_data import _1564, _1565
...
class ISO14179Settings(_1826.NamedDatabaseItem):
    """ISO14179Settings
    ...
    def isotr141792001f1_specification_method(
        self: Self, value: "_2062.PowerRatingF1EstimationMethod"
    ):

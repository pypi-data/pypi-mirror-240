...
if TYPE_CHECKING:
    from mastapy.utility.property import _1835, _1838, _1836, _1837
...
class LoadedRollingBearingDutyCycle(_1953.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    class _Cast_LoadedRollingBearingDutyCycle:
        ...
        def loaded_non_linear_bearing_duty_cycle_results(
            ...
            return self._parent._cast(_1953.LoadedNonLinearBearingDutyCycleResults)
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: Self,
    ) -> "_1835.DutyCyclePropertySummaryForce[_1872.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1838.DutyCyclePropertySummaryStress[_1872.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_truncation_summary(
        self: Self,
    ) -> "_1836.DutyCyclePropertySummaryPercentage[_1872.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: Self,
    ) -> "_1837.DutyCyclePropertySummarySmallAngle[_1872.BearingLoadCaseResultsLightweight]":

...
from mastapy.utility.units_and_measurements.measurements import _1664, _1685
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def chordal_span(
        self: Self,
    ) -> "_1034.CylindricalGearToothThicknessSpecification[_1664.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: Self,
    ) -> "_1034.CylindricalGearToothThicknessSpecification[_1685.Number]":
    ...
    def tooth_thickness(
        self: Self,
    ) -> "List[_1034.CylindricalGearToothThicknessSpecification[_1664.LengthShort]]":

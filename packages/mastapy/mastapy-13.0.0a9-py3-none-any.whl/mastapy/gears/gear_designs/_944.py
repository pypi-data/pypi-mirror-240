...
if TYPE_CHECKING:
    from mastapy.utility.property import _1833
...
class DesignConstraintsCollection(_1826.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: Self,
    ) -> "List[_1833.DeletableCollectionMember[_942.DesignConstraint]]":

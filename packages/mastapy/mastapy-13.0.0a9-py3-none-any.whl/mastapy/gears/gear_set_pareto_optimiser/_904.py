...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1546, _1543, _1537
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def filters(self: Self) -> "List[_1543.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: Self) -> "List[_1537.InputSetter[TAnalysis]]":

...
class CylindricalGearDesignAndRatingSettingsItem(_1826.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def tolerance_rounding_system(self: Self) -> "_1604.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.units_and_measurements._1604", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(self: Self, value: "_1604.MeasurementSystem"):
        value = conversion.mp_to_pn_enum(

...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    class _Cast_AbstractForceAndDisplacementResults:
        ...
        def force_and_displacement_results(
            ...
            return self._parent._cast(_1557.ForceAndDisplacementResults)
        ...
        def force_results(
            ...
            return self._parent._cast(_1558.ForceResults)
    ...
    @property
    def force(self: Self) -> "_1561.VectorWithLinearAndAngularComponents":

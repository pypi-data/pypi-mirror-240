...
class OnedimensionalFunctionLookupTable(
    _1563.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    def lookup_table(self: Self, value: "_1531.Vector2DListAccessor"):

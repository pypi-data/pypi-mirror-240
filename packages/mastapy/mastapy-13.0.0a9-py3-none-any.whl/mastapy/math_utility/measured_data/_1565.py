...
class TwodimensionalFunctionLookupTable(
    _1563.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1562.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: Self, value: "_1562.GriddedSurfaceAccessor"):

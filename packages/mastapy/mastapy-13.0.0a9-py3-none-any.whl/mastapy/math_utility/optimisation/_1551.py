...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1555, _1554
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationVariableBase:
        ...
        def pareto_optimisation_input(
            ...
            return self._parent._cast(_1544.ParetoOptimisationInput)
        ...
        def pareto_optimisation_output(
            ...
            return self._parent._cast(_1545.ParetoOptimisationOutput)
        ...
        def pareto_optimisation_variable(
            ...
            return self._parent._cast(_1550.ParetoOptimisationVariable)
        ...
        def parametric_study_doe_result_variable(
            ...
            return self._parent._cast(_4380.ParametricStudyDOEResultVariable)
    ...
    @property
    def integer_range(self: Self) -> "_1585.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: Self, value: "_1585.IntegerRange"):
    ...
    @property
    def range(self: Self) -> "_1485.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: Self, value: "_1485.Range"):
        self.wrapped.Range = value

    @property
    def specification_type(self: Self) -> "_1555.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1555", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1555.TargetingPropertyTo"):
    ...
    @property
    def specify_input_range_as(self: Self) -> "_1554.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1554", "SpecifyOptimisationInputAs"
        )(value)

    @specify_input_range_as.setter
    @enforce_parameter_types
    def specify_input_range_as(self: Self, value: "_1554.SpecifyOptimisationInputAs"):
        value = conversion.mp_to_pn_enum(

...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1437
...
class KeywayRating(_1445.InterferenceFitRating):
    """KeywayRating
    ...
    class _Cast_KeywayRating:
        ...
        def shaft_hub_connection_rating(self: "KeywayRating._Cast_KeywayRating"):
            from mastapy.detailed_rigid_connectors.rating import _1432

            return self._parent._cast(_1432.ShaftHubConnectionRating)
    ...
    @property
    def keyed_joint_design(self: Self) -> "_1433.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: Self) -> "List[_1437.KeywayHalfRating]":

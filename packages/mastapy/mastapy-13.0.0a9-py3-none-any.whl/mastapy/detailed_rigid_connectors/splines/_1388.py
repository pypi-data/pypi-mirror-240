...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1407, _1398
...
class DIN5480SplineHalfDesign(_1415.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    class _Cast_DIN5480SplineHalfDesign:
        ...
        def spline_half_design(
            ...
            return self._parent._cast(_1410.SplineHalfDesign)
    ...
    @property
    def finishing_method(self: Self) -> "_1407.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1407", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1407.FinishingMethods"):
    ...
    @property
    def manufacturing_type(self: Self) -> "_1398.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1398", "ManufacturingTypes"
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: Self, value: "_1398.ManufacturingTypes"):
        value = conversion.mp_to_pn_enum(

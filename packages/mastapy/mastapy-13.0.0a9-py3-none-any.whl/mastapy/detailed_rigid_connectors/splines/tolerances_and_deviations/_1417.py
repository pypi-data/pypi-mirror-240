...
from mastapy.detailed_rigid_connectors.splines import _1408, _1414
...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(self: Self, value: "_1408.SplineFitClassType"):
    ...
    @enforce_parameter_types
    def tolerance_class(self: Self, value: "_1414.SplineToleranceClassTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

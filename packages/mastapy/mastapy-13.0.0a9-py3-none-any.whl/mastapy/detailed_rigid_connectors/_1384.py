...
class DetailedRigidConnectorHalfDesign(_0.APIBase):
    ...
    class _Cast_DetailedRigidConnectorHalfDesign:
        ...
        def keyway_joint_half_design(
            ...
            from mastapy.detailed_rigid_connectors.keyed_joints import _1435

            return self._parent._cast(_1435.KeywayJointHalfDesign)
        ...
        def interference_fit_half_design(
            ...
            return self._parent._cast(_1442.InterferenceFitHalfDesign)

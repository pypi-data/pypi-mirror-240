...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    class _Cast_ShaftHubConnectionRating:
        ...
        def agma6123_spline_joint_rating(
            ...
            return self._parent._cast(_1420.AGMA6123SplineJointRating)
        ...
        def din5466_spline_rating(
            ...
            return self._parent._cast(_1422.DIN5466SplineRating)
        ...
        def gbt17855_spline_joint_rating(
            ...
            return self._parent._cast(_1424.GBT17855SplineJointRating)
        ...
        def sae_spline_joint_rating(
            ...
            return self._parent._cast(_1426.SAESplineJointRating)
        ...
        def spline_joint_rating(
            ...
            return self._parent._cast(_1428.SplineJointRating)
        ...
        def keyway_rating(
            ...
            return self._parent._cast(_1438.KeywayRating)

        @property
        def interference_fit_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ):
            from mastapy.detailed_rigid_connectors.interference_fits.rating import _1445

            return self._parent._cast(_1445.InterferenceFitRating)
    ...
    @property
    def joint_design(self: Self) -> "_1383.DetailedRigidConnectorDesign":

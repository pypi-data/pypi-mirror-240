...
class InterferenceFitHalfDesign(_1384.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self: Self) -> "_1443.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1443", "StressRegions"
        )(value)
    ...
    @property
    def tolerance(self: Self) -> "_1919.SupportTolerance":

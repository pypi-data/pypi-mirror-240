...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    class _Cast_DetailedRigidConnectorDesign:
        ...
        def keyed_joint_design(
            ...
            from mastapy.detailed_rigid_connectors.keyed_joints import _1433

            return self._parent._cast(_1433.KeyedJointDesign)
        ...
        def interference_fit_design(
            ...
            return self._parent._cast(_1441.InterferenceFitDesign)
    ...
    @property
    def halves(self: Self) -> "List[_1384.DetailedRigidConnectorHalfDesign]":

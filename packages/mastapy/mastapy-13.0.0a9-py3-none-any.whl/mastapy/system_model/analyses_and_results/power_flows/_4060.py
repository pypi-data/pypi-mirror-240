...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4059, _4058
...
class ConceptGearSetPowerFlow(_4091.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4059.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: Self) -> "List[_4059.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4058.ConceptGearMeshPowerFlow]":
    ...
    @property
    def concept_meshes_power_flow(self: Self) -> "List[_4058.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]

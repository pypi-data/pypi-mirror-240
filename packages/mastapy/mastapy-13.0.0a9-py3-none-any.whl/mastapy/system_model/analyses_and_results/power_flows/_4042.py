...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4041, _4040
...
class BevelDifferentialGearSetPowerFlow(_4047.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4041.BevelDifferentialGearPowerFlow]":
    ...
    def bevel_differential_gears_power_flow(
        self: Self,
    ) -> "List[_4041.BevelDifferentialGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelDifferentialGearPowerFlow]
    ...
    def meshes_power_flow(
        self: Self,
    ) -> "List[_4040.BevelDifferentialGearMeshPowerFlow]":

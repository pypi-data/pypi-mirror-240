...
class CycloidalAssemblyCompoundPowerFlow(_4261.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4072.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4072.CycloidalAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalAssemblyPowerFlow]

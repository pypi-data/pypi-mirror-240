...
class ConceptGearCompoundPowerFlow(_4221.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4059.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4059.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]

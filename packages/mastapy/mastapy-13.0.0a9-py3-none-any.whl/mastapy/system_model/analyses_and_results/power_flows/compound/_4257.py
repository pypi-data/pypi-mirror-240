...
class RootAssemblyCompoundPowerFlow(_4170.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self: Self) -> "_5656.AbstractStaticLoadCaseGroup":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4127.RootAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4127.RootAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RootAssemblyPowerFlow]

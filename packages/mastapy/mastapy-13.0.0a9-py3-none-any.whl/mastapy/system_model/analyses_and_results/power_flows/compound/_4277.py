...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4278
...
class SynchroniserHalfCompoundPowerFlow(_4278.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4146.SynchroniserHalfPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4146.SynchroniserHalfPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserHalfPowerFlow]

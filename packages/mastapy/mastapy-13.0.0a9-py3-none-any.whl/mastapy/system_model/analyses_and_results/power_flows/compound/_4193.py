...
class ConceptGearMeshCompoundPowerFlow(_4222.GearMeshCompoundPowerFlow):
    """ConceptGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4058.ConceptGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4058.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]

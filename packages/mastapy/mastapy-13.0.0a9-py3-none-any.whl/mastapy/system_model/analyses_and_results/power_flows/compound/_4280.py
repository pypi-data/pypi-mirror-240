...
class TorqueConverterCompoundPowerFlow(_4200.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4152.TorqueConverterPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4152.TorqueConverterPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]

...
class StraightBevelGearSetCompoundPowerFlow(_4181.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def straight_bevel_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4271.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4272.StraightBevelGearMeshCompoundPowerFlow]":

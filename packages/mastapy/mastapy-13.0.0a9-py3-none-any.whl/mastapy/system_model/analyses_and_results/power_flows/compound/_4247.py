...
class PlanetaryGearSetCompoundPowerFlow(_4212.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4115.PlanetaryGearSetPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4115.PlanetaryGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetaryGearSetPowerFlow]

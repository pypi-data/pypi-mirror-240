...
class WormGearMeshCompoundPowerFlow(_4222.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4157.WormGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4157.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]

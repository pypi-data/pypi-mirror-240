...
class WormGearCompoundPowerFlow(_4221.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4158.WormGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4158.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]

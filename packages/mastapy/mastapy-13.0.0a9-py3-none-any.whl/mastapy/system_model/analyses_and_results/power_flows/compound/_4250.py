...
class PowerLoadCompoundPowerFlow(_4285.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4120.PowerLoadPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4120.PowerLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PowerLoadPowerFlow]

...
class StraightBevelDiffGearSetCompoundPowerFlow(_4181.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4268.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4269.StraightBevelDiffGearMeshCompoundPowerFlow]":

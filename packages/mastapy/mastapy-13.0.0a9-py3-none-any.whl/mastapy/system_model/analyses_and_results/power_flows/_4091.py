...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4090, _4089
...
class GearSetPowerFlow(_4131.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4090.GearPowerFlow]":
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4089.GearMeshPowerFlow]":

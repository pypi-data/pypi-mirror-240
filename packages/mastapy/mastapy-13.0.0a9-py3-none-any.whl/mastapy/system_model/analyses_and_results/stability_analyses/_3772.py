...
class BevelDifferentialGearSetStabilityAnalysis(_3777.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    def bevel_differential_gears_stability_analysis(
        self: Self,
    ) -> "List[_3773.BevelDifferentialGearStabilityAnalysis]":
    ...
    def bevel_differential_meshes_stability_analysis(
        self: Self,
    ) -> "List[_3771.BevelDifferentialGearMeshStabilityAnalysis]":

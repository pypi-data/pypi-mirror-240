...
class BevelDifferentialGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3772.BevelDifferentialGearSetStabilityAnalysis]":
    ...
    def bevel_differential_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3905.BevelDifferentialGearCompoundStabilityAnalysis]":
    ...
    def bevel_differential_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3906.BevelDifferentialGearMeshCompoundStabilityAnalysis]":

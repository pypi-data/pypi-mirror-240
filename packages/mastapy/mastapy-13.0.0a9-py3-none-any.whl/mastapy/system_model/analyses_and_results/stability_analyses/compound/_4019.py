...
class WormGearSetCompoundStabilityAnalysis(_3954.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3889.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_4017.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_4018.WormGearMeshCompoundStabilityAnalysis]":

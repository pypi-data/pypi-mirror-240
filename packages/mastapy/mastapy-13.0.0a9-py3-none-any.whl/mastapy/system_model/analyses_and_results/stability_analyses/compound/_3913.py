...
class BoltCompoundStabilityAnalysis(_3919.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3780.BoltStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3780.BoltStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BoltStabilityAnalysis]

...
class FaceGearSetCompoundStabilityAnalysis(_3954.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3816.FaceGearSetStabilityAnalysis]":
    ...
    def face_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3947.FaceGearCompoundStabilityAnalysis]":
    ...
    def face_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3948.FaceGearMeshCompoundStabilityAnalysis]":

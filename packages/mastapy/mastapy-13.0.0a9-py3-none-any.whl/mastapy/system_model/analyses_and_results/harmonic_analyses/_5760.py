...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5748, _5807
...
class HarmonicAnalysisFEExportOptions(
    _5759.HarmonicAnalysisExportOptions[
        "_2651.IHaveFEPartHarmonicAnalysisResults", "_2450.FEPart"
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    class _Cast_HarmonicAnalysisFEExportOptions:
        ...
        def harmonic_analysis_export_options(
            ...
            return self._parent._cast(_5759.HarmonicAnalysisExportOptions)
    ...
    @enforce_parameter_types
    def distance_unit(self: Self, value: "_1607.Unit"):
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: Self, value: "_1607.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )

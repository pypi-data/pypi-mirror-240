...
class SynchroniserHarmonicAnalysis(_5806.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2821.SynchroniserSystemDeflection":

...
class CylindricalGearSetCompoundHarmonicAnalysis(_5935.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5922.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5923.CylindricalGearMeshCompoundHarmonicAnalysis]":

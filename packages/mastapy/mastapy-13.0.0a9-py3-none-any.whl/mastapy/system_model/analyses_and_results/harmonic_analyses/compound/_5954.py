...
class PartCompoundHarmonicAnalysis(_7542.PartCompoundAnalysis):
    """PartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5784.PartHarmonicAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5784.PartHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.PartHarmonicAnalysis]

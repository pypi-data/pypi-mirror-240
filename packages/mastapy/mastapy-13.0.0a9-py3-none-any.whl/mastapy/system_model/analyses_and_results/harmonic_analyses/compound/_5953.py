...
class OilSealCompoundHarmonicAnalysis(_5911.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5783.OilSealHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5783.OilSealHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.OilSealHarmonicAnalysis]

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5743, _5744
...
class FaceGearSetHarmonicAnalysis(_5754.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5743.FaceGearHarmonicAnalysis]":
    ...
    def face_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5743.FaceGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.FaceGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5744.FaceGearMeshHarmonicAnalysis]":

...
class ClutchHalfHarmonicAnalysis(_5714.CouplingHalfHarmonicAnalysis):
    """ClutchHalfHarmonicAnalysis
    ...
    @property
    def component_load_case(self: Self) -> "_6830.ClutchHalfLoadCase":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2709.ClutchHalfSystemDeflection":

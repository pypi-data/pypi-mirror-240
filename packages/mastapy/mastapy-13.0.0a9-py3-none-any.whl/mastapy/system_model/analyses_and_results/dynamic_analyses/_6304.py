...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6302, _6303
...
class ConceptGearSetDynamicAnalysis(_6335.GearSetDynamicAnalysis):
    """ConceptGearSetDynamicAnalysis
    ...
    def concept_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6303.ConceptGearMeshDynamicAnalysis]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6398, _6399
...
class WormGearSetDynamicAnalysis(_6335.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    def worm_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6398.WormGearDynamicAnalysis]":
    ...
    def worm_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6399.WormGearMeshDynamicAnalysis]":

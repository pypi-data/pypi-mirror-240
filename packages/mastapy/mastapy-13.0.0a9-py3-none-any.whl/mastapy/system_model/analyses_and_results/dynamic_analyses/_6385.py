...
class StraightBevelGearSetDynamicAnalysis(_6291.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis
    ...
    def straight_bevel_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6383.StraightBevelGearDynamicAnalysis]":
    ...
    def straight_bevel_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6384.StraightBevelGearMeshDynamicAnalysis]":

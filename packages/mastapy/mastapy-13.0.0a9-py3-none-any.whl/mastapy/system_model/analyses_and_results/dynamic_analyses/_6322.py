...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6320, _6321
...
class CylindricalGearSetDynamicAnalysis(_6335.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    def cylindrical_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6320.CylindricalGearDynamicAnalysis]":
    ...
    def cylindrical_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6321.CylindricalGearMeshDynamicAnalysis]":

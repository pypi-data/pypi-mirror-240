...
class BearingCompoundDynamicAnalysis(_6440.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6281.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6281.BearingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]

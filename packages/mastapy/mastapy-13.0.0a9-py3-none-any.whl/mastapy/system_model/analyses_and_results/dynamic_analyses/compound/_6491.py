...
class PowerLoadCompoundDynamicAnalysis(_6526.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6362.PowerLoadDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6362.PowerLoadDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PowerLoadDynamicAnalysis]

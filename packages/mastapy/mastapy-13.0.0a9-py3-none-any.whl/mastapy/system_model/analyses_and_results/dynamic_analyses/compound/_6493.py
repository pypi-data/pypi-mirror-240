...
class RingPinsCompoundDynamicAnalysis(_6481.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6364.RingPinsDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6364.RingPinsDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.RingPinsDynamicAnalysis]

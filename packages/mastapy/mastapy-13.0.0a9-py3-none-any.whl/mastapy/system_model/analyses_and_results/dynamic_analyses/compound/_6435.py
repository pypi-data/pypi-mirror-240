...
class ConceptGearSetCompoundDynamicAnalysis(_6464.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6304.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6433.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6434.ConceptGearMeshCompoundDynamicAnalysis]":

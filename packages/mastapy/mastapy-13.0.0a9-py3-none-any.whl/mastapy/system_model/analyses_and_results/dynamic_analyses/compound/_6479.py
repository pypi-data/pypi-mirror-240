...
class MassDiscCompoundDynamicAnalysis(_6526.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6350.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6350.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]

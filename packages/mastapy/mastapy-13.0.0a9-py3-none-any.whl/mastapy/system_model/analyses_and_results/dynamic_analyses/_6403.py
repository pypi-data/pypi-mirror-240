...
class ZerolBevelGearSetDynamicAnalysis(_6291.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    def zerol_bevel_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6401.ZerolBevelGearDynamicAnalysis]":
    ...
    def zerol_bevel_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6402.ZerolBevelGearMeshDynamicAnalysis]":

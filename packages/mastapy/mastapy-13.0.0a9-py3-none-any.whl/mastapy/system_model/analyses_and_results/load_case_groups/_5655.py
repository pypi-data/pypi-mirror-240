...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6945, _6800
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_AbstractLoadCaseGroup:
        ...
        def abstract_static_load_case_group(
            ...
            return self._parent._cast(_5656.AbstractStaticLoadCaseGroup)
        ...
        def time_series_load_case_group(
            ...
            return self._parent._cast(_5667.TimeSeriesLoadCaseGroup)
    ...
    @property
    def model(self: Self) -> "_2197.Design":
    ...
    @property
    def load_case_root_assemblies(self: Self) -> "List[_6945.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: Self, number_of_load_cases: "int", token: "_7555.TaskProgress"
    ) -> "List[_6800.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: Self, progress: "_7555.TaskProgress"):
        """Method does not return.

...
class PartStaticLoadCaseGroup(_5671.DesignEntityStaticLoadCaseGroup):
    """PartStaticLoadCaseGroup
    ...
    class _Cast_PartStaticLoadCaseGroup:
        ...
        def abstract_assembly_static_load_case_group(
            ...
            return self._parent._cast(_5668.AbstractAssemblyStaticLoadCaseGroup)
        ...
        def component_static_load_case_group(
            ...
            return self._parent._cast(_5669.ComponentStaticLoadCaseGroup)
        ...
        def gear_set_static_load_case_group(
            ...
            return self._parent._cast(_5672.GearSetStaticLoadCaseGroup)
    ...
    @property
    def part_load_cases(self: Self) -> "List[_6925.PartLoadCase]":

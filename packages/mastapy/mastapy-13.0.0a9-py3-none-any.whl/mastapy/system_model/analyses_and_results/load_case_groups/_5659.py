...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5657, _5658
...
class DesignState(_5654.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: Self) -> "List[_5657.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: Self, clutch_connection: "_2339.ClutchConnection"
    ...
    def concept_synchro_gear_engagement_status_for(
        self: Self, gear: "_2522.CylindricalGear"

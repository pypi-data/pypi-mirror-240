...
class DutyCycle(_5656.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: Self,
    ) -> "List[_5663.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: Self) -> "_6998.TimeSeriesImporter":
    ...
    def add_static_load(self: Self, static_load: "_6801.StaticLoadCase"):
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: Self, sub_group: "_5663.SubGroupInSingleDesignState"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: Self, static_load: "_6801.StaticLoadCase"):
        """Method does not return.

...
class FEPartLoadCase(_6805.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: Self) -> "_2356.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2356", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: Self, value: "_2380.FESubstructure"):
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: Self,
    ) -> "List[_6832.CMSElementFaceGroupWithSelectionOption]":

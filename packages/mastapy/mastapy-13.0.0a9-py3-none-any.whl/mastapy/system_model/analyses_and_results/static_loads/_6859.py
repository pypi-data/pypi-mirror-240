...
class CylindricalGearManufactureError(_6888.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_left_flank(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.PitchErrorsLeftFlank = value

    @property
    def pitch_errors_right_flank(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_right_flank(self: Self, value: "_1531.Vector2DListAccessor"):

...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2636, _2617
...
class TimeSeriesLoadCase(_6800.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: Self) -> "_2636.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: Self) -> "_5457.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: Self) -> "_5667.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: Self,
        new_load_case_group: "_5667.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6979, _6980
...
class WormGearSetLoadCase(_6892.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6979.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: Self) -> "List[_6979.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def worm_meshes_load_case(self: Self) -> "List[_6980.WormGearMeshLoadCase]":

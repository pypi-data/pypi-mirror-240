...
class ClutchConnectionLoadCase(_6848.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: Self, value: "_1531.Vector2DListAccessor"):

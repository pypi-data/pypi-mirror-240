...
class StaticLoadCase(_6800.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self: Self) -> "_2643.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: Self) -> "_2638.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: Self) -> "_2629.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: Self) -> "_2637.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: Self) -> "_2632.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: Self) -> "_2622.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: Self) -> "_2639.StabilityAnalysis":
    ...
    def unbalanced_mass_inclusion(
        self: Self,
        value: "Union[_2475.UnbalancedMassInclusionOption, Tuple[_2475.UnbalancedMassInclusionOption, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def clutch_engagements(self: Self) -> "List[_5657.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: Self,
    ) -> "List[_5658.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: Self) -> "_5659.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_design_state_group: "_5659.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":

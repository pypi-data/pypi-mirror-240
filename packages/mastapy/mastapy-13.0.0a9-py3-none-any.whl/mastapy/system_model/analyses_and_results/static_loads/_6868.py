...
from mastapy.electric_machines.harmonic_load_data import _1378, _1374
...
class ElectricMachineHarmonicLoadData(_1374.ElectricMachineHarmonicLoadDataBase):
    """ElectricMachineHarmonicLoadData
    ...
    @enforce_parameter_types
    def data_type_for_scaling(self: Self, value: "_1378.HarmonicLoadDataType"):
    ...
    @enforce_parameter_types
    def torque_ripple_input_type(self: Self, value: "_6973.TorqueRippleInputType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

...
if TYPE_CHECKING:
    ...
    from mastapy.utility.file_access_helpers import _1814
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: Self, value: "_6988.DestinationDesignState"
    ):
    ...
    @property
    def force_chart(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def import_type(self: Self) -> "_6905.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6905", "ImportType"
        )(value)

    @import_type.setter
    @enforce_parameter_types
    def import_type(self: Self, value: "_6905.ImportType"):
    ...
    @property
    def moment_chart(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def speed_chart(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def torque_chart(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def design_state_options(self: Self) -> "_6987.DesignStateOptions":
    ...
    @property
    def gear_ratio_options(self: Self) -> "_6990.GearRatioInputOptions":
    ...
    @property
    def load_case_name_inputs(self: Self) -> "_6991.LoadCaseNameOptions":
    ...
    @property
    def time_step_input(self: Self) -> "_6999.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: Self,
    ) -> "List[_6986.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    def file_inputs(self: Self) -> "List[_6993.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    def force_inputs(self: Self) -> "List[_6989.ForceInputOptions]":
    ...
    @property
    def moment_inputs(self: Self) -> "List[_6992.MomentInputOptions]":
    ...
    @property
    def speed_inputs(self: Self) -> "List[_6997.SpeedInputOptions]":
    ...
    @property
    def torque_inputs(self: Self) -> "List[_7000.TorqueInputOptions]":
    ...
    @property
    def columns(self: Self) -> "List[_1814.ColumnTitle]":

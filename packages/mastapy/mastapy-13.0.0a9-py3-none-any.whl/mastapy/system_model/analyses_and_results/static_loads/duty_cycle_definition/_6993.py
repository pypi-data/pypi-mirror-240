...
class MultiTimeSeriesDataInputFileOptions(_1845.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    class _Cast_MultiTimeSeriesDataInputFileOptions:
        ...
        def data_input_file_options(
            ...
            return self._parent._cast(_1845.DataInputFileOptions)
    ...
    @property
    def delimiter_options(self: Self) -> "_1815.TextFileDelimiterOptions":

...
from mastapy.system_model.analyses_and_results.static_loads import _6894, _6801
...
class PartLoadCase(_2654.PartAnalysis):
    """PartLoadCase
    ...
    def harmonic_excitation_type(self: Self, value: "_6894.HarmonicExcitationType"):
    ...
    @enforce_parameter_types
    def load_case_for_harmonic_excitation_type_advanced_system_deflection_current_load_case_set_up(
        self: Self, value: "_6801.StaticLoadCase"
    ):
        wrapper_type = (
    ...
    def get_harmonic_load_data_for_import(self: Self) -> "_1376.HarmonicLoadDataBase":

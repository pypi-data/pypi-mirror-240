...
class HarmonicLoadDataImportFromMotorPackages(_6898.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
    ...
    class _Cast_HarmonicLoadDataImportFromMotorPackages:
        ...
        def harmonic_load_data_csv_import(
            ...
            return self._parent._cast(_6895.HarmonicLoadDataCSVImport)
        ...
        def harmonic_load_data_motor_cad_import(
            ...
            return self._parent._cast(_6901.HarmonicLoadDataMotorCADImport)

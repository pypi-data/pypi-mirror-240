...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6819, _6820
...
class BevelDifferentialGearSetLoadCase(_6826.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6819.BevelDifferentialGearLoadCase]":
    ...
    def bevel_differential_gears_load_case(
        self: Self,
    ) -> "List[_6819.BevelDifferentialGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelDifferentialGearLoadCase]
    ...
    def bevel_differential_meshes_load_case(
        self: Self,
    ) -> "List[_6820.BevelDifferentialGearMeshLoadCase]":

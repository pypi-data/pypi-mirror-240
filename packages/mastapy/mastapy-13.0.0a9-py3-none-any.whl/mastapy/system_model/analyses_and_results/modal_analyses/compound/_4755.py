...
class ConceptGearSetCompoundModalAnalysis(_4784.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4599.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4753.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4754.ConceptGearMeshCompoundModalAnalysis]":

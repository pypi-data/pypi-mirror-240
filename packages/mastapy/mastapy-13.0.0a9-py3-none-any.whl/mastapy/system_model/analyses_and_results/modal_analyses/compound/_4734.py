...
class BeltDriveCompoundModalAnalysis(_4822.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4578.BeltDriveModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4578.BeltDriveModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BeltDriveModalAnalysis]

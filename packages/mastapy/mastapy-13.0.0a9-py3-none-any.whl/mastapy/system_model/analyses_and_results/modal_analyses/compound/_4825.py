...
class SpiralBevelGearSetCompoundModalAnalysis(_4742.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4823.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4824.SpiralBevelGearMeshCompoundModalAnalysis]":

...
class PartModalAnalysis(_7544.PartStaticLoadAnalysisCase):
    """PartModalAnalysis
    ...
    def gear_mesh_excitation_details(
        self: Self,
    ) -> "List[_4720.RigidlyConnectedDesignEntityGroupModalAnalysis]":
    ...
    @property
    def results_for_modes(self: Self) -> "List[_4723.SingleModeResults]":
    ...
    def create_viewable(self: Self) -> "_2248.ModalAnalysisViewable":

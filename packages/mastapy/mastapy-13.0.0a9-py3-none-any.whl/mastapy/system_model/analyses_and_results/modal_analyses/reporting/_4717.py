...
class PerModeResultsReport(_1753.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: Self) -> "_1817.TableAndChartOptions":
    ...
    def display_option(self: Self, value: "_1817.TableAndChartOptions"):

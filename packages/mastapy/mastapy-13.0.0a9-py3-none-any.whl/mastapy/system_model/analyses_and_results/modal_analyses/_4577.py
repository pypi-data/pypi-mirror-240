...
class BeltConnectionModalAnalysis(_4638.InterMountableComponentConnectionModalAnalysis):
    """BeltConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2696.BeltConnectionSystemDeflection":

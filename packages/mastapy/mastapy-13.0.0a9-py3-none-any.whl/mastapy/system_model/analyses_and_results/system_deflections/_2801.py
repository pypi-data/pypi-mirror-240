...
class ShaftSystemDeflection(_2684.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4129.ShaftPowerFlow":
    ...
    @property
    def mounted_components_applying_torque(self: Self) -> "List[_1558.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: Self,
    ) -> "List[_2799.ShaftSectionEndResultsSystemDeflection]":
    ...
    @property
    def shaft_section_results(self: Self) -> "List[_2800.ShaftSectionSystemDeflection]":

...
class FlexiblePinAssemblySystemDeflection(_2803.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: Self) -> "_6885.FlexiblePinAssemblyLoadCase":
    ...
    @property
    def flexible_pin_shaft_details(self: Self) -> "_2801.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: Self) -> "_2801.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4088.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: Self) -> "_2801.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: Self) -> "List[_2695.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: Self,
    ) -> "List[_2775.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: Self,
    ) -> "List[_2780.ObservedPinStiffnessReporter]":
    ...
    def planet_gear_system_deflections(
        self: Self,
    ) -> "List[_2742.CylindricalGearSystemDeflection]":

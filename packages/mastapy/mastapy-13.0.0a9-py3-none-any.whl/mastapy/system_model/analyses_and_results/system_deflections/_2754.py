...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_vectors import _1561, _1557
...
class FEPartSystemDeflection(_2683.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4087.FEPartPowerFlow":
    ...
    @property
    def export(self: Self) -> "_2407.SystemDeflectionFEExportOptions":

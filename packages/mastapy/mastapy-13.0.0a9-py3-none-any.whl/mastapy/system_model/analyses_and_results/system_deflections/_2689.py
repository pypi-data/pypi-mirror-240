...
class AssemblySystemDeflection(_2682.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4036.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: Self) -> "List[_2695.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_2697.BeltDriveSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_2699.BevelDifferentialGearSetSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2706.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_2707.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_2731.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_2710.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: Self) -> "List[_2712.ComponentSystemDeflection]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_2716.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_2718.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: Self) -> "List[_2724.ConnectionSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_2732.CycloidalAssemblySystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_2735.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_2739.CylindricalGearSetSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2754.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2752.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_2755.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_2761.HypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_2772.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_2776.MassDiscSystemDeflection]":
    ...
    def mountable_component_details(
        self: Self,
    ) -> "List[_2779.MountableComponentSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2781.OilSealSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_2785.PartToPartShearCouplingSystemDeflection]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_2787.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2788.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2789.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_2791.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: Self) -> "List[_2695.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_2798.ShaftHubConnectionSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2801.ShaftSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_2805.SpiralBevelGearSetSystemDeflection]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_2809.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_2821.SynchroniserSystemDeflection]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_2827.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_2831.UnbalancedMassSystemDeflection]":
    ...
    def unconverged_bearings_sorted_by_load(
        self: Self,
    ) -> "List[_2695.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2834.WormGearSetSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_2837.ZerolBevelGearSetSystemDeflection]":

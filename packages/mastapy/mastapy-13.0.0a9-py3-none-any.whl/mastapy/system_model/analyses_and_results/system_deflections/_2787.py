...
class PlanetCarrierSystemDeflection(_2779.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4116.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: Self) -> "List[_2843.PlanetCarrierWindup]":

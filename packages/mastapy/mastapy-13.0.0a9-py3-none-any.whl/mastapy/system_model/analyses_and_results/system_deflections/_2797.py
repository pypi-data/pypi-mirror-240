...
class RootAssemblySystemDeflection(_2689.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4127.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: Self) -> "_2822.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: Self,
    ) -> "List[_2713.ConcentricPartGroupCombinationSystemDeflectionResults]":

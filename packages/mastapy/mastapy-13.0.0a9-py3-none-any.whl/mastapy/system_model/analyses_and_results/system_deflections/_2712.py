...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_vectors import _1558, _1559
...
class ComponentSystemDeflection(_2782.PartSystemDeflection):
    """ComponentSystemDeflection
    ...
    @property
    def connected_components_forces_in_lcs(self: Self) -> "List[_1558.ForceResults]":
    ...
    @property
    def connected_components_forces_in_wcs(self: Self) -> "List[_1558.ForceResults]":
        """List[mastapy.math_utility.measured_vectors.ForceResults]
    ...
    @property
    def node_results(self: Self) -> "List[_1559.NodeResults]":
    ...
    @property
    def power_flow_results(self: Self) -> "_4054.ComponentPowerFlow":

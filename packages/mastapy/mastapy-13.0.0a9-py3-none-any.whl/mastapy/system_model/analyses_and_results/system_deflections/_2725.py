...
class ConnectorSystemDeflection(_2779.MountableComponentSystemDeflection):
    """ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self: Self) -> "_2754.FEPartSystemDeflection":
    ...
    @property
    def outer_fe_substructure_nodes(self: Self) -> "List[_2382.FESubstructureNode]":
    ...
    @property
    def power_flow_results(self: Self) -> "_4065.ConnectorPowerFlow":

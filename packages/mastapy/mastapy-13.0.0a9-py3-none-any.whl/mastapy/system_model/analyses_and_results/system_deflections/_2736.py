...
class CylindricalGearMeshSystemDeflection(_2756.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2742.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2742.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4077.CylindricalGearMeshPowerFlow":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2742.CylindricalGearSystemDeflection]":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: Self,
    ) -> "List[_2746.CylindricalMeshedGearSystemDeflection]":
    ...
    @property
    def mesh_deflections_left_flank(self: Self) -> "List[_2842.MeshDeflectionResults]":
    ...
    @property
    def mesh_deflections_right_flank(self: Self) -> "List[_2842.MeshDeflectionResults]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.MeshDeflectionResults]
    ...
    @property
    def gear_set(self: Self) -> "_2739.CylindricalGearSetSystemDeflection":

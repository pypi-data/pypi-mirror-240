...
class BearingCompoundSystemDeflection(_2884.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1945.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2695.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]

...
class PointLoadCompoundSystemDeflection(_2972.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2788.PointLoadSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2788.PointLoadSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PointLoadSystemDeflection]

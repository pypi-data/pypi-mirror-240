...
class DatumCompoundSystemDeflection(_2873.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2748.DatumSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2748.DatumSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]

...
class MassDiscCompoundSystemDeflection(_2972.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2776.MassDiscSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2776.MassDiscSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.MassDiscSystemDeflection]

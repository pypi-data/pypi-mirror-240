...
class StraightBevelDiffGearMeshSystemDeflection(_2703.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4138.StraightBevelDiffGearMeshPowerFlow":

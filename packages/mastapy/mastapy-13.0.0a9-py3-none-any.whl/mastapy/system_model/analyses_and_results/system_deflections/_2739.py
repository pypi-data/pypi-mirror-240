...
class CylindricalGearSetSystemDeflection(_2757.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4079.CylindricalGearSetPowerFlow":
    ...
    def cylindrical_meshes_system_deflection(
        self: Self,
    ) -> "List[_2736.CylindricalGearMeshSystemDeflection]":

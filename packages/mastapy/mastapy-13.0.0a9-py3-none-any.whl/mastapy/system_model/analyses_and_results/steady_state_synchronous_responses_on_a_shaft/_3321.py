...
class PartSteadyStateSynchronousResponseOnAShaft(_7544.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self: Self) -> "_2255.SteadyStateSynchronousResponseViewable":

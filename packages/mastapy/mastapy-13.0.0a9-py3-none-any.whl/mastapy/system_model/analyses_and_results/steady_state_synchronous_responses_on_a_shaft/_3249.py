...
class AssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def bolts(self: Self) -> "List[_3262.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3284.CVTSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def shafts(self: Self) -> "List[_3338.ShaftSteadyStateSynchronousResponseOnAShaft]":

...
class WormGearSetModalAnalysisAtAStiffness(_4914.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    def worm_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4979.WormGearModalAnalysisAtAStiffness]":
    ...
    def worm_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4978.WormGearMeshModalAnalysisAtAStiffness]":

...
class RootAssemblyParametricStudyTool(_4299.AssemblyParametricStudyTool):
    """RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self: Self) -> "_4384.ParametricStudyTool":
    ...
    def root_assembly_duty_cycle_results(
        self: Self,
    ) -> "List[_2900.DutyCycleEfficiencyResults]":

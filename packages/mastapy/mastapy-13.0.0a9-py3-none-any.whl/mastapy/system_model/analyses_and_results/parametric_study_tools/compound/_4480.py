...
class CVTCompoundParametricStudyTool(_4449.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4333.CVTParametricStudyTool]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4333.CVTParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.CVTParametricStudyTool]

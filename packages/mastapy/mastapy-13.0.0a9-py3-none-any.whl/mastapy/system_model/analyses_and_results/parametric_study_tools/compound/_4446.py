...
class AssemblyCompoundParametricStudyTool(
    ...
    @property
    def all_duty_cycle_results(self: Self) -> "_4346.DutyCycleResultsForAllComponents":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4299.AssemblyParametricStudyTool]":
    ...
    @property
    def bearings(self: Self) -> "List[_4447.BearingCompoundParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4449.BeltDriveCompoundParametricStudyTool]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4452.BevelDifferentialGearSetCompoundParametricStudyTool]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_4459.BoltedJointCompoundParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4458.BoltCompoundParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4480.CVTCompoundParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4460.ClutchCompoundParametricStudyTool]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4465.ConceptCouplingCompoundParametricStudyTool]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4470.ConceptGearSetCompoundParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4482.CycloidalAssemblyCompoundParametricStudyTool]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_4484.CycloidalDiscCompoundParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4488.CylindricalGearSetCompoundParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4495.FEPartCompoundParametricStudyTool]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_4494.FaceGearSetCompoundParametricStudyTool]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4496.FlexiblePinAssemblyCompoundParametricStudyTool]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4503.HypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4510.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4513.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4514.MassDiscCompoundParametricStudyTool]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4515.MeasurementComponentCompoundParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4517.OilSealCompoundParametricStudyTool]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4519.PartToPartShearCouplingCompoundParametricStudyTool]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_4524.PlanetCarrierCompoundParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4525.PointLoadCompoundParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4526.PowerLoadCompoundParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4528.RingPinsCompoundParametricStudyTool]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4530.RollingRingAssemblyCompoundParametricStudyTool]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4535.ShaftHubConnectionCompoundParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4534.ShaftCompoundParametricStudyTool]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4540.SpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_4541.SpringDamperCompoundParametricStudyTool]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4546.StraightBevelDiffGearSetCompoundParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4549.StraightBevelGearSetCompoundParametricStudyTool]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_4552.SynchroniserCompoundParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4556.TorqueConverterCompoundParametricStudyTool]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4560.UnbalancedMassCompoundParametricStudyTool]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_4564.WormGearSetCompoundParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4567.ZerolBevelGearSetCompoundParametricStudyTool]":

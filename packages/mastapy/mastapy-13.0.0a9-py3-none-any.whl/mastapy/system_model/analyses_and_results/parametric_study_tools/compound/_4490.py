...
class DatumCompoundParametricStudyTool(_4464.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4343.DatumParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4343.DatumParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.DatumParametricStudyTool]

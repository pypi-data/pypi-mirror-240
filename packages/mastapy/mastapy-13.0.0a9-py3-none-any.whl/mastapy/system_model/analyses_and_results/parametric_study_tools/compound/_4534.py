...
class ShaftCompoundParametricStudyTool(_4440.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4406.ShaftParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4406.ShaftParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ShaftParametricStudyTool]

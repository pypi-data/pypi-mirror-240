...
class AssemblyParametricStudyTool(_4292.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    def all_duty_cycle_results(
        self: Self,
    ) -> "List[_4346.DutyCycleResultsForAllComponents]":
    ...
    @property
    def bearings(self: Self) -> "List[_4300.BearingParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4302.BeltDriveParametricStudyTool]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4311.BoltedJointParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4312.BoltParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4333.CVTParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4315.ClutchParametricStudyTool]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4337.CycloidalDiscParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4355.FEPartParametricStudyTool]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4354.FaceGearSetParametricStudyTool]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4363.HypoidGearSetParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4374.MassDiscParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4378.OilSealParametricStudyTool]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4395.PlanetCarrierParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4396.PointLoadParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4397.PowerLoadParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4399.RingPinsParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4406.ShaftParametricStudyTool]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4414.SpringDamperParametricStudyTool]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4424.SynchroniserParametricStudyTool]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4435.WormGearSetParametricStudyTool]":

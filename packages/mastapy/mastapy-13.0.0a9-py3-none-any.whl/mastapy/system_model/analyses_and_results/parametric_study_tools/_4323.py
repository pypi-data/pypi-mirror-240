...
class ConceptGearSetParametricStudyTool(_4359.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    def concept_gears_parametric_study_tool(
        self: Self,
    ) -> "List[_4322.ConceptGearParametricStudyTool]":
    ...
    def concept_meshes_parametric_study_tool(
        self: Self,
    ) -> "List[_4321.ConceptGearMeshParametricStudyTool]":

...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6264
...
class FlexiblePinAnalysis(_6264.CombinationAnalysis):
    """FlexiblePinAnalysis
    ...
    class _Cast_FlexiblePinAnalysis:
        ...
        def combination_analysis(self: "FlexiblePinAnalysis._Cast_FlexiblePinAnalysis"):
            return self._parent._cast(_6264.CombinationAnalysis)
        ...
        def flexible_pin_analysis_concept_level(
            ...
            return self._parent._cast(_6266.FlexiblePinAnalysisConceptLevel)
        ...
        def flexible_pin_analysis_gear_and_bearing_rating(
            ...
            return self._parent._cast(_6268.FlexiblePinAnalysisGearAndBearingRating)
        ...
        def flexible_pin_analysis_manufacture_level(
            ...
            return self._parent._cast(_6269.FlexiblePinAnalysisManufactureLevel)
        ...
        def flexible_pin_analysis_stop_start_analysis(
            ...
            return self._parent._cast(_6271.FlexiblePinAnalysisStopStartAnalysis)
    ...
    @property
    def analysis_options(self: Self) -> "_6270.FlexiblePinAnalysisOptions":

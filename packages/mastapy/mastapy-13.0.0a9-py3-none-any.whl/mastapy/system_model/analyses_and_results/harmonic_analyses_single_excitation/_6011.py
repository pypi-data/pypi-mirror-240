...
class AssemblyHarmonicAnalysisOfSingleExcitation(
    ...
    @property
    def bearings(self: Self) -> "List[_6012.BearingHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_6014.BeltDriveHarmonicAnalysisOfSingleExcitation]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_6023.BoltedJointHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def bolts(self: Self) -> "List[_6024.BoltHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6045.CVTHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def clutches(self: Self) -> "List[_6027.ClutchHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6032.ConceptCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6035.ConceptGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6047.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6049.CycloidalDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6053.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6060.FEPartHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6059.FaceGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6061.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6069.HypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6076.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6079.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_6080.MassDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6081.MeasurementComponentHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_6084.OilSealHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6088.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6091.PlanetCarrierHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_6092.PointLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_6093.PowerLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6095.RingPinsHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6097.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6102.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def shafts(self: Self) -> "List[_6101.ShaftHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6107.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6110.SpringDamperHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6113.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6116.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6120.SynchroniserHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6124.TorqueConverterHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6127.UnbalancedMassHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6131.WormGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6134.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]":

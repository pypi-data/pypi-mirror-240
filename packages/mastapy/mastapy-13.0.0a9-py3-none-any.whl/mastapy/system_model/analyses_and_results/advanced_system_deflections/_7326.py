...
class FaceGearSetAdvancedSystemDeflection(_7331.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: Self,
    ) -> "List[_2752.FaceGearSetSystemDeflection]":
    ...
    def face_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7324.FaceGearAdvancedSystemDeflection]":
    ...
    def face_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7325.FaceGearMeshAdvancedSystemDeflection]":

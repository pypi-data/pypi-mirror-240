...
class WormGearSetAdvancedSystemDeflection(_7331.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: Self,
    ) -> "List[_2834.WormGearSetSystemDeflection]":
    ...
    def worm_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7396.WormGearAdvancedSystemDeflection]":
    ...
    def worm_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7397.WormGearMeshAdvancedSystemDeflection]":

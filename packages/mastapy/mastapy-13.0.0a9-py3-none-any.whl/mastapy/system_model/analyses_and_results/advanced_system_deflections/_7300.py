...
class ConceptGearSetAdvancedSystemDeflection(_7331.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    def concept_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7298.ConceptGearAdvancedSystemDeflection]":
    ...
    def concept_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7299.ConceptGearMeshAdvancedSystemDeflection]":

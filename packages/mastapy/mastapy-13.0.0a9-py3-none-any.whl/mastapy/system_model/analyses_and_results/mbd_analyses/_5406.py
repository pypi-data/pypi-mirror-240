...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5405, _5404
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5436.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self: Self) -> "List[_5405.ConceptGearMultibodyDynamicsAnalysis]":
    ...
    def concept_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5405.ConceptGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.ConceptGearMultibodyDynamicsAnalysis]
    ...
    def concept_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5404.ConceptGearMeshMultibodyDynamicsAnalysis]":

...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5382, _5434, _5480
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: Self) -> "_5379.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5379",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: Self, value: "_5379.AnalysisTypes"):
    ...
    @enforce_parameter_types
    def gear_mesh_stiffness_model(self: Self, value: "_5434.GearMeshStiffnessModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: Self, value: "_5480.ShaftAndHousingFlexibilityOption"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def method_to_define_period(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5441",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: Self, value: "_5441.InertiaAdjustedLoadCasePeriodMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(self: Self, value: "_2469.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: Self, value: "_5442.InertiaAdjustedLoadCaseResultsToCreate"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: Self,
    ) -> "_5524.DynamicExternalInterfaceOptions":
    ...
    @property
    def run_up_analysis_options(self: Self) -> "_5458.MBDRunUpAnalysisOptions":

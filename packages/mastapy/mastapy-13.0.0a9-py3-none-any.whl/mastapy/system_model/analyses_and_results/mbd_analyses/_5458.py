...
class MBDRunUpAnalysisOptions(
    _7532.AbstractAnalysisOptions["_6802.TimeSeriesLoadCase"]
):
    """MBDRunUpAnalysisOptions
    ...
    class _Cast_MBDRunUpAnalysisOptions:
        ...
        def abstract_analysis_options(
            ...
            return self._parent._cast(_7532.AbstractAnalysisOptions)
    ...
    def input_velocity_processing_type(
        self: Self, value: "_5444.InputVelocityForRunUpProcessingType"
    ):
    ...
    @property
    def run_up_driving_mode(self: Self) -> "_5479.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5479",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: Self, value: "_5479.RunUpDrivingMode"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    def shape_of_initial_acceleration_period(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5484",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: Self, value: "_5484.ShapeOfInitialAccelerationPeriodForRunUp"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",

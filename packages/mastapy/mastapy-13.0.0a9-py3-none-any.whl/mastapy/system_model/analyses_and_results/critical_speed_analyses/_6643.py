...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6557.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def spiral_bevel_gears_critical_speed_analysis(
        self: Self,
    ) -> "List[_6641.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_meshes_critical_speed_analysis(
        self: Self,
    ) -> "List[_6642.SpiralBevelGearMeshCriticalSpeedAnalysis]":

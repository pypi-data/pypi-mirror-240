...
class CylindricalGearSetCriticalSpeedAnalysis(_6602.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    def cylindrical_gears_critical_speed_analysis(
        self: Self,
    ) -> "List[_6589.CylindricalGearCriticalSpeedAnalysis]":
    ...
    def cylindrical_meshes_critical_speed_analysis(
        self: Self,
    ) -> "List[_6590.CylindricalGearMeshCriticalSpeedAnalysis]":

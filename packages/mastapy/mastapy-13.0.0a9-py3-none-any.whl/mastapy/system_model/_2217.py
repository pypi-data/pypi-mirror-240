...
T = TypeVar("T", bound="_2441.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: Self) -> "_1487.AlignmentAxis":
    ...
    def alignment_axis(self: Self, value: "_1487.AlignmentAxis"):
    ...
    @property
    def axial_offset(self: Self) -> "_2218.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2218", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: Self, value: "_2218.RelativeOffsetOption"):
        value = conversion.mp_to_pn_enum(

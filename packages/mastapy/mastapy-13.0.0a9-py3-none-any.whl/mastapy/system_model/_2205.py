...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1259, _1265, _1282
...
class ElectricMachineGroup(_0.APIBase):
    ...
    def electric_machine_load_case_groups(
        self: Self,
    ) -> "List[_1356.ElectricMachineLoadCaseGroup]":
    ...
    def try_remove_load_case_group(
        self: Self, load_case_group: "_1356.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool

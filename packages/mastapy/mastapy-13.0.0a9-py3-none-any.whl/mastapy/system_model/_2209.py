...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1876, _1877, _1890, _1896
    from mastapy.bolts import _1465, _1467, _1472
    from mastapy.cycloidal import _1453, _1460
    from mastapy.electric_machines import _1280, _1298, _1311
    ...
    from mastapy.system_model.optimization import _2225, _2233
    ...
    from mastapy.utility.cad_export import _1829
    from mastapy.utility.databases import _1824
    from mastapy.utility import _1593, _1594
    from mastapy.utility.scripting import _1736
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: Self) -> "_1972.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: Self) -> "_1876.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: Self) -> "_1877.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: Self) -> "_1890.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: Self) -> "_1896.SKFSettings":
    ...
    @property
    def bolt_geometry_database(self: Self) -> "_1465.BoltGeometryDatabase":
    ...
    @property
    def bolt_material_database(self: Self) -> "_1467.BoltMaterialDatabase":
    ...
    @property
    def ring_pins_material_database(self: Self) -> "_1460.RingPinsMaterialDatabase":
    ...
    @property
    def magnet_material_database(self: Self) -> "_1280.MagnetMaterialDatabase":
    ...
    @property
    def winding_material_database(self: Self) -> "_1311.WindingMaterialDatabase":
    ...
    @property
    def harmonic_analysis_draw_style(self: Self) -> "_5758.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: Self) -> "_5456.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: Self) -> "_4652.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: Self) -> "_4119.PowerFlowDrawStyle":
    ...
    @property
    def stability_analysis_draw_style(self: Self) -> "_3868.StabilityAnalysisDrawStyle":
    ...
    @property
    def system_deflection_draw_style(self: Self) -> "_2823.SystemDeflectionDrawStyle":
    ...
    @property
    def model_view_options_draw_style(self: Self) -> "_2249.ModelViewOptionsDrawStyle":
    ...
    @property
    def planet_carrier_settings(self: Self) -> "_2467.PlanetCarrierSettings":
    ...
    @property
    def cad_export_settings(self: Self) -> "_1829.CADExportSettings":
    ...
    @property
    def database_settings(self: Self) -> "_1824.DatabaseSettings":
    ...
    @property
    def program_settings(self: Self) -> "_1593.ProgramSettings":
    ...
    @property
    def pushbullet_settings(self: Self) -> "_1594.PushbulletSettings":
    ...
    @property
    def scripting_setup(self: Self) -> "_1736.ScriptingSetup":
    ...
    @property
    def measurement_settings(self: Self) -> "_1603.MeasurementSettings":

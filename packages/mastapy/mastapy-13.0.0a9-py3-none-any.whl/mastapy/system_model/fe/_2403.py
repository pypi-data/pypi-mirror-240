...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2354, _2361
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: Self) -> "_2354.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2354", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2354.AlignmentMethodForRaceBearing"):
    ...
    @property
    def links(self: Self) -> "List[_2361.BearingRaceNodeLink]":

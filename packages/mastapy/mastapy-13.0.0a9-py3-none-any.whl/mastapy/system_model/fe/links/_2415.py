...
from mastapy.system_model.fe import _2360, _2395, _2399, _2382
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(self: Self, value: "_2360.BearingNodeOption"):
    ...
    @enforce_parameter_types
    def link_node_source(self: Self, value: "_2395.LinkNodeSource"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def node_selection_depth(
        self: Self,
        value: "Union[_2399.NodeSelectionDepthOption, Tuple[_2399.NodeSelectionDepthOption, bool]]",
    ):
    ...
    @property
    def component(self: Self) -> "_2461.MountableComponent":
    ...
    @property
    def socket(self: Self) -> "_2293.Socket":
    ...
    def nodes_grouped_by_angle(
        self: Self,
    ) -> "OrderedDict[float, List[_2382.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: Self, node: "_2382.FESubstructureNode"):

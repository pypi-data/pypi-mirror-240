...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1561, _1559
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self: Self) -> "_1561.VectorWithLinearAndAngularComponents":
    ...
    @property
    def new_result(self: Self) -> "_1559.NodeResults":
    ...
    @property
    def original_result(self: Self) -> "_1559.NodeResults":
        """mastapy.math_utility.measured_vectors.NodeResults

...
if TYPE_CHECKING:
    from mastapy.system_model.fe.version_comparer import _2413, _2409
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self: Self) -> "_2413.LoadCasesToRun":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe.version_comparer._2413", "LoadCasesToRun"
        )(value)

    @load_cases_to_run.setter
    @enforce_parameter_types
    def load_cases_to_run(self: Self, value: "_2413.LoadCasesToRun"):
    ...
    @property
    def design_results(self: Self) -> "List[_2409.DesignResults]":

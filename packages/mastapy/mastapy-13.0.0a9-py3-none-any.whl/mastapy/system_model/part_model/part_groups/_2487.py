...
from mastapy.system_model.part_model.part_groups import _2483
...
class ParallelPartGroup(_2483.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    class _Cast_ParallelPartGroup:
        ...
        def concentric_or_parallel_part_group(
            ...
            return self._parent._cast(_2483.ConcentricOrParallelPartGroup)
        ...
        def part_group(self: "ParallelPartGroup._Cast_ParallelPartGroup"):
            ...
            return self._parent._cast(_2489.PartGroup)
        ...
        def parallel_part_group_selection(
            ...
            return self._parent._cast(_2488.ParallelPartGroupSelection)
    ...
    @property
    def concentric_part_groups(self: Self) -> "List[_2484.ConcentricPartGroup]":

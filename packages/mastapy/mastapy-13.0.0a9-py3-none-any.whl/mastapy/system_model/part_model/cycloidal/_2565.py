...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1449
    from mastapy.system_model.part_model.cycloidal import _2567, _2566
...
class CycloidalAssembly(_2473.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    @property
    def cycloidal_assembly_design(self: Self) -> "_1449.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: Self) -> "_2567.RingPins":
    ...
    @property
    def known_designs(self: Self) -> "List[_1449.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: Self) -> "_2566.CycloidalDisc":
    ...
    def design_named(self: Self, name: "str") -> "_1449.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: Self, cycloidal_assembly_design: "_1449.CycloidalAssemblyDesign"
    ):
        """Method does not return.
    ...
    def try_remove_design(
        self: Self, design: "_1449.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool

...
if TYPE_CHECKING:
    from mastapy.math_utility.stiffness_calculators import _1533
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self: Self) -> "_1533.IndividualContactPosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.stiffness_calculators._1533",
    ...
    @property
    def microgeometry_clearance_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def crowning(self: Self) -> "_2582.CrowningSpecification":

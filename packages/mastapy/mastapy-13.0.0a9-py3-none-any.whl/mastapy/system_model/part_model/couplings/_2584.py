...
from mastapy.system_model.part_model.couplings import _2595, _2587
...
class CVTPulley(_2587.Pulley):
    ...
    @enforce_parameter_types
    def sliding_connection(self: Self, value: "_2595.ShaftHubConnection"):
        wrapper_type = (

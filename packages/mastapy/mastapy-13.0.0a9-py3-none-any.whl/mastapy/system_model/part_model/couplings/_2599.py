...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.couplings import _2603, _2601
...
class Synchroniser(_2473.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: Self) -> "_2339.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: Self) -> "_2339.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: Self) -> "_2603.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: Self) -> "_2601.SynchroniserHalf":
    ...
    @property
    def right_cone(self: Self) -> "_2601.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf

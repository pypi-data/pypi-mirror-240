...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2446, _2478
...
class PowerLoad(_2476.VirtualComponent):
    """PowerLoad
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: Self, value: "_2446.ElectricMachineSearchRegionSpecificationMethod"
    ):
    ...
    @property
    def engine_fuel_consumption_grid(self: Self) -> "_1562.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def engine_fuel_consumption_grid(self: Self, value: "_1562.GriddedSurfaceAccessor"):
        self.wrapped.EngineFuelConsumptionGrid = value

    @property
    def engine_torque_grid(self: Self) -> "_1562.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: Self, value: "_1562.GriddedSurfaceAccessor"):
    ...
    @enforce_parameter_types
    def power_load_type(self: Self, value: "_2216.PowerLoadType"):
    ...
    @property
    def single_blade_details(self: Self) -> "_2478.WindTurbineSingleBladeDetails":

...
from mastapy.bearings.tolerances import _1899, _1901
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2435.AxialInternalClearanceTolerance)
        ...
        def radial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2470.RadialInternalClearanceTolerance)
    ...
    def clearance_class(self: Self, value: "_1899.InternalClearanceClass"):

...
class ZerolBevelGearSet(_2517.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self: Self) -> "List[_2550.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: Self) -> "List[_2328.ZerolBevelGearMesh]":

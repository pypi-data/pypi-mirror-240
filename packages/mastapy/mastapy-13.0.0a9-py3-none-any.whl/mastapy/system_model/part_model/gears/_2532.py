...
class HypoidGearSet(_2511.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self: Self) -> "List[_2531.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_2312.HypoidGearMesh]":

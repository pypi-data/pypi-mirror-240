...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2560
...
class CylindricalGearSet(_2529.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self: Self) -> "_2560.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2522.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_2306.CylindricalGearMesh]":
    ...
    def add_gear(self: Self) -> "_2522.CylindricalGear":

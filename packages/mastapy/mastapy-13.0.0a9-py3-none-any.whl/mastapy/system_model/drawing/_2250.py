...
from mastapy.utility.enums import _1819, _1820
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    class _Cast_PartAnalysisCaseWithContourViewable:
        ...
        def abstract_system_deflection_viewable(
            ...
            return self._parent._cast(_2240.AbstractSystemDeflectionViewable)
        ...
        def advanced_system_deflection_viewable(
            ...
            return self._parent._cast(_2241.AdvancedSystemDeflectionViewable)
        ...
        def harmonic_analysis_viewable(
            ...
            return self._parent._cast(_2246.HarmonicAnalysisViewable)
        ...
        def modal_analysis_viewable(
            ...
            return self._parent._cast(_2248.ModalAnalysisViewable)
        ...
        def system_deflection_viewable(
            ...
            return self._parent._cast(_2257.SystemDeflectionViewable)
    ...
    def contour(self: Self, value: "_1819.ThreeDViewContourOptionFirstSelection"):
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: Self, value: "_1820.ThreeDViewContourOptionSecondSelection"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def contour_draw_style(self: Self) -> "_2243.ContourDrawStyle":

...
class RotorDynamicsViewable(_0.APIBase):
    ...
    class _Cast_RotorDynamicsViewable:
        ...
        def critical_speed_analysis_viewable(
            ...
            return self._parent._cast(_2244.CriticalSpeedAnalysisViewable)
        ...
        def stability_analysis_viewable(
            ...
            return self._parent._cast(_2254.StabilityAnalysisViewable)
        ...
        def steady_state_synchronous_response_viewable(
            ...
            return self._parent._cast(_2255.SteadyStateSynchronousResponseViewable)
    ...
    @property
    def rotor_dynamics(self: Self) -> "_4023.RotorDynamicsDrawStyle":

...
class CycloidalDiscDesignExporter(_0.APIBase):
    ...
    @property
    def geometry_to_export(self: Self) -> "_1456.GeometryToExport":
        ...
        return constructor.new_from_mastapy(
            "mastapy.cycloidal._1456", "GeometryToExport"
        )(value)

    @geometry_to_export.setter
    @enforce_parameter_types
    def geometry_to_export(self: Self, value: "_1456.GeometryToExport"):
    ...
    def profile_points(
        self: Self,
        geometry_to_export: "_1456.GeometryToExport",

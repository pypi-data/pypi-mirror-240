...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1458, _1457, _1450
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: Self) -> "_1458.RingPinsDesign":
    ...
    @property
    def disc_phases(self: Self) -> "List[_1457.NamedDiscPhase]":
    ...
    @property
    def discs(self: Self) -> "List[_1450.CycloidalDiscDesign]":

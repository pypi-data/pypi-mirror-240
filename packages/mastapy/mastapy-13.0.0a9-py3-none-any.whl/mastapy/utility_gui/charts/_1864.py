...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1850, _1860
...
class TwoDChartDefinition(_1856.NDChartDefinition):
    """TwoDChartDefinition
    ...
    @property
    def const_lines(self: Self) -> "List[_1850.ConstantLine]":
    ...
    @property
    def series_list(self: Self) -> "List[_1860.Series2D]":

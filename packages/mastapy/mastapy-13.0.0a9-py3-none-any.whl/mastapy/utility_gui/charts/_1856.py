...
class NDChartDefinition(_1745.ChartDefinition):
    """NDChartDefinition
    ...
    class _Cast_NDChartDefinition:
        ...
        def matrix_visualisation_definition(
            ...
            return self._parent._cast(_1854.MatrixVisualisationDefinition)
    ...
    @property
    def x_axis(self: Self) -> "_1740.AxisSettings":
    ...
    @property
    def y_axis(self: Self) -> "_1740.AxisSettings":
        """mastapy.utility.report.AxisSettings

...
if TYPE_CHECKING:
    from mastapy.system_model import _2197, _2200
    from mastapy.utility.operation_modes import _1787
    from mastapy.geometry.two_d import _309
    from mastapy.nodal_analysis.geometry_modeller_link import _155, _162, _163
    from mastapy.math_utility import _1507, _1489
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: Self) -> "_2197.Design":
    ...
    @enforce_parameter_types
    def active_design(self: Self, value: "_2197.Design"):
    ...
    @property
    def open_designs(self: Self) -> "List[_2197.Design]":
    ...
    @property
    def operation_mode(self: Self) -> "_1787.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.operation_modes._1787", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: Self, value: "_1787.OperationMode"):
    ...
    @property
    def selected_design_entity(self: Self) -> "_2200.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: Self, value: "_2200.DesignEntity"):
    ...
    def add_fe_substructure_from_data(
        self: Self,
        vertices_and_facets: "_1507.FacetedBody",
        geometry_modeller_design_information: "_155.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _156.GeometryModellerDimension]",
        body_moniker: "str",
    ):
    ...
    def add_line_from_geometry_modeller(
        self: Self, circles_on_axis: "_1489.CirclesOnAxis"
    ):
        """Method does not return.
    ...
    def circle_pairs_from_geometry_modeller(
        self: Self,
        preselection_circles: "_1489.CirclesOnAxis",
        selected_circles: "List[_1489.CirclesOnAxis]",
    ):
        """Method does not return.
    ...
    def create_new_circles_on_axis(self: Self) -> "_1489.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: Self) -> "_1507.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: Self, design: "_2197.Design"):
        """Method does not return.

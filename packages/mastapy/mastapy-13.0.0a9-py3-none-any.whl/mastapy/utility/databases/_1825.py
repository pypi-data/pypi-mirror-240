...
TValue = TypeVar("TValue", bound="_1826.NamedDatabaseItem")


class NamedDatabase(_1828.SQLDatabase["_1827.NamedKey", TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_name: "str", item: "_1826.NamedDatabaseItem"
    ...
    @enforce_parameter_types
    def rename(self: Self, item: "_1826.NamedDatabaseItem", new_name: "str") -> "bool":
        """bool

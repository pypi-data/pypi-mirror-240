...
class NamedDatabaseItem(_0.APIBase):
    ...
    class _Cast_NamedDatabaseItem:
        ...
        def pareto_optimisation_strategy(
            ...
            return self._parent._cast(_1546.ParetoOptimisationStrategy)

        @property
        def bearing_settings_item(self: "NamedDatabaseItem._Cast_NamedDatabaseItem"):
            from mastapy.bearings import _1878

            return self._parent._cast(_1878.BearingSettingsItem)
        ...
        def iso14179_settings(self: "NamedDatabaseItem._Cast_NamedDatabaseItem"):
            ...
            return self._parent._cast(_1971.ISO14179Settings)
        ...
        def conical_gear_optimisation_strategy(
            ...
            return self._parent._cast(_2223.ConicalGearOptimisationStrategy)
        ...
        def cylindrical_gear_optimisation_strategy(
            ...
            return self._parent._cast(_2226.CylindricalGearOptimisationStrategy)
        ...
        def optimization_strategy(self: "NamedDatabaseItem._Cast_NamedDatabaseItem"):
            ...
            return self._parent._cast(_2231.OptimizationStrategy)
        ...
        def optimization_strategy_base(
            ...
            return self._parent._cast(_2232.OptimizationStrategyBase)
        ...
        def supercharger_rotor_set(self: "NamedDatabaseItem._Cast_NamedDatabaseItem"):
            ...
            return self._parent._cast(_2560.SuperchargerRotorSet)
    ...
    @property
    def database_key(self: Self) -> "_1827.NamedKey":
    ...
    @database_key.setter
    @enforce_parameter_types
    def database_key(self: Self, value: "_1827.NamedKey"):

...
if TYPE_CHECKING:
    from mastapy.utility import _1590, _1576
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: Self) -> "_1590.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1576.DispatcherHelper]":

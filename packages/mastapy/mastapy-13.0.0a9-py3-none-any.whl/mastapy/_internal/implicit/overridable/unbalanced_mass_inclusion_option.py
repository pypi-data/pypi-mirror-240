...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2475.UnbalancedMassInclusionOption":
        ...
        return _2475.UnbalancedMassInclusionOption

    @classmethod
    def implicit_type(cls) -> "_2475.UnbalancedMassInclusionOption.type_()":
        ...
        return _2475.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: Self) -> "_2475.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: Self) -> "_2475.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: Self) -> "_2475.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption

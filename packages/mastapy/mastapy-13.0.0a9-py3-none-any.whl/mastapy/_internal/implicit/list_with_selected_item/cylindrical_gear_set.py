...
class ListWithSelectedItem_CylindricalGearSet(
    _2523.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2523.CylindricalGearSet.TYPE":
        ...
        return _2523.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2523.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2523.CylindricalGearSet]":

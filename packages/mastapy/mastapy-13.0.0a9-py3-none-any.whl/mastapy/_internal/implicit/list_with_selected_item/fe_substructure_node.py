...
class ListWithSelectedItem_FESubstructureNode(
    _2382.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2382.FESubstructureNode.TYPE":
        ...
        return _2382.FESubstructureNode.TYPE

    @property
    def selected_value(self: Self) -> "_2382.FESubstructureNode":
    ...
    @property
    def available_values(self: Self) -> "List[_2382.FESubstructureNode]":

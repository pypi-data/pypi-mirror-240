...
class ListWithSelectedItem_CylindricalGear(
    _2522.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2522.CylindricalGear.TYPE":
        ...
        return _2522.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2522.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2522.CylindricalGear]":

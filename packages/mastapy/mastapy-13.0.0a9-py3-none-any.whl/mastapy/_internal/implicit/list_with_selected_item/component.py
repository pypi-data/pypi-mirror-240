...
class ListWithSelectedItem_Component(_2441.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2441.Component.TYPE":
        ...
        return _2441.Component.TYPE

    @property
    def selected_value(self: Self) -> "_2441.Component":
    ...
    @property
    def available_values(self: Self) -> "List[_2441.Component]":

...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2509.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2509.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2509.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2509.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2509.ActiveGearSetDesignSelectionGroup]":

...
class ListWithSelectedItem_FEPart(_2450.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2450.FEPart.TYPE":
        ...
        return _2450.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2450.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2450.FEPart]":

...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2370.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2370.ElectricMachineDataSet.TYPE":
        ...
        return _2370.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2370.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2370.ElectricMachineDataSet]":

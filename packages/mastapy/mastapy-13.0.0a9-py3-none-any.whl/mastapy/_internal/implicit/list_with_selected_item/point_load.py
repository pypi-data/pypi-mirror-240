...
class ListWithSelectedItem_PointLoad(_2468.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2468.PointLoad.TYPE":
        ...
        return _2468.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2468.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2468.PointLoad]":

...
class ListWithSelectedItem_ElectricMachineResults(
    _1322.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1322.ElectricMachineResults.TYPE":
        ...
        return _1322.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1322.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1322.ElectricMachineResults]":

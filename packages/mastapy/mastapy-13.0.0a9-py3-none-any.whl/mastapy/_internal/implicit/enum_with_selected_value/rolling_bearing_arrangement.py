...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1889.RollingBearingArrangement":
        ...
        return _1889.RollingBearingArrangement

    @classmethod
    def implicit_type(cls) -> "_1889.RollingBearingArrangement.type_()":
        ...
        return _1889.RollingBearingArrangement.type_()

    @property
    def selected_value(self: Self) -> "_1889.RollingBearingArrangement":
    ...
    @property
    def available_values(self: Self) -> "List[_1889.RollingBearingArrangement]":

...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6814.AnalysisType":
        ...
        return _6814.AnalysisType

    @classmethod
    def implicit_type(cls) -> "_6814.AnalysisType.type_()":
        ...
        return _6814.AnalysisType.type_()

    @property
    def selected_value(self: Self) -> "_6814.AnalysisType":
    ...
    @property
    def available_values(self: Self) -> "List[_6814.AnalysisType]":

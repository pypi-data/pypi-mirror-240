...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2592.RigidConnectorTypes":
        ...
        return _2592.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2592.RigidConnectorTypes.type_()":
        ...
        return _2592.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2592.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2592.RigidConnectorTypes]":

...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6973.TorqueRippleInputType":
        ...
        return _6973.TorqueRippleInputType

    @classmethod
    def implicit_type(cls) -> "_6973.TorqueRippleInputType.type_()":
        ...
        return _6973.TorqueRippleInputType.type_()

    @property
    def selected_value(self: Self) -> "_6973.TorqueRippleInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_6973.TorqueRippleInputType]":

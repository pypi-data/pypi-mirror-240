...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1818.ThreeDViewContourOption":
        ...
        return _1818.ThreeDViewContourOption

    @classmethod
    def implicit_type(cls) -> "_1818.ThreeDViewContourOption.type_()":
        ...
        return _1818.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: Self) -> "_1818.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1818.ThreeDViewContourOption]":

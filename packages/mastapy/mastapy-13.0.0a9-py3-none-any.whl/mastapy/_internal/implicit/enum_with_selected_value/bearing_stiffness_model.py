...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5382.BearingStiffnessModel":
        ...
        return _5382.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5382.BearingStiffnessModel.type_()":
        ...
        return _5382.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5382.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5382.BearingStiffnessModel]":

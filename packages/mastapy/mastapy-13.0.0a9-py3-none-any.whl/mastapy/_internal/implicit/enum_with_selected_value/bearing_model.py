...
class EnumWithSelectedValue_BearingModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1874.BearingModel":
        ...
        return _1874.BearingModel

    @classmethod
    def implicit_type(cls) -> "_1874.BearingModel.type_()":
        ...
        return _1874.BearingModel.type_()

    @property
    def selected_value(self: Self) -> "_1874.BearingModel":
    ...
    @property
    def available_values(self: Self) -> "List[_1874.BearingModel]":

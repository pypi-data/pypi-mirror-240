...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1888.RollerBearingProfileTypes":
        ...
        return _1888.RollerBearingProfileTypes

    @classmethod
    def implicit_type(cls) -> "_1888.RollerBearingProfileTypes.type_()":
        ...
        return _1888.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: Self) -> "_1888.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1888.RollerBearingProfileTypes]":

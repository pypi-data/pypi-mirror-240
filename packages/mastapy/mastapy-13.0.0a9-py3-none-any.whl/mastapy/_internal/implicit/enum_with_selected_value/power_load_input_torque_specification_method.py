...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2214.PowerLoadInputTorqueSpecificationMethod":
        ...
        return _2214.PowerLoadInputTorqueSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_2214.PowerLoadInputTorqueSpecificationMethod.type_()":
        ...
        return _2214.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2214.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2214.PowerLoadInputTorqueSpecificationMethod]":

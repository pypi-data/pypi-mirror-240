...
class EnumWithSelectedValue_FitTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1391.FitTypes":
        ...
        return _1391.FitTypes

    @classmethod
    def implicit_type(cls) -> "_1391.FitTypes.type_()":
        ...
        return _1391.FitTypes.type_()

    @property
    def selected_value(self: Self) -> "_1391.FitTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1391.FitTypes]":

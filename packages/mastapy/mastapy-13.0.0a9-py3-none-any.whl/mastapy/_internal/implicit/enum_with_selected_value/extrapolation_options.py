...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1506.ExtrapolationOptions":
        ...
        return _1506.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1506.ExtrapolationOptions.type_()":
        ...
        return _1506.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1506.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1506.ExtrapolationOptions]":

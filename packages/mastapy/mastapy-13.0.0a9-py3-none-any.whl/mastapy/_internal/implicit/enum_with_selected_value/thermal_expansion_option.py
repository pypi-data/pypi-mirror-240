...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2408.ThermalExpansionOption":
        ...
        return _2408.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2408.ThermalExpansionOption.type_()":
        ...
        return _2408.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2408.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2408.ThermalExpansionOption]":

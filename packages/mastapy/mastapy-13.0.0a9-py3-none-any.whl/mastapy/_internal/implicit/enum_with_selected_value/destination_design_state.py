...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6988.DestinationDesignState":
        ...
        return _6988.DestinationDesignState

    @classmethod
    def implicit_type(cls) -> "_6988.DestinationDesignState.type_()":
        ...
        return _6988.DestinationDesignState.type_()

    @property
    def selected_value(self: Self) -> "_6988.DestinationDesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_6988.DestinationDesignState]":

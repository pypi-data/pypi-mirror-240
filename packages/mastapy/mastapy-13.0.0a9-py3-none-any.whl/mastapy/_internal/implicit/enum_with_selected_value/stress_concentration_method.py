...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2106.StressConcentrationMethod":
        ...
        return _2106.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2106.StressConcentrationMethod.type_()":
        ...
        return _2106.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2106.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2106.StressConcentrationMethod]":

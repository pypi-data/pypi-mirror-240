...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1820.ThreeDViewContourOptionSecondSelection":
        ...
        return _1820.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1820.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1820.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1820.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1820.ThreeDViewContourOptionSecondSelection]":

...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1408.SplineFitClassType":
        ...
        return _1408.SplineFitClassType

    @classmethod
    def implicit_type(cls) -> "_1408.SplineFitClassType.type_()":
        ...
        return _1408.SplineFitClassType.type_()

    @property
    def selected_value(self: Self) -> "_1408.SplineFitClassType":
    ...
    @property
    def available_values(self: Self) -> "List[_1408.SplineFitClassType]":

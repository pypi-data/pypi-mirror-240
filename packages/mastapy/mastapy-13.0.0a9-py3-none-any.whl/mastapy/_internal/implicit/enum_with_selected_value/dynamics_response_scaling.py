...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1502.DynamicsResponseScaling":
        ...
        return _1502.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1502.DynamicsResponseScaling.type_()":
        ...
        return _1502.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1502.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1502.DynamicsResponseScaling]":

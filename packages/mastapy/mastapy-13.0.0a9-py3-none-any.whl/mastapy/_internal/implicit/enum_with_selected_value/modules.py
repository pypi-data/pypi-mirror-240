...
class EnumWithSelectedValue_Modules(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1399.Modules":
        ...
        return _1399.Modules

    @classmethod
    def implicit_type(cls) -> "_1399.Modules.type_()":
        ...
        return _1399.Modules.type_()

    @property
    def selected_value(self: Self) -> "_1399.Modules":
    ...
    @property
    def available_values(self: Self) -> "List[_1399.Modules]":

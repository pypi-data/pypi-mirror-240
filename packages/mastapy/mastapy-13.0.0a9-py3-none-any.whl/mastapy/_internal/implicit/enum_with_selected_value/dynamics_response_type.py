...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4623.DynamicsResponseType":
        ...
        return _4623.DynamicsResponseType

    @classmethod
    def implicit_type(cls) -> "_4623.DynamicsResponseType.type_()":
        ...
        return _4623.DynamicsResponseType.type_()

    @property
    def selected_value(self: Self) -> "_4623.DynamicsResponseType":
    ...
    @property
    def available_values(self: Self) -> "List[_4623.DynamicsResponseType]":

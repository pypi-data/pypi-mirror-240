...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1491.ComplexPartDisplayOption":
        ...
        return _1491.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1491.ComplexPartDisplayOption.type_()":
        ...
        return _1491.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1491.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1491.ComplexPartDisplayOption]":

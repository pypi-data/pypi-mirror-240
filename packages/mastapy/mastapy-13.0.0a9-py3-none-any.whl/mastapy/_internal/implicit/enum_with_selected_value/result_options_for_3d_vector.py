...
class EnumWithSelectedValue_ResultOptionsFor3DVector(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1523.ResultOptionsFor3DVector":
        ...
        return _1523.ResultOptionsFor3DVector

    @classmethod
    def implicit_type(cls) -> "_1523.ResultOptionsFor3DVector.type_()":
        ...
        return _1523.ResultOptionsFor3DVector.type_()

    @property
    def selected_value(self: Self) -> "_1523.ResultOptionsFor3DVector":
    ...
    @property
    def available_values(self: Self) -> "List[_1523.ResultOptionsFor3DVector]":

...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2216.PowerLoadType":
        ...
        return _2216.PowerLoadType

    @classmethod
    def implicit_type(cls) -> "_2216.PowerLoadType.type_()":
        ...
        return _2216.PowerLoadType.type_()

    @property
    def selected_value(self: Self) -> "_2216.PowerLoadType":
    ...
    @property
    def available_values(self: Self) -> "List[_2216.PowerLoadType]":

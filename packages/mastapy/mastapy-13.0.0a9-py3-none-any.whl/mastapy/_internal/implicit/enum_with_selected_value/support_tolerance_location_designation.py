...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1920.SupportToleranceLocationDesignation":
        ...
        return _1920.SupportToleranceLocationDesignation

    @classmethod
    def implicit_type(cls) -> "_1920.SupportToleranceLocationDesignation.type_()":
        ...
        return _1920.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1920.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1920.SupportToleranceLocationDesignation]":

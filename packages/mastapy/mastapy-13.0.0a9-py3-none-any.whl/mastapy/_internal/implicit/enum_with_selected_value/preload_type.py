...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1958.PreloadType":
        ...
        return _1958.PreloadType

    @classmethod
    def implicit_type(cls) -> "_1958.PreloadType.type_()":
        ...
        return _1958.PreloadType.type_()

    @property
    def selected_value(self: Self) -> "_1958.PreloadType":
    ...
    @property
    def available_values(self: Self) -> "List[_1958.PreloadType]":

...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5765.HarmonicAnalysisTorqueInputType":
        ...
        return _5765.HarmonicAnalysisTorqueInputType

    @classmethod
    def implicit_type(cls) -> "_5765.HarmonicAnalysisTorqueInputType.type_()":
        ...
        return _5765.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: Self) -> "_5765.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5765.HarmonicAnalysisTorqueInputType]":

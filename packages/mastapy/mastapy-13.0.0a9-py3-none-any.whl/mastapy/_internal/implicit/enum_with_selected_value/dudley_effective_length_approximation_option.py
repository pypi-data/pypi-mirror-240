...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1390.DudleyEffectiveLengthApproximationOption":
        ...
        return _1390.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1390.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1390.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1390.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1390.DudleyEffectiveLengthApproximationOption]":

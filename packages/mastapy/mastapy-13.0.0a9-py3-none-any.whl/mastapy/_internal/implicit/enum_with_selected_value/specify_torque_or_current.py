...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1368.SpecifyTorqueOrCurrent":
        ...
        return _1368.SpecifyTorqueOrCurrent

    @classmethod
    def implicit_type(cls) -> "_1368.SpecifyTorqueOrCurrent.type_()":
        ...
        return _1368.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: Self) -> "_1368.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: Self) -> "List[_1368.SpecifyTorqueOrCurrent]":

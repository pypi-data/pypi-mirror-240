...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1867.BasicDynamicLoadRatingCalculationMethod":
        ...
        return _1867.BasicDynamicLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1867.BasicDynamicLoadRatingCalculationMethod.type_()":
        ...
        return _1867.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1867.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1867.BasicDynamicLoadRatingCalculationMethod]":

...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6974.TorqueSpecificationForSystemDeflection":
        ...
        return _6974.TorqueSpecificationForSystemDeflection

    @classmethod
    def implicit_type(cls) -> "_6974.TorqueSpecificationForSystemDeflection.type_()":
        ...
        return _6974.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: Self) -> "_6974.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6974.TorqueSpecificationForSystemDeflection]":

...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2472.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        return _2472.ShaftDiameterModificationDueToRollingBearingRing

    @classmethod
    def implicit_type(
        cls,
    ) -> "_2472.ShaftDiameterModificationDueToRollingBearingRing.type_()":
        ...
        return _2472.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_2472.ShaftDiameterModificationDueToRollingBearingRing]":

...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4345.DoeValueSpecificationOption":
        ...
        return _4345.DoeValueSpecificationOption

    @classmethod
    def implicit_type(cls) -> "_4345.DoeValueSpecificationOption.type_()":
        ...
        return _4345.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: Self) -> "_4345.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_4345.DoeValueSpecificationOption]":

...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6894.HarmonicExcitationType":
        ...
        return _6894.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6894.HarmonicExcitationType.type_()":
        ...
        return _6894.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6894.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6894.HarmonicExcitationType]":

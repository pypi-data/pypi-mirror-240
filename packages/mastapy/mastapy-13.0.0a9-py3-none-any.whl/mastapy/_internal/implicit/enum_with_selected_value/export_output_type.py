...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_5741.ExportOutputType":
        ...
        return _5741.ExportOutputType

    @classmethod
    def implicit_type(cls) -> "_5741.ExportOutputType.type_()":
        ...
        return _5741.ExportOutputType.type_()

    @property
    def selected_value(self: Self) -> "_5741.ExportOutputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5741.ExportOutputType]":

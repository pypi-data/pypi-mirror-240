...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1899.InternalClearanceClass":
        ...
        return _1899.InternalClearanceClass

    @classmethod
    def implicit_type(cls) -> "_1899.InternalClearanceClass.type_()":
        ...
        return _1899.InternalClearanceClass.type_()

    @property
    def selected_value(self: Self) -> "_1899.InternalClearanceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1899.InternalClearanceClass]":

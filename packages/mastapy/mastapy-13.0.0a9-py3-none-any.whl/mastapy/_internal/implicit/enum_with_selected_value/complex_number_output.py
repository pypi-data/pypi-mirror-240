...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls,
    ) -> "_5760.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        return _5760.HarmonicAnalysisFEExportOptions.ComplexNumberOutput

    @classmethod
    def implicit_type(
        cls,
    ) -> "_5760.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()":
        ...
        return _5760.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_5760.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":

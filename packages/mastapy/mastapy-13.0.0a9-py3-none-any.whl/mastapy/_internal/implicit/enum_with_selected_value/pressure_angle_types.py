...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1400.PressureAngleTypes":
        ...
        return _1400.PressureAngleTypes

    @classmethod
    def implicit_type(cls) -> "_1400.PressureAngleTypes.type_()":
        ...
        return _1400.PressureAngleTypes.type_()

    @property
    def selected_value(self: Self) -> "_1400.PressureAngleTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1400.PressureAngleTypes]":

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1254, _1265, _1289, _1241
    from mastapy.electric_machines.results import _1338, _1339
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def non_cad_electric_machine_detail(
            ...
            return self._parent._cast(_1282.NonCADElectricMachineDetail)
        ...
        def surface_permanent_magnet_machine(
            ...
            return self._parent._cast(_1299.SurfacePermanentMagnetMachine)
        ...
        def synchronous_reluctance_machine(
            ...
            return self._parent._cast(_1301.SynchronousReluctanceMachine)
        ...
        def wound_field_synchronous_machine(
            ...
            return self._parent._cast(_1316.WoundFieldSynchronousMachine)
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1338.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1289.Rotor":
    ...
    @property
    def results_locations(self: Self) -> "List[_1518.Named2DLocation]":
    ...
    def generate_design_without_non_linear_dq_model(
        self: Self,
    ) -> "_1588.MethodOutcomeWithResult[ElectricMachineDetail]":
    ...
    def try_generate_non_linear_dq_model_with_task_progress(
        self: Self, progress: "_7555.TaskProgress"
    ) -> "_1588.MethodOutcomeWithResult[ElectricMachineDetail]":
        """mastapy.utility.MethodOutcomeWithResult[mastapy.electric_machines.ElectricMachineDetail]

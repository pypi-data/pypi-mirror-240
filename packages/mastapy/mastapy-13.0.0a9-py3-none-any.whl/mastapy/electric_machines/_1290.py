...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def u_shaped_layer_specification(
            ...
            return self._parent._cast(_1306.UShapedLayerSpecification)
        ...
        def v_shaped_magnet_layer_specification(
            ...
            return self._parent._cast(_1307.VShapedMagnetLayerSpecification)
    ...
    @property
    def magnets(self: Self) -> "_1278.MagnetForLayer":

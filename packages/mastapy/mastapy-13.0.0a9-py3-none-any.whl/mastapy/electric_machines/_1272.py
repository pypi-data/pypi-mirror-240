...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1268, _1292, _1252, _1284, _1306, _1307
...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1286.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
        ...
        def permanent_magnet_rotor(
            ...
            return self._parent._cast(_1286.PermanentMagnetRotor)
        ...
        def rotor(
            ...
            return self._parent._cast(_1289.Rotor)
    ...
    @property
    def rotor_type(self: Self) -> "_1292.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1292", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: Self, value: "_1292.RotorType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def notch_specifications(self: Self) -> "List[_1284.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: Self) -> "List[_1306.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: Self,
    ) -> "List[_1307.VShapedMagnetLayerSpecification]":

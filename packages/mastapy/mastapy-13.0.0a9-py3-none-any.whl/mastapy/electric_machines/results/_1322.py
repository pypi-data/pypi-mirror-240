...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1331, _1323, _1325, _1327
...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def on_load_electric_machine_results(
            ...
            return self._parent._cast(_1340.OnLoadElectricMachineResults)
        ...
        def open_circuit_electric_machine_results(
            ...
            return self._parent._cast(_1341.OpenCircuitElectricMachineResults)
    ...
    @property
    def results_timesteps(self: Self) -> "List[_1331.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: Self,
    ) -> "List[_1323.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1325.ElectricMachineResultsForLineToLine]":
    ...
    @property
    def results_for_phases(self: Self) -> "List[_1327.ElectricMachineResultsForPhase]":

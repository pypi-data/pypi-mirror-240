...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1351, _1346
...
class EfficiencyMapLoadCase(_1363.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase

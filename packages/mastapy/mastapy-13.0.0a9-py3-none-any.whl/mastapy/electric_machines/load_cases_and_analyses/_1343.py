...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1342, _1352
...
class DynamicForceAnalysis(_1348.ElectricMachineAnalysis):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1342.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1317.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1352.ElectricMachineFEAnalysis]":

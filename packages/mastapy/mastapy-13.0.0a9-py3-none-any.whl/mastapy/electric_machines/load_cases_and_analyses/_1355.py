...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1373, _1348, _1356
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1342

            return self._parent._cast(_1342.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1344.DynamicForceLoadCase)
        ...
        def efficiency_map_load_case(
            ...
            return self._parent._cast(_1347.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1354.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1357.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            return self._parent._cast(_1371.SpeedTorqueCurveLoadCase)
        ...
        def speed_torque_load_case(
            ...
            return self._parent._cast(_1372.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1373.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1348.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1356.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1348.ElectricMachineAnalysis"
    ):
        """Method does not return.

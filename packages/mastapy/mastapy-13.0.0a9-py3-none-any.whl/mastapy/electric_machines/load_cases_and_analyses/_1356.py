...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: Self) -> "List[_1344.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1342.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: Self) -> "List[_1347.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: Self,
    ) -> "List[_1372.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1354.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: Self,
    ) -> "List[_1371.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: Self, load_case_type: "_1360.LoadCaseType"
    ...
    def add_load_case_named(
        self: Self, load_case_type: "_1360.LoadCaseType", name: "str"
    ) -> "_1355.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        ...
        load_case_type: "_1360.LoadCaseType",
    ) -> "_1587.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1264.ElectricMachineSetup",
        load_case_type: "_1360.LoadCaseType",
        task_progress: "_7555.TaskProgress",
    ) -> "_1587.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: Self, load_case: "_1355.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool

...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1364, _1345, _1343
...
class BasicDynamicForceLoadCase(_1355.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: Self, value: "_1364.NumberOfStepsPerOperatingPointSpecificationMethod"
    ):
    ...
    @property
    def operating_points(self: Self) -> "List[_1345.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: Self, operating_point: "_1345.DynamicForcesOperatingPoint"
    ):
        """Method does not return.

...
from mastapy.electric_machines.load_cases_and_analyses import _1368, _1342
...
class DynamicForceLoadCase(_1342.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    class _Cast_DynamicForceLoadCase:
        ...
        def electric_machine_load_case_base(
            ...
            return self._parent._cast(_1355.ElectricMachineLoadCaseBase)
    ...
    @property
    def control_strategy(self: Self) -> "_1350.ElectricMachineControlStrategy":
    ...
    def control_strategy(self: Self, value: "_1350.ElectricMachineControlStrategy"):
    ...
    @enforce_parameter_types
    def load_specification(self: Self, value: "_1368.SpecifyTorqueOrCurrent"):
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: Self, value: "_1365.OperatingPointsSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: Self) -> "_1369.SpeedPointsDistribution":
    ...
    @enforce_parameter_types
    def speed_points_distribution(self: Self, value: "_1369.SpeedPointsDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
        )

...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1354, _1367
...
class SingleOperatingPointAnalysis(_1348.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    class _Cast_SingleOperatingPointAnalysis:
        ...
        def electric_machine_analysis(
            ...
            return self._parent._cast(_1348.ElectricMachineAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1354.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1367.SlotDetailForAnalysis]":

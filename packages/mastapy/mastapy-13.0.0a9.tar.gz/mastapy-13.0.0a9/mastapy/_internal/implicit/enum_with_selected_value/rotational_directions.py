...
class EnumWithSelectedValue_RotationalDirections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1894.RotationalDirections":
        ...
        return _1894.RotationalDirections

    @classmethod
    def implicit_type(cls) -> "_1894.RotationalDirections.type_()":
        ...
        return _1894.RotationalDirections.type_()

    @property
    def selected_value(self: Self) -> "_1894.RotationalDirections":
    ...
    @property
    def available_values(self: Self) -> "List[_1894.RotationalDirections]":

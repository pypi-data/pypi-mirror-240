...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2149.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2149.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2149.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2149.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2149.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2149.FatigueLoadLimitCalculationMethodEnum]":

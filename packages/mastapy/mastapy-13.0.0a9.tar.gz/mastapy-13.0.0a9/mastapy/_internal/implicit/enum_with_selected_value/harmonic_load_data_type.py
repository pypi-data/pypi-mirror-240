...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1378.HarmonicLoadDataType":
        ...
        return _1378.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1378.HarmonicLoadDataType.type_()":
        ...
        return _1378.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1378.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1378.HarmonicLoadDataType]":

...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5505.TorqueConverterLockupRule":
        ...
        return _5505.TorqueConverterLockupRule

    @classmethod
    def implicit_type(cls) -> "_5505.TorqueConverterLockupRule.type_()":
        ...
        return _5505.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: Self) -> "_5505.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: Self) -> "List[_5505.TorqueConverterLockupRule]":

...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1892.RollingBearingRaceType":
        ...
        return _1892.RollingBearingRaceType

    @classmethod
    def implicit_type(cls) -> "_1892.RollingBearingRaceType.type_()":
        ...
        return _1892.RollingBearingRaceType.type_()

    @property
    def selected_value(self: Self) -> "_1892.RollingBearingRaceType":
    ...
    @property
    def available_values(self: Self) -> "List[_1892.RollingBearingRaceType]":

...
class EnumWithSelectedValue_ITDesignation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1907.ITDesignation":
        ...
        return _1907.ITDesignation

    @classmethod
    def implicit_type(cls) -> "_1907.ITDesignation.type_()":
        ...
        return _1907.ITDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1907.ITDesignation":
    ...
    @property
    def available_values(self: Self) -> "List[_1907.ITDesignation]":

...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1901.BearingToleranceDefinitionOptions":
        ...
        return _1901.BearingToleranceDefinitionOptions

    @classmethod
    def implicit_type(cls) -> "_1901.BearingToleranceDefinitionOptions.type_()":
        ...
        return _1901.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: Self) -> "_1901.BearingToleranceDefinitionOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1901.BearingToleranceDefinitionOptions]":

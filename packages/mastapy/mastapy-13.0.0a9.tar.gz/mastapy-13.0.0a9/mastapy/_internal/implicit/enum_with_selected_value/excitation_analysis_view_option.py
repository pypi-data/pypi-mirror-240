...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2259.ExcitationAnalysisViewOption":
        ...
        return _2259.ExcitationAnalysisViewOption

    @classmethod
    def implicit_type(cls) -> "_2259.ExcitationAnalysisViewOption.type_()":
        ...
        return _2259.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: Self) -> "_2259.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2259.ExcitationAnalysisViewOption]":

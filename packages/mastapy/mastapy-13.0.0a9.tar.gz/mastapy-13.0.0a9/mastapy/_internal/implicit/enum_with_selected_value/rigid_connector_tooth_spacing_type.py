...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2591.RigidConnectorToothSpacingType":
        ...
        return _2591.RigidConnectorToothSpacingType

    @classmethod
    def implicit_type(cls) -> "_2591.RigidConnectorToothSpacingType.type_()":
        ...
        return _2591.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: Self) -> "_2591.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: Self) -> "List[_2591.RigidConnectorToothSpacingType]":

...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1960.RaceAxialMountingType":
        ...
        return _1960.RaceAxialMountingType

    @classmethod
    def implicit_type(cls) -> "_1960.RaceAxialMountingType.type_()":
        ...
        return _1960.RaceAxialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1960.RaceAxialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1960.RaceAxialMountingType]":

...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1963.BallBearingAnalysisMethod":
        ...
        return _1963.BallBearingAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_1963.BallBearingAnalysisMethod.type_()":
        ...
        return _1963.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: Self) -> "_1963.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1963.BallBearingAnalysisMethod]":

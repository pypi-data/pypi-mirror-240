...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2395.LinkNodeSource":
        ...
        return _2395.LinkNodeSource

    @classmethod
    def implicit_type(cls) -> "_2395.LinkNodeSource.type_()":
        ...
        return _2395.LinkNodeSource.type_()

    @property
    def selected_value(self: Self) -> "_2395.LinkNodeSource":
    ...
    @property
    def available_values(self: Self) -> "List[_2395.LinkNodeSource]":

...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1792.StatusItemSeverity":
        ...
        return _1792.StatusItemSeverity

    @classmethod
    def implicit_type(cls) -> "_1792.StatusItemSeverity.type_()":
        ...
        return _1792.StatusItemSeverity.type_()

    @property
    def selected_value(self: Self) -> "_1792.StatusItemSeverity":
    ...
    @property
    def available_values(self: Self) -> "List[_1792.StatusItemSeverity]":

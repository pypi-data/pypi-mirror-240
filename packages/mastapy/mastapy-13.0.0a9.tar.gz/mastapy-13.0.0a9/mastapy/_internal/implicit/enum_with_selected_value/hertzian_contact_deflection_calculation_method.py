...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1570.HertzianContactDeflectionCalculationMethod":
        ...
        return _1570.HertzianContactDeflectionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1570.HertzianContactDeflectionCalculationMethod.type_()":
        ...
        return _1570.HertzianContactDeflectionCalculationMethod.type_()

    @property
    def selected_value(
        self: Self,
    ) -> "_1570.HertzianContactDeflectionCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1570.HertzianContactDeflectionCalculationMethod]":

...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1868.BasicStaticLoadRatingCalculationMethod":
        ...
        return _1868.BasicStaticLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1868.BasicStaticLoadRatingCalculationMethod.type_()":
        ...
        return _1868.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1868.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1868.BasicStaticLoadRatingCalculationMethod]":

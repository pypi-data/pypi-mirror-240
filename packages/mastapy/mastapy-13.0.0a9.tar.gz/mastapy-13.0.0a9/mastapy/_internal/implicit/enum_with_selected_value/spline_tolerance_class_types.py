...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1414.SplineToleranceClassTypes":
        ...
        return _1414.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1414.SplineToleranceClassTypes.type_()":
        ...
        return _1414.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1414.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1414.SplineToleranceClassTypes]":

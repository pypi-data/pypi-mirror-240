...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1413.SplineRatingTypes":
        ...
        return _1413.SplineRatingTypes

    @classmethod
    def implicit_type(cls) -> "_1413.SplineRatingTypes.type_()":
        ...
        return _1413.SplineRatingTypes.type_()

    @property
    def selected_value(self: Self) -> "_1413.SplineRatingTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1413.SplineRatingTypes]":

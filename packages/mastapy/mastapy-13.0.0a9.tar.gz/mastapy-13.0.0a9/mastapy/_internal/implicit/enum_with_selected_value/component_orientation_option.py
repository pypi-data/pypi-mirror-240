...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2363.ComponentOrientationOption":
        ...
        return _2363.ComponentOrientationOption

    @classmethod
    def implicit_type(cls) -> "_2363.ComponentOrientationOption.type_()":
        ...
        return _2363.ComponentOrientationOption.type_()

    @property
    def selected_value(self: Self) -> "_2363.ComponentOrientationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2363.ComponentOrientationOption]":

...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6935.PointLoadLoadCase.ForceSpecification":
        ...
        return _6935.PointLoadLoadCase.ForceSpecification

    @classmethod
    def implicit_type(cls) -> "_6935.PointLoadLoadCase.ForceSpecification.type_()":
        ...
        return _6935.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: Self) -> "_6935.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6935.PointLoadLoadCase.ForceSpecification]":

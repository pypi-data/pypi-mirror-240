...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1961.RaceRadialMountingType":
        ...
        return _1961.RaceRadialMountingType

    @classmethod
    def implicit_type(cls) -> "_1961.RaceRadialMountingType.type_()":
        ...
        return _1961.RaceRadialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1961.RaceRadialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1961.RaceRadialMountingType]":

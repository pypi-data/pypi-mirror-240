...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1959.LoadedBallElementPropertyType":
        ...
        return _1959.LoadedBallElementPropertyType

    @classmethod
    def implicit_type(cls) -> "_1959.LoadedBallElementPropertyType.type_()":
        ...
        return _1959.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: Self) -> "_1959.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: Self) -> "List[_1959.LoadedBallElementPropertyType]":

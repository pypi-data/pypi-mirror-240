...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2211.MeshStiffnessModel":
        ...
        return _2211.MeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_2211.MeshStiffnessModel.type_()":
        ...
        return _2211.MeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_2211.MeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2211.MeshStiffnessModel]":

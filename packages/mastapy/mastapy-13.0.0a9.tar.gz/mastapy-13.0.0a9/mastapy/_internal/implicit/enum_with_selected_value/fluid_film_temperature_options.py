...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1881.FluidFilmTemperatureOptions":
        ...
        return _1881.FluidFilmTemperatureOptions

    @classmethod
    def implicit_type(cls) -> "_1881.FluidFilmTemperatureOptions.type_()":
        ...
        return _1881.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: Self) -> "_1881.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1881.FluidFilmTemperatureOptions]":

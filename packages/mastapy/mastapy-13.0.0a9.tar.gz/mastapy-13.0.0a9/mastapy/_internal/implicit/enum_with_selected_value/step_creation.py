...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5814.StiffnessOptionsForHarmonicAnalysis.StepCreation":
        ...
        return _5814.StiffnessOptionsForHarmonicAnalysis.StepCreation

    @classmethod
    def implicit_type(
        cls,
    ) -> "_5814.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()":
        ...
        return _5814.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()

    @property
    def selected_value(
        self: Self,
    ) -> "_5814.StiffnessOptionsForHarmonicAnalysis.StepCreation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_5814.StiffnessOptionsForHarmonicAnalysis.StepCreation]":

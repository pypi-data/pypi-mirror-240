...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1819.ThreeDViewContourOptionFirstSelection":
        ...
        return _1819.ThreeDViewContourOptionFirstSelection

    @classmethod
    def implicit_type(cls) -> "_1819.ThreeDViewContourOptionFirstSelection.type_()":
        ...
        return _1819.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: Self) -> "_1819.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1819.ThreeDViewContourOptionFirstSelection]":

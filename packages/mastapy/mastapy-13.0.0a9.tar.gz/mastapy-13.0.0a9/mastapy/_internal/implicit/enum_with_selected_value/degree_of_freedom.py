...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1500.DegreeOfFreedom":
        ...
        return _1500.DegreeOfFreedom

    @classmethod
    def implicit_type(cls) -> "_1500.DegreeOfFreedom.type_()":
        ...
        return _1500.DegreeOfFreedom.type_()

    @property
    def selected_value(self: Self) -> "_1500.DegreeOfFreedom":
    ...
    @property
    def available_values(self: Self) -> "List[_1500.DegreeOfFreedom]":

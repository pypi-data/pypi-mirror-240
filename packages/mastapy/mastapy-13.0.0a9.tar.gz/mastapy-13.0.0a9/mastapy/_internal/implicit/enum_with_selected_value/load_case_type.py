...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1360.LoadCaseType":
        ...
        return _1360.LoadCaseType

    @classmethod
    def implicit_type(cls) -> "_1360.LoadCaseType.type_()":
        ...
        return _1360.LoadCaseType.type_()

    @property
    def selected_value(self: Self) -> "_1360.LoadCaseType":
    ...
    @property
    def available_values(self: Self) -> "List[_1360.LoadCaseType]":

...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2588.RigidConnectorStiffnessType":
        ...
        return _2588.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2588.RigidConnectorStiffnessType.type_()":
        ...
        return _2588.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2588.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2588.RigidConnectorStiffnessType]":

...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1900.BearingToleranceClass":
        ...
        return _1900.BearingToleranceClass

    @classmethod
    def implicit_type(cls) -> "_1900.BearingToleranceClass.type_()":
        ...
        return _1900.BearingToleranceClass.type_()

    @property
    def selected_value(self: Self) -> "_1900.BearingToleranceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1900.BearingToleranceClass]":

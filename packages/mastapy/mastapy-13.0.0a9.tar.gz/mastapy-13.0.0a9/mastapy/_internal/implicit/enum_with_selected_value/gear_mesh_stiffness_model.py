...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5434.GearMeshStiffnessModel":
        ...
        return _5434.GearMeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5434.GearMeshStiffnessModel.type_()":
        ...
        return _5434.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5434.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5434.GearMeshStiffnessModel]":

...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1375.ForceDisplayOption":
        ...
        return _1375.ForceDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1375.ForceDisplayOption.type_()":
        ...
        return _1375.ForceDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1375.ForceDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1375.ForceDisplayOption]":

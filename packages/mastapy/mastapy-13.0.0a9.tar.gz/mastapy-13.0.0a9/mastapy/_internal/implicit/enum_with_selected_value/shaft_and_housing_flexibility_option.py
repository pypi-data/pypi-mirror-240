...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5480.ShaftAndHousingFlexibilityOption":
        ...
        return _5480.ShaftAndHousingFlexibilityOption

    @classmethod
    def implicit_type(cls) -> "_5480.ShaftAndHousingFlexibilityOption.type_()":
        ...
        return _5480.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: Self) -> "_5480.ShaftAndHousingFlexibilityOption":
    ...
    @property
    def available_values(self: Self) -> "List[_5480.ShaftAndHousingFlexibilityOption]":

...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1789.Severity":
        ...
        return _1789.Severity

    @classmethod
    def implicit_type(cls) -> "_1789.Severity.type_()":
        ...
        return _1789.Severity.type_()

    @property
    def selected_value(self: Self) -> "_1789.Severity":
    ...
    @property
    def available_values(self: Self) -> "List[_1789.Severity]":

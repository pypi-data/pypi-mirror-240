...
class ListWithSelectedItem_ShaftHubConnection(
    _2595.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2595.ShaftHubConnection.TYPE":
        ...
        return _2595.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2595.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2595.ShaftHubConnection]":

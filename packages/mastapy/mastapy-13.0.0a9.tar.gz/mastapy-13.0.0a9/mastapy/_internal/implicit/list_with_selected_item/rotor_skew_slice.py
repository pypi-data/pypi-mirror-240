...
class ListWithSelectedItem_RotorSkewSlice(
    _1291.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1291.RotorSkewSlice.TYPE":
        ...
        return _1291.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1291.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1291.RotorSkewSlice]":

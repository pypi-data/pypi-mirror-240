...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5675.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5675.AbstractPeriodicExcitationDetail.TYPE":
        ...
        return _5675.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: Self) -> "_5675.AbstractPeriodicExcitationDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_5675.AbstractPeriodicExcitationDetail]":

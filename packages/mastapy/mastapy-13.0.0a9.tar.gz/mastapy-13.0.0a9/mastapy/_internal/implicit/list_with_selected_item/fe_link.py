...
class ListWithSelectedItem_FELink(_2415.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2415.FELink.TYPE":
        ...
        return _2415.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2415.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2415.FELink]":

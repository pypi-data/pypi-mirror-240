...
class ListWithSelectedItem_ColumnTitle(
    _1814.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1814.ColumnTitle.TYPE":
        ...
        return _1814.ColumnTitle.TYPE

    @property
    def selected_value(self: Self) -> "_1814.ColumnTitle":
    ...
    @property
    def available_values(self: Self) -> "List[_1814.ColumnTitle]":

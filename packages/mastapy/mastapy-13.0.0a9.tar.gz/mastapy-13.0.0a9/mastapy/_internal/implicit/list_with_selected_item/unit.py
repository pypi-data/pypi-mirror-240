...
class ListWithSelectedItem_Unit(_1607.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1607.Unit.TYPE":
        ...
        return _1607.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1607.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1607.Unit]":

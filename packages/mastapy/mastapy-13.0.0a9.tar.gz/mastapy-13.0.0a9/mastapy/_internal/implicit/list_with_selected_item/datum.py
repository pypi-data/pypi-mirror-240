...
class ListWithSelectedItem_Datum(_2445.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2445.Datum.TYPE":
        ...
        return _2445.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2445.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2445.Datum]":

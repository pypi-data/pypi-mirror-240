...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        cls,
    ) -> "_5766.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE":
        ...
        return _5766.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_5766.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":

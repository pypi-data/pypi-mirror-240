...
class ListWithSelectedItem_StaticLoadCase(
    _6801.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6801.StaticLoadCase.TYPE":
        ...
        return _6801.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6801.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6801.StaticLoadCase]":

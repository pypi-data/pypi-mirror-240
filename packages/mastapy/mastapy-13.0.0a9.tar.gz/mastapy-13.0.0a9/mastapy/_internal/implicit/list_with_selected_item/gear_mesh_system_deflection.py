...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2756.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2756.GearMeshSystemDeflection.TYPE":
        ...
        return _2756.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2756.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2756.GearMeshSystemDeflection]":

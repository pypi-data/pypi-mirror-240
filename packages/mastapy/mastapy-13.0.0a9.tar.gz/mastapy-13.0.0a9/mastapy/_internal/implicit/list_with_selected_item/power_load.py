...
class ListWithSelectedItem_PowerLoad(_2469.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2469.PowerLoad.TYPE":
        ...
        return _2469.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2469.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2469.PowerLoad]":

...
class ListWithSelectedItem_MeasurementBase(
    _1602.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1602.MeasurementBase.TYPE":
        ...
        return _1602.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1602.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1602.MeasurementBase]":

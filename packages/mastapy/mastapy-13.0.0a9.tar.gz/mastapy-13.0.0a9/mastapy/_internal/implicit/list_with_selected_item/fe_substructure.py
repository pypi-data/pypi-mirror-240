...
class ListWithSelectedItem_FESubstructure(
    _2380.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2380.FESubstructure.TYPE":
        ...
        return _2380.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2380.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2380.FESubstructure]":

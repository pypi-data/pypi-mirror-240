...
class ListWithSelectedItem_GearSet(_2529.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2529.GearSet.TYPE":
        ...
        return _2529.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2529.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2529.GearSet]":

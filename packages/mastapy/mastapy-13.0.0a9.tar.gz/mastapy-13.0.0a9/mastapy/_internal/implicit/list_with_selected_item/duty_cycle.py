...
class ListWithSelectedItem_DutyCycle(_5660.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5660.DutyCycle.TYPE":
        ...
        return _5660.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5660.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5660.DutyCycle]":

...
class ListWithSelectedItem_GuideDxfModel(
    _2452.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2452.GuideDxfModel.TYPE":
        ...
        return _2452.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2452.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2452.GuideDxfModel]":

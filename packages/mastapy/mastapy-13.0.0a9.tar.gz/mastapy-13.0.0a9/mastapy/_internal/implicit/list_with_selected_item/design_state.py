...
class ListWithSelectedItem_DesignState(
    _5659.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5659.DesignState.TYPE":
        ...
        return _5659.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5659.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5659.DesignState]":

...
class ListWithSelectedItem_SystemDirectory(
    _1597.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1597.SystemDirectory.TYPE":
        ...
        return _1597.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1597.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1597.SystemDirectory]":

...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2742.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2742.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2742.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2742.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2742.CylindricalGearSystemDeflection]":

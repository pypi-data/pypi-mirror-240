...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1895.SealLocation":
        ...
        return _1895.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1895.SealLocation.type_()":
        ...
        return _1895.SealLocation.type_()

    @property
    def value(self: Self) -> "_1895.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1895.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1895.SealLocation":
        """mastapy.bearings.SealLocation

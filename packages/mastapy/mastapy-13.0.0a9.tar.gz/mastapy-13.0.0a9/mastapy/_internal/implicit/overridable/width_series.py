...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2172.WidthSeries":
        ...
        return _2172.WidthSeries

    @classmethod
    def implicit_type(cls) -> "_2172.WidthSeries.type_()":
        ...
        return _2172.WidthSeries.type_()

    @property
    def value(self: Self) -> "_2172.WidthSeries":
    ...
    @property
    def override_value(self: Self) -> "_2172.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2172.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries

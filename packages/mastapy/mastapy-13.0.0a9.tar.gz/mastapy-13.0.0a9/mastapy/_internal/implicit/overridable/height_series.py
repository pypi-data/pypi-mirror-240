...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2155.HeightSeries":
        ...
        return _2155.HeightSeries

    @classmethod
    def implicit_type(cls) -> "_2155.HeightSeries.type_()":
        ...
        return _2155.HeightSeries.type_()

    @property
    def value(self: Self) -> "_2155.HeightSeries":
    ...
    @property
    def override_value(self: Self) -> "_2155.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2155.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries

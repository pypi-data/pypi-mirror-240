...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1969.FrictionModelForGyroscopicMoment":
        ...
        return _1969.FrictionModelForGyroscopicMoment

    @classmethod
    def implicit_type(cls) -> "_1969.FrictionModelForGyroscopicMoment.type_()":
        ...
        return _1969.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: Self) -> "_1969.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: Self) -> "_1969.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: Self) -> "_1969.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment

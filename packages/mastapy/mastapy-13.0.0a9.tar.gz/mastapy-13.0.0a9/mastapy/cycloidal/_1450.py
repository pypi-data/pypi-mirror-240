...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1451, _1454
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1451.CycloidalDiscDesignExporter":

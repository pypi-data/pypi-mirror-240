...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @enforce_parameter_types
    def selected_version(self: Self, value: "_1597.SystemDirectory"):
        wrapper_type = (
    ...
    @property
    def current_version(self: Self) -> "_1597.SystemDirectory":
    ...
    @property
    def version_to_copy(self: Self) -> "_1597.SystemDirectory":
        """mastapy.utility.SystemDirectory

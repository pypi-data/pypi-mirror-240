...
class CustomReportChartItem(_1770.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    class _Cast_CustomReportChartItem:
        ...
        def custom_report_property_item(
            ...
            return self._parent._cast(_1770.CustomReportPropertyItem)
    ...
    @property
    def point_shape(self: Self) -> "_1746.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1746", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: Self, value: "_1746.SMTChartPointShape"):

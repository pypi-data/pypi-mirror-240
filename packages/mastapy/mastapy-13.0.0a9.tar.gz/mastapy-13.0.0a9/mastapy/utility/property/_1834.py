...
TMeasurement = TypeVar("TMeasurement", bound="_1602.MeasurementBase")
T = TypeVar("T")
...
class DutyCyclePropertySummary(_0.APIBase, Generic[TMeasurement, T]):
    ...
    class _Cast_DutyCyclePropertySummary:
        ...
        def duty_cycle_property_summary_force(
            ...
            return self._parent._cast(_1835.DutyCyclePropertySummaryForce)
        ...
        def duty_cycle_property_summary_percentage(
            ...
            return self._parent._cast(_1836.DutyCyclePropertySummaryPercentage)
        ...
        def duty_cycle_property_summary_small_angle(
            ...
            return self._parent._cast(_1837.DutyCyclePropertySummarySmallAngle)
        ...
        def duty_cycle_property_summary_stress(
            ...
            return self._parent._cast(_1838.DutyCyclePropertySummaryStress)
        ...
        def duty_cycle_property_summary_very_short_length(
            ...
            return self._parent._cast(_1839.DutyCyclePropertySummaryVeryShortLength)

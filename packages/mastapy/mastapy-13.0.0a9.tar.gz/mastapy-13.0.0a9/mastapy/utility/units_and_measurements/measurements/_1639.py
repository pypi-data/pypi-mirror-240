...
class Force(_1602.MeasurementBase):
    """Force
    ...
    class _Cast_Force:
        ...
        def measurement_base(self: "Force._Cast_Force"):
            return self._parent._cast(_1602.MeasurementBase)
    ...
    @property
    def kilograms_force(self: Self) -> "_1607.Unit":
    ...
    @property
    def kilonewtons(self: Self) -> "_1607.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millinewtons(self: Self) -> "_1607.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def newtons(self: Self) -> "_1607.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def ounces_force(self: Self) -> "_1607.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def pounds_force(self: Self) -> "_1607.Unit":
        """mastapy.utility.units_and_measurements.Unit

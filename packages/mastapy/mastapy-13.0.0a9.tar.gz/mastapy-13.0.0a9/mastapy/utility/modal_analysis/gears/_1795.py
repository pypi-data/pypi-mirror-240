...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis.gears import _1796, _1799
...
class GearOrderForTE(_1801.OrderWithRadius):
    """GearOrderForTE
    ...
    class _Cast_GearOrderForTE:
        ...
        def order_for_te(self: "GearOrderForTE._Cast_GearOrderForTE"):
            return self._parent._cast(_1799.OrderForTE)
    ...
    @property
    def position(self: Self) -> "_1796.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.modal_analysis.gears._1796", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: Self) -> "List[_1799.OrderForTE]":

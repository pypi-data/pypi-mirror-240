...
class BoltMaterial(_1462.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: Self) -> "_1481.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1481", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1481.StrengthGrades"):

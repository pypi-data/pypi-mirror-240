...
if TYPE_CHECKING:
    from mastapy.bolts import _1468, _1469, _1480, _1470, _1475, _1482
...
class BoltGeometry(_1826.NamedDatabaseItem):
    """BoltGeometry
    ...
    class _Cast_BoltGeometry:
        ...
        def named_database_item(self: "BoltGeometry._Cast_BoltGeometry"):
            return self._parent._cast(_1826.NamedDatabaseItem)
    ...
    @property
    def bolt_sections(self: Self) -> "List[_1468.BoltSection]":
    ...
    @enforce_parameter_types
    def bolt_sections(self: Self, value: "List[_1468.BoltSection]"):
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self: Self) -> "_1469.BoltShankType":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1469", "BoltShankType")(
            value
        )

    @bolt_shank_type.setter
    @enforce_parameter_types
    def bolt_shank_type(self: Self, value: "_1469.BoltShankType"):
    ...
    @property
    def standard_size(self: Self) -> "_1480.StandardSizes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1480", "StandardSizes")(
            value
        )

    @standard_size.setter
    @enforce_parameter_types
    def standard_size(self: Self, value: "_1480.StandardSizes"):
    ...
    @property
    def type_of_bolted_joint(self: Self) -> "_1470.BoltTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1470", "BoltTypes")(value)

    @type_of_bolted_joint.setter
    @enforce_parameter_types
    def type_of_bolted_joint(self: Self, value: "_1470.BoltTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.BoltTypes")
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self: Self) -> "_1475.HeadCapTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1475", "HeadCapTypes")(
            value
        )

    @type_of_head_cap.setter
    @enforce_parameter_types
    def type_of_head_cap(self: Self, value: "_1475.HeadCapTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.HeadCapTypes")
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self: Self) -> "_1482.ThreadTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1482", "ThreadTypes")(value)

    @type_of_thread.setter
    @enforce_parameter_types
    def type_of_thread(self: Self, value: "_1482.ThreadTypes"):

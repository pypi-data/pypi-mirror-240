...
if TYPE_CHECKING:
    from mastapy.bolts import _1471, _1476, _1479, _1464, _1466, _1462
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: Self) -> "List[_1471.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: Self, value: "List[_1471.ClampedSection]"):
    ...
    @property
    def joint_geometry(self: Self) -> "_1476.JointGeometries":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1476", "JointGeometries")(
            value
        )

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: Self, value: "_1476.JointGeometries"):
    ...
    def rolled_before_or_after_heat_treatment(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bolts._1479", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: Self, value: "_1479.RolledBeforeOrAfterHeatTreatment"
    ):
    ...
    @property
    def bolt_geometry(self: Self) -> "_1464.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: Self) -> "_1466.BoltMaterial":
    ...
    @property
    def material_of_nut(self: Self) -> "_1462.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: Self) -> "_1462.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: Self) -> "List[_1471.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]

...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1924, _1926, _1936
...
class RollerBearingUserSpecifiedProfile(_1933.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    class _Cast_RollerBearingUserSpecifiedProfile:
        ...
        def roller_bearing_profile(
            ...
            return self._parent._cast(_1933.RollerBearingProfile)
    ...
    @property
    def data_to_use(self: Self) -> "_1924.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1924", "ProfileDataToUse"
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: Self, value: "_1924.ProfileDataToUse"):
    ...
    @property
    def profile_to_fit(self: Self) -> "_1926.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1926", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: Self, value: "_1926.ProfileToFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: Self) -> "List[_1936.UserSpecifiedProfilePoint]":

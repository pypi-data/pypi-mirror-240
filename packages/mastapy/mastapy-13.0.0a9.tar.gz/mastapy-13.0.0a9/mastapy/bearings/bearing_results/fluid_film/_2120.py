...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedPlainJournalBearingRow:
        ...
        def loaded_plain_oil_fed_journal_bearing_row(
            ...
            return self._parent._cast(_2122.LoadedPlainOilFedJournalBearingRow)
    ...
    @property
    def row(self: Self) -> "_1875.BearingRow":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1875", "BearingRow")(
            value
        )

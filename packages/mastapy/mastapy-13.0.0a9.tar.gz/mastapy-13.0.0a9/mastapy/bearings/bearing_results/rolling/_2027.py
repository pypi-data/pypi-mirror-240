...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2026, _1967
...
class LoadedRollerBearingRow(_2031.LoadedRollingBearingRow):
    """LoadedRollerBearingRow
    ...
    class _Cast_LoadedRollerBearingRow:
        ...
        def loaded_rolling_bearing_row(
            ...
            return self._parent._cast(_2031.LoadedRollingBearingRow)
    ...
    @property
    def loaded_bearing(self: Self) -> "_2026.LoadedRollerBearingResults":
    ...
    def lamina_dynamic_equivalent_loads(
        self: Self,
    ) -> "List[_1967.ForceAtLaminaGroupReportable]":

...
class MaximumStaticContactStress(_2059.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
    ...
    class _Cast_MaximumStaticContactStress:
        ...
        def maximum_static_contact_stress_results_abstract(
            ...
            return self._parent._cast(_2059.MaximumStaticContactStressResultsAbstract)

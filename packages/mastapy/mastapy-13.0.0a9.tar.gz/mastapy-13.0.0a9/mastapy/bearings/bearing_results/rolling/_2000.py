...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1999, _1998
...
class LoadedBallBearingRow(_2031.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_1999.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: Self) -> "List[_1998.LoadedBallBearingRaceResults]":

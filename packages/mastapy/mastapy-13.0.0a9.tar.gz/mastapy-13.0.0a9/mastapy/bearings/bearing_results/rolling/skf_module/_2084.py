...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2083, _2085, _2086
...
class GreaseLifeAndRelubricationInterval(_2093.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    class _Cast_GreaseLifeAndRelubricationInterval:
        ...
        def skf_calculation_result(
            ...
            return self._parent._cast(_2093.SKFCalculationResult)
    ...
    @property
    def grease(self: Self) -> "_2083.Grease":
    ...
    @property
    def grease_quantity(self: Self) -> "_2085.GreaseQuantity":
    ...
    @property
    def initial_fill(self: Self) -> "_2086.InitialFill":

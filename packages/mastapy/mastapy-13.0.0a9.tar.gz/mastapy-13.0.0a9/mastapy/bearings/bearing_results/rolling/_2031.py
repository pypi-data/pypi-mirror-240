...
class LoadedRollingBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedRollingBearingRow:
        ...
        def loaded_angular_contact_ball_bearing_row(
            ...
            return self._parent._cast(_1981.LoadedAngularContactBallBearingRow)
        ...
        def loaded_angular_contact_thrust_ball_bearing_row(
            ...
            return self._parent._cast(_1984.LoadedAngularContactThrustBallBearingRow)
        ...
        def loaded_asymmetric_spherical_roller_bearing_row(
            ...
            return self._parent._cast(_1987.LoadedAsymmetricSphericalRollerBearingRow)
        ...
        def loaded_axial_thrust_needle_roller_bearing_row(
            ...
            return self._parent._cast(_1995.LoadedAxialThrustNeedleRollerBearingRow)
        ...
        def loaded_ball_bearing_row(
            ...
            return self._parent._cast(_2000.LoadedBallBearingRow)
        ...
        def loaded_crossed_roller_bearing_row(
            ...
            return self._parent._cast(_2003.LoadedCrossedRollerBearingRow)
        ...
        def loaded_cylindrical_roller_bearing_row(
            ...
            return self._parent._cast(_2007.LoadedCylindricalRollerBearingRow)
        ...
        def loaded_deep_groove_ball_bearing_row(
            ...
            return self._parent._cast(_2010.LoadedDeepGrooveBallBearingRow)
        ...
        def loaded_four_point_contact_ball_bearing_row(
            ...
            return self._parent._cast(_2015.LoadedFourPointContactBallBearingRow)
        ...
        def loaded_needle_roller_bearing_row(
            ...
            return self._parent._cast(_2019.LoadedNeedleRollerBearingRow)
        ...
        def loaded_non_barrel_roller_bearing_row(
            ...
            return self._parent._cast(_2022.LoadedNonBarrelRollerBearingRow)
        ...
        def loaded_roller_bearing_row(
            ...
            return self._parent._cast(_2027.LoadedRollerBearingRow)
        ...
        def loaded_self_aligning_ball_bearing_row(
            ...
            return self._parent._cast(_2034.LoadedSelfAligningBallBearingRow)
        ...
        def loaded_spherical_roller_radial_bearing_row(
            ...
            return self._parent._cast(_2038.LoadedSphericalRollerRadialBearingRow)
        ...
        def loaded_spherical_roller_thrust_bearing_row(
            ...
            return self._parent._cast(_2041.LoadedSphericalRollerThrustBearingRow)
        ...
        def loaded_taper_roller_bearing_row(
            ...
            return self._parent._cast(_2046.LoadedTaperRollerBearingRow)
        ...
        def loaded_three_point_contact_ball_bearing_row(
            ...
            return self._parent._cast(_2049.LoadedThreePointContactBallBearingRow)
        ...
        def loaded_thrust_ball_bearing_row(
            ...
            return self._parent._cast(_2052.LoadedThrustBallBearingRow)
        ...
        def loaded_toroidal_roller_bearing_row(
            ...
            return self._parent._cast(_2055.LoadedToroidalRollerBearingRow)
    ...
    @property
    def subsurface_shear_stress_chart_inner(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def subsurface_shear_stress_chart_outer(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def loaded_bearing(self: Self) -> "_2030.LoadedRollingBearingResults":
    ...
    @property
    def maximum_operating_internal_clearance(self: Self) -> "_1970.InternalClearance":
    ...
    @property
    def minimum_operating_internal_clearance(self: Self) -> "_1970.InternalClearance":
        """mastapy.bearings.bearing_results.rolling.InternalClearance
    ...
    @property
    def elements(self: Self) -> "List[_2011.LoadedElement]":
    ...
    @property
    def race_results(self: Self) -> "List[_2029.LoadedRollingBearingRaceResults]":
    ...
    def ring_force_and_displacement_results(
        self: Self,
    ) -> "List[_2065.RingForceAndDisplacement]":

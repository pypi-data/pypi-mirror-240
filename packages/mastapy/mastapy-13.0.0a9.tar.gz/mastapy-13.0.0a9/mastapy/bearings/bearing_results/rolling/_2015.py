...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2014, _2013
...
class LoadedFourPointContactBallBearingRow(_2000.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2014.LoadedFourPointContactBallBearingResults":
    ...
    def race_results(
        self: Self,
    ) -> "List[_2013.LoadedFourPointContactBallBearingRaceResults]":

...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.fitting import _2107, _2109, _2110
...
class LoadedRollingBearingResults(_1951.LoadedDetailedBearingResults):
    """LoadedRollingBearingResults
    ...
    def fluid_film_temperature_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1881", "FluidFilmTemperatureOptions"
        )(value)
    ...
    @property
    def ansiabma(self: Self) -> "_2114.ANSIABMAResults":
    ...
    @property
    def din7322010(self: Self) -> "_1966.DIN7322010Results":
    ...
    @property
    def iso2812007(self: Self) -> "_2100.ISO2812007Results":
    ...
    @property
    def iso762006(self: Self) -> "_2101.ISO762006Results":
    ...
    @property
    def isotr1417912001(self: Self) -> "_1975.ISOTR1417912001Results":
    ...
    @property
    def isotr1417922001(self: Self) -> "_1977.ISOTR1417922001Results":
    ...
    @property
    def isots162812008(self: Self) -> "_2103.ISOTS162812008Results":
    ...
    @property
    def maximum_static_contact_stress(self: Self) -> "_2057.MaximumStaticContactStress":
    ...
    @property
    def skf_module_results(self: Self) -> "_2095.SKFModuleResults":
    ...
    @property
    def all_mounting_results(self: Self) -> "List[_2110.RingFittingThermalResults]":
    ...
    @property
    def rows(self: Self) -> "List[_2031.LoadedRollingBearingRow]":

...
class InterferenceTolerance(_1898.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self: Self) -> "_1901.BearingToleranceDefinitionOptions":
    ...
    def definition_option(self: Self, value: "_1901.BearingToleranceDefinitionOptions"):
    ...
    def mounting_point_surface_finish(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1885", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: Self, value: "_1885.MountingPointSurfaceFinishes"
    ):
        value = conversion.mp_to_pn_enum(

...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1918, _1913
...
class SupportDetail(_1905.InterferenceDetail):
    """SupportDetail
    ...
    class _Cast_SupportDetail:
        ...
        def bearing_connection_component(self: "SupportDetail._Cast_SupportDetail"):
            ...
            return self._parent._cast(_1898.BearingConnectionComponent)
    ...
    @property
    def material_source(self: Self) -> "_1918.SupportMaterialSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1918", "SupportMaterialSource"
        )(value)
    ...
    @property
    def radial_specification_method(self: Self) -> "_1913.RadialSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1913", "RadialSpecificationMethod"
        )(value)

    @radial_specification_method.setter
    @enforce_parameter_types
    def radial_specification_method(
        self: Self, value: "_1913.RadialSpecificationMethod"
    ):

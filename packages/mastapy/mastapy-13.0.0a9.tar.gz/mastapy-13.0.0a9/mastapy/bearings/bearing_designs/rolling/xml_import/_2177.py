...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2173
...
class XMLVariableAssignment(_2173.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
    ...
    class _Cast_XMLVariableAssignment:
        ...
        def abstract_xml_variable_assignment(
            ...
            return self._parent._cast(_2173.AbstractXmlVariableAssignment)

...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1925, _1935
...
class RollerBearing(_2162.RollingBearing):
    """RollerBearing
    ...
    @enforce_parameter_types
    def roller_profile(self: Self, value: "_1888.RollerBearingProfileTypes"):
    ...
    @property
    def inner_race_profile_set(self: Self) -> "_1925.ProfileSet":
    ...
    @property
    def outer_race_profile_set(self: Self) -> "_1925.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    @property
    def roller_profile_set(self: Self) -> "_1925.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    def inner_race_and_roller_profiles(
        self: Self,
    ) -> "List[_1935.RollerRaceProfilePoint]":

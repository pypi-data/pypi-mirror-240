...
class ThrustBallBearing(_2137.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: Self) -> "_1886.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1886", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: Self, value: "_1886.OuterRingMounting"):

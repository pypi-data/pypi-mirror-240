...
from mastapy.bearings import _1889, _1867, _1868, _1892
from mastapy.bearings.bearing_designs.rolling import _2148, _2149, _2155, _2172
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1869, _1866
...
class RollingBearing(_2128.DetailedBearing):
    """RollingBearing
    ...
    @arrangement.setter
    @enforce_parameter_types
    def arrangement(self: Self, value: "_1889.RollingBearingArrangement"):
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: Self, value: "_1867.BasicDynamicLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: Self, value: "_1868.BasicStaticLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def cage_bridge_shape(self: Self) -> "_2144.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2144", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @enforce_parameter_types
    def cage_bridge_shape(self: Self, value: "_2144.CageBridgeShape"):
    ...
    @property
    def cage_material(self: Self) -> "_1869.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1869", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @enforce_parameter_types
    def cage_material(self: Self, value: "_1869.BearingCageMaterial"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def catalogue(self: Self) -> "_1866.BearingCatalog":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1866", "BearingCatalog")(
            value
        )
    ...
    def diameter_series(
        self: Self,
        value: "Union[_2148.DiameterSeries, Tuple[_2148.DiameterSeries, bool]]",
    ):
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: Self, value: "_2149.FatigueLoadLimitCalculationMethodEnum"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def height_series(
        self: Self, value: "Union[_2155.HeightSeries, Tuple[_2155.HeightSeries, bool]]"
    ):
    ...
    @enforce_parameter_types
    def inner_race_type(self: Self, value: "_1892.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def outer_race_type(self: Self, value: "_1892.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        )
    ...
    @property
    def sleeve_type(self: Self) -> "_2165.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2165", "SleeveType"
        )(value)
    ...
    @property
    def type_information(self: Self) -> "_2143.BearingTypeExtraInformation":
    ...
    @enforce_parameter_types
    def width_series(
        self: Self, value: "Union[_2172.WidthSeries, Tuple[_2172.WidthSeries, bool]]"
    ):
    ...
    @property
    def geometric_constants(self: Self) -> "_2152.GeometricConstants":
    ...
    @property
    def history(self: Self) -> "_1579.FileHistory":
    ...
    @property
    def iso153122018(self: Self) -> "_1974.ISO153122018Results":
    ...
    @property
    def protection(self: Self) -> "_2140.BearingProtection":

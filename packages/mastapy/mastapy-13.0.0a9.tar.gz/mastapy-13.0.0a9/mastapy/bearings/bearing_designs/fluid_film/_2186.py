...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2187, _2189
...
class PlainGreaseFilledJournalBearing(_2188.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self: Self) -> "_2187.PlainGreaseFilledJournalBearingHousingType":
    ...
    def housing_type(
        self: Self, value: "_2187.PlainGreaseFilledJournalBearingHousingType"
    ):
    ...
    @property
    def housing_detail(self: Self) -> "_2189.PlainJournalHousing":

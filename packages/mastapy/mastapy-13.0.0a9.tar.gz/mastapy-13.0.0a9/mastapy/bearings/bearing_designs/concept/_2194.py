...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.concept import _2193
...
class ConceptAxialClearanceBearing(_2195.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: Self) -> "_2193.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.concept._2193", "BearingNodePosition"
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: Self, value: "_2193.BearingNodePosition"):

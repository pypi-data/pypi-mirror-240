...
class BearingDesign(_0.APIBase):
    ...
    @property
    def mass_properties_of_elements_from_geometry(self: Self) -> "_1514.MassProperties":
    ...
    @property
    def total_mass_properties(self: Self) -> "_1514.MassProperties":
        """mastapy.math_utility.MassProperties

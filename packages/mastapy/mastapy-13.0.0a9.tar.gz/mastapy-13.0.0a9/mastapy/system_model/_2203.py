...
from mastapy.system_model.part_model import _2468, _2469
...
if TYPE_CHECKING:
    from mastapy.system_model import _2204, _2208
...
class DutyCycleImporter(_0.APIBase):
    ...
    def design_state_destinations(
        self: Self,
    ) -> "List[_2204.DutyCycleImporterDesignEntityMatch[_5659.DesignState]]":
    ...
    @property
    def duty_cycles_to_import(self: Self) -> "List[_2208.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: Self,
    ) -> "List[_2204.DutyCycleImporterDesignEntityMatch[_2468.PointLoad]]":
    ...
    def power_load_destinations(
        self: Self,
    ) -> "List[_2204.DutyCycleImporterDesignEntityMatch[_2469.PowerLoad]]":

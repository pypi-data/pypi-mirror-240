...
from mastapy.bearings.bearing_results import _1960, _1961
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def inner_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2455.InnerBearingRaceMountingOptions)
        ...
        def outer_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2464.OuterBearingRaceMountingOptions)
    ...
    def axial_mounting(self: Self, value: "_1960.RaceAxialMountingType"):
    ...
    @enforce_parameter_types
    def simple_radial_mounting(self: Self, value: "_1961.RaceRadialMountingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

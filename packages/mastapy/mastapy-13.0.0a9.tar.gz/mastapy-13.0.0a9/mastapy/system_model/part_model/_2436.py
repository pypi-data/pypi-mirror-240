...
from mastapy.bearings.bearing_results import _1939, _1958
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1870, _1883, _1866
    from mastapy.system_model.part_model import _2437, _2435, _2470, _2438, _2442
...
class Bearing(_2444.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1900.BearingToleranceClass"):
    ...
    def bearing_tolerance_definition(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1901", "BearingToleranceDefinitionOptions"
        )(value)

    @bearing_tolerance_definition.setter
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1901.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1870.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1870", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1870.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2437", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2437.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1783.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1883.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1883", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1883.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1874.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1783.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1939.CylindricalRollerMaxAxialLoadMethod, Tuple[_1939.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1958.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2127.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2067.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1917.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1917.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1917.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def right_support_detail(self: Self) -> "_1917.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1903.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1914.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1909.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1914.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2127.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1904.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1919.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1910.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1919.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: Self) -> "List[_2438.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1921.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1866.BearingCatalog", designation: "str"
    ):
    ...
    def try_attach_left_side_to(
        self: Self, shaft: "_2479.Shaft", offset: "float" = float("nan")

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.gears import _2522, _2524
...
class PlanetaryGearSet(_2523.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    def annuluses(self: Self) -> "List[_2522.CylindricalGear]":
    ...
    @property
    def planets(self: Self) -> "List[_2524.CylindricalPlanetGear]":
    ...
    @property
    def suns(self: Self) -> "List[_2522.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    def add_annulus(self: Self) -> "_2522.CylindricalGear":
    ...
    def add_planet(self: Self) -> "_2522.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    def add_sun(self: Self) -> "_2522.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""

...
class SuperchargerRotorSet(_1826.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: Self) -> "_1862.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: Self) -> "_2562.YVariableForImportedData":
    ...
    def y_variable_for_imported_data(
        self: Self, value: "_2562.YVariableForImportedData"
    ):
    ...
    @property
    def boost_pressure(self: Self) -> "_2552.BoostPressureInputOptions":
    ...
    @property
    def file(self: Self) -> "_2555.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: Self) -> "_2553.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: Self) -> "_2554.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: Self) -> "_2557.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: Self) -> "List[_2556.RotorSetMeasuredPoint]":

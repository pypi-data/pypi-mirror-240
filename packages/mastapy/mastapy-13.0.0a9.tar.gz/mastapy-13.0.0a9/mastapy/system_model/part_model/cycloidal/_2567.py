...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1458, _1459
...
class RingPins(_2461.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: Self) -> "_1458.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: Self) -> "_1459.RingPinsMaterial":

...
class PlanetCarrierSettings(_1591.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2212", "PlanetPinManufacturingErrorsCoordinateSystem"
        )(value)

    @planet_pin_manufacturing_errors_coordinate_system.setter
    @enforce_parameter_types
    def planet_pin_manufacturing_errors_coordinate_system(
        self: Self, value: "_2212.PlanetPinManufacturingErrorsCoordinateSystem"
    ):

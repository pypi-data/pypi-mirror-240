...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2605, _2607
...
class TorqueConverter(_2580.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: Self) -> "_2605.TorqueConverterPump":
    ...
    @property
    def turbine(self: Self) -> "_2607.TorqueConverterTurbine":

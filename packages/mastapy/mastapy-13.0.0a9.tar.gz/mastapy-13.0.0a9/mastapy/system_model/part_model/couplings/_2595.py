...
from mastapy.system_model.part_model.couplings import _2588, _2591, _2592
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1406, _1411
    from mastapy.system_model.part_model.couplings import _2589, _2596, _2590
    from mastapy.detailed_rigid_connectors.interference_fits import _1441
...
class ShaftHubConnection(_2444.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self: Self) -> "_1406.SplineDesignTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1406", "SplineDesignTypes"
        )(value)

    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: Self, value: "_1406.SplineDesignTypes"):
    ...
    @enforce_parameter_types
    def stiffness_type(self: Self, value: "_2588.RigidConnectorStiffnessType"):
    ...
    @property
    def tilt_stiffness_type(self: Self) -> "_2589.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: Self, value: "_2589.RigidConnectorTiltStiffnessTypes"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(self: Self, value: "_2591.RigidConnectorToothSpacingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2592.RigidConnectorTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: Self, value: "_1391.FitTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def interference_fit_design(self: Self) -> "_1441.InterferenceFitDesign":
    ...
    @property
    def left_flank_lead_relief(self: Self) -> "_2596.SplineLeadRelief":
    ...
    @property
    def right_flank_lead_relief(self: Self) -> "_2596.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_joint_design(self: Self) -> "_1411.SplineJointDesign":
    ...
    @property
    def lead_reliefs(self: Self) -> "List[_2596.SplineLeadRelief]":
    ...
    def tooth_locations_external_spline_half(
        self: Self,
    ) -> "List[_2590.RigidConnectorToothLocation]":

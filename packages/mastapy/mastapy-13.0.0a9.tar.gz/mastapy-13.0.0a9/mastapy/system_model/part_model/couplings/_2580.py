...
class Coupling(_2473.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: Self) -> "List[_2581.CouplingHalf]":
    ...
    @property
    def half_a(self: Self) -> "_2581.CouplingHalf":
    ...
    @property
    def half_b(self: Self) -> "_2581.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf

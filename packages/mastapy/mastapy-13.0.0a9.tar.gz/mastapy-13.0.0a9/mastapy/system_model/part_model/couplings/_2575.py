...
class Clutch(_2580.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self: Self) -> "_1562.GriddedSurfaceAccessor":
    ...
    @property
    def clutch_type(self: Self) -> "_2577.ClutchType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2577", "ClutchType"
        )(value)

    @clutch_type.setter
    @enforce_parameter_types
    def clutch_type(self: Self, value: "_2577.ClutchType"):
    ...
    @property
    def flow_rate_vs_speed(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def flow_rate_vs_speed(self: Self, value: "_1531.Vector2DListAccessor"):
    ...
    @property
    def linear_speed_temperature_grid(self: Self) -> "_1562.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def spring_type(self: Self) -> "_5398.ClutchSpringType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5398",
            "ClutchSpringType",
        )(value)

    @spring_type.setter
    @enforce_parameter_types
    def spring_type(self: Self, value: "_5398.ClutchSpringType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType",
        )
    ...
    @property
    def clutch_connection(self: Self) -> "_2339.ClutchConnection":

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2574, _2587
...
class BeltDrive(_2473.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: Self) -> "_2574.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2574", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: Self, value: "_2574.BeltDriveType"):
    ...
    @property
    def belt_connections(self: Self) -> "List[_2265.BeltConnection]":
    ...
    @property
    def pulleys(self: Self) -> "List[_2587.Pulley]":

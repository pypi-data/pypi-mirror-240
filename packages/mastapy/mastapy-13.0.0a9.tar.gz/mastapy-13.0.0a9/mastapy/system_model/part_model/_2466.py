...
class PlanetCarrier(_2461.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def load_sharing_settings(self: Self) -> "_2458.LoadSharingSettings":
    ...
    @property
    def planetary_sockets(self: Self) -> "List[_2285.PlanetarySocket]":

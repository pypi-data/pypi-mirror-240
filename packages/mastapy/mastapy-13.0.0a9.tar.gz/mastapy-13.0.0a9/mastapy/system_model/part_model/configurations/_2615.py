...
class PartDetailSelection(_0.APIBase, Generic[TPart, TSelectableItem]):
    ...
    class _Cast_PartDetailSelection:
        ...
        def active_cylindrical_gear_set_design_selection(
            ...
            return self._parent._cast(_2507.ActiveCylindricalGearSetDesignSelection)
        ...
        def active_gear_set_design_selection(
            ...
            return self._parent._cast(_2508.ActiveGearSetDesignSelection)

        @property
        def active_fe_substructure_selection(
            self: "PartDetailSelection._Cast_PartDetailSelection",
        ):
            from mastapy.system_model.part_model.configurations import _2608

            return self._parent._cast(_2608.ActiveFESubstructureSelection)
        ...
        def active_shaft_design_selection(
            ...
            return self._parent._cast(_2610.ActiveShaftDesignSelection)
        ...
        def bearing_detail_selection(
            ...
            return self._parent._cast(_2613.BearingDetailSelection)

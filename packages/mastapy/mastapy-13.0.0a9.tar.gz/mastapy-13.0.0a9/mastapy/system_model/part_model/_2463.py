...
class OilSeal(_2444.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @property
    def oil_seal_orientation(self: Self) -> "_1957.Orientations":
    ...
    @enforce_parameter_types
    def oil_seal_orientation(self: Self, value: "_1957.Orientations"):
        value = conversion.mp_to_pn_enum(

...
class ParallelPartGroupSelection(_2487.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    class _Cast_ParallelPartGroupSelection:
        ...
        def parallel_part_group(
            ...
            return self._parent._cast(_2487.ParallelPartGroup)
    ...
    @property
    def design_measurements(self: Self) -> "List[_2486.DesignMeasurements]":

...
from mastapy.system_model.part_model import _2452, _2432
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2453, _2461
...
class Shaft(_2432.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: Self, value: "_2452.GuideDxfModel"):
        wrapper_type = (
    ...
    @property
    def guide_image(self: Self) -> "_2453.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: Self) -> "_2380.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: Self, component: "_2461.MountableComponent", offset: "float"
    ):
        """Method does not return.

...
class ConnectorFromCAD(_2501.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self: Self) -> "_2500.HousedOrMounted":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.import_from_cad._2500", "HousedOrMounted"
        )(value)

    @mounting.setter
    @enforce_parameter_types
    def mounting(self: Self, value: "_2500.HousedOrMounted"):

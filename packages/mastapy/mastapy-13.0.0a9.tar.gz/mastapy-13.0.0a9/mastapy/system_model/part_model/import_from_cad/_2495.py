...
from mastapy.system_model.part_model.gears import _2523, _2522
...
class CylindricalGearFromCAD(_2501.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: Self, value: "_2523.CylindricalGearSet"):
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: Self, value: "_2522.CylindricalGear"):
        wrapper_type = (

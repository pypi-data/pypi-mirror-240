...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: Self) -> "_1485.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: Self, value: "_1485.Range"):
        self.wrapped.FilteringFrequencyRange = value

    @property
    def filtering_method(self: Self) -> "_5846.ModalContributionFilteringMethod":
    ...
    @enforce_parameter_types
    def filtering_method(self: Self, value: "_5846.ModalContributionFilteringMethod"):
    ...
    @property
    def frequency_range(self: Self) -> "_1485.Range":
        """mastapy.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: Self, value: "_1485.Range"):
    ...
    @property
    def index_range(self: Self) -> "_1585.IntegerRange":
    ...
    @index_range.setter
    @enforce_parameter_types
    def index_range(self: Self, value: "_1585.IntegerRange"):
        self.wrapped.IndexRange = value

    @property
    def modes_to_display(self: Self) -> "_5845.ModalContributionDisplayMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5845",
            "ModalContributionDisplayMethod",
        )(value)

    @modes_to_display.setter
    @enforce_parameter_types
    def modes_to_display(self: Self, value: "_5845.ModalContributionDisplayMethod"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
        )

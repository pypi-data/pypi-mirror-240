...
class ContourDrawStyle(_306.DrawStyleBase):
    ...
    class _Cast_ContourDrawStyle:
        ...
        def system_deflection_draw_style(
            ...
            return self._parent._cast(_2823.SystemDeflectionDrawStyle)
        ...
        def steady_state_synchronous_response_draw_style(
            ...
            return self._parent._cast(_3087.SteadyStateSynchronousResponseDrawStyle)
        ...
        def stability_analysis_draw_style(
            ...
            return self._parent._cast(_3868.StabilityAnalysisDrawStyle)

        @property
        def rotor_dynamics_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4023

            return self._parent._cast(_4023.RotorDynamicsDrawStyle)
        ...
        def modal_analysis_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            ...
            return self._parent._cast(_4652.ModalAnalysisDrawStyle)
        ...
        def mbd_analysis_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            ...
            return self._parent._cast(_5456.MBDAnalysisDrawStyle)
        ...
        def harmonic_analysis_draw_style(
            ...
            return self._parent._cast(_5758.HarmonicAnalysisDrawStyle)
        ...
        def dynamic_analysis_draw_style(
            ...
            return self._parent._cast(_6326.DynamicAnalysisDrawStyle)
        ...
        def critical_speed_analysis_draw_style(
            ...
            return self._parent._cast(_6580.CriticalSpeedAnalysisDrawStyle)
    ...
    @property
    def contour(self: Self) -> "_1818.ThreeDViewContourOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.enums._1818", "ThreeDViewContourOption"
        )(value)

    @contour.setter
    @enforce_parameter_types
    def contour(self: Self, value: "_1818.ThreeDViewContourOption"):
    ...
    @property
    def deflection_scaling(self: Self) -> "_1848.ScalingDrawStyle":
    ...
    @property
    def model_view_options(self: Self) -> "_2249.ModelViewOptionsDrawStyle":

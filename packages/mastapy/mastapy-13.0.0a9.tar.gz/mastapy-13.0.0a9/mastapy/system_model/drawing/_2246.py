...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5675, _5766
...
from mastapy.system_model.drawing.options import _2259
...
class HarmonicAnalysisViewable(_2245.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    class _Cast_HarmonicAnalysisViewable:
        ...
        def dynamic_analysis_viewable(
            ...
            return self._parent._cast(_2245.DynamicAnalysisViewable)
        ...
        def part_analysis_case_with_contour_viewable(
            ...
            return self._parent._cast(_2250.PartAnalysisCaseWithContourViewable)
    ...
    def excitation(self: Self, value: "_5675.AbstractPeriodicExcitationDetail"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: Self, value: "_5766.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ):
        wrapper_type = (
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: Self, value: "_1525.RoundedOrder"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: Self, value: "_2756.GearMeshSystemDeflection"):
        wrapper_type = (
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: Self, value: "_2259.ExcitationAnalysisViewOption"):
    ...
    @property
    def dynamic_analysis_draw_style(self: Self) -> "_6326.DynamicAnalysisDrawStyle":

...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5666, _5665
    from mastapy.system_model.optimization.system_optimiser import _2235, _2234
...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        self: Self, value: "_5666.SystemOptimiserTargets"
    ):
    ...
    @property
    def gear_set_optimisation(self: Self) -> "_5665.SystemOptimiserGearSetOptimisation":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.load_case_groups._5665",
    ...
    def gear_set_optimisation(
        self: Self, value: "_5665.SystemOptimiserGearSetOptimisation"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.LoadCaseGroups.SystemOptimiserGearSetOptimisation",
    ...
    @property
    def planet_gear_options(self: Self) -> "List[_2235.PlanetGearOptions]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.optimization.system_optimiser import _2237, _2238, _2234
    from mastapy.utility.logging import _1805
    from mastapy.system_model.part_model.gears import _2523, _2529
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(self: Self, value: "_5660.DutyCycle"):
        wrapper_type = (
    ...
    @property
    def design(self: Self) -> "_2197.Design":
    ...
    @property
    def details(self: Self) -> "_2237.SystemOptimiserDetails":
    ...
    @property
    def log(self: Self) -> "_1805.Logger":
    ...
    @property
    def tooth_number_finder(self: Self) -> "_2238.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: Self,
    ) -> "List[_5664.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: Self) -> "List[_2234.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: Self) -> "_5660.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: Self, value: "_5660.DutyCycle"):
        self.wrapped.SystemOptimiserDutyCycle = value

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6881, _6882
...
class FaceGearSetLoadCase(_6892.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6881.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: Self) -> "List[_6881.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def face_meshes_load_case(self: Self) -> "List[_6882.FaceGearMeshLoadCase]":

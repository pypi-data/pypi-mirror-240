...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6801, _6862
...
class RootAssemblyLoadCase(_6815.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: Self) -> "_1573.PIDControlSettings":
    ...
    @property
    def supercharger_rotor_sets(self: Self) -> "List[_6862.CylindricalGearSetLoadCase]":

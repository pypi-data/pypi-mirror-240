...
class ZerolBevelGearSetLoadCase(_6826.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6982.ZerolBevelGearLoadCase]":
    ...
    @property
    def zerol_bevel_gears_load_case(self: Self) -> "List[_6982.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def zerol_bevel_meshes_load_case(
        self: Self,
    ) -> "List[_6983.ZerolBevelGearMeshLoadCase]":

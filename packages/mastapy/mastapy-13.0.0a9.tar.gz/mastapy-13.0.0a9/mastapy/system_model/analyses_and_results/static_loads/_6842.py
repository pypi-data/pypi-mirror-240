...
class ConicalGearManufactureError(_6888.GearManufactureError):
    """ConicalGearManufactureError
    ...
    class _Cast_ConicalGearManufactureError:
        ...
        def gear_manufacture_error(
            ...
            return self._parent._cast(_6888.GearManufactureError)
    ...
    @property
    def pitch_errors_concave_flank(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_concave_flank(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.PitchErrorsConcaveFlank = value

    @property
    def pitch_errors_convex_flank(self: Self) -> "_1531.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_convex_flank(self: Self, value: "_1531.Vector2DListAccessor"):

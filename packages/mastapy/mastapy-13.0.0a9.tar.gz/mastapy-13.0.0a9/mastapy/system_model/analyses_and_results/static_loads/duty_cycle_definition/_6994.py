...
from mastapy.utility_gui import _1844
...
class PointLoadInputOptions(_1844.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    class _Cast_PointLoadInputOptions:
        ...
        def column_input_options(
            ...
            return self._parent._cast(_1844.ColumnInputOptions)
    ...
    def axis(self: Self, value: "_1488.Axis"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self: Self) -> "_6985.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition._6985",
    ...
    def conversion_to_load_case(
        self: Self, value: "_6985.AdditionalForcesObtainedFrom"
    ):
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: Self, value: "_2468.PointLoad"):
        wrapper_type = (

...
if TYPE_CHECKING:
    from mastapy.math_utility import _1500, _1509
...
class PointLoadHarmonicLoadData(_1379.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: Self) -> "_1500.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1500", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1500.DegreeOfFreedom"):

...
from mastapy.bearings.bearing_results.rolling import _1963, _1964, _1969, _2066
from mastapy.materials.efficiency import _290
from mastapy.system_model.part_model import _2437
from mastapy.math_utility.hertzian_contact import _1570
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.dysla import _2111
    from mastapy.bearings.bearing_results.rolling import _2067
    from mastapy.bearings.tolerances import _1911, _1917
...
class BearingLoadCase(_6847.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @enforce_parameter_types
    def ball_bearing_analysis_method(
        self: Self, value: "_1963.BallBearingAnalysisMethod"
    ):
    ...
    def ball_bearing_contact_calculation(
        self: Self,
        value: "Union[_1964.BallBearingContactCalculation, Tuple[_1964.BallBearingContactCalculation, bool]]",
    ):
        wrapper_type = (
    ...
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self,
        value: "Union[_1969.FrictionModelForGyroscopicMoment, Tuple[_1969.FrictionModelForGyroscopicMoment, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def bearing_stiffness_model(self: Self) -> "_5382.BearingStiffnessModel":
    ...
    @enforce_parameter_types
    def bearing_stiffness_model(self: Self, value: "_5382.BearingStiffnessModel"):
    ...
    def force_at_zero_displacement_input_method(
        self: Self,
        value: "Union[_2437.BearingF0InputMethod, Tuple[_2437.BearingF0InputMethod, bool]]",
    ):
    ...
    @enforce_parameter_types
    def hertzian_contact_deflection_calculation_method(
        self: Self, value: "_1570.HertzianContactDeflectionCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def include_fitting_effects(self: Self) -> "_1586.LoadCaseOverrideOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility._1586", "LoadCaseOverrideOption"
        )(value)

    @include_fitting_effects.setter
    @enforce_parameter_types
    def include_fitting_effects(self: Self, value: "_1586.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def include_ring_ovality(self: Self) -> "_1586.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    @enforce_parameter_types
    def include_ring_ovality(self: Self, value: "_1586.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    @property
    def include_thermal_expansion_effects(self: Self) -> "_1586.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    def include_thermal_expansion_effects(
        self: Self, value: "_1586.LoadCaseOverrideOption"
    ):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    def roller_analysis_method(
        self: Self,
        value: "Union[_2066.RollerAnalysisMethod, Tuple[_2066.RollerAnalysisMethod, bool]]",
    ):
    ...
    @property
    def dynamic_analysis_options(self: Self) -> "_2111.DynamicBearingAnalysisOptions":
    ...
    @property
    def inner_ring_detail(self: Self) -> "_1911.RaceDetail":
    ...
    @property
    def left_ring_detail(self: Self) -> "_1911.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def outer_ring_detail(self: Self) -> "_1911.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def right_ring_detail(self: Self) -> "_1911.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail

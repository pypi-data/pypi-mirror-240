...
class TorqueInputOptions(_6995.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self: Self) -> "_7001.TorqueValuesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition._7001",
            "TorqueValuesObtainedFrom",
        )(value)

    @conversion_to_load_case.setter
    @enforce_parameter_types
    def conversion_to_load_case(self: Self, value: "_7001.TorqueValuesObtainedFrom"):

...
class HarmonicLoadDataFluxImport(
    ...
    @property
    def inner_diameter_reference(self: Self) -> "_6907.InnerDiameterReference":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6907",
            "InnerDiameterReference",
        )(value)

    @inner_diameter_reference.setter
    @enforce_parameter_types
    def inner_diameter_reference(self: Self, value: "_6907.InnerDiameterReference"):

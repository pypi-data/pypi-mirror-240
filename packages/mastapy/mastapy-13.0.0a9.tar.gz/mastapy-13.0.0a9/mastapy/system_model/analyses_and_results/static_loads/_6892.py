...
from mastapy.system_model.analyses_and_results.static_loads import _6920, _6949
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6887, _6889
...
class GearSetLoadCase(_6949.SpecialisedAssemblyLoadCase):
    """GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self: Self) -> "_5434.GearMeshStiffnessModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5434",
    ...
    def mesh_stiffness_source(
        self: Self,
        value: "Union[_6920.MeshStiffnessSource, Tuple[_6920.MeshStiffnessSource, bool]]",
    ):
    ...
    @property
    def gears(self: Self) -> "List[_6887.GearLoadCase]":
    ...
    @property
    def gears_without_clones(self: Self) -> "List[_6887.GearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.GearLoadCase]

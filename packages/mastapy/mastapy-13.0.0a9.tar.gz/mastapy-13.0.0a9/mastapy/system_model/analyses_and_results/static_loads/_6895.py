...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6865, _6877
...
class HarmonicLoadDataCSVImport(_6899.HarmonicLoadDataImportFromMotorPackages[T]):
    """HarmonicLoadDataCSVImport
    ...
    class _Cast_HarmonicLoadDataCSVImport:
        ...
        def harmonic_load_data_import_from_motor_packages(
            ...
            return self._parent._cast(_6899.HarmonicLoadDataImportFromMotorPackages)
        ...
        def harmonic_load_data_import_base(
            ...
            return self._parent._cast(_6898.HarmonicLoadDataImportBase)
        ...
        def harmonic_load_data_flux_import(
            ...
            return self._parent._cast(_6897.HarmonicLoadDataFluxImport)
        ...
        def harmonic_load_data_jmag_import(
            ...
            return self._parent._cast(_6900.HarmonicLoadDataJMAGImport)
    ...
    def electric_machine_data_per_speed(
        self: Self,
    ) -> "List[_6865.DataFromMotorPackagePerSpeed]":

...
class AssemblyLoadCase(_6803.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: Self) -> "List[_6816.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6818.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6821.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6827.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: Self) -> "List[_6828.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6852.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: Self) -> "List[_6829.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: Self) -> "List[_6831.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6837.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6840.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_6854.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6856.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_6862.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6884.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6883.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6885.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: Self) -> "List[_6889.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6904.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6914.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6917.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6918.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6919.MeasurementComponentLoadCase]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6923.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6928.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6932.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6935.PointLoadLoadCase]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6936.PowerLoadLoadCase]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6940.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: Self,
    ) -> "List[_6941.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6942.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_6946.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: Self) -> "List[_6947.ShaftLoadCase]":
    ...
    @property
    def shafts_and_housings(self: Self) -> "List[_6805.AbstractShaftOrHousingLoadCase]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_6952.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6955.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6958.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6961.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6965.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6970.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6977.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6981.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_6984.ZerolBevelGearSetLoadCase]":

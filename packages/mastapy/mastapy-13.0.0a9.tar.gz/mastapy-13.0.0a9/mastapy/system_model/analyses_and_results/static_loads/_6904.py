...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6902, _6903
...
class HypoidGearSetLoadCase(_6812.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6902.HypoidGearLoadCase]":
    ...
    @property
    def hypoid_gears_load_case(self: Self) -> "List[_6902.HypoidGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearLoadCase]
    ...
    @property
    def hypoid_meshes_load_case(self: Self) -> "List[_6903.HypoidGearMeshLoadCase]":

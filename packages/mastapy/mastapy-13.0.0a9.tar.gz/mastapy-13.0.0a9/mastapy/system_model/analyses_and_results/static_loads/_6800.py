...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1964, _2066
    from mastapy.system_model import _2207, _2221
...
class LoadCase(_2647.Context):
    ...
    def ball_bearing_contact_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results.rolling._1964",
    ...
    @enforce_parameter_types
    def ball_bearing_contact_calculation(
        self: Self, value: "_1964.BallBearingContactCalculation"
    ):
    ...
    @enforce_parameter_types
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self, value: "_1969.FrictionModelForGyroscopicMoment"
    ):
    ...
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2207", "HypoidWindUpRemovalMethod"
        )(value)

    @hypoid_gear_wind_up_removal_method_for_misalignments.setter
    @enforce_parameter_types
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: Self, value: "_2207.HypoidWindUpRemovalMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def mesh_stiffness_model(self: Self, value: "_2211.MeshStiffnessModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def roller_analysis_method(self: Self) -> "_2066.RollerAnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results.rolling._2066", "RollerAnalysisMethod"
        )(value)

    @roller_analysis_method.setter
    @enforce_parameter_types
    def roller_analysis_method(self: Self, value: "_2066.RollerAnalysisMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def stress_concentration_method_for_rating(
        self: Self, value: "_2106.StressConcentrationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def additional_acceleration(self: Self) -> "_6807.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: Self) -> "_6936.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: Self) -> "_6936.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    @property
    def parametric_study_tool_options(self: Self) -> "_4385.ParametricStudyToolOptions":
    ...
    @property
    def temperatures(self: Self) -> "_2221.TransmissionTemperatureSet":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: Self, design_entity: "_2583.CVT") -> "_6852.CVTLoadCase":

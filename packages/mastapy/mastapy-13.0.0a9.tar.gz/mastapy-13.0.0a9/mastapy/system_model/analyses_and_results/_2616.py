...
class CompoundAnalysis(_7549.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    class _Cast_CompoundAnalysis:
        ...
        def compound_advanced_system_deflection_analysis(
            ...
            return self._parent._cast(_2655.CompoundAdvancedSystemDeflectionAnalysis)
        ...
        def compound_advanced_system_deflection_sub_analysis(
            ...
            return self._parent._cast(_2656.CompoundAdvancedSystemDeflectionSubAnalysis)
        ...
        def compound_critical_speed_analysis(
            ...
            return self._parent._cast(_2658.CompoundCriticalSpeedAnalysis)

        @property
        def compound_dynamic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            from mastapy.system_model.analyses_and_results import _2659

            return self._parent._cast(_2659.CompoundDynamicAnalysis)
        ...
        def compound_dynamic_model_at_a_stiffness_analysis(
            ...
            return self._parent._cast(_2660.CompoundDynamicModelAtAStiffnessAnalysis)
        ...
        def compound_dynamic_model_for_harmonic_analysis(
            ...
            return self._parent._cast(_2661.CompoundDynamicModelForHarmonicAnalysis)
        ...
        def compound_dynamic_model_for_modal_analysis(
            ...
            return self._parent._cast(_2662.CompoundDynamicModelForModalAnalysis)
        ...
        def compound_dynamic_model_for_stability_analysis(
            ...
            return self._parent._cast(_2663.CompoundDynamicModelForStabilityAnalysis)
        ...
        def compound_harmonic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            ...
            return self._parent._cast(_2665.CompoundHarmonicAnalysis)
        ...
        def compound_harmonic_analysis_for_advanced_time_stepping_analysis_for_modulation(
            ...
            return self._parent._cast(
                _2666.CompoundHarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
            )
        ...
        def compound_modal_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            ...
            return self._parent._cast(_2668.CompoundModalAnalysis)
        ...
        def compound_modal_analysis_at_a_speed(
            ...
            return self._parent._cast(_2669.CompoundModalAnalysisAtASpeed)
        ...
        def compound_modal_analysis_at_a_stiffness(
            ...
            return self._parent._cast(_2670.CompoundModalAnalysisAtAStiffness)
        ...
        def compound_modal_analysis_for_harmonic_analysis(
            ...
            return self._parent._cast(_2671.CompoundModalAnalysisForHarmonicAnalysis)
        ...
        def compound_multibody_dynamics_analysis(
            ...
            return self._parent._cast(_2672.CompoundMultibodyDynamicsAnalysis)
        ...
        def compound_power_flow_analysis(
            ...
            return self._parent._cast(_2673.CompoundPowerFlowAnalysis)
        ...
        def compound_stability_analysis(
            ...
            return self._parent._cast(_2674.CompoundStabilityAnalysis)
        ...
        def compound_system_deflection_analysis(
            ...
            return self._parent._cast(_2678.CompoundSystemDeflectionAnalysis)
        ...
        def compound_torsional_system_deflection_analysis(
            ...
            return self._parent._cast(_2679.CompoundTorsionalSystemDeflectionAnalysis)
    ...
    def perform_analysis_with_progress(self: Self, progress: "_7555.TaskProgress"):
        """Method does not return.
    ...
    ) -> "Iterable[_7539.DesignEntityCompoundAnalysis]":

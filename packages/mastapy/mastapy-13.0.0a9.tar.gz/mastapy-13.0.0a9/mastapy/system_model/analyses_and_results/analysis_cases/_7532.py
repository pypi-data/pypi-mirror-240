...
T = TypeVar("T", bound="_6800.LoadCase")
...
class AbstractAnalysisOptions(_0.APIBase, Generic[T]):
    ...
    class _Cast_AbstractAnalysisOptions:
        ...
        def system_deflection_options(
            ...
            return self._parent._cast(_2824.SystemDeflectionOptions)
        ...
        def frequency_response_analysis_options(
            ...
            return self._parent._cast(_4630.FrequencyResponseAnalysisOptions)
        ...
        def mbd_run_up_analysis_options(
            ...
            return self._parent._cast(_5458.MBDRunUpAnalysisOptions)
        ...
        def frequency_options_for_harmonic_analysis_results(
            ...
            return self._parent._cast(_5748.FrequencyOptionsForHarmonicAnalysisResults)
        ...
        def speed_options_for_harmonic_analysis_results(
            ...
            return self._parent._cast(_5807.SpeedOptionsForHarmonicAnalysisResults)
        ...
        def stiffness_options_for_harmonic_analysis(
            ...
            return self._parent._cast(_5814.StiffnessOptionsForHarmonicAnalysis)

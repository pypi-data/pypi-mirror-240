...
class ConceptGearSetModalAnalysisAtASpeed(_5173.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    def concept_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5143.ConceptGearModalAnalysisAtASpeed]":
    ...
    def concept_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5142.ConceptGearMeshModalAnalysisAtASpeed]":

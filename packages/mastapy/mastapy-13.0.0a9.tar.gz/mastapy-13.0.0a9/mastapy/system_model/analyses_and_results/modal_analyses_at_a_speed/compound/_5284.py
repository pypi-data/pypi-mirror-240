...
class CVTCompoundModalAnalysisAtASpeed(_5253.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5154.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5154.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]

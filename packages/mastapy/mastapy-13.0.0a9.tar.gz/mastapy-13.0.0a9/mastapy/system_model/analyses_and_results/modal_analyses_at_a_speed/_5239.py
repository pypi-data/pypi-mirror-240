...
class WormGearSetModalAnalysisAtASpeed(_5173.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    def worm_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5238.WormGearModalAnalysisAtASpeed]":
    ...
    def worm_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5237.WormGearMeshModalAnalysisAtASpeed]":

...
class FaceGearSetCriticalSpeedAnalysis(_6602.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    def face_gears_critical_speed_analysis(
        self: Self,
    ) -> "List[_6595.FaceGearCriticalSpeedAnalysis]":
    ...
    def face_meshes_critical_speed_analysis(
        self: Self,
    ) -> "List[_6596.FaceGearMeshCriticalSpeedAnalysis]":

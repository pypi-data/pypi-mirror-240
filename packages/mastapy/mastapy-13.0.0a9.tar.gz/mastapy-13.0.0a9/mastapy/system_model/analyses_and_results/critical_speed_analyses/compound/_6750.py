...
class PartCompoundCriticalSpeedAnalysis(_7542.PartCompoundAnalysis):
    """PartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6621.PartCriticalSpeedAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6621.PartCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.PartCriticalSpeedAnalysis]

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5767, _5768
...
class HypoidGearSetHarmonicAnalysis(_5681.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5767.HypoidGearHarmonicAnalysis]":
    ...
    def hypoid_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5767.HypoidGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.HypoidGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5768.HypoidGearMeshHarmonicAnalysis]":

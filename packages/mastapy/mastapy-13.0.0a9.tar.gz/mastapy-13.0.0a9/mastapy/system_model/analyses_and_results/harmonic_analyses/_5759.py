...
TPart = TypeVar("TPart", bound="_2465.Part")
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    class _Cast_HarmonicAnalysisExportOptions:
        ...
        def harmonic_analysis_fe_export_options(
            ...
            return self._parent._cast(_5760.HarmonicAnalysisFEExportOptions)
        ...
        def harmonic_analysis_root_assembly_export_options(
            ...
            return self._parent._cast(_5763.HarmonicAnalysisRootAssemblyExportOptions)
        ...
        def harmonic_analysis_shaft_export_options(
            ...
            return self._parent._cast(_5764.HarmonicAnalysisShaftExportOptions)
    ...
    def distance_units_for_export(self: Self, value: "_1607.Unit"):
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: Self, value: "_5741.ExportOutputType"):
    ...
    @enforce_parameter_types
    def type_of_result_to_export(self: Self, value: "_4623.DynamicsResponseType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def analysis_options(self: Self) -> "_5762.HarmonicAnalysisOptions":

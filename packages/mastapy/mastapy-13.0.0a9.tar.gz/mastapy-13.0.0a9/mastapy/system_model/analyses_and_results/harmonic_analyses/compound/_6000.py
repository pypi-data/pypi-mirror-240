...
class WormGearSetCompoundHarmonicAnalysis(_5935.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5836.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5998.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5999.WormGearMeshCompoundHarmonicAnalysis]":

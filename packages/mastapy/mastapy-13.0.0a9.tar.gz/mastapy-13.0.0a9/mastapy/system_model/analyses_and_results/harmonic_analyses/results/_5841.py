...
class ExcitationSourceSelection(_5842.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self: Self) -> "List[_5844.HarmonicSelection]":
    ...
    def include_only_harmonic_with_order(
        self: Self, order: "_1525.RoundedOrder"
    ) -> "bool":
        """bool

...
class GuideDxfModelHarmonicAnalysis(_5701.ComponentHarmonicAnalysis):
    """GuideDxfModelHarmonicAnalysis
    ...
    @property
    def component_design(self: Self) -> "_2452.GuideDxfModel":
    ...
    @property
    def component_load_case(self: Self) -> "_6893.GuideDxfModelLoadCase":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2759.GuideDxfModelSystemDeflection":

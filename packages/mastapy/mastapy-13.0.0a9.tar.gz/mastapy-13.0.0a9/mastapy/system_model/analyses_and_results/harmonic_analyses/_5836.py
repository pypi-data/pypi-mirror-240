...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5834, _5835
...
class WormGearSetHarmonicAnalysis(_5754.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5834.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5834.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5835.WormGearMeshHarmonicAnalysis]":

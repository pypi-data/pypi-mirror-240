...
class FEPartHarmonicAnalysis(_5677.AbstractShaftOrHousingHarmonicAnalysis):
    """FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4628.FEPartModalAnalysis":
    ...
    @property
    def export(self: Self) -> "_5760.HarmonicAnalysisFEExportOptions":
    ...
    @property
    def results(self: Self) -> "_5853.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2754.FEPartSystemDeflection":

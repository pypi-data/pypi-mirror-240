...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5808, _5809
...
class SpiralBevelGearSetHarmonicAnalysis(_5693.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5808.SpiralBevelGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5809.SpiralBevelGearMeshHarmonicAnalysis]":

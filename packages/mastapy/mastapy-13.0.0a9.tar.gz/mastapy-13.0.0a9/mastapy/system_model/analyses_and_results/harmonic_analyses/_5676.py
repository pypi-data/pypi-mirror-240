...
class AbstractShaftHarmonicAnalysis(_5677.AbstractShaftOrHousingHarmonicAnalysis):
    """AbstractShaftHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2684.AbstractShaftSystemDeflection":

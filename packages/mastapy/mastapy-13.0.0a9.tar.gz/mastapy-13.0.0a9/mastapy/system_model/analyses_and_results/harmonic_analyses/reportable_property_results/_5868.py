...
class ResultsForOrderIncludingSurfaces(_5867.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    class _Cast_ResultsForOrderIncludingSurfaces:
        ...
        def results_for_order_including_nodes(
            ...
            return self._parent._cast(_5867.ResultsForOrderIncludingNodes)
        ...
        def results_for_order(
            ...
            return self._parent._cast(_5865.ResultsForOrder)
    ...
    def fe_surfaces(
        self: Self,
    ) -> "List[_5860.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":

...
class CVTCompoundHarmonicAnalysis(_5885.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_5717.CVTHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5717.CVTHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.CVTHarmonicAnalysis]

...
class GearMeshExcitationDetail(_5675.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    class _Cast_GearMeshExcitationDetail:
        ...
        def abstract_periodic_excitation_detail(
            ...
            return self._parent._cast(_5675.AbstractPeriodicExcitationDetail)
    ...
    @property
    def gear_mesh(self: Self) -> "_2756.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5700.ComplianceAndForceData":

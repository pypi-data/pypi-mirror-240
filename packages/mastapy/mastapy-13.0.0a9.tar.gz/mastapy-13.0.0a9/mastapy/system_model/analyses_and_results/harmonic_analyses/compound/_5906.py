...
class ConceptGearSetCompoundHarmonicAnalysis(_5935.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5707.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5904.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5905.ConceptGearMeshCompoundHarmonicAnalysis]":

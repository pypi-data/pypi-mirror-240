...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5386, _5385
...
class BevelDifferentialGearSetMultibodyDynamicsAnalysis(
    ...
    def gears(
        self: Self,
    ) -> "List[_5386.BevelDifferentialGearMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5385.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]":

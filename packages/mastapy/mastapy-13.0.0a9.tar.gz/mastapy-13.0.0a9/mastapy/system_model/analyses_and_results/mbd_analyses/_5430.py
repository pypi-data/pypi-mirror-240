...
class FaceGearSetMultibodyDynamicsAnalysis(_5436.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self: Self) -> "List[_5429.FaceGearMultibodyDynamicsAnalysis]":
    ...
    def face_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5429.FaceGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.FaceGearMultibodyDynamicsAnalysis]
    ...
    def face_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5428.FaceGearMeshMultibodyDynamicsAnalysis]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5423, _5422
...
class CylindricalGearSetMultibodyDynamicsAnalysis(
    ...
    @property
    def gears(self: Self) -> "List[_5423.CylindricalGearMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5423.CylindricalGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.CylindricalGearMultibodyDynamicsAnalysis]
    ...
    def cylindrical_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5422.CylindricalGearMeshMultibodyDynamicsAnalysis]":

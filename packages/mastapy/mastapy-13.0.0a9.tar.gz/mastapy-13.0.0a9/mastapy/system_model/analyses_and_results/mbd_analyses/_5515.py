...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5514, _5513
...
class WormGearSetMultibodyDynamicsAnalysis(_5436.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self: Self) -> "List[_5514.WormGearMultibodyDynamicsAnalysis]":
    ...
    def worm_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5514.WormGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.WormGearMultibodyDynamicsAnalysis]
    ...
    def worm_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5513.WormGearMeshMultibodyDynamicsAnalysis]":

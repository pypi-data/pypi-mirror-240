...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5450, _5449
...
class KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis(
    ...
    def gears(
        self: Self,
    ) -> "List[_5450.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5449.KlingelnbergCycloPalloidHypoidGearMeshMultibodyDynamicsAnalysis]":

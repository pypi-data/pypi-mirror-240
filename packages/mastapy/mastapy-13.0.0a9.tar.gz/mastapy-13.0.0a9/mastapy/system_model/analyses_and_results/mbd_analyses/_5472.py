...
class PulleyMultibodyDynamicsAnalysis(_5413.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self: Self) -> "List[_5522.DynamicTorqueResultAtTime]":

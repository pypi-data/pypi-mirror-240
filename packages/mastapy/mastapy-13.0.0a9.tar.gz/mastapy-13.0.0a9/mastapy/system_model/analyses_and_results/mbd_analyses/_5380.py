...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: Self) -> "List[_5381.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5384.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5393.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5394.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5416.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5397.ClutchMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5403.ConceptCouplingMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5406.ConceptGearSetMultibodyDynamicsAnalysis]":
    ...
    def connections(
        self: Self,
    ) -> "List[_5445.InterMountableComponentConnectionMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5418.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5420.CycloidalDiscMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5424.CylindricalGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5431.FEPartMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5430.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5432.FlexiblePinAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_5436.GearSetMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5440.HypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5451.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5454.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5455.MassDiscMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5459.MeasurementComponentMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5462.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5466.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5469.PlanetCarrierMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5470.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5471.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5473.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5475.RollingRingAssemblyMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5481.ShaftHubConnectionMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5482.ShaftMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5488.SpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5491.SpringDamperMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5494.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5497.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5501.SynchroniserMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5506.TorqueConverterMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5510.UnbalancedMassMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5515.WormGearSetMultibodyDynamicsAnalysis]":

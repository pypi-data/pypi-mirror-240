...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5439, _5438
...
class HypoidGearSetMultibodyDynamicsAnalysis(
    ...
    @property
    def gears(self: Self) -> "List[_5439.HypoidGearMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5439.HypoidGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.HypoidGearMultibodyDynamicsAnalysis]
    ...
    def hypoid_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5438.HypoidGearMeshMultibodyDynamicsAnalysis]":

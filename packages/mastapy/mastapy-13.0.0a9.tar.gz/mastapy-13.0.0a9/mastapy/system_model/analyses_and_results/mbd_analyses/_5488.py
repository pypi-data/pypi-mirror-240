...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5487, _5486
...
class SpiralBevelGearSetMultibodyDynamicsAnalysis(
    ...
    @property
    def gears(self: Self) -> "List[_5487.SpiralBevelGearMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5487.SpiralBevelGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.SpiralBevelGearMultibodyDynamicsAnalysis]
    ...
    def spiral_bevel_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5486.SpiralBevelGearMeshMultibodyDynamicsAnalysis]":

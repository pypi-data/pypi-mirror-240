...
class ConceptGearSetModalAnalysisAtAStiffness(_4914.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    def concept_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4883.ConceptGearModalAnalysisAtAStiffness]":
    ...
    def concept_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4882.ConceptGearMeshModalAnalysisAtAStiffness]":

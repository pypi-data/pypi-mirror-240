...
class FaceGearSetModalAnalysisAtAStiffness(_4914.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    def face_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4908.FaceGearModalAnalysisAtAStiffness]":
    ...
    def face_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4907.FaceGearMeshModalAnalysisAtAStiffness]":

...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4884.ConceptGearSetModalAnalysisAtAStiffness]":
    ...
    def concept_gears_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5013.ConceptGearCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_meshes_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5014.ConceptGearMeshCompoundModalAnalysisAtAStiffness]":

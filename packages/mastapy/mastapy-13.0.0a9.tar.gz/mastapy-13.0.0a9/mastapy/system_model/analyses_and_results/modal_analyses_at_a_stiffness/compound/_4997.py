...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4866.BevelDifferentialGearSetModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4995.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4996.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]":

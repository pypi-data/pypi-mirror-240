...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2601, _2603
...
class SynchroniserShift(_0.APIBase):
    ...
    @enforce_parameter_types
    def final_design_state(self: Self, value: "_5659.DesignState"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def initial_design_state(self: Self, value: "_5659.DesignState"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_DesignState.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def cone(self: Self) -> "_2601.SynchroniserHalf":
    ...
    @property
    def sleeve(self: Self) -> "_2603.SynchroniserSleeve":

...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis import _1793
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2649.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: Self,
    ) -> "List[_1793.DesignEntityExcitationDescription]":

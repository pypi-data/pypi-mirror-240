...
class WormGearSetCompoundModalAnalysis(_4784.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4708.WormGearSetModalAnalysis]":
    ...
    def worm_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4847.WormGearCompoundModalAnalysis]":
    ...
    def worm_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4848.WormGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4708.WormGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearSetModalAnalysis]

...
class SingleExcitationResultsModalAnalysis(_4715.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def design_entity_modal_analysis_group_results(
            ...
            return self._parent._cast(_4715.DesignEntityModalAnalysisGroupResults)
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4718.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):

...
class RootAssemblyCompoundModalAnalysis(_4731.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4673.RootAssemblyModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4673.RootAssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RootAssemblyModalAnalysis]

...
class OilSealCompoundModalAnalysis(_4760.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4656.OilSealModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4656.OilSealModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.OilSealModalAnalysis]

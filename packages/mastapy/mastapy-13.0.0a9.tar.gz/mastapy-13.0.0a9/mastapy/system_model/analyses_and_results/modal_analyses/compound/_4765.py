...
class CVTCompoundModalAnalysis(_4734.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4610.CVTModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4610.CVTModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTModalAnalysis]

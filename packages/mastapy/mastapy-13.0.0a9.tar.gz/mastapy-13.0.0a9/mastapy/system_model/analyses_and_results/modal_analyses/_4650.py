...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses import _4653, _4651
...
class ModalAnalysis(_7546.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    def analysis_settings(self: Self) -> "_4653.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: Self) -> "_4651.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: Self) -> "_6325.DynamicAnalysis":

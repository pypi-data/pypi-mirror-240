...
class PointLoadCompoundModalAnalysis(_4846.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4665.PointLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4665.PointLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PointLoadModalAnalysis]

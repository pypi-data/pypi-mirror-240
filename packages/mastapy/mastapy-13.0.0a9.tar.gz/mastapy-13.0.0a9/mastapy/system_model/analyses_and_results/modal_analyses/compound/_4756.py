...
class ConicalGearCompoundModalAnalysis(_4782.GearCompoundModalAnalysis):
    """ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4601.ConicalGearModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4601.ConicalGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConicalGearModalAnalysis]

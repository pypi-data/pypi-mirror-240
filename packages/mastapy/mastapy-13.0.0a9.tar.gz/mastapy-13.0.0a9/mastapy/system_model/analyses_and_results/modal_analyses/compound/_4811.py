...
class PowerLoadCompoundModalAnalysis(_4846.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4666.PowerLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4666.PowerLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PowerLoadModalAnalysis]

...
class FaceGearCompoundModalAnalysis(_4782.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4626.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4626.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]

...
class CouplingHalfCompoundModalAnalysis(_4801.MountableComponentCompoundModalAnalysis):
    """CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4607.CouplingHalfModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4607.CouplingHalfModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CouplingHalfModalAnalysis]

...
class StraightBevelGearSetModalAnalysis(_4586.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    def straight_bevel_gears_modal_analysis(
        self: Self,
    ) -> "List[_4689.StraightBevelGearModalAnalysis]":
    ...
    def straight_bevel_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4688.StraightBevelGearMeshModalAnalysis]":

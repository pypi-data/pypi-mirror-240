...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4707, _4706
...
class WormGearSetModalAnalysis(_4633.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self: Self) -> "List[_4707.WormGearModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4706.WormGearMeshModalAnalysis]":

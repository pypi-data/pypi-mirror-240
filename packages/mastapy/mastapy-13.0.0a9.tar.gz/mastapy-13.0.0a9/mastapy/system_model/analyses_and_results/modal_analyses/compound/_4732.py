...
class BearingCompoundModalAnalysis(_4760.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4576.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4576.BearingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]

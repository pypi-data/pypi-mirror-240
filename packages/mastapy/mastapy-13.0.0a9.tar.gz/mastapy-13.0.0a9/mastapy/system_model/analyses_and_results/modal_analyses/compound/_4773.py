...
class CylindricalGearSetCompoundModalAnalysis(_4784.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4771.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4772.CylindricalGearMeshCompoundModalAnalysis]":

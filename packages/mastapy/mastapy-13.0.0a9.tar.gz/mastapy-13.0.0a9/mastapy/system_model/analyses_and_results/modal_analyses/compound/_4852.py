...
class ZerolBevelGearSetCompoundModalAnalysis(_4742.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    def zerol_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4850.ZerolBevelGearCompoundModalAnalysis]":
    ...
    def zerol_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4851.ZerolBevelGearMeshCompoundModalAnalysis]":

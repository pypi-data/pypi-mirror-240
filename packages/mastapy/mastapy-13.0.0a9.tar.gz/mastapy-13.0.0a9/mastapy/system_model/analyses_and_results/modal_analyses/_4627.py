...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4626, _4625
...
class FaceGearSetModalAnalysis(_4633.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self: Self) -> "List[_4626.FaceGearModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4625.FaceGearMeshModalAnalysis]":

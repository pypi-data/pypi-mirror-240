...
class SingleAnalysis(_7549.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    class _Cast_SingleAnalysis:
        ...
        def advanced_system_deflection_analysis(
            ...
            return self._parent._cast(_2618.AdvancedSystemDeflectionAnalysis)
        ...
        def advanced_system_deflection_sub_analysis(
            ...
            return self._parent._cast(_2619.AdvancedSystemDeflectionSubAnalysis)
        ...
        def advanced_time_stepping_analysis_for_modulation(
            ...
            return self._parent._cast(_2620.AdvancedTimeSteppingAnalysisForModulation)
        ...
        def compound_parametric_study_tool_analysis(
            ...
            return self._parent._cast(_2621.CompoundParametricStudyToolAnalysis)
        ...
        def dynamic_model_at_a_stiffness_analysis(
            ...
            return self._parent._cast(_2624.DynamicModelAtAStiffnessAnalysis)
        ...
        def dynamic_model_for_harmonic_analysis(
            ...
            return self._parent._cast(_2625.DynamicModelForHarmonicAnalysis)
        ...
        def dynamic_model_for_modal_analysis(
            ...
            return self._parent._cast(_2626.DynamicModelForModalAnalysis)
        ...
        def dynamic_model_for_stability_analysis(
            ...
            return self._parent._cast(_2627.DynamicModelForStabilityAnalysis)
        ...
        def harmonic_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            ...
            return self._parent._cast(_2629.HarmonicAnalysis)
        ...
        def harmonic_analysis_of_single_excitation_analysis(
            ...
            return self._parent._cast(_2631.HarmonicAnalysisOfSingleExcitationAnalysis)

        @property
        def modal_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            from mastapy.system_model.analyses_and_results import _2632

            return self._parent._cast(_2632.ModalAnalysis)

        @property
        def modal_analysis_at_a_speed(self: "SingleAnalysis._Cast_SingleAnalysis"):
            from mastapy.system_model.analyses_and_results import _2633

            return self._parent._cast(_2633.ModalAnalysisAtASpeed)
        ...
        def modal_analysis_at_a_stiffness(self: "SingleAnalysis._Cast_SingleAnalysis"):
            ...
            return self._parent._cast(_2634.ModalAnalysisAtAStiffness)
        ...
        def modal_analysis_for_harmonic_analysis(
            ...
            return self._parent._cast(_2635.ModalAnalysisForHarmonicAnalysis)

        @property
        def multibody_dynamics_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            from mastapy.system_model.analyses_and_results import _2636

            return self._parent._cast(_2636.MultibodyDynamicsAnalysis)
        ...
        def parametric_study_tool_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            ...
            return self._parent._cast(_2637.ParametricStudyToolAnalysis)
        ...
        def power_flow_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            ...
            return self._parent._cast(_2638.PowerFlowAnalysis)

        @property
        def stability_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            from mastapy.system_model.analyses_and_results import _2639

            return self._parent._cast(_2639.StabilityAnalysis)
        ...
        def steady_state_synchronous_response_analysis(
            ...
            return self._parent._cast(_2640.SteadyStateSynchronousResponseAnalysis)
        ...
        def system_deflection_analysis(self: "SingleAnalysis._Cast_SingleAnalysis"):
            ...
            return self._parent._cast(_2643.SystemDeflectionAnalysis)
        ...
        def torsional_system_deflection_analysis(
            ...
            return self._parent._cast(_2644.TorsionalSystemDeflectionAnalysis)
    ...
    def perform_analysis_with_progress(self: Self, task_progress: "_7555.TaskProgress"):
        """Method does not return.
    ...
    def results_for_design_entity_analysis(
        self: Self, design_entity_analysis: "_2648.DesignEntityAnalysis"
    ) -> "_2648.DesignEntityAnalysis":
        """mastapy.system_model.analyses_and_results.DesignEntityAnalysis

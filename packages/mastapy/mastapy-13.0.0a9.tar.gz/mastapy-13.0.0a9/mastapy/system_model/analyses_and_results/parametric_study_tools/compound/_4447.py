...
class BearingCompoundParametricStudyTool(_4475.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: Self) -> "_1945.LoadedBearingDutyCycle":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4300.BearingParametricStudyTool]":

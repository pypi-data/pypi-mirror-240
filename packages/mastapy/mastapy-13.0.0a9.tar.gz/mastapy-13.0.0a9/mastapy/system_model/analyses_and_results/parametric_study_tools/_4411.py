...
class SpiralBevelGearSetParametricStudyTool(_4310.BevelGearSetParametricStudyTool):
    """SpiralBevelGearSetParametricStudyTool
    ...
    def spiral_bevel_gears_parametric_study_tool(
        self: Self,
    ) -> "List[_4410.SpiralBevelGearParametricStudyTool]":
    ...
    def spiral_bevel_meshes_parametric_study_tool(
        self: Self,
    ) -> "List[_4409.SpiralBevelGearMeshParametricStudyTool]":

...
class ParametricStudyVariable(_2645.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    class _Cast_ParametricStudyVariable:
        ...
        def analysis_case_variable(
            ...
            return self._parent._cast(_2645.AnalysisCaseVariable)
    ...
    @property
    def dimension(self: Self) -> "_4379.ParametricStudyDimension":
    ...
    def dimension(self: Self, value: "_4379.ParametricStudyDimension"):
    ...
    @property
    def distribution(self: Self) -> "_4376.MonteCarloDistribution":
    ...
    @distribution.setter
    @enforce_parameter_types
    def distribution(self: Self, value: "_4376.MonteCarloDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: Self) -> "_4344.DesignOfExperimentsVariableSetter":

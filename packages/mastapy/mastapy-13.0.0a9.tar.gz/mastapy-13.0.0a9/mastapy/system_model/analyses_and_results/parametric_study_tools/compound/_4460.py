...
class ClutchCompoundParametricStudyTool(_4476.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4315.ClutchParametricStudyTool]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4315.ClutchParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ClutchParametricStudyTool]

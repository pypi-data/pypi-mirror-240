...
class PulleyCompoundParametricStudyTool(_4478.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4398.PulleyParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4398.PulleyParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.PulleyParametricStudyTool]

...
class ZerolBevelGearSetParametricStudyTool(_4310.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    def zerol_bevel_gears_parametric_study_tool(
        self: Self,
    ) -> "List[_4437.ZerolBevelGearParametricStudyTool]":
    ...
    def zerol_bevel_meshes_parametric_study_tool(
        self: Self,
    ) -> "List[_4436.ZerolBevelGearMeshParametricStudyTool]":

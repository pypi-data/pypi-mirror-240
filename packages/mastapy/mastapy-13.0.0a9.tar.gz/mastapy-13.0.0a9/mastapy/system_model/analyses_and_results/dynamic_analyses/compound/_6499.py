...
class ShaftCompoundDynamicAnalysis(_6405.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6370.ShaftDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6370.ShaftDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ShaftDynamicAnalysis]

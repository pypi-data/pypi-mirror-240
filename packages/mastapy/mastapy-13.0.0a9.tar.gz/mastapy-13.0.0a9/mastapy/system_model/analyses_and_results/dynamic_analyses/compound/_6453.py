...
class CylindricalGearSetCompoundDynamicAnalysis(_6464.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6451.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6452.CylindricalGearMeshCompoundDynamicAnalysis]":

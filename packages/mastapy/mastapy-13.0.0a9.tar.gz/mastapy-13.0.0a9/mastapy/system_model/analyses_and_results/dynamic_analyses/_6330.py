...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6328, _6329
...
class FaceGearSetDynamicAnalysis(_6335.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    def face_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6328.FaceGearDynamicAnalysis]":
    ...
    def face_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6329.FaceGearMeshDynamicAnalysis]":

...
class PartCompoundDynamicAnalysis(_7542.PartCompoundAnalysis):
    """PartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6354.PartDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_6354.PartDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PartDynamicAnalysis]

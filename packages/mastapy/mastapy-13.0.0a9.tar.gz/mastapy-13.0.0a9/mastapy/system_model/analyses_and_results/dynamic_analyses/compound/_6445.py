...
class CVTCompoundDynamicAnalysis(_6414.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_6314.CVTDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6314.CVTDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CVTDynamicAnalysis]

...
class PulleyCompoundDynamicAnalysis(_6443.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6363.PulleyDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6363.PulleyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PulleyDynamicAnalysis]

...
class WindTurbineCertificationReport(_6264.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def extreme_load_case(self: Self, value: "_6801.StaticLoadCase"):
        wrapper_type = (
    ...
    @ldd.setter
    @enforce_parameter_types
    def ldd(self: Self, value: "_5660.DutyCycle"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def nominal_load_case(self: Self, value: "_6801.StaticLoadCase"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def design(self: Self) -> "_2471.RootAssembly":
    ...
    @property
    def ldd_static_analysis(self: Self) -> "_2943.RootAssemblyCompoundSystemDeflection":

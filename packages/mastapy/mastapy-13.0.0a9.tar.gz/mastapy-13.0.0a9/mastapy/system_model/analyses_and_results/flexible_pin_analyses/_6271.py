...
class FlexiblePinAnalysisStopStartAnalysis(_6265.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self: Self) -> "_2801.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: Self) -> "_2801.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection

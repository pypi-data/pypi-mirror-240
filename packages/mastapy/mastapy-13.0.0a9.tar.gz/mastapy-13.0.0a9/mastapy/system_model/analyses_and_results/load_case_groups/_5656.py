...
from mastapy.system_model.part_model import _2436, _2450, _2468, _2469
...
from mastapy.system_model.part_model.gears import _2523, _2522, _2529, _2527
from mastapy.system_model.connections_and_sockets.gears import _2306, _2310
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.load_case_groups import _5654
    from mastapy.system_model.analyses_and_results.static_loads import _6801, _6814
...
class AbstractStaticLoadCaseGroup(_5655.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    class _Cast_AbstractStaticLoadCaseGroup:
        ...
        def abstract_load_case_group(
            ...
            return self._parent._cast(_5655.AbstractLoadCaseGroup)

        @property
        def abstract_design_state_load_case_group(
            self: "AbstractStaticLoadCaseGroup._Cast_AbstractStaticLoadCaseGroup",
        ):
            return self._parent._cast(_5654.AbstractDesignStateLoadCaseGroup)
        ...
        def design_state(
            ...
            return self._parent._cast(_5659.DesignState)
        ...
        def duty_cycle(
            ...
            return self._parent._cast(_5660.DutyCycle)
        ...
        def sub_group_in_single_design_state(
            ...
            return self._parent._cast(_5663.SubGroupInSingleDesignState)
    ...
    def bearings(
        ...
        "List[_5669.ComponentStaticLoadCaseGroup[_2436.Bearing, _6816.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5672.GearSetStaticLoadCaseGroup[_2523.CylindricalGearSet, _2522.CylindricalGear, _6858.CylindricalGearLoadCase, _2306.CylindricalGearMesh, _6860.CylindricalGearMeshLoadCase, _6862.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: Self) -> "List[_5654.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_5669.ComponentStaticLoadCaseGroup[_2450.FEPart, _6884.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: Self,
    ) -> "List[_5672.GearSetStaticLoadCaseGroup[_2529.GearSet, _2527.Gear, _6887.GearLoadCase, _2310.GearMesh, _6889.GearMeshLoadCase, _6892.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: Self) -> "List[_5673.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5669.ComponentStaticLoadCaseGroup[_2468.PointLoad, _6935.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5669.ComponentStaticLoadCaseGroup[_2469.PowerLoad, _6936.PowerLoadLoadCase]]":
    ...
    @property
    def compound_power_flow(self: Self) -> "_2673.CompoundPowerFlowAnalysis":
    ...
    @property
    def compound_harmonic_analysis(self: Self) -> "_2665.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: Self) -> "_2668.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: Self) -> "_2674.CompoundStabilityAnalysis":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: Self, analysis_type: "_6814.AnalysisType"

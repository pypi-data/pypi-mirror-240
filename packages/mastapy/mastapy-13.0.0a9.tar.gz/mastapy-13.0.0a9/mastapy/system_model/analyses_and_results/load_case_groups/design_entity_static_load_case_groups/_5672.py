...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2529, _2527
...
TGearSet = TypeVar("TGearSet", bound="_2529.GearSet")
TGear = TypeVar("TGear", bound="_2527.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_6887.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2310.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_6889.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_6892.GearSetLoadCase")
...
class GearSetStaticLoadCaseGroup(
    ...
    class _Cast_GearSetStaticLoadCaseGroup:
        ...
        def part_static_load_case_group(
            ...
            return self._parent._cast(_5673.PartStaticLoadCaseGroup)
        ...
        def design_entity_static_load_case_group(
            ...
            return self._parent._cast(_5671.DesignEntityStaticLoadCaseGroup)
    ...
    def gears_load_cases(
        self: Self,
    ) -> "List[_5669.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: Self,
    ) -> "List[_5670.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":

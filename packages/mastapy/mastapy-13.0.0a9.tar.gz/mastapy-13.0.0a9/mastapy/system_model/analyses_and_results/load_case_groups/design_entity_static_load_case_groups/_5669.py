...
TReal = TypeVar("TReal", bound="_2441.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6834.ComponentLoadCase")


class ComponentStaticLoadCaseGroup(
    _5673.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup

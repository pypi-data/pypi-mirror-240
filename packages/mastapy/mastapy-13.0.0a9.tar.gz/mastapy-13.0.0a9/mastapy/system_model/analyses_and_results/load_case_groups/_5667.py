...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6802, _6814
    from mastapy.system_model.analyses_and_results import _2672, _2616
...
class TimeSeriesLoadCaseGroup(_5655.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: Self) -> "List[_6802.TimeSeriesLoadCase]":

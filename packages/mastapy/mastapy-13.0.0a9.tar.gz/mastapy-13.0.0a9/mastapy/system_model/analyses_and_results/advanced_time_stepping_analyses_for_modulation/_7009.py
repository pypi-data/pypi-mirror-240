...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6809, _6892
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    def advanced_time_stepping_analysis_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6809",
    ...
    def advanced_time_stepping_analysis_method(
        self: Self, value: "_6809.AdvancedTimeSteppingAnalysisForModulationType"
    ):
    ...
    @property
    def time_options(self: Self) -> "_2681.TimeOptions":

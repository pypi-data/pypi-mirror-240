...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def component_design(self: Self) -> "_2335.CycloidalDiscPlanetaryBearingConnection":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_7053.CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation]":

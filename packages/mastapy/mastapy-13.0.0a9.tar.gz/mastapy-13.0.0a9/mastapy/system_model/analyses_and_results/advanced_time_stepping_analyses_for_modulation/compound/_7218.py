...
class PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def component_design(self: Self) -> "_2345.PartToPartShearCouplingConnection":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_7089.PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]":

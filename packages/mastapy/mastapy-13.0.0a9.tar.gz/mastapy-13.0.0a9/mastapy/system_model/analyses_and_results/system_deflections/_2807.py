...
class SpringDamperConnectionSystemDeflection(_2726.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4135.SpringDamperConnectionPowerFlow":

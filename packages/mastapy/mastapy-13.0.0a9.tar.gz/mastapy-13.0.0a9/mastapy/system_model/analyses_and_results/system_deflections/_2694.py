...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: Self) -> "_2695.BearingSystemDeflection":
    ...
    def bearing_results(
        self: Self,
    ) -> "List[_2693.BearingDynamicResultsPropertyWrapper]":
    ...
    @property
    def cage_results(self: Self) -> "List[_2693.BearingDynamicResultsPropertyWrapper]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingDynamicResultsPropertyWrapper]
    ...
    def element_results(
        self: Self,
    ) -> "List[_2691.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: Self,
    ) -> "List[_2692.BearingDynamicPostAnalysisResultWrapper]":

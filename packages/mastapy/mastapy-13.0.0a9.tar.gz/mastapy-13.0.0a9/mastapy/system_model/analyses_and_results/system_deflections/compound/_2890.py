...
class CVTPulleyCompoundSystemDeflection(_2937.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2730.CVTPulleySystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2730.CVTPulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTPulleySystemDeflection]

...
class BeltDriveSystemDeflection(_2803.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4039.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: Self) -> "List[_2696.BeltConnectionSystemDeflection]":

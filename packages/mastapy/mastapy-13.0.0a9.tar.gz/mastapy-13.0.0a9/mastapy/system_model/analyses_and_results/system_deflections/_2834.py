...
class WormGearSetSystemDeflection(_2757.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4159.WormGearSetPowerFlow":
    ...
    def worm_gears_system_deflection(
        self: Self,
    ) -> "List[_2835.WormGearSystemDeflection]":
    ...
    def worm_meshes_system_deflection(
        self: Self,
    ) -> "List[_2833.WormGearMeshSystemDeflection]":

...
class RigidlyConnectedComponentGroupSystemDeflection(_2649.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
        ...
        def design_entity_group_analysis(
            ...
            return self._parent._cast(_2649.DesignEntityGroupAnalysis)
    ...
    @property
    def mass_properties(self: Self) -> "_1514.MassProperties":
    ...
    @property
    def components(self: Self) -> "List[_2712.ComponentSystemDeflection]":

...
class ConceptGearSetCompoundSystemDeflection(_2909.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2718.ConceptGearSetSystemDeflection]":
    ...
    def concept_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2877.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2878.ConceptGearMeshCompoundSystemDeflection]":

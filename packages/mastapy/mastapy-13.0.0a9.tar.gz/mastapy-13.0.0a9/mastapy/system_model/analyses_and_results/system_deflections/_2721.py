...
class ConicalGearMeshSystemDeflection(_2756.GearMeshSystemDeflection):
    """ConicalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2723.ConicalGearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2723.ConicalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4061.ConicalGearMeshPowerFlow":

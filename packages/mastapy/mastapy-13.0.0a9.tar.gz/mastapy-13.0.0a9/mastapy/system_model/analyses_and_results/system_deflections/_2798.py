...
class ShaftHubConnectionSystemDeflection(_2725.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1432.ShaftHubConnectionRating":
    ...
    @property
    def power_flow_results(self: Self) -> "_4128.ShaftHubConnectionPowerFlow":
    ...
    @property
    def left_flank_contacts(self: Self) -> "List[_2847.SplineFlankContactReporting]":
    ...
    @property
    def right_flank_contacts(self: Self) -> "List[_2847.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
    ...
    @property
    def tip_contacts(self: Self) -> "List[_2847.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]

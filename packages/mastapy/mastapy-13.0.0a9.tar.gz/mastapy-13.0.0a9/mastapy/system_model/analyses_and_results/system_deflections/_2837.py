...
class ZerolBevelGearSetSystemDeflection(_2704.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4162.ZerolBevelGearSetPowerFlow":
    ...
    def zerol_bevel_meshes_system_deflection(
        self: Self,
    ) -> "List[_2836.ZerolBevelGearMeshSystemDeflection]":

...
class GearMeshSystemDeflection(_2764.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2758.GearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2758.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    def mesh_separations(self: Self) -> "List[_2778.MeshSeparationsAtFaceWidth]":
    ...
    @property
    def power_flow_results(self: Self) -> "_4089.GearMeshPowerFlow":

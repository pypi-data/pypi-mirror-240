...
class ShaftCompoundSystemDeflection(_2849.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2801.ShaftSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2801.ShaftSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]

...
class PartToPartShearCouplingHalfSystemDeflection(_2727.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4112.PartToPartShearCouplingHalfPowerFlow":

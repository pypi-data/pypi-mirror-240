...
class CycloidalAssemblySystemDeflection(_2803.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: Self) -> "_6854.CycloidalAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: Self) -> "_4072.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: Self,
    ) -> "List[_2792.RingPinsToDiscConnectionSystemDeflection]":

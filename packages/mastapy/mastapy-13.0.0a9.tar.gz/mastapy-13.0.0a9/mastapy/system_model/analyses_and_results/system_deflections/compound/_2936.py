...
class PowerLoadCompoundSystemDeflection(_2972.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2789.PowerLoadSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PowerLoadSystemDeflection]

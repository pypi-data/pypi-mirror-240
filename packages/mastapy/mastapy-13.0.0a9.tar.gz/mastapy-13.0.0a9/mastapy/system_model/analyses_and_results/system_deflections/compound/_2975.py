...
class WormGearSetCompoundSystemDeflection(_2909.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def worm_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2973.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2974.WormGearMeshCompoundSystemDeflection]":

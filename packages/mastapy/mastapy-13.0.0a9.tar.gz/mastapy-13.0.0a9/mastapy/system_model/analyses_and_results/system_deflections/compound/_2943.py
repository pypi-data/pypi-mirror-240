...
class RootAssemblyCompoundSystemDeflection(_2855.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    @property
    def duty_cycle_efficiency_results(self: Self) -> "_2900.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2797.RootAssemblySystemDeflection]":
    ...
    @property
    def bearing_race_f_es(self: Self) -> "List[_2404.RaceBearingFESystemDeflection]":

...
class OilSealCompoundSystemDeflection(_2884.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2781.OilSealSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2781.OilSealSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.OilSealSystemDeflection]

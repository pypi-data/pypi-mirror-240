...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2436, _2438
    from mastapy.bearings.bearing_results import _1946, _1938
...
class BearingSystemDeflection(_2725.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1946.LoadedBearingResults":
    ...
    @property
    def power_flow_results(self: Self) -> "_4037.BearingPowerFlow":
    ...
    @property
    def preload_spring_stiffness(self: Self) -> "_1938.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_between_rings(self: Self) -> "_1938.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: Self) -> "_1938.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: Self,
    ) -> "List[_2438.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: Self,
    ) -> "List[_1938.BearingStiffnessMatrixReporter]":

...
class SpiralBevelGearSetSystemDeflection(_2704.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4134.SpiralBevelGearSetPowerFlow":
    ...
    def spiral_bevel_gears_system_deflection(
        self: Self,
    ) -> "List[_2806.SpiralBevelGearSystemDeflection]":

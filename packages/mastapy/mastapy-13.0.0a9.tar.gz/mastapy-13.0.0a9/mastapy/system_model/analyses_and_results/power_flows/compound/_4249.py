...
class PointLoadCompoundPowerFlow(_4285.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4117.PointLoadPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4117.PointLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PointLoadPowerFlow]

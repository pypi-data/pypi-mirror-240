...
class SynchroniserPartCompoundPowerFlow(_4202.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4147.SynchroniserPartPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4147.SynchroniserPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPartPowerFlow]

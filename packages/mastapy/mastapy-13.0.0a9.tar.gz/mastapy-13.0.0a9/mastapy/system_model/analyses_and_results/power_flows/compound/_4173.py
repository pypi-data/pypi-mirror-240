...
class BeltDriveCompoundPowerFlow(_4261.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4039.BeltDrivePowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4039.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]

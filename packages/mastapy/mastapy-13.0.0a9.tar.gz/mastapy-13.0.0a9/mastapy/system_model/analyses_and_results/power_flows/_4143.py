...
class StraightBevelGearSetPowerFlow(_4047.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4142.StraightBevelGearPowerFlow]":
    ...
    def straight_bevel_gears_power_flow(
        self: Self,
    ) -> "List[_4142.StraightBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.StraightBevelGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4141.StraightBevelGearMeshPowerFlow]":
    ...
    def straight_bevel_meshes_power_flow(
        self: Self,
    ) -> "List[_4141.StraightBevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.StraightBevelGearMeshPowerFlow]

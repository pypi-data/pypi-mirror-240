...
class BoltedJointCompoundPowerFlow(_4261.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def component_design(self: Self) -> "_2440.BoltedJoint":
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4048.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4048.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]

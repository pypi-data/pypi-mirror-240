...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4158, _4157
...
class WormGearSetPowerFlow(_4091.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4158.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: Self) -> "List[_4158.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4157.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: Self) -> "List[_4157.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]

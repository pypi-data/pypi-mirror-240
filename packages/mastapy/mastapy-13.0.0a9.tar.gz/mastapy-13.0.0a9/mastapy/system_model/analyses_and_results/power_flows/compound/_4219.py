...
class FEPartCompoundPowerFlow(_4165.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4087.FEPartPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4087.FEPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FEPartPowerFlow]

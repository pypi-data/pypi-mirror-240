...
class ShaftCompoundPowerFlow(_4164.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4129.ShaftPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4129.ShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ShaftPowerFlow]

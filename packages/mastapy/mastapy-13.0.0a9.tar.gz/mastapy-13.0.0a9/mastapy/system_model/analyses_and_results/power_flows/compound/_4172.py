...
class BeltConnectionCompoundPowerFlow(
    ...
    @property
    def component_design(self: Self) -> "_2265.BeltConnection":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4038.BeltConnectionPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4038.BeltConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltConnectionPowerFlow]

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4084, _4083
...
class FaceGearSetPowerFlow(_4091.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4084.FaceGearPowerFlow]":
    ...
    @property
    def face_gears_power_flow(self: Self) -> "List[_4084.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4083.FaceGearMeshPowerFlow]":
    ...
    @property
    def face_meshes_power_flow(self: Self) -> "List[_4083.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]

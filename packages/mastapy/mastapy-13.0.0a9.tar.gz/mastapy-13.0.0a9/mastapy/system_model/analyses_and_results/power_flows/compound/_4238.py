...
class MassDiscCompoundPowerFlow(_4285.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4106.MassDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4106.MassDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MassDiscPowerFlow]

...
class DatumCompoundPowerFlow(_4188.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4081.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4081.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]

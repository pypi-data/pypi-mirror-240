...
class StraightBevelDiffGearSetPowerFlow(_4047.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4139.StraightBevelDiffGearPowerFlow]":
    ...
    def straight_bevel_diff_gears_power_flow(
        self: Self,
    ) -> "List[_4139.StraightBevelDiffGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.StraightBevelDiffGearPowerFlow]
    ...
    def meshes_power_flow(
        self: Self,
    ) -> "List[_4138.StraightBevelDiffGearMeshPowerFlow]":

...
class FaceGearSetCompoundPowerFlow(_4223.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4085.FaceGearSetPowerFlow]":
    ...
    def face_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4216.FaceGearCompoundPowerFlow]":
    ...
    def face_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4217.FaceGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4085.FaceGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearSetPowerFlow]

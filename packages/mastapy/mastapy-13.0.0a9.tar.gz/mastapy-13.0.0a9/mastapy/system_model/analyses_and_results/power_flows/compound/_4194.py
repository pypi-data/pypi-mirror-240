...
class ConceptGearSetCompoundPowerFlow(_4223.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4060.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4192.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4193.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4060.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]

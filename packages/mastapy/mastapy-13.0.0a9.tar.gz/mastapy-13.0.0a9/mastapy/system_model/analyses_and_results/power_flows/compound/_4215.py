...
class ExternalCADModelCompoundPowerFlow(_4188.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4082.ExternalCADModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4082.ExternalCADModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ExternalCADModelPowerFlow]

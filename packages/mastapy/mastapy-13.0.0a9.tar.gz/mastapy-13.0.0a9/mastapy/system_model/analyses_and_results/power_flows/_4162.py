...
class ZerolBevelGearSetPowerFlow(_4047.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4161.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: Self,
    ) -> "List[_4161.ZerolBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4160.ZerolBevelGearMeshPowerFlow]":
    ...
    def zerol_bevel_meshes_power_flow(
        self: Self,
    ) -> "List[_4160.ZerolBevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearMeshPowerFlow]

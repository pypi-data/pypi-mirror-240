...
class RingPinsCompoundPowerFlow(_4240.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4122.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4122.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]

...
class CVTCompoundPowerFlow(_4173.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4070.CVTPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4070.CVTPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPowerFlow]

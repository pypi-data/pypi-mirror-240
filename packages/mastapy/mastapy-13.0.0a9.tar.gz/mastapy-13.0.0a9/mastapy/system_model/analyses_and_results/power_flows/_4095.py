...
class HypoidGearSetPowerFlow(_4035.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4094.HypoidGearPowerFlow]":
    ...
    @property
    def hypoid_gears_power_flow(self: Self) -> "List[_4094.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4093.HypoidGearMeshPowerFlow]":
    ...
    @property
    def hypoid_meshes_power_flow(self: Self) -> "List[_4093.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]

...
class ConicalGearMeshCompoundPowerFlow(_4222.GearMeshCompoundPowerFlow):
    """ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4061.ConicalGearMeshPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4061.ConicalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearMeshPowerFlow]

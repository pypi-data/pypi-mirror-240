...
class FaceGearMeshCompoundPowerFlow(_4222.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def component_design(self: Self) -> "_2308.FaceGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4083.FaceGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4083.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]

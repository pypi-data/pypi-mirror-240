...
class AbstractAssemblyCompoundPowerFlow(_4242.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4029.AbstractAssemblyPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4029.AbstractAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AbstractAssemblyPowerFlow]

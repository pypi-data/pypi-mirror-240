...
class CVTCompoundStabilityAnalysis(_3904.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_3803.CVTStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3803.CVTStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.CVTStabilityAnalysis]

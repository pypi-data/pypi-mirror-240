...
class DatumCompoundStabilityAnalysis(_3919.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3812.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3812.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]

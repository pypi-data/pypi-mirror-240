...
class CylindricalGearSetStabilityAnalysis(_3821.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    def cylindrical_gears_stability_analysis(
        self: Self,
    ) -> "List[_3810.CylindricalGearStabilityAnalysis]":
    ...
    def cylindrical_meshes_stability_analysis(
        self: Self,
    ) -> "List[_3808.CylindricalGearMeshStabilityAnalysis]":

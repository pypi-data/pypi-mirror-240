...
class ShaftCompoundStabilityAnalysis(_3895.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3858.ShaftStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3858.ShaftStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.ShaftStabilityAnalysis]

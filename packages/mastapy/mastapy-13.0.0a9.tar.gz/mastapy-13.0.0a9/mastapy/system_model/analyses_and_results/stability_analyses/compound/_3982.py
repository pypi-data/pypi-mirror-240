...
class PulleyCompoundStabilityAnalysis(_3933.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3850.PulleyStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3850.PulleyStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.PulleyStabilityAnalysis]

...
class FaceGearCompoundStabilityAnalysis(_3952.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3817.FaceGearStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3817.FaceGearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.FaceGearStabilityAnalysis]

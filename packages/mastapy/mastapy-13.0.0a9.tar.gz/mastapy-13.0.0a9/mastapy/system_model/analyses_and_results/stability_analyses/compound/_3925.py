...
class ConceptGearSetCompoundStabilityAnalysis(_3954.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3790.ConceptGearSetStabilityAnalysis]":
    ...
    def concept_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3923.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3924.ConceptGearMeshCompoundStabilityAnalysis]":

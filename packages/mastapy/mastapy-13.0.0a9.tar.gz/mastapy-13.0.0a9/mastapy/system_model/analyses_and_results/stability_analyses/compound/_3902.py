...
class BearingCompoundStabilityAnalysis(_3930.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3768.BearingStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3768.BearingStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BearingStabilityAnalysis]

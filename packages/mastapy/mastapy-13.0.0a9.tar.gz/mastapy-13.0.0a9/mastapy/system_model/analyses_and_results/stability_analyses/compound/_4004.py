...
class StraightBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3874.StraightBevelGearSetStabilityAnalysis]":
    ...
    def straight_bevel_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_4002.StraightBevelGearCompoundStabilityAnalysis]":
    ...
    def straight_bevel_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_4003.StraightBevelGearMeshCompoundStabilityAnalysis]":

...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1602.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1602.MeasurementBase")
...
class ShaftComplexShape(_0.APIBase, Generic[TLinearMeasurement, TAngularMeasurement]):
    ...
    class _Cast_ShaftComplexShape:
        ...
        def shaft_forced_complex_shape(
            ...
            return self._parent._cast(_4025.ShaftForcedComplexShape)
        ...
        def shaft_modal_complex_shape(
            ...
            return self._parent._cast(_4026.ShaftModalComplexShape)
        ...
        def shaft_modal_complex_shape_at_speeds(
            ...
            return self._parent._cast(_4027.ShaftModalComplexShapeAtSpeeds)
        ...
        def shaft_modal_complex_shape_at_stiffness(
            ...
            return self._parent._cast(_4028.ShaftModalComplexShapeAtStiffness)

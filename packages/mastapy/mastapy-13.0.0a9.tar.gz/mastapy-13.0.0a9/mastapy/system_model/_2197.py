...
from mastapy.system_model.part_model import _2469, _2472
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1843
    from mastapy.gears import _320, _326
    from mastapy.system_model import _2220, _2221, _2205, _2202, _2219, _2209
    ...
    from mastapy.utility import _1579, _1580
    from mastapy.gears.materials import _596
    from mastapy.shafts import _35
    from mastapy.system_model.optimization.system_optimiser import _2237, _2236
    from mastapy.system_model.part_model.configurations import _2612, _2609, _2611
    from mastapy.bearings.bearing_results.rolling import _1973
    from mastapy.system_model.database_access import _2261
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6801, _6800
    from mastapy.utility.model_validation import _1790
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2979
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1843.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2509.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2469.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2469.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2472.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2220", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2220.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2475.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2475", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2475.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2221.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1387.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2205.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2358.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1579.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1580.FileHistoryItem":
    ...
    @property
    def settings(self: Self) -> "_2202.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2219.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2237.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2612.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2609.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2509.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1973.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2611.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2261.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5659.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5660.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2530.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2530.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value

    @property
    def masta_settings(self: Self) -> "_2209.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2471.RootAssembly":
    ...
    @property
    def static_loads(self: Self) -> "List[_6801.StaticLoadCase]":
    ...
    @property
    def system_optimiser(self: Self) -> "_2236.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5667.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5660.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_2979.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_2979.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5659.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5660.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2162.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_2979.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1790.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6800.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2430.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1578.ExternalFullFEFileOption" = _1578.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2461, _2432
...
class AbstractShaftToMountableComponentConnection(_2269.Connection):
    """AbstractShaftToMountableComponentConnection
    ...
    @property
    def mountable_component(self: Self) -> "_2461.MountableComponent":
    ...
    @property
    def shaft(self: Self) -> "_2432.AbstractShaft":

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2441, _2442
...
class Socket(_0.APIBase):
    ...
    class _Cast_Socket:
        ...
        def cylindrical_socket(self: "Socket._Cast_Socket"):
            ...
            return self._parent._cast(_2273.CylindricalSocket)
        ...
        def electric_machine_stator_socket(self: "Socket._Cast_Socket"):
            ...
            return self._parent._cast(_2275.ElectricMachineStatorSocket)
    ...
    @property
    def connected_components(self: Self) -> "List[_2441.Component]":
    ...
    @property
    def owner(self: Self) -> "_2441.Component":
    ...
    @enforce_parameter_types
    def connection_to(self: Self, socket: "Socket") -> "_2269.Connection":
    ...
    def get_possible_sockets_to_connect_to(
        self: Self, component_to_connect_to: "_2441.Component"
    ) -> "List[Socket]":

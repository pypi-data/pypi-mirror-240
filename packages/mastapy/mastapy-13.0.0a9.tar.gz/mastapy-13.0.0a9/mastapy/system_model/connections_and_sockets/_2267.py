...
class ComponentConnection(_2268.ComponentMeasurer):
    """ComponentConnection
    ...
    class _Cast_ComponentConnection:
        ...
        def component_measurer(self: "ComponentConnection._Cast_ComponentConnection"):
            return self._parent._cast(_2268.ComponentMeasurer)
        ...
        def cylindrical_component_connection(
            ...
            return self._parent._cast(_2272.CylindricalComponentConnection)
    ...
    @property
    def connected_component(self: Self) -> "_2441.Component":

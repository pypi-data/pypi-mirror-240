...
class FESubstructureWithSelectionForStaticAnalysis(_2387.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: Self, value: "_1818.ThreeDViewContourOption"):
    ...
    def boundary_conditions_all_nodes(
        self: Self,
    ) -> "List[_2397.NodeBoundaryConditionStaticAnalysis]":
    ...
    @property
    def force_results(self: Self) -> "List[_1561.VectorWithLinearAndAngularComponents]":
        """List[mastapy.math_utility.measured_vectors.VectorWithLinearAndAngularComponents]

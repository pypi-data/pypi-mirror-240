...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2380, _2372, _2398
...
class FESubstructureWithSelection(_2357.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    class _Cast_FESubstructureWithSelection:
        ...
        def fe_substructure_with_selection_components(
            ...
            return self._parent._cast(_2388.FESubstructureWithSelectionComponents)
        ...
        def fe_substructure_with_selection_for_modal_analysis(
            ...
            return self._parent._cast(_2390.FESubstructureWithSelectionForModalAnalysis)
    ...
    @property
    def fe_substructure(self: Self) -> "_2380.FESubstructure":
    ...
    @property
    def element_face_groups(self: Self) -> "List[_2372.ElementFaceGroupWithSelection]":
    ...
    @property
    def node_groups(self: Self) -> "List[_2398.NodeGroupWithSelection]":

...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2401, _2402
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @length_unit.setter
    @enforce_parameter_types
    def length_unit(self: Self, value: "_1607.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def links(self: Self) -> "List[_2401.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: Self) -> "List[_2402.PerNodeExportOptions]":

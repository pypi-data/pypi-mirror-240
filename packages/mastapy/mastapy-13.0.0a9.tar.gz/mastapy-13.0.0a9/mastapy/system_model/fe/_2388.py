...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2373, _2364, _2365, _2396
...
class FESubstructureWithSelectionComponents(_2387.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    class _Cast_FESubstructureWithSelectionComponents:
        ...
        def fe_substructure_with_selection(
            ...
            return self._parent._cast(_2387.FESubstructureWithSelection)
        ...
        def base_fe_with_selection(
            ...
            return self._parent._cast(_2357.BaseFEWithSelection)
    ...
    @property
    def manual_alignment(self: Self) -> "_1496.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_208.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: Self) -> "List[_2417.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_2364.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_2365.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_209.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: Self) -> "List[_2417.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: Self) -> "List[_2417.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_210.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: Self) -> "List[_2396.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_207.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_211.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_212.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_213.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_2373.ElementPropertiesWithSelection[_214.ElementPropertiesSpringDashpot]]":

...
from mastapy.math_utility.measured_vectors import _1556
...
class ForceAndDisplacementResults(_1556.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    class _Cast_ForceAndDisplacementResults:
        ...
        def abstract_force_and_displacement_results(
            ...
            return self._parent._cast(_1556.AbstractForceAndDisplacementResults)
    ...
    @property
    def displacement(self: Self) -> "_1561.VectorWithLinearAndAngularComponents":

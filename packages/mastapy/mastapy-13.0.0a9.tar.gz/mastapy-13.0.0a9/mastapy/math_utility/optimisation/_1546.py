...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1548, _1544, _1545
...
class ParetoOptimisationStrategy(_1826.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    @property
    def charts(self: Self) -> "List[_1548.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: Self) -> "List[_1544.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: Self) -> "List[_1545.ParetoOptimisationOutput]":

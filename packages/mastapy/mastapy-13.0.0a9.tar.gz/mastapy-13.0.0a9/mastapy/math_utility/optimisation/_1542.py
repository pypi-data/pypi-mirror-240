...
class OptimizationVariable(_0.APIBase):
    ...
    class _Cast_OptimizationVariable:
        ...
        def optimization_input(self: "OptimizationVariable._Cast_OptimizationVariable"):
            ...
            return self._parent._cast(_1541.OptimizationInput)
        ...
        def reporting_optimization_input(
            ...
            return self._parent._cast(_1553.ReportingOptimizationInput)
    ...
    @property
    def measurement(self: Self) -> "_1602.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1602.MeasurementBase"):

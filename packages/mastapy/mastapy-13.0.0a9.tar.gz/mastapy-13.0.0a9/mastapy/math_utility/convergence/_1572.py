...
class DataLogger(_0.APIBase):
    ...
    class _Cast_DataLogger:
        ...
        def convergence_logger(self: "DataLogger._Cast_DataLogger"):
            from mastapy.math_utility.convergence import _1571

            return self._parent._cast(_1571.ConvergenceLogger)

        @property
        def data_logger_with_charts(self: "DataLogger._Cast_DataLogger"):
            from mastapy.utility_gui import _1847

            return self._parent._cast(_1847.DataLoggerWithCharts)

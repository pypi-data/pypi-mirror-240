...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1434, _1436
...
class KeyedJointDesign(_1441.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: Self) -> "_1434.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1434", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: Self, value: "_1434.KeyTypes"):
    ...
    @property
    def number_of_keys(self: Self) -> "_1436.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1436", "NumberOfKeys"
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: Self, value: "_1436.NumberOfKeys"):
        value = conversion.mp_to_pn_enum(

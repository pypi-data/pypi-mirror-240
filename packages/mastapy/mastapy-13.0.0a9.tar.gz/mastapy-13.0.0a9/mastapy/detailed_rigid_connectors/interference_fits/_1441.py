...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1439, _1440
...
class InterferenceFitDesign(_1383.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self: Self) -> "_1439.AssemblyMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1439",
            "AssemblyMethods",
        )(value)

    @assembly_method.setter
    @enforce_parameter_types
    def assembly_method(self: Self, value: "_1439.AssemblyMethods"):
    ...
    @property
    def calculation_method(self: Self) -> "_1440.CalculationMethods":
    ...
    @enforce_parameter_types
    def calculation_method(self: Self, value: "_1440.CalculationMethods"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(self: Self, value: "_1444.Table4JointInterfaceTypes"):

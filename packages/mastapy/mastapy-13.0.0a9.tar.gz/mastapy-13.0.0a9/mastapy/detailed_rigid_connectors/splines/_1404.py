...
class SAESplineJointDesign(_1416.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: Self) -> "_1391.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1391", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: Self, value: "_1391.FitTypes"):

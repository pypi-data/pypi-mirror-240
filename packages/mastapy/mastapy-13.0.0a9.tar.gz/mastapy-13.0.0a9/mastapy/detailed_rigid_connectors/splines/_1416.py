...
from mastapy.detailed_rigid_connectors.splines import _1399, _1400, _1411
...
class StandardSplineJointDesign(_1411.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    class _Cast_StandardSplineJointDesign:
        ...
        def spline_joint_design(
            ...
            return self._parent._cast(_1411.SplineJointDesign)
    ...
    @enforce_parameter_types
    def module_preferred(self: Self, value: "_1399.Modules"):
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(self: Self, value: "_1400.PressureAngleTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

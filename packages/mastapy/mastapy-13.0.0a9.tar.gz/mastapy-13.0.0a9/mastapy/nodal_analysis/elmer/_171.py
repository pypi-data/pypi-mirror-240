...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(
            ...
            return self._parent._cast(_1321.ElectricMachineMechanicalResultsViewable)
        ...
        def electric_machine_results_viewable(
            ...
            return self._parent._cast(_1333.ElectricMachineResultsViewable)
    ...
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1523.ResultOptionsFor3DVector"):
    ...
    @property
    def scaling_draw_style(self: Self) -> "_1848.ScalingDrawStyle":

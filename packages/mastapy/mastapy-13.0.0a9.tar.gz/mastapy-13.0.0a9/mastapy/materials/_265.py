...
class LubricationDetail(_1826.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def density_vs_temperature(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def density_vs_temperature(self: Self, value: "_1531.Vector2DListAccessor"):

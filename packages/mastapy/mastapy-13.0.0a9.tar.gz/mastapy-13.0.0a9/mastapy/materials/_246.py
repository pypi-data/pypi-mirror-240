...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: Self) -> "_1531.Vector2DListAccessor":
    ...
    def bh_curve(self: Self, value: "_1531.Vector2DListAccessor"):
        self.wrapped.BHCurve = value

    @property
    def bh_curve_plot(self: Self) -> "_1864.TwoDChartDefinition":

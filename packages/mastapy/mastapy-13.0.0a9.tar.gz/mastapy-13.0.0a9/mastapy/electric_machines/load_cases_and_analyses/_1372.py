...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1350, _1368, _1349
...
class SpeedTorqueLoadCase(_1354.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def load_specification(self: Self) -> "_1368.SpecifyTorqueOrCurrent":

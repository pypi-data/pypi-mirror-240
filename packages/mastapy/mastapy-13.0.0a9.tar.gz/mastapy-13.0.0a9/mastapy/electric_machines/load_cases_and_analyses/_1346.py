...
class EfficiencyMapAnalysis(_1348.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: Self) -> "_1318.EfficiencyResults":
    ...
    @property
    def load_case(self: Self) -> "_1347.EfficiencyMapLoadCase":

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1304, _1303
...
class ToothAndSlot(_1242.AbstractToothAndSlot):
    ...
    @property
    def tooth_taper_specification(self: Self) -> "_1304.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1304", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(self: Self, value: "_1304.ToothTaperSpecification"):
    ...
    @property
    def tooth_slot_style(self: Self) -> "_1303.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1303", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: Self, value: "_1303.ToothSlotStyle"):
        value = conversion.mp_to_pn_enum(

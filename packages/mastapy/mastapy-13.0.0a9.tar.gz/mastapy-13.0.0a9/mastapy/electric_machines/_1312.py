...
class Windings(_0.APIBase):
    ...
    @property
    def end_winding_inductance_method(self: Self) -> "_1358.EndWindingInductanceMethod":
    ...
    def end_winding_inductance_method(
        self: Self, value: "_1358.EndWindingInductanceMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.EndWindingInductanceMethod",
    ...
    @property
    def mmf(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def single_double_layer_windings(self: Self) -> "_1293.SingleOrDoubleLayerWindings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1293", "SingleOrDoubleLayerWindings"
        )(value)

    @single_double_layer_windings.setter
    @enforce_parameter_types
    def single_double_layer_windings(
        self: Self, value: "_1293.SingleOrDoubleLayerWindings"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_connection(self: Self) -> "_1309.WindingConnection":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1309", "WindingConnection"
        )(value)

    @winding_connection.setter
    @enforce_parameter_types
    def winding_connection(self: Self, value: "_1309.WindingConnection"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_type(self: Self) -> "_1314.WindingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1314", "WindingType"
        )(value)

    @winding_type.setter
    @enforce_parameter_types
    def winding_type(self: Self, value: "_1314.WindingType"):
        value = conversion.mp_to_pn_enum(
    ...
    def wire_size_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1315", "WireSizeSpecificationMethod"
        )(value)

    @wire_size_specification_method.setter
    @enforce_parameter_types
    def wire_size_specification_method(
        self: Self, value: "_1315.WireSizeSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf_fourier_series_electrical(self: Self) -> "_1509.FourierSeries":
    ...
    @property
    def mmf_fourier_series_mechanical(self: Self) -> "_1509.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    @property
    def windings_viewer(self: Self) -> "_1313.WindingsViewer":
    ...
    @property
    def conductors(self: Self) -> "List[_1308.WindingConductor]":
    ...
    @property
    def phases(self: Self) -> "List[_1287.Phase]":
    ...
    @property
    def slot_section_details(self: Self) -> "List[_1294.SlotSectionDetail]":

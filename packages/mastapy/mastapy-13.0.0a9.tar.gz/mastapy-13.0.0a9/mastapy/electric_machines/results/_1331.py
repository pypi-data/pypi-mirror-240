...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1329, _1332, _1330, _1328
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: Self) -> "_1864.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: Self,
    ) -> "List[_1329.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: Self,
    ) -> "List[_1332.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1330.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: Self,
    ) -> "List[_1328.ElectricMachineResultsForPhaseAtTimeStep]":

...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1362, _1359
...
class OnLoadElectricMachineResults(_1322.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1322.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1362.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: Self) -> "_1359.LeadingOrLagging":
    ...
    @property
    def windings(self: Self) -> "_1312.Windings":

...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1340, _1341
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self: Self) -> "_1864.TwoDChartDefinition":
    ...
    @property
    def on_load_results(self: Self) -> "_1340.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: Self) -> "_1341.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: Self) -> "List[_1340.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: Self,
    ) -> "List[_1341.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: Self,
    ) -> "List[_1340.OnLoadElectricMachineResults]":
        """List[mastapy.electric_machines.results.OnLoadElectricMachineResults]

...
from mastapy.electric_machines import _1291, _1288
...
class ElectricMachineResultsViewable(_171.ElmerResultsViewable):
    ...
    @property
    def force_view_options(self: Self) -> "_1334.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.results._1334", "ElectricMachineForceViewOptions"
        )(value)

    @force_view_options.setter
    @enforce_parameter_types
    def force_view_options(self: Self, value: "_1334.ElectricMachineForceViewOptions"):
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: Self, value: "_1322.ElectricMachineResults"):
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: Self) -> "List[_1840.EnumWithBoolean[_1288.RegionID]]":

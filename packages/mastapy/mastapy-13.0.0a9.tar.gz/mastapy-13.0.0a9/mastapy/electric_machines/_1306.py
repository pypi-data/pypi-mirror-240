...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1275, _1276, _1278
...
class UShapedLayerSpecification(_1290.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    class _Cast_UShapedLayerSpecification:
        ...
        def rotor_internal_layer_specification(
            ...
            return self._parent._cast(_1290.RotorInternalLayerSpecification)
    ...
    @property
    def outer_magnets(self: Self) -> "_1278.MagnetForLayer":

...
from mastapy.electric_machines.harmonic_load_data import _1378, _1375, _1379
...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1863, _1859
    from mastapy.electric_machines.harmonic_load_data import _1381, _1382
...
class ElectricMachineHarmonicLoadDataBase(_1379.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    class _Cast_ElectricMachineHarmonicLoadDataBase:
        ...
        def speed_dependent_harmonic_load_data(
            ...
            return self._parent._cast(_1379.SpeedDependentHarmonicLoadData)
        ...
        def harmonic_load_data_base(
            ...
            return self._parent._cast(_1376.HarmonicLoadDataBase)
        ...
        def dynamic_force_results(
            ...
            return self._parent._cast(_1317.DynamicForceResults)
        ...
        def electric_machine_harmonic_load_data(
            ...
            return self._parent._cast(_6868.ElectricMachineHarmonicLoadData)
        ...
        def electric_machine_harmonic_load_data_from_excel(
            ...
            return self._parent._cast(_6869.ElectricMachineHarmonicLoadDataFromExcel)
        ...
        def electric_machine_harmonic_load_data_from_flux(
            ...
            return self._parent._cast(_6870.ElectricMachineHarmonicLoadDataFromFlux)
        ...
        def electric_machine_harmonic_load_data_from_jmag(
            ...
            return self._parent._cast(_6871.ElectricMachineHarmonicLoadDataFromJMAG)
        ...
        def electric_machine_harmonic_load_data_from_masta(
            ...
            return self._parent._cast(_6872.ElectricMachineHarmonicLoadDataFromMASTA)
        ...
        def electric_machine_harmonic_load_data_from_motor_cad(
            ...
            return self._parent._cast(_6873.ElectricMachineHarmonicLoadDataFromMotorCAD)
    ...
    @enforce_parameter_types
    def data_type_for_force_moment_distribution_and_temporal_spatial_harmonics_charts(
        self: Self, value: "_1378.HarmonicLoadDataType"
    ):
    ...
    @enforce_parameter_types
    def display_option_for_slice_data(self: Self, value: "_1375.ForceDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def force_distribution_3d(self: Self) -> "_1863.ThreeDVectorChartDefinition":
    ...
    @slice.setter
    @enforce_parameter_types
    def slice(self: Self, value: "_1291.RotorSkewSlice"):
        wrapper_type = (
    ...
    @property
    def temporal_spatial_harmonics_chart(self: Self) -> "_1859.ScatterChartDefinition":
    ...
    @property
    def stator_axial_loads(self: Self) -> "_1381.StatorToothLoadInterpolator":
    ...
    @property
    def stator_radial_loads(self: Self) -> "_1381.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tangential_loads(self: Self) -> "_1381.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tooth_moments(self: Self) -> "_1382.StatorToothMomentInterpolator":
    ...
    def multiple_fourier_series_interpolator_for(
        self: Self,
        harmonic_load_data_type: "_1378.HarmonicLoadDataType",
        slice_index: "int",

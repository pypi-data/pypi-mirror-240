...
class ThreeDChartDefinition(_1856.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: Self) -> "_1740.AxisSettings":
    ...
    @property
    def x_axis_range(self: Self) -> "_1485.Range":
    ...
    def x_axis_range(self: Self, value: "_1485.Range"):
        self.wrapped.XAxisRange = value

    @property
    def y_axis_range(self: Self) -> "_1485.Range":
        """mastapy.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: Self, value: "_1485.Range"):
        self.wrapped.YAxisRange = value

    @property
    def z_axis_range(self: Self) -> "_1485.Range":
        """mastapy.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: Self, value: "_1485.Range"):
        self.wrapped.ZAxisRange = value

    def data_points_for_surfaces(self: Self) -> "List[_1858.PointsForSurface]":

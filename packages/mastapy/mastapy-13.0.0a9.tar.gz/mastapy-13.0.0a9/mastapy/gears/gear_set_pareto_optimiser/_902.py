...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self: Self) -> "_1786.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1786", "CustomChartType"
        )(value)
    ...
    def select_chart_type(
        self: Self,
    ) -> "_1548.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1548",
    ...
    def select_chart_type(
        self: Self,
        value: "_1548.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ):

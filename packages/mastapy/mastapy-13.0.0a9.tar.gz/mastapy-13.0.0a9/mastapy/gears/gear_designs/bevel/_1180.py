...
class BevelGearSetDesign(_1193.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self: Self) -> "_1515.MaxMinMean":
        ...
        return constructor.new_from_mastapy("mastapy.math_utility._1515", "MaxMinMean")(
            value
        )
    ...
    def backlash_used_for_tooth_thickness_calculation(
        self: Self, value: "_1515.MaxMinMean"
    ):

...
def utilities():
    ...
    format_json=make_component("Checkbox",'format json',default = True,key=text_to_key("-FORMAT_JSON_TO_STRING-",section="bool"))
    ...
    layout.append(make_component("Tab",'RESPONSES', abstract_browser_layout(section='responses',extra_component = make_component("Frame","responses",ensure_nested_list([collate_responses,format_json]))),key=text_to_key(text='response tab'),**expandable(size=(50, 100)))),

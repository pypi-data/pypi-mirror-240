...
from .abstract_ai_gui import get_total_layout,instructions_keys, all_token_keys, test_options_keys,multi_line_slider
...
#WindowManagement
    ...
    def right_click_event_query(self,values=None,event=None,window=None):
        ...
        event=event or self.window_mgr.get_event()
        window=window or self.window
        multi_line_slider.right_click_event(values,event,window)

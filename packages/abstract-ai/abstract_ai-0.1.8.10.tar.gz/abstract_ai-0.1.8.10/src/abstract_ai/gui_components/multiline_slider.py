...
from . import (num_tokens_from_string,
               chunk_any_to_tokens,
               get_code_blocks)
...
class MultilineSlider:
    ...
    def drop_downs_component(self, key):
        layout = []
        right_click_menu = ['Right', ['Undo', 'Cut', 'Copy', 'Paste', 'Delete', 'Select All', 'Key Term Search', 'Text Parsing']]
    ...
    def right_click_event(self,event,window):

...
from .abstract_ai_gui import get_total_layout,instructions_keys, all_token_keys, test_options_keys
...
class AbstractNavigationManager:  # Replace with your actual class name
    ...
    def calculate_new_counter(self, current_counter, direction,min_value, max_value):
        """
        ...
        if direction == 'forward':
            ...
            return max(current_counter - 1, min_value)
...
#PromptManagement
    ...
    def update_prompt_mgr(self,prompt_data_list=None,request_data_list=None,chunk_token_distributions=None,completion_percentage=None,notation=None,chunk_number=None,chunk_type="CODE"):
        ...
        initializes the prompt manager with the information needed for querying the GPT AI model.
	"""
        for i,data in enumerate(self.request_data_list):

...
class AbstractVideo(models.Model):
    ...
    def _create_frame_object(self, frame_number, image_file):
        ...
        assert frame, "placeholder method in abstract class, define in derived class"

        return frame

    def _bulk_create_frames(self, frames_to_create):
        assert None == True, "placeholder method in abstract class, define in derived class"

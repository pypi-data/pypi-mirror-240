...
The latest released version of :obj:`pydrad` can be installed from `PyPI <https://pypi.org/project/pydrad/>`_ using `pip`.
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/pydrad.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/pydrad.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import pydrad`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/pydrad.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e pydrad/
...
.. code-block:: console
   ...
   $ python3 -m pip install pydrad[dev]

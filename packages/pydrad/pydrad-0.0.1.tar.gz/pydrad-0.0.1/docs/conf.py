...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("pydrad")
...
html_title = "pydrad"
# html_favicon = "../logo/pydrad-favicon-color.png"
# html_logo = "../logo/pydrad-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://pydrad.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/pydrad",
    "repo_name": "bernardodionisi/pydrad",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/pydrad",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/pydrad/",
        },
    ],
    "edit_uri": "",
...
ipython_execlines = ["import pydrad"]
...
#     member for member in dir(pydrad.Array) if inspect.isdatadescriptor(getattr(type(pydrad.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(pydrad._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(pydrad._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(pydrad.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(pydrad._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(pydrad.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(pydrad.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(pydrad._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(pydrad._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(pydrad._domains._meta.ArrayMeta, p)
#     delattr(pydrad._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(pydrad.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(pydrad._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(pydrad._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)

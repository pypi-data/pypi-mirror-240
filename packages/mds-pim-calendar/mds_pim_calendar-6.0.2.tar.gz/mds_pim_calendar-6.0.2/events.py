...
class Event(ModelSQL, ModelView):
    ...
    calendar = fields.Many2One(
        string='Calendar', required=True, select=True,
    ...
    name = fields.Char(
        string='Title', required=True, select=True, states=states_ro,
        depends=['isowner', 'permchange'])
    ...
    startpos = fields.DateTime(
        string='Begin', required=True, select=True, states=states_ro,
        depends=['isowner', 'permchange'])
    endpos = fields.DateTime(
        string='End', required=True, select=True, states=states_ro,
        depends=['isowner', 'permchange'])

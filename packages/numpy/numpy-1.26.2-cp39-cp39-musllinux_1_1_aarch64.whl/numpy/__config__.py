...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": "USE_64BITINT=1 DYNAMIC_ARCH=1 DYNAMIC_OLDER= NO_CBLAS= NO_LAPACK= NO_LAPACKE= NO_AFFINITY=1 USE_OPENMP= NEOVERSEN1 MAX_THREADS=2",
                "pc file directory": r"/usr/local/lib/pkgconfig",
            },
            "lapack": {
                "name": "dep281473652060368",
                "found": bool("True".lower().replace("false", "")),
                "version": "1.26.2",

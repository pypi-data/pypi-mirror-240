...
class RedisMongoDB(IAtomDB):
    ...
    def _connection_mongo_db(self) -> Database:
        mongo_hostname = config.get('DAS_MONGODB_HOSTNAME')
        mongo_port = config.get('DAS_MONGODB_PORT')
        mongo_username = config.get('DAS_MONGODB_USERNAME')
        mongo_password = config.get('DAS_MONGODB_PASSWORD')
    ...
    def _connection_redis(self) -> Redis:
        redis_hostname = config.get('DAS_REDIS_HOSTNAME')
        redis_port = config.get('DAS_REDIS_PORT')

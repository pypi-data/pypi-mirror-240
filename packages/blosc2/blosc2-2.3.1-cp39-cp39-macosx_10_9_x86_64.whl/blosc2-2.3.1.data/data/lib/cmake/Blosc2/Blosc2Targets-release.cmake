...
set_target_properties(Blosc2::blosc2_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libblosc2.2.11.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libblosc2.2.dylib"
  )

list(APPEND _cmake_import_check_targets Blosc2::blosc2_shared )
list(APPEND _cmake_import_check_files_for_Blosc2::blosc2_shared "${_IMPORT_PREFIX}/lib/libblosc2.2.11.2.dylib" )

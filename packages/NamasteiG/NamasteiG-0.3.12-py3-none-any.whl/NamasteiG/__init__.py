...
class Instagram:
    ...
    def __init__(self,User,Password,Proxy=None):
        ...
        self.UserAgent = "Instagram 308.0.0.36.109 Android (" + ["23/6.0", "24/7.0", "25/7.1.1", "26/8.0", "27/8.1", "28/9.0"][random.randint(0, 5)] + "; " + str(random.randint(100, 1300)) + "dpi; " + str(random.randint(200, 2000)) + "x" + str(random.randint(200, 2000)) + "; " + ["SAMSUNG", "HUAWEI", "LGE/lge", "HTC", "ASUS", "ZTE", "ONEPLUS", "XIAOMI", "OPPO", "VIVO", "SONY", "REALME"][random.randint(0, 11)] + "; SM-T" + rnd + "; SM-T" + rnd + "; qcom; en_US; 534961"+str(random.randint(111,999))+")"
        self.Blockversion = '131e552d088ec90a45af8e2ca9561ed11e3e51dd833be2d0154104e68ac1b33e'
        self.proxy = Proxy

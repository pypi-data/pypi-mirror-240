"""
CREATE TABLE `aaa_ddd` (
  `date_str` date DEFAULT NULL COMMENT '日期',
  `tac` varchar(100) DEFAULT NULL,
  `model_name` varchar(100) DEFAULT NULL,
  `companyname` varchar(255) DEFAULT NULL,
  `rat` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
/*!50100 PARTITION BY RANGE (to_days(`date_str`))
(PARTITION p20220711 VALUES LESS THAN (738712) ENGINE = InnoDB,
 PARTITION p20220712 VALUES LESS THAN (738713) ENGINE = InnoDB,
 PARTITION p20220916 VALUES LESS THAN (738780) ENGINE = InnoDB,
) */
"""

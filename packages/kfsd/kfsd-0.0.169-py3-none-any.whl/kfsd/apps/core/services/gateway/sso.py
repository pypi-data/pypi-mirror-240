...
class SSO(APIGateway):
    ...
    def getTokenPublicKeyUrl(self):
        return self.constructUrl(["services.context.gateway_api.sso.public_key_url"])

    def getRefreshAccessTokenUrl(self):
        return self.constructUrl(
            ["services.context.gateway_api.sso.refresh_access_token_url"]
        )

    def getLogoutUrl(self):
        return self.constructUrl(["services.context.gateway_api.sso.logout_url"])

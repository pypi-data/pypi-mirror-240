...
class SSO(APIGateway):
    ...
    def getTokenPublicKeyUrl(self):
        return self.constructUrl(["services.gateway_api.sso.public_key_uri"])

    def getRefreshAccessTokenUrl(self):
        return self.constructUrl(["services.gateway_api.sso.refresh_access_token_uri"])

    def getLogoutUrl(self):
        return self.constructUrl(["services.gateway_api.sso.logout_uri"])

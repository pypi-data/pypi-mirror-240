...
class Chunk:
    ...
    def __add__(self, other: Chunk):
        ...
        def merge_structure_tags(ours: str, theirs: str):
            """
            Merges two sets of structure tags, returning the concatenation if disjoint
            or the larger one if one is a subset of the other.

            >>> merge_structure_tags('lim', 'h1')
            'lim h1'
            >>> merge_structure_tags('lim h1', 'h1')
            'lim h1'
            >>> merge_structure_tags('lim h1 div', 'lim div')
            'lim div'
            """
        ...
        return Chunk(
            tag=merge_structure_tags(self.tag, other.tag),

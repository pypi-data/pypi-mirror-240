...
class Configuration(object):
    ...
    conf = nomos.api_resources.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://production.getnomos.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("nomos.api_resources")
        ...
        return [
            {
                ...
                "description": "Production server for Nomos API endpoints",
            }
        ]

...
class ProjectVersionGetActiveRequest(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["branch_name"]
    ) -> MetaOapg.properties.branch_name:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["branch_name"]
    ) -> typing.Union[MetaOapg.properties.branch_name, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        branch_name: typing.Union[
            MetaOapg.properties.branch_name, str, schemas.Unset
        ] = schemas.unset,

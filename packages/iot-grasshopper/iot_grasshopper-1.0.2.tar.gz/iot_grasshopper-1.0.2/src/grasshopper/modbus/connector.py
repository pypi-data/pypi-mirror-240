...
class GGv2ModbusConnector:
    ...
    def __init__(self, ipc: GreengrassCoreIPCClientV2,
                 conn: SingleModbusConnection, cfg: ConfigLoader, callback=None):
    ...
    def _publish_to(self, target, topic, model):
        if self.ggv2_ipc is not None:
            ...
            if self.AWS_IOT_CORE == target:
                ...
                message = PublishMessage(json_message=JsonMessage(model))

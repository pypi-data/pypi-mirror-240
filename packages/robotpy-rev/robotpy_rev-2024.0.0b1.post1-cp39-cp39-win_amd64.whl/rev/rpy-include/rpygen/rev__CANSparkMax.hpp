...
struct PyTrampoline_rev__CANSparkMax : PyTrampolineBase_rev__CANSparkMax<PyTrampolineBase, PyTrampolineCfg> {
  ...
  using ExternalFollower [[maybe_unused]] = typename rev::CANSparkMax::ExternalFollower;


  using IdleMode [[maybe_unused]] = typename rev::CANSparkMax::IdleMode;

  using SoftLimitDirection [[maybe_unused]] = typename rev::CANSparkMax::SoftLimitDirection;

  using FaultID [[maybe_unused]] = typename rev::CANSparkMax::FaultID;


    using MotorType = rev::CANSparkMaxLowLevel::MotorType;


    static constexpr auto kFollowerDisabled [[maybe_unused]] = rev::CANSparkMax::kFollowerDisabled;

    static constexpr auto kFollowerSparkMax [[maybe_unused]] = rev::CANSparkMax::kFollowerSparkMax;

    static constexpr auto kFollowerPhoenix [[maybe_unused]] = rev::CANSparkMax::kFollowerPhoenix;

...
class GPULoggingThread(BaseSystemLoggingThread):
    def __init__(
        self,
        ...
        self.name = "GPULoggingThread"

        LOGGER.debug(
            "GPUThread create with %ds interval",
            initial_interval,
        )

    def get_metrics(self) -> Union[NamedSystemMetricsList, PlainSystemMetrics]:

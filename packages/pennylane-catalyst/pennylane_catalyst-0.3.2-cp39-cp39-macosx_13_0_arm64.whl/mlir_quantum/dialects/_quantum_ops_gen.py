...
class DeviceOp(_ods_ir.OpView):
  ...
  @builtins.property
  def specs(self):
    if "specs" not in self.operation.attributes:
      return None
    return self.operation.attributes["specs"]

  @specs.setter
  def specs(self, value):
    if value is not None:
      self.operation.attributes["specs"] = value
    elif "specs" in self.operation.attributes:
      del self.operation.attributes["specs"]

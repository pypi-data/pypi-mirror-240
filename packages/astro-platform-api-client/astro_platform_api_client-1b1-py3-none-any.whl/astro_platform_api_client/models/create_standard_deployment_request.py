...
class CreateStandardDeploymentRequest:
    ...
    Attributes:
        ...
        type (CreateStandardDeploymentRequestType): The type of the Deployment. Example: DEDICATED.
    ...
    type: CreateStandardDeploymentRequestType
    workspace_id: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = CreateStandardDeploymentRequestType(d.pop("type"))

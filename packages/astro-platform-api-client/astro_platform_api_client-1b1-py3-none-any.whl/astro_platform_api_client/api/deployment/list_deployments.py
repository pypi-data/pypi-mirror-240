...
def _get_kwargs(
    organization_id: str,
    *,
    deployment_ids: Union[Unset, None, List[str]] = UNSET,
    workspace_ids: Union[Unset, None, List[str]] = UNSET,
    offset: Union[Unset, None, int] = 0,
    limit: Union[Unset, None, int] = 20,
    sorts: Union[Unset, None, List[ListDeploymentsSortsItem]] = UNSET,
) -> Dict[str, Any]:
    pass

    params: Dict[str, Any] = {}
    json_deployment_ids: Union[Unset, None, List[str]] = UNSET
    if not isinstance(deployment_ids, Unset):
        if deployment_ids is None:
            json_deployment_ids = None
        else:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization_id (str):
        deployment_ids (Union[Unset, None, List[str]]):
        workspace_ids (Union[Unset, None, List[str]]):
        offset (Union[Unset, None, int]):
        limit (Union[Unset, None, int]):  Default: 20.
        sorts (Union[Unset, None, List[ListDeploymentsSortsItem]]):

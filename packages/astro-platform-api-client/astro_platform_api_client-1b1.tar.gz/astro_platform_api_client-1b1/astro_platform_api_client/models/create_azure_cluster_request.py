...
class CreateAzureClusterRequest:
    ...
    Attributes:
        ...
        type (CreateAzureClusterRequestType): The cluster's type. Example: DEDICATED.
    ...
    name: str
    region: str
    type: CreateAzureClusterRequestType
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = CreateAzureClusterRequestType(d.pop("type"))

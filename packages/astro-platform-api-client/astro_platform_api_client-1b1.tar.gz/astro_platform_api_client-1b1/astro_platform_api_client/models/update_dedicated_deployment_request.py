...
class UpdateDedicatedDeploymentRequest:
    ...
    Attributes:
        ...
        environment_variables (List['DeploymentEnvironmentVariableRequest']): List of environment variables to add to
            the Deployment.
        executor (UpdateDedicatedDeploymentRequestExecutor): The executor Deployment's executor. Example: CELERY.
        ...
        type (UpdateDedicatedDeploymentRequestType): The type of the Deployment. Example: DEDICATED.
    ...
    type: UpdateDedicatedDeploymentRequestType
    workspace_id: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = UpdateDedicatedDeploymentRequestType(d.pop("type"))

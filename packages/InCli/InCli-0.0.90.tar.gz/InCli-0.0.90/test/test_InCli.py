...
#07L3O00000Dy7SAUAZ
    def test_log_ID(self):
        try:
            InCli._main(["-u","NOSQSM","-logs","07L7a00000WPmlcEAD"])
        except Exception as e:
            print(e)
            print(traceback.format_exc())
    ...
    def test_log_ID_to_file(self):
        try:
            InCli._main(["-u","NOSQSM","-logs","07L7a00000VBNh9EAH","-file","-allLimits"])
        except Exception as e:
            print(e)
            print(traceback.format_exc())
    ...
    def test_log_folder_file(self):
        try:
            res = InCli._main(["-logs","-folder",f"/Users/uormaechea/Documents/Dev/python/InCliLib/InCLipkg/InCli/logs1","-file"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_file(self):
        try:
            res = InCli._main(["-logs","-inputfile",f'/Users/uormaechea/Downloads/07LMT000000nZjs2AE.log'])
        #    res = InCli._main(["-logs","-inputfile",f'/Users/uormaechea/Documents/Dev/python/InCliLib/InCLipkg/incli/logs/07L7a00000WcxCzEAJ.log',"-var","100"])
    ...
    def test_log_tail_loguser_guest_auto_delete(self):
        try:
            InCli._main(["-u","NOSQSM","-logs","-tail","-auto","-deletelogs"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_tail_auto_delete(self):
        try:
            #return
            InCli._main(["-u","NOSPRD","-logs","-tail","-auto","-deletelogs","-debuglevel","S"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)  
    ...
    def test_ipe(self):
        try:
            InCli._main(["-u","NOSPRD","-ipe","-where","vlocity_cmt__SourceName__c like '%orta%'","-contains","PP00034719","-limit","5000"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_ipa_dates(self):
        try:
            InCli._main(["-u","NOSPRD","-ipa","-from","2023-09-25T01:00:00","-to","2023-09-27T20:59:04"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_ipa_id_toFile(self):
        try:
            InCli._main(["-u","NOSQSM","-ipa","a2J7a000002mqCxEAI","-file"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)

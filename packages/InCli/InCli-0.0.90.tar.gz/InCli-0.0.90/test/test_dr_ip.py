...
############################################################################################################
    ...
    def test_nos_performance_degradation(self):
        restClient.init('NOSQSM')


        data = {
            'input':{'mergeListFilter':'Name,Description,ProductCode,CatalogCode'},
            "options": {
                    "chainable": False,
                    "postTransformBundle": "",
                    "preTransformBundle": "",
        ...
        call = DR_IP.ip('woo_getOffers',data['input'],data['options'])

        ...
        for num,line in enumerate(context['lines']):
            ...
            if len(chunks)<2:
                if line.startswith('Execute Anonymous'):
                    ...
                    elementParser.executeAnonymous(context)
                continue
            if len(chunks[0])<10:
                continue
            if len(chunks[1])>30:
           ...
           # print(context['line'])
            ...
            if elementParser.parseVariableAssigment(context,pc['var']):      continue
            ...
            if elementParser.parseVariableScope(context): continue

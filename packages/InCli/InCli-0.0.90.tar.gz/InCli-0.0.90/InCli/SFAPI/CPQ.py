...
def getCartsProducts(cartF, maxProdListHierarchy=None, query=None, filters=None,getCartsProducts=None,lastRecordId=None,includeAttachment=None,offsetSize=None,fields=None,pagesize=None,attributes=None,includeAttributes=None,includeIneligible=True,onlyOne=False):
    cartId = utils.Id(cartF)

    products = getCartsProducts_api(cartId=cartId, 
                        maxProdListHierarchy=maxProdListHierarchy, 
                        query=query, 
                        filters=filters,
                        getCartsProducts=getCartsProducts,
...
def getCartsProducts_api(cartId, maxProdListHierarchy=None, query=None, filters=None,getCartsProducts=None,lastRecordId=None,includeAttachment=None,offsetSize=None,fields=None,pagesize=None,attributes=None,includeAttributes=None,includeIneligible=True):
    """

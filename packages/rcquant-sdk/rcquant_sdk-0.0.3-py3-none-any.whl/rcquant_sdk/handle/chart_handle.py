...
from ..data.chart.OHLCValueListData import OHLCValueListData
from ..data.chart.OHLCValueData import OHLCValueData
from ..data.chart.GraphValueListData import GraphValueListData
from ..data.chart.GraphValueData import GraphValueData
from ..data.chart.BarGraphParamData import BarGraphParamData
from ..data.chart.TimeSpanGVListData import TimeSpanGVListData
...
class ChartHandle():
    ...
    def add_timespan_graphvalue_list(self, timespans: List[int], graphvalues: Dict[str, List[float]] = {},
        ...
        data = TimeSpanGVListData(timespans=timespans, graphvalues=graphvalues, ohlcvalues=ohlcvalues)

...
from egp.sdk.models import (
    Chunk, CrossEncoderRankStrategy, RougeRankStrategy, ChunkRankRequest,
    ChunkRankResponse, ChunkSynthesisRequest, ChunkSynthesisResponse,
)
...
class ChunkCollection(APIEngine):
    ...
    def rank(
        ...
        rank_strategy: Union[CrossEncoderRankStrategy, RougeRankStrategy],

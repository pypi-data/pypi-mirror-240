...
from egp.sdk.enums import TestCaseSchemaType
from egp.sdk.models import (
    TestCase,
    TestCaseRequest,
    EvaluationDataset,
    EvaluationDatasetVersion, EvaluationDatasetVersionRequest,
    TestCaseSchemaValidator, TestCaseData, EvaluationDatasetRequest,
)
    ...
    def update_dataset_version(self, evaluation_dataset: EvaluationDataset) -> EvaluationDataset:
        ...
        **Warning**: By default, the `add_test_cases`, `delete_test_cases`, and `modify_test_cases`
        ...
        Returns:
            The updated dataset.
        """
        evaluation_dataset_version = self._versions().create(
            evaluation_dataset=evaluation_dataset
        )

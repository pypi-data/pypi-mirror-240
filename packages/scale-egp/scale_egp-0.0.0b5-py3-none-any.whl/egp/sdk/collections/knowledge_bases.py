...
from egp.sdk.enums import EmbeddingModelName, ChunkUploadStatus
from egp.sdk.models import (
    KnowledgeBase, KnowledgeBaseRequest, EmbeddingConfig, Chunk,
    KnowledgeBaseQueryRequest, KnowledgeBaseUpload, LocalChunksSourceConfig, ChunkToUpload,
    KnowledgeBaseArtifact,
    S3DataSourceConfig,
    GoogleDriveDataSourceConfig, SharePointDataSourceConfig, SharePointDataSourceAuthConfig,
    CharacterChunkingStrategyConfig, KnowledgeBaseResponse, ListKnowledgeBasesResponse,
    ListKnowledgeBaseArtifactsResponse, KnowledgeBaseQueryResponse,
    KnowledgeBaseRemoteUploadRequest, KnowledgeBaseUploadResponse,
    KnowledgeBaseLocalChunkUploadRequest, ListKnowledgeBaseUploadsResponse,
    CancelKnowledgeBaseUploadResponse,
)
from egp.utils.api_utils import APIEngine
...
class KnowledgeBaseArtifactsCollection(APIEngine):
    ...
    def get(
        ...
        id: str,
        knowledge_base: KnowledgeBase,
        status_filter: Optional[ChunkUploadStatus] = ChunkUploadStatus.COMPLETED,
    ) -> KnowledgeBaseArtifact:
        """
...
class KnowledgeBaseUploadsCollection(APIEngine):
    ...
    def create_remote_upload(
        ...
        data_source_auth_config: Optional[Union[
            SharePointDataSourceAuthConfig
        ]],
        chunking_strategy_config: Union[

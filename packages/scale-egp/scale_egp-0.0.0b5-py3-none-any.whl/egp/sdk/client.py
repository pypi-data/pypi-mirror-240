...
from egp.sdk.collections.application_specs import ApplicationSpecCollection
from egp.sdk.collections.chunks import ChunkCollection
from egp.sdk.collections.completions import CompletionCollection
from egp.sdk.collections.evaluation_datasets import EvaluationDatasetCollection
from egp.sdk.collections.evaluations import EvaluationCollection
from egp.sdk.collections.knowledge_bases import KnowledgeBaseCollection
from egp.sdk.collections.studio_projects import StudioProjectCollection
...
class EGPClient:
    ...
    def __init__(self, api_key: str = None, account_id: str = None, endpoint_url: str = None):

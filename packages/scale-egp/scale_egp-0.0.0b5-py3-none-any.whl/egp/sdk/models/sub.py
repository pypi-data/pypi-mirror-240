...
from egp.sdk.enums import (
    EmbeddingModelName, DataSource, DeduplicationStrategy, ChunkingStrategy,
    EvaluationType, QuestionType, ExtraInfoSchema, CrossEncoderModelName,
)
from egp.utils.model_utils import BaseModel, Entity
...
class ExtraInfo(BaseModel):
    ...
    """
    schema_type: Union[ExtraInfoSchema]
    info: Union[str]
...
TestCaseData: TypeAlias = Union[GenerationTestCaseData]
...
TestCaseResultData: TypeAlias = Union[GenerationTestCaseResultData]

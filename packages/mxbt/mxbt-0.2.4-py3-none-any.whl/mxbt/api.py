from nio import AsyncClient, LoginResponse, OlmUnverifiedDeviceError, UploadResponse, AsyncClientConfig
...
class Api:
    ...
    async def __send(self, room_id: str, body: str | File, use_html: bool, reply_to: str="", edit_id: str="") -> None:
        if isinstance(body, str):
            if use_html: 
                await self.send_markdown(room_id, body, reply_to=reply_to, edit_id=edit_id)
            else: 
                await self.send_text(room_id, body, reply_to=reply_to, edit_id=edit_id)
        elif isinstance(body, File):
            await self.send_file(room_id, body.path, reply_to=reply_to, edit_id=edit_id)

    async def send(self, room_id: str, body: str | File, use_html: bool=False) -> None:
        """
    ...
    async def reply(self, room_id: str, body: str | File, reply_to: str, use_html: bool=False) -> None:
        """
        ...
        use_html: bool, optional
            Use html formatting or not
        """
        await self.__send(room_id, body, use_html, reply_to=reply_to)

    async def edit(self, room_id: str, body: str | File, edit_id: str, use_html: bool=False) -> None:
        """
        ...
        use_html: bool, optional
            Use html formatting or not
        """
        await self.__send(room_id, body, use_html, edit_id=edit_id) 

...
class QuoteDependencyAllOf(object):
    ...
    def __init__(self, market_identifier=None, code=None, date=None, dependency_type=None, local_vars_configuration=None):  # noqa: E501
        """QuoteDependencyAllOf - a model defined in OpenAPI"
    ...
    def market_identifier(self):
        """Gets the market_identifier of this QuoteDependencyAllOf.  # noqa: E501

        Type of the code identifying the asset, e.g. ISIN or CUSIP  # noqa: E501

        :return: The market_identifier of this QuoteDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def market_identifier(self, market_identifier):
        """Sets the market_identifier of this QuoteDependencyAllOf.

        Type of the code identifying the asset, e.g. ISIN or CUSIP  # noqa: E501

        :param market_identifier: The market_identifier of this QuoteDependencyAllOf.  # noqa: E501
        :type market_identifier: str
        """
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this QuoteDependencyAllOf.

        The code identifying the corresponding equity, e.g. US0378331005 if the MarketIdentifier was set to ISIN  # noqa: E501

        :param code: The code of this QuoteDependencyAllOf.  # noqa: E501
        :type code: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this QuoteDependencyAllOf.  # noqa: E501

        The effectiveAt of the quote for the identified entity.  # noqa: E501

        :return: The date of this QuoteDependencyAllOf.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this QuoteDependencyAllOf.

        The effectiveAt of the quote for the identified entity.  # noqa: E501

        :param date: The date of this QuoteDependencyAllOf.  # noqa: E501
        :type date: datetime
        """
    ...
    def dependency_type(self):
        """Gets the dependency_type of this QuoteDependencyAllOf.  # noqa: E501
        ...
        :return: The dependency_type of this QuoteDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_type(self, dependency_type):
        """Sets the dependency_type of this QuoteDependencyAllOf.

        The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor, CalendarDependency, InflationFixingDependency  # noqa: E501

        :param dependency_type: The dependency_type of this QuoteDependencyAllOf.  # noqa: E501
        :type dependency_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuoteDependencyAllOf):
            return False

...
class OpenEvent(object):
    ...
    def __init__(self, anchor_date=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """OpenEvent - a model defined in OpenAPI"
    ...
    def anchor_date(self):
        """Gets the anchor_date of this OpenEvent.  # noqa: E501

        The date on the which the instrument was opened.  # noqa: E501

        :return: The anchor_date of this OpenEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def anchor_date(self, anchor_date):
        """Sets the anchor_date of this OpenEvent.

        The date on the which the instrument was opened.  # noqa: E501

        :param anchor_date: The anchor_date of this OpenEvent.  # noqa: E501
        :type anchor_date: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this OpenEvent.  # noqa: E501
        ...
        :return: The instrument_event_type of this OpenEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this OpenEvent.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this OpenEvent.  # noqa: E501
        :type instrument_event_type: str
        """

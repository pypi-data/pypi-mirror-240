...
file_path_base = "environment_infras"
with description('EnvironmentInfra') as self:
    with before.each:
        unstub()
        ...
        self.instance = self.instance_parent.environment_infra

    with context("__init__"):
        with it("shoud get an instance"):
            expect(isinstance(self.instance, cnd_eyes_injector._environment_infra.EnvironmentInfra)).to(equal(True))

...
file_path_base = "softwares"
with description('Software') as self:
    with before.each:
        unstub()
        ...
        self.instance = self.instance_parent.software

    with context("__init__"):
        with it("shoud get an instance"):
            expect(isinstance(self.instance, cnd_eyes_injector._software.Software)).to(equal(True))

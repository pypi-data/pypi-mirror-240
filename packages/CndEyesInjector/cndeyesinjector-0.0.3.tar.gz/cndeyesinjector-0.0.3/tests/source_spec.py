...
file_path_base = "sources"
with description('Source') as self:
    with before.each:
        unstub()
        ...
        self.instance = self.instance_parent.source

    with context("__init__"):
        with it("shoud get an instance"):
            expect(isinstance(self.instance, cnd_eyes_injector._source.Source)).to(equal(True))

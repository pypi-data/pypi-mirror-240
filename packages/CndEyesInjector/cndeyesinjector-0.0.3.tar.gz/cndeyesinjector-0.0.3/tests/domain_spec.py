...
file_path_base = "domains"
with description('Domain') as self:
    with before.each:
        unstub()
        ...
        self.instance = self.instance_parent.domain

    with context("__init__"):
        with it("shoud get an instance"):
            expect(isinstance(self.instance, cnd_eyes_injector._domain.Domain)).to(equal(True))

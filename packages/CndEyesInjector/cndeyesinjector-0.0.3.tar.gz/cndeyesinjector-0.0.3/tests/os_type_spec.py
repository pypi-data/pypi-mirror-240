...
file_path_base = "os_types"
with description('OsType') as self:
    with before.each:
        unstub()
        ...
        self.instance = self.instance_parent.os_type

    with context("__init__"):
        with it("shoud get an instance"):
            expect(isinstance(self.instance, cnd_eyes_injector._os_type.OsType)).to(equal(True))

...
DynamicsAvoidSelfCollisionsConstraint = typing.NewType("DynamicsAvoidSelfCollisionsConstraint", None)
...
KinematicsAvoidSelfCollisionsConstraint = typing.NewType("KinematicsAvoidSelfCollisionsConstraint", None)
...
class CubicSpline3D:
  ...
  def add_point(
    self: CubicSpline3D,
    pos: float, # double
    val: numpy.ndarray, # Eigen::Vector3d
    delta: numpy.ndarray, # Eigen::Vector3d
...
class DynamicsAvoidSelfCollisionsConstraint:
  def __init__(
    arg1: object,
  ...
  def configure(
    self: DynamicsAvoidSelfCollisionsConstraint,
    name: str, # std::string
    priority: any, # placo::dynamics::RelativePositionTask::Priority
    weight: float = 1.0, # double
...
class DynamicsSolver:
  def __init__(
    self: DynamicsSolver,
    robot: RobotWrapper, # placo::RobotWrapper
  ...
  ) -> DynamicsAvoidSelfCollisionsConstraint:
...
class Footstep:
  ...
  side: any # placo::HumanoidRobot::Side
...
class FootstepsPlanner:
  def __init__(
    ...
    parameters: HumanoidParameters, # placo::HumanoidParameters
  ...
  def add_first_support(
    supports: Support, # placo::FootstepsPlanner::Support
  ...
  @staticmethod
  def make_supports(
    footsteps: Footstep, # placo::FootstepsPlanner::Footstep
...
class FootstepsPlannerNaive:
  ...
  def plan(
    self: FootstepsPlannerNaive,
    flying_side: any, # placo::HumanoidRobot::Side
...
class HumanoidRobot:
  ...
  def frame_jacobian(
    ...
    :return: jacobian (6 x nv matrix), where nv is the size of"""
    ...
  ...
  def frame_jacobian_time_variation(
    ...
    :return: jacobian time variation (6 x nv matrix), where nv is the size of"""
    ...
  ...
  def get_com_velocity(
    self: HumanoidRobot,
    support: any, # placo::HumanoidRobot::Side
  ...
  def get_joint_offset(
    ...
    """Gets the offset for a given joint in the 
  ...
  def self_collisions(
    ...
    """Finds the self collision in current state, if 
  ...
  def set_velocity_limits(
    ...
    """Set the velocity limits for 

    :param limit: limit"""
    ...

  state: RobotWrapper_State # placo::RobotWrapper::State
...
class Integrator:
  A: numpy.ndarray # Eigen::MatrixXd
  """The discrete system matrix such that """
...
class KinematicsAvoidSelfCollisionsConstraint:
  def __init__(
    arg1: object,
  ...
  def configure(
    self: KinematicsAvoidSelfCollisionsConstraint,
    name: str, # std::string
    priority: any, # placo::dynamics::RelativePositionTask::Priority
    weight: float = 1.0, # double
...
class KinematicsSolver:
  ...
  def __init__(
    ...
    robot_: RobotWrapper, # placo::RobotWrapper
  ...
  ) -> KinematicsAvoidSelfCollisionsConstraint:
...
class ProblemConstraint:
  """Represents a constraint to be enforced by a """
  def __init__(
    arg1: object,
...
class Sparsity:
  ...
  intervals: SparsityInterval # placo::problem::Sparsity::Interval
...
class Support:
  ...
  def side(
    ...
    """The support side (you should call"""
    ...
...
class SwingFoot:
  """A cubic fitting of swing foot, see: """
  def __init__(
    arg1: object,
...
class WalkPatternGenerator:
  def __init__(
    ...
    robot: HumanoidRobot, # placo::HumanoidRobot
    parameters: HumanoidParameters, # placo::HumanoidParameters

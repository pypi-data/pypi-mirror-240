...
def structured_match(results_, target, *, ops=None, interface=None, op_attrs=None, filter_result_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(MatchOp(results_=results_, target=target, ops=ops, interface=interface, op_attrs=op_attrs, filter_result_type=filter_result_type, loc=loc, ip=ip))
  ...
  def __init__(self, padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_461')) else
          _ods_ir.AttrBuilder.get('anonymous_461')(transpose_paddings, context=_ods_context))
...
def structured_vectorize_children_and_apply_patterns(transformed, target, *, vectorize_padding=None, vectorize_nd_extract=None, disable_multi_reduction_to_contract_patterns=None, disable_transfer_permutation_map_lowering_patterns=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(VectorizeChildrenAndApplyPatternsOp(transformed=transformed, target=target, vectorize_padding=vectorize_padding, vectorize_nd_extract=vectorize_nd_extract, disable_multi_reduction_to_contract_patterns=disable_multi_reduction_to_contract_patterns, disable_transfer_permutation_map_lowering_patterns=disable_transfer_permutation_map_lowering_patterns, loc=loc, ip=ip))

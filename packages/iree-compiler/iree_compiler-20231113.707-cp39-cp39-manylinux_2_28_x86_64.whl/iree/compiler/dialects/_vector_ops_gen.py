...
def load(result, base, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(LoadOp(result=result, base=base, indices=indices, loc=loc, ip=ip))
...
def store(value_to_store, base, indices, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(StoreOp(valueToStore=value_to_store, base=base, indices=indices, loc=loc, ip=ip))
...
def transpose(result, vector, transp, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TransposeOp(result=result, vector=vector, transp=transp, loc=loc, ip=ip))

...
class DispatchExternOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, export, workload, arguments, argument_dims, result_dims, layout, objects, *, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, bindings=None, tied_operands=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def dispatch_extern(results_, export, workload, arguments, argument_dims, result_dims, layout, objects, *, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, bindings=None, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchExternOp(results_=results_, export=export, workload=workload, arguments=arguments, argument_dims=argument_dims, result_dims=result_dims, layout=layout, objects=objects, workgroup_size=workgroup_size, subgroup_size=subgroup_size, workgroup_local_memory=workgroup_local_memory, bindings=bindings, tied_operands=tied_operands, loc=loc, ip=ip))
...
def ex_shared_device(result, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExSharedDeviceOp(result=result, loc=loc, ip=ip))
...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_745')) else
      _ods_ir.AttrBuilder.get('anonymous_745')(function_type, context=_ods_context))

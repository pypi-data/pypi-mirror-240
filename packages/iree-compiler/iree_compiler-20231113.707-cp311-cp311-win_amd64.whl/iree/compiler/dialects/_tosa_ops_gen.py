...
def conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(Conv2DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, loc=loc, ip=ip))
...
def conv3d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(Conv3DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, loc=loc, ip=ip))
...
def depthwise_conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DepthwiseConv2DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, loc=loc, ip=ip))
...
def fft2d(output_real, output_imag, input_real, input_imag, inverse, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(FFT2dOp(output_real=output_real, output_imag=output_imag, input_real=input_real, input_imag=input_imag, inverse=inverse, loc=loc, ip=ip))
...
def rfft2d(output_real, output_imag, input, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(RFFT2dOp(output_real=output_real, output_imag=output_imag, input=input, loc=loc, ip=ip))
...
def transpose_conv2d(output, input, filter, bias, out_pad, stride, out_shape, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TransposeConv2DOp(output=output, input=input, filter=filter, bias=bias, out_pad=out_pad, stride=stride, out_shape=out_shape, quantization_info=quantization_info, loc=loc, ip=ip))

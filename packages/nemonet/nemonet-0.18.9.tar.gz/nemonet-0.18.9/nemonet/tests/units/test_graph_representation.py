...
class MyTestCase(unittest.TestCase):
    ...
    def test_action_str(self):
        ...
        a = Action("some_xpathstring", "DUMMY", value="value", wait_after= 3, key = "something")
        expected = 'type=DUMMY xpath=some_xpathstring value=value key=something waitafter=3'

        expect = 'nodename=None ' + expected
        actual = str(a)
        self.assertEqual(expect, actual, msg="action str seems to have changed")

        expect = 'nodename=some_nodename ' + expected
        a.set_node_name("some_nodename")
        actual = str(a)
        self.assertEqual(expect, actual, msg="node_name changes should be reflected ins str")

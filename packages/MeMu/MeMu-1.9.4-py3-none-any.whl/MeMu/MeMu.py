...
class Memu:
    def __init__(self):
        ...
        self.font_path = pkg_resources.resource_filename(__name__, 'fonts/Gbboot-ALpM.ttf')
        self.custom_font = font.Font(family="G.B.BOOT", name="G.B.BOOT")
        self.image_path = pkg_resources.resource_filename(__name__, 'images/bg.png')
        self.icon_path = pkg_resources.resource_filename(__name__, 'icons/icon.ico')
        ...
        self.main_font.configure(file=self.font_path)
        self.main_font_bold_large = ctk.CTkFont(family="G.B.BOOT", size=64, weight='bold')
        self.main_font_bold_large.configure(file=self.font_path)
        self.main_font_small = ctk.CTkFont(family="G.B.BOOT", size=16)
        self.main_font_small.configure(file=self.font_path)

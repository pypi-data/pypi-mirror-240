...
# %% auto 0
__all__ = ['isallstr', 'isprivate', 'ismangled', 'issunder', 'isdunder', 'isnilstr', 'ispublic', 'isstar', 'iselps', 'ispunc',
           'isupper', 'islower', 'isquote', 'ischar', 'ischars', 'isuniqchrs', 'isdig', 'isdotstr']

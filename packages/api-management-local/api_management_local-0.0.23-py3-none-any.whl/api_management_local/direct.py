        ...
        try:
                ...
                if arr==None:
                    ...
                    if check!=BIGER_HARD:
                        ...
                        api_call_id=APICall1._insert_api_call_dict(api_call_data_dict)
                    ...
                    APICall1=APICallsLocal()
                    api_call_id=APICall1._insert_api_call_dict(api_call_data_dict)
                    logger.info("bringing result from cache in database", object={'status_code':status_code,'text':text})
                    return {'status_code':status_code,'text':text}                                  

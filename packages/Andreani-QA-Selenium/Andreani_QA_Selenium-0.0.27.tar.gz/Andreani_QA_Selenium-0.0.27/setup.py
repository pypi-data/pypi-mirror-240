...
INSTALL_REQUIRES = [
    ...
    'Andreani-QA-Functions', 'Andreani-QA-Debugger', 'requests', 'selenium==4.11.2', 'webdriver_manager', 'pywin32'
    'humanize==4.3.0', 'loguru==0.6.0', 'numpy==1.23.2', 'opencv_python==4.6.0.66', 'Pillow==9.2.0', 'PyAutoGUI==0.9.53'
]

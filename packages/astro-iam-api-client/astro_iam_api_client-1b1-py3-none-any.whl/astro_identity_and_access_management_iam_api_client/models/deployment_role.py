...
from ..models.deployment_role_role import DeploymentRoleRole
...
class DeploymentRole:
    ...
    Attributes:
        ...
        role (DeploymentRoleRole): The role of the subject in the Deployment. Example: DEPLOYMENT_ADMIN.
    """

    deployment_id: str
    role: DeploymentRoleRole
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        role = DeploymentRoleRole(d.pop("role"))

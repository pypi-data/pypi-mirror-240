...
def load_image_data_mn():
    ...
    model.print_result()
    model.convert(checkpoint="new_mn_ckpt/basenn.pth", out_file="basenn_mn.onnx")
...
def load_npz_data_tang():
    ...
    model.convert(checkpoint="111ckpt/basenn.pth", out_file="basenn_tang.onnx")

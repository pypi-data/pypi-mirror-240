...
class GeometryRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["method_id", b"method_id", "mill", b"mill", "previews", b"previews", "source", b"source", "thickness", b"thickness", "title_block", b"title_block", "units", b"units"]) -> None: ...

...
from abstract_ai.gui_components.abstract_ai_gui_shared import instructions_keys, all_token_keys, test_options_keys
...
def signal_handler(signum, frame):
    prompt_manager.set_shutdown_flag()
    # Set shutdown flags for other managers if necessary
...
#PromptManagement
    ...
    def chunk_event_check(self):
 	...
 	"""
        ...
        if self.event in section_navigation_keys+sub_navigation_keys:

...
def process_speech(service="google", language="en-US"):
    print("Please speak into the microphone...")
    response = recognize_speech_from_mic(
        r, sr.Microphone(), service=service, language=language
    )
    print("Please speak into the microphone...")
    language = input(
        "Enter the language code (e.g., 'en-US' for English, 'es-ES' for Spanish): "
    )

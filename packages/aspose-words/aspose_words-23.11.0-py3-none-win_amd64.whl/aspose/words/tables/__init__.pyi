...
class PreferredWidth:
    ...
    @staticmethod
    def from_percent(percent: float) -> aspose.words.tables.PreferredWidth:
    ...
    @staticmethod
    def from_points(points: float) -> aspose.words.tables.PreferredWidth:
...
class AutoFitBehavior(Enum):
    ...
    The widths of the cells remain as they are specified by their :attr:`CellFormat.width` properties."""
...
class CellVerticalAlignment(Enum):

...
class IStructuredDocumentTag:
    ...
    def placeholder_name(self) -> str:
        ...
        :raises RuntimeError (Proxy error(InvalidOperationException)): Throw if BuildingBlock with this name :attr:`aspose.words.buildingblocks.BuildingBlock.name` is not present in :attr:`aspose.words.Document.glossary_document`."""
        ...
...
class SmartTag(aspose.words.CompositeNode):
    ...
    def __init__(self, doc: aspose.words.DocumentBase):
        ...
        and :attr:`aspose.words.Node.parent_node` is null. To insert a node into the document, use the
        :meth:`aspose.words.CompositeNode.insert_after` or :meth:`aspose.words.CompositeNode.insert_before`
...
class SdtAppearance(Enum):
    ...
    """Defaults to :attr:`SdtAppearance.BOUNDING_BOX`."""
    DEFAULT: int
    

class SdtCalendarType(Enum):
    ...
    """Used as default value in OOXML. Equals :attr:`SdtCalendarType.GREGORIAN`."""
    DEFAULT: int
    ...
    None is not default for OOXML, instead :attr:`SdtCalendarType.GREGORIAN` is default and is first member of this enum."""
    NONE: int
...
class SdtDateStorageFormat(Enum):
    ...
    """Defaults to :attr:`SdtDateStorageFormat.DATE_TIME`"""
    DEFAULT: int

...
def firmem_read_port(memory, address, clk, *, enable=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def firmem_read_write_port(memory, address, clk, write_data, mode, *, enable=None, mask=None, loc=None, ip=None) -> _ods_ir.OpResult:

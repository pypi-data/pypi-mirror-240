...
from olympict.utils.bbox_painter import (
    BBoxAbsolutePainter,
    BBoxHFPainter,
    HeatmapOperation,
...
from olympict.utils.image_op import (
    CropOperation,
    DiscarderOperation,
    ImageOperation,
    RandomCropOperation,
)
from olympict.utils.path_op import (
    ExtensionOperation,
    FolderOperation,
    PathOperation,
    VideoSequencer,
...
class ImagePipeline(OPipeline[OlympImage]):
    ...
    def load_paths(
        ...
        return ImagePipeline(tqdm(data))
    ...
    def load_folders(
        ...
        return ImagePipeline(tqdm(all_data))
...
class VideoPipeline(OPipeline[OlympVid]):
    ...
    def load_folder(
        ...
        return VideoPipeline(tqdm(data))

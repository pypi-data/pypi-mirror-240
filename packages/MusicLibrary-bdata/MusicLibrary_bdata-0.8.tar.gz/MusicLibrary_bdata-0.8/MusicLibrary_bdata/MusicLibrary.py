...
class LyricsSearch:
    ...
    def search_lyrics(self):
        ...
        Returns:
            ...
            track_id (str): Identificadores único de la canción.
        """
    ...
    def top_songs_by_country(self):
        ...
        Returns:
            songs_info (list): Lista de diccionarios con detalles de las canciones, incluyendo el nombre de la canción, la calificación, el ID común de la canción y las letras.
        """

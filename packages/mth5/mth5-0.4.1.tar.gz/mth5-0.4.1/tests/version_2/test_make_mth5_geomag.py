...
class TestMakeMTH5FromGeomag(unittest.TestCase):
    ...
    def test_survey_metadata(self):
        s = self.m.get_survey("USGS-GEOMAG")
        sm = OrderedDict(
            [
    ...
    def test_station_frn(self):
        s = self.m.get_station("Fresno", survey="USGS-GEOMAG")
        sm = OrderedDict(
            [
    ...
    def test_fresno_run_001_metadata(self):
        r = self.m.get_run("Fresno", "sp1_001", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
    ...
    def test_fresno_run_002_metadata(self):
        r = self.m.get_run("Fresno", "sp1_002", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_fresno_run_001_hx_metadata(self):
        r = self.m.get_channel("Fresno", "sp1_001", "hx", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hx"),
    ...
    def test_fresno_run_001_hy_metadata(self):
        r = self.m.get_channel("Fresno", "sp1_001", "hy", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hy"),
    ...
    def test_station_ottowa(self):
        s = self.m.get_station("Ottowa", survey="USGS-GEOMAG")
        sm = OrderedDict(
            [
                ("acquired_by.name", None),
                ("channels_recorded", ["hx", "hy"]),
    ...
    def test_ottowa_run_001_metadata(self):
        r = self.m.get_run("Ottowa", "sp1_001", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_ottowa_run_002_metadata(self):
        r = self.m.get_run("Ottowa", "sp1_002", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_ottowa_run_001_hx_metadata(self):
        r = self.m.get_channel("Ottowa", "sp1_001", "hx", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hx"),
    ...
    def test_ottowa_run_001_hy_metadata(self):
        r = self.m.get_channel("Ottowa", "sp1_001", "hy", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hy"),

...
SYNDB_TABLE_NAME_TO_ENUM = {e.name: e for e in SyndbTable}
...
COMPARTMENT_HIERARCHY: list[tuple[SyndbTable, ...]] = [
    ...
    (SyndbTable.MITOCHONDRIA, SyndbTable.ENDOPLASMIC_RETICULUM, SyndbTable.NUCLEUS, SyndbTable.VESICLE),
]
...
for level in range(1, len(COMPARTMENT_HIERARCHY)):
    ...
    for l_comp in COMPARTMENT_HIERARCHY[level]:
        compartment_to_valid_parents[l_comp] = ascending_parents

hierarchy_descending = [SyndbTable.NEURON, *compartment_to_valid_parents]

		...
		def drawfft(event):
			...
			try:
				...
				figureinfo={
					...
					"x_lim":None if entry_fxa.get()=="" or entry_fxb.get()=="" else (str_to_float(entry_fxa.get()),str_to_float(entry_fxb.get())),
					"y_lim":None if entry_fya.get()=="" or entry_fyb.get()=="" else (str_to_float(entry_fya.get()),str_to_float(entry_fyb.get()))
				}
		...
		def drawlines(event):
			...
			try:
				...
				figureinfo={
					...
					"x_lim":None if entry_fxa.get()=="" or entry_fxb.get()=="" else (str_to_float(entry_fxa.get()),str_to_float(entry_fxb.get())),
					"y_lim":None if entry_fya.get()=="" or entry_fyb.get()=="" else (str_to_float(entry_fya.get()),str_to_float(entry_fyb.get())),
					"z_lim":None if entry_fya.get()=="" or entry_fyb.get()=="" else (str_to_float(entry_fza.get()),str_to_float(entry_fzb.get()))
				}
				for i in entry_fargs.get().split("@"):
					iic=i.split("=")
					if len(iic)==2:

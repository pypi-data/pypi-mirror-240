...
def get(Dataobj,quantity_name,args={},vargs={}):
	...
	for i in need:
		if i not in Dataobj.quantities.keys() and i not in vargs.keys():
			...
			return Dataobj
	quantities={
		"BVF_"+rho+"_"+prs:-1/Dataobj.quantities[rho]*Dataobj.quantities["Gradient_"+prs+"_x1"]*(1/Dataobj.quantities["gamma"]/Dataobj.quantities[prs]*Dataobj.quantities["Gradient_"+prs+"_x1"]-1/Dataobj.quantities[rho]*Dataobj.quantities["Gradient_"+rho+"_x1"])
	}

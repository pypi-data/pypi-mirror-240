...
from .digit import DigitLists, possible_ProvMaker_digits
...
class Prov(Enum):
    """A ProvMaker of a statute may be abbreviated and the same may have different variations:
    ...
    def create_attribute_rules(
        self,
        attrs: dict[str, Any],
        digit_patterns: list[dict[str, Any]] = possible_ProvMaker_digits,
        index: int = 1,
    ):

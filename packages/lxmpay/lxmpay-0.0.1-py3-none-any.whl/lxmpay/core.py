...
from lxmpay.models import PayMethod, PayResult, PayType
import abc
...
class AsyncPayCore():
    ...
    @abc.abstractmethod
    async def cancel(self, refund_trace_no: str, refund_fee: int, out_trade_no: str, trade_no: str = None, **kwargs) -> Dict:
        '''

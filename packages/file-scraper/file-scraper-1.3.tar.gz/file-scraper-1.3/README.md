...
* remove `jq` from the tool so it can be OS independent.
...
python3 -m pip install dist/file_scraper-1.3-py3-none-any.whl
...
| decode | boolean | no | Decode matches. Available decodings: `base64`, `url`. |
...
```fundamental
File Scraper v1.3 ( github.com/ivan-sincek/file-scraper )
...
<p align="center"><img src="https://github.com/ivan-sincek/file-scraper/blob/main/img/apk_craping.png" alt="APK Scraping"></p>

<p align="center">Figure 1 - APK Scraping</p>
...
<p align="center">Figure 2 - Interactive Report</p>

...
class AicaEndpoint(object):
    ...
    def __init__(self, name=None, aviary_version=None, service_id=None, model_config=None, id=None, created_at=None, creator_id=None, creator_email=None, archived_at=None, cloud_id=None, project_id=None, state=None, local_vars_configuration=None):  # noqa: E501

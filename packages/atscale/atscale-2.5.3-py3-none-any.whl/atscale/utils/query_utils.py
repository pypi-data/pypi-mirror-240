...
def generate_db_query(
    ...
    """
    logger.info(
        "The function generate_db_query is will be deprecated in version 2.7, please use DataModel.get_database_query instead. "
    )

    inspection = getfullargspec(generate_db_query)

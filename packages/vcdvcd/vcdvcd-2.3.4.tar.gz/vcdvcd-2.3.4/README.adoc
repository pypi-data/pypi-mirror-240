...
TODO: this option is now broken because Pypi deleted the package https://pypi.org/project/china-dictatorship/ without any notification in 2023. Transparency and freedom of speech is not their thing apparently, oh well.

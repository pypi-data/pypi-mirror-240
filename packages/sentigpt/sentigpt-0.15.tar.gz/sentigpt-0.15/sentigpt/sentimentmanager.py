...
class SentimentManager:
    ...
    def translate_en2kr(self, sentence_en:str) -> list:
        try:
        ...
        return [sentence_en, sentence_kr]
    ...
    def plot_hist_each(self, df_analyzed_results:pd.DataFrame, output_folder=None, file_name=None):
        if df_analyzed_results is None:
            return None
        else:
    ...
    def plot_hist_all(self, df_analyzed_results:pd.DataFrame, output_folder=None, file_name=None):
        if df_analyzed_results is None:
            return None
        else:
            sns.set(style="white")

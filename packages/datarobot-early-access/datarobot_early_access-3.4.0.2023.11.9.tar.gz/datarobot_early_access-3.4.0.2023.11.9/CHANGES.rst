...
- Added a new class, :class:`CustomModel <datarobot._experimental.models.genai.custom_model.CustomModel>`, for registering a custom model from a generative AI LLM blueprint.
  :meth:`CustomModel.create <datarobot._experimental.models.genai.custom_model.CustomModel.create>` creates a new custom model from an LLM blueprint.

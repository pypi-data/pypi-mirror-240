...
from pybi.core.components.containerComponent import QsSizebarComponent, QsTabsComponent
...
class App(ContainerComponent):
    def __init__(self) -> None:
        ...
        self.sizebar: Optional[QsSizebarComponent] = None
    ...
    def to_html(self, file, display_output_path=False):
        try:
            ...
            raw = self._resourceManager.build_html(
...
class ElementUi:
    ...
    def sizebar(
        ...
        *,
        ...
        cp = SizebarComponent(appHost=self.__app)
        host = host or self.__app._get_temp_host() or self.__app
        host._add_children(cp)
        self.__app._resourceManager.register_element_cps()
...
class Quasar:
    ...
    def sizebar(self):
        ...
        cp = QsSizebarComponent(appHost=self.__app)
        app = self.__app
        app.sizebar = cp
        self.__app._resourceManager.register_quasar_cps()
        return cp

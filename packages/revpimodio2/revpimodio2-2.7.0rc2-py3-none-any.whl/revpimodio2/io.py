...
class RelaisOutput(IOBase):
    ...
    This class is for the output variant, in which all relays are defined
    as BOOL.
    ...
    def __init__(self, parentdevice, valuelist, iotype, byteorder, signed):
        ...
        self.__ioctl_arg_format = "<HxIIII"
    ...
    def get_switching_cycles(self):
        ...
        :return: Number of switching cycles as single value or tuple of all
        """

...
class HyperV:
    ...
    def gen_job(self, job, vms_list=[], **kwargs):
        ...
        if kwargs:
            ...
            if 'get_snapshot' in kwargs.keys(): params = f"| Get-VMSnapshot | Format-Table -AutoSize | Out-String -Width 4096"
            if 'current_snapshot' in kwargs.keys(): params = f"| select Name, ParentSnapshotName | Format-Table -AutoSize | Out-String -Width 4096"

...
class Figure:
    ...
    def line(self, x: Union[str, list, np.ndarray, pd.Series], y: Union[str, list, np.ndarray, pd.Series],
             ...
             ,sortOrder: Optional[str]= None, sortOn: Optional[str]=None, xAxisName:Optional[str]=None, yAxisName: Optional[str]=None):
        """
    ...
    def scatter(self, x: Union[str, list, np.ndarray, pd.Series], y: Union[str, list, np.ndarray, pd.Series],
                ...
                animationDuration: Optional[float]=None, animationType: Optional[str]='parallel', sortOrder: Optional[str]= None, sortOn: Optional[str]=None, xAxisName:Optional[str]=None, yAxisName: Optional[str]=None):
        """
    ...
    def candlestick(self, df: pd.DataFrame, label: Optional[str] = None, indicators: Optional[list] = None, animationDelay: Optional[float] = None, animationDuration: Optional[float] = None, xAxisName:Optional[str]=None, yAxisName: Optional[str]=None ):

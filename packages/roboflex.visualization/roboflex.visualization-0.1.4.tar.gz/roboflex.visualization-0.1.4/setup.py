...
setup(
    ...
    version='0.1.4',
    description='Roboflex Visualization Library',
    ...
    ext_modules=[CMakeExtension('roboflex/visualization/roboflex_visualization_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.visualization'],
    package_dir={'roboflex.visualization': 'python'}
)

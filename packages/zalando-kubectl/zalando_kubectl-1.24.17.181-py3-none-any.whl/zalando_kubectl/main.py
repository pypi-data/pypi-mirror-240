...
def decrypt(env: Environment, role, okta, encrypted_value):
    ...
    if okta:
        ...
        # zalando-aws-cli v0.4.0 always adds a newline to the decrypted output:
        #
        #   https://github.bus.zalan.do/Base-Infrastructure/zalando-aws-cli/blob/v0.4.0/cmd/secrets.go#L218
        #
        # To ensure values are returned in the same way as with non-Okta encrypted values, we strip the last character.

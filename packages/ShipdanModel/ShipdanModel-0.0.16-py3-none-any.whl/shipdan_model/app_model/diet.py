...
class DietPlan(models.Model):
    first_day_diet_id = models.IntegerField(help_text='백필용 필드. 배포 후 삭제될 예정', null=True, default=True)
...
class DietPlanFood(models.Model):
    ...
    day_diet_food_id = models.IntegerField(help_text='백필용 필드. 배포 후 삭제될 예정', null=True, default=None)
...
class UserMealTagLog(models.Model):
    ...
    user_meal_tag = models.ForeignKey(UserMealTag, related_name='logs', on_delete=models.CASCADE, null=True, default=None)

...
class Controllers:
    ...
    def init_app(self, app):        
        ...
        if has_google:
            self.oauth.register(
                ...
                consumer_key=self.google_key,
                consumer_secret=self.google_secret
            )
    ...
    def authenticate(self, token, next, callback_url, private_token):
        ...
        for provider, params in self.remote_apps.items():
            ...
            login_url = params.app.create_authorization_url(redirect_uri=callback_url, state=pstate)['url']
    ...
    def oauth_callback(self, state, callback_url, private_token,
        ...
        if provider is not None:
            try:
                ...
                access_token = app.authorize_access_token()

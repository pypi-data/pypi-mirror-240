...
__all__ = ['AbsoluteSensorRange', 'AxisDirection', 'BasePigeon', 'BasePigeonConfigUtils', 'BasePigeonConfiguration', 'BasePigeonSimCollection', 'CANCoder', 'CANCoderConfigUtils', 'CANCoderConfiguration', 'CANCoderFaults', 'CANCoderSimCollection', 'CANCoderStatusFrame', 'CANCoderStickyFaults', 'MagnetFieldStrength', 'Pigeon2', 'Pigeon2ConfigUtils', 'Pigeon2Configuration', 'Pigeon2_Faults', 'Pigeon2_StickyFaults', 'PigeonIMU', 'PigeonIMUConfigUtils', 'PigeonIMUConfiguration', 'PigeonIMU_ControlFrame', 'PigeonIMU_Faults', 'PigeonIMU_StatusFrame', 'PigeonIMU_StickyFaults', 'SensorInitializationStrategy', 'SensorTimeBase', 'SensorVelocityMeasPeriod', 'WPI_CANCoder', 'WPI_Pigeon2', 'WPI_PigeonIMU']
...
class AxisDirection:
    ...
    Members:
      ...
      NegativeX
    """
    NegativeX: typing.ClassVar[AxisDirection]  # value = <AxisDirection.NegativeX: 5>
    NegativeY: typing.ClassVar[AxisDirection]  # value = <AxisDirection.NegativeY: 4>
    NegativeZ: typing.ClassVar[AxisDirection]  # value = <AxisDirection.NegativeZ: 3>
    PositiveX: typing.ClassVar[AxisDirection]  # value = <AxisDirection.PositiveX: 2>
    PositiveY: typing.ClassVar[AxisDirection]  # value = <AxisDirection.PositiveY: 1>
    PositiveZ: typing.ClassVar[AxisDirection]  # value = <AxisDirection.PositiveZ: 0>
    __members__: typing.ClassVar[dict[str, AxisDirection]]  # value = {'PositiveZ': <AxisDirection.PositiveZ: 0>, 'PositiveY': <AxisDirection.PositiveY: 1>, 'PositiveX': <AxisDirection.PositiveX: 2>, 'NegativeZ': <AxisDirection.NegativeZ: 3>, 'NegativeY': <AxisDirection.NegativeY: 4>, 'NegativeX': <AxisDirection.NegativeX: 5>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class Pigeon2(BasePigeon):
    ...
    def __init__(self, deviceNumber: int, canbus: str = '') -> None:
        ...
        :param canbus:       Name of the CANbus; can be a SocketCAN interface (on Linux),
                             or a CANivore device name or serial number
        """
    def configAllSettings(self, settings: Pigeon2Configuration, timeoutMs: int = 50) -> phoenix5._ctre.ErrorCode:
        """
        Configures all persistent settings.
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configDisableNoMotionCalibration(self, disable: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def configDisableTemperatureCompensation(self, disable: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode Status of the config response
        """
    def configEnableCompass(self, enable: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    @typing.overload
    def configMountPose(self, forward: AxisDirection, up: AxisDirection, timeoutMs: int = 50) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    @typing.overload
    def configMountPose(self, yaw: float, pitch: float, roll: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def configMountPosePitch(self, pitch: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def configMountPoseRoll(self, roll: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode of configSet
        """
    def configMountPoseYaw(self, yaw: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode of configSet
        """
    def configXAxisGyroError(self, err: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def configYAxisGyroError(self, err: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode fo configSet
        """
    def configZAxisGyroError(self, err: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
    ...
    def getAllConfigs(self, allConfigs: Pigeon2Configuration, timeoutMs: int = 50) -> None:
        ...
        :param timeoutMs:  Timeout value in ms. If nonzero, function will wait for
                           ...
                           If zero, no blocking or checking is performed.
        """
    def getFaults(self, toFill: Pigeon2_Faults) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def getGravityVector(self) -> tuple[phoenix5._ctre.ErrorCode, typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]]:
        """
        ...
        """
    def getStickyFaults(self, toFill: Pigeon2_StickyFaults) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def zeroGyroBiasNow(self, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
...
class Pigeon2ConfigUtils:
    ...
    def __init__(self) -> None:
        ...
class Pigeon2Configuration(phoenix5._ctre.CustomParamConfiguration):
    """
    Configurables available to Pigeon
    """
    DisableNoMotionCalibration: bool
    DisableTemperatureCompensation: bool
    EnableCompass: bool
    MountPosePitch: float
    MountPoseRoll: float
    MountPoseYaw: float
    XAxisGyroError: float
    YAxisGyroError: float
    ZAxisGyroError: float
    def __init__(self) -> None:
        ...
    @typing.overload
    def toString(self) -> str:
...
class WPI_CANCoder(CANCoder, wpiutil._wpiutil.Sendable):
    ...
    def initSendable(self, builder: wpiutil._wpiutil.SendableBuilder) -> None:
        ...
class WPI_Pigeon2(Pigeon2, wpilib.interfaces._interfaces.Gyro, wpiutil._wpiutil.Sendable):
    def __init__(self, deviceNumber: int, canbus: str = '') -> None:
        """
    ...
    def reset(self) -> None:
        ...
class WPI_PigeonIMU(PigeonIMU, wpilib.interfaces._interfaces.Gyro, wpiutil._wpiutil.Sendable):
    @typing.overload
    def __init__(self, deviceNumber: int) -> None:
        """

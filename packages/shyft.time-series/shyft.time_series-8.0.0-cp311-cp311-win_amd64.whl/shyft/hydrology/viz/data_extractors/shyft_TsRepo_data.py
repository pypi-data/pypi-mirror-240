import numpy as np
from shyft.time_series import TsVector,TimeAxis,UtcTimeVector,Calendar
...
class TsRepoDataExtractor:
    def __init__(self, shyft_data_ext, ref_repo, ref_ts, period):
        ...
        self.cal = Calendar()
        self.t_ax_shyft = TimeAxis(UtcTimeVector(self.t_ax.tolist()))

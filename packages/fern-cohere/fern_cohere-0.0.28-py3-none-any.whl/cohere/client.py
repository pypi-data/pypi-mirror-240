...
class Cohere:
    ...
    def generate(
        ...
        *,
        ...
        Parameters:
            ...
            - stream: typing.Optional[bool]. When `true`, the response will be a JSON stream of events. Streaming is beneficial for user interfaces that render the contents of the response piece by piece, as it gets generated.
        ...
        *,
        ...
        Parameters:
            ...
            - examples: typing.List[ClassifyRequestExamplesItem]. An array of examples to provide context to the model. Each example is a text string and its associated label/class. Each unique label requires at least 2 examples associated with it; the maximum number of examples is 2500, and each example has a maximum length of 512 tokens. The values should be structured as `{text: "...",label: "..."}`.
                                                                  Note: [Custom Models](/training-representation-models) trained on classification examples don't require the `examples` parameter to be passed in explicitly.
            - model: typing.Optional[str]. The identifier of the model. Currently available models are `embed-multilingual-v2.0`, `embed-english-light-v2.0`, and `embed-english-v2.0` (default). Smaller "light" models are faster, while larger models will perform better. [Custom models](/docs/training-custom-models) can also be supplied with their full ID.
    ...
    def chat_stream(
        ...
        *,
        ...
        Parameters:
            ...
            - connectors: typing.Optional[typing.List[ChatConnector]]. Currently only accepts `{"id": "web-search"}`.
                                                                       When specified, the model's reply will be enriched with information found by quering each of the connectors (RAG).

            - search_queries_only: typing.Optional[bool]. Defaults to `false`.
                                                          When `true`, the response will only contain a list of generated search queries, but no search will take place, and no reply from the model to the user's `message` will be generated.

            - documents: typing.Optional[typing.List[ChatDocument]]. A list of relevant documents that the model can use to enrich its reply (RAG).
    ...
    def detect_language(self, *, texts: typing.List[str], model: typing.Optional[str] = OMIT) -> DetectLanguageResponse:
        ...
        client = Cohere(token="YOUR_TOKEN")
        client.detect_language(texts=[])
        """
        _request: typing.Dict[str, typing.Any] = {"texts": texts}
        if model is not OMIT:
            _request["model"] = model
...
class AsyncCohere:
    ...
    async def detect_language(
        ...
        client = AsyncCohere(token="YOUR_TOKEN")
        await client.detect_language(texts=[])
        """
        _request: typing.Dict[str, typing.Any] = {"texts": texts}
        if model is not OMIT:
            _request["model"] = model

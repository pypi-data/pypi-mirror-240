...
from arc_vector_client.fastembed_common import QueryResponse
from arc_vector_client.http import models
from arc_vector_client.uploader.uploader import iter_batch
...
class ArcVectorFastembedMixin(ArcVectorBase):
    ...
    def get_vector_field_name(self) -> str:
        """
        Returns name of the vector field in arc_vector collection, used by current fastembed model.
        Returns:
    ...
    def add(
        ...
        **kwargs: Any,
        ...
        """
        Adds text documents into arc_vector collection.
    ...
    def query(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional search parameters. See `arc_vector_client.models.SearchRequest` for details.

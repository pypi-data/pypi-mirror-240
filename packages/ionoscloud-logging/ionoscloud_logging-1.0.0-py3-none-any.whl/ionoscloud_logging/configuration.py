...
conf = ionoscloud_logging.Configuration(
    token='AuthToken'
    token_prefix='Bearer'
)
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://logging.de-txl.ionos.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ionoscloud_logging")

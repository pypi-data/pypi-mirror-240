...
class Destination(object):
    ...
    def __init__(self, type='loki', retention_in_days=30, local_vars_configuration=None):  # noqa: E501
    ...
    def type(self):
        ...
        The internal output stream to send logs to  # noqa: E501
    ...
    def retention_in_days(self):
        """Gets the retention_in_days of this Destination.  # noqa: E501

        defines the number of days a log record should be kept in loki. Works with loki destination type only.  # noqa: E501

        :return: The retention_in_days of this Destination.  # noqa: E501
        :rtype: int
        """
    ...
    def retention_in_days(self, retention_in_days):
        """Sets the retention_in_days of this Destination.

        defines the number of days a log record should be kept in loki. Works with loki destination type only.  # noqa: E501

        :param retention_in_days: The retention_in_days of this Destination.  # noqa: E501
        :type retention_in_days: int
        """
        allowed_values = [7, 14, 30]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and retention_in_days not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `retention_in_days` ({0}), must be one of {1}"  # noqa: E501

...
import ionoscloud_logging.models
from ionoscloud_logging import rest
from ionoscloud_logging.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_logging.models, klass)

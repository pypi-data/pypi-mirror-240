...
class CreateRequestProperties(object):
    ...
    openapi_types = {
        ...
        'logs': 'list[CreateRequestPipeline]',
    }
    ...
    def __init__(self, name=None, logs=None, local_vars_configuration=None):  # noqa: E501
        """CreateRequestProperties - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this CreateRequestProperties.  # noqa: E501

        The friendly name of your pipeline.  # noqa: E501

        :return: The name of this CreateRequestProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateRequestProperties.

        The friendly name of your pipeline.  # noqa: E501

        :param name: The name of this CreateRequestProperties.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def logs(self):
        """Gets the logs of this CreateRequestProperties.  # noqa: E501

        The information of the log pipelines  # noqa: E501

        :return: The logs of this CreateRequestProperties.  # noqa: E501
        :rtype: list[CreateRequestPipeline]
        """
        return self._logs

    @logs.setter
    def logs(self, logs):
        """Sets the logs of this CreateRequestProperties.

        The information of the log pipelines  # noqa: E501

        :param logs: The logs of this CreateRequestProperties.  # noqa: E501
        :type logs: list[CreateRequestPipeline]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRequestProperties):
            return False

...
class PipelineCreateProperties(object):
    ...
    openapi_types = {
        ...
        'logs': 'list[PipelineCreatePropertiesLogs]',
    }
    ...
    def __init__(self, name=None, logs=None, local_vars_configuration=None):  # noqa: E501
        """PipelineCreateProperties - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PipelineCreateProperties.  # noqa: E501

        The friendly name of your pipeline.  # noqa: E501

        :return: The name of this PipelineCreateProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PipelineCreateProperties.

        The friendly name of your pipeline.  # noqa: E501

        :param name: The name of this PipelineCreateProperties.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def logs(self):
        """Gets the logs of this PipelineCreateProperties.  # noqa: E501

        The information of the log pipelines  # noqa: E501

        :return: The logs of this PipelineCreateProperties.  # noqa: E501
        :rtype: list[PipelineCreatePropertiesLogs]
        """
        return self._logs

    @logs.setter
    def logs(self, logs):
        """Sets the logs of this PipelineCreateProperties.

        The information of the log pipelines  # noqa: E501

        :param logs: The logs of this PipelineCreateProperties.  # noqa: E501
        :type logs: list[PipelineCreatePropertiesLogs]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PipelineCreateProperties):
            return False

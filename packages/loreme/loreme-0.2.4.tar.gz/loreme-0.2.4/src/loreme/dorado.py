...
def dorado_basecall(input_dir, output, speed: int = 400, accuracy: str ='fast',
           ...
           pore: str = 'r10.4.1', bacterial: bool = False,
    ...
    modified_bases : str
        ...
        (default: 5mCG_5hmCG)
    bacterial: bool
        use bacterial methylation model (default: False)
    reference : str
    ...
    if bacterial:
        model = 'res_dna_r10.4.1_e8.2_400bps_sup@2023-09-22_bacterial-methylation'
        no_mod = False

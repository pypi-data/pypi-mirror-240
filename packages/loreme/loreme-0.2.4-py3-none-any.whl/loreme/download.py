...
from loreme.env import (PBCPG_URL, PBCPG_DIR, PB_EXAMPLE_DATA_URLS, EXAMPLE_DATA_DIR, HG38_FTP,
                       ...
                       KAZU_090722_ANNOT_URL, DORADO_BACTERIAL_URL)
...
def download_dorado(pfm, directory=DORADO_DIR, model_dir=DORADO_MODEL_DIR,
    ...
    http = urllib3.PoolManager()
    dest_zipfile = os.path.join(directory, f'res_dna_r10.4.1_e8.2_400bps_sup@2023-09-22_bacterial-methylation.zip')
    with http.request('GET', DORADO_BACTERIAL_URL, preload_content=False) as r, open(dest_zipfile, 'wb') as f:
        shutil.copyfileobj(r, f)
    with zipfile.ZipFile(dest_zipfile, 'r') as zip_ref:

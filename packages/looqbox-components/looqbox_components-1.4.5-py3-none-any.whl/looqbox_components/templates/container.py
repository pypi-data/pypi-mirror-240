        ...
        """
            Args:
                ...
                **properties: Optional properties for the container configuration. Supported properties are:
                    ...
                    line (bool, optional): If the container should have a side line. Defaults to True.
                    line_thickness (str, optional): Thickness of the side line. Defaults to '5px'.
                    tooltip (str, optional): Tooltip text. Displayed if not empty. Defaults to an empty string.

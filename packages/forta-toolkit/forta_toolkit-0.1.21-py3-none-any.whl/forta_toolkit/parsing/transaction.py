...
def parse_transaction_data(transaction: dict) -> dict:
    ...
    return {
        'hash': forta_toolkit.parsing.common.get_field(dataset=transaction, keys=('hash',), default='0x', callback=forta_toolkit.parsing.common.to_hexstr),
        ...
        'value': forta_toolkit.parsing.common.get_field(dataset=transaction, keys=('value',), default='0x00', callback=forta_toolkit.parsing.common.to_hexstr),
        'data': forta_toolkit.parsing.common.get_field(dataset=transaction, keys=('data', 'input'), default='0x', callback=forta_toolkit.parsing.common.to_hexstr),}

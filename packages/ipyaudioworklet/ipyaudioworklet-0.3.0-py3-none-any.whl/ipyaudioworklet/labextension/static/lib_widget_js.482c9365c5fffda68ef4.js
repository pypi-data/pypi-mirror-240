...
exports.blob_url = '';
function run(full_app_url = '', annealing_time_ms = 500) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('(1)');
        yield prepareCustomAudioProcessor(full_app_url +
            '/extensions/@naoh16/ipyaudioworklet/static/audio-processor.js', 'audio-reorder-processor');

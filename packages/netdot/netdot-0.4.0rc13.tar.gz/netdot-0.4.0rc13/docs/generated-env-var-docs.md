...
>
> Version 0.4.0 documentation generated on Nov 12, 2023 at 12:18PM 

```
usage: __main__.py [-h] [--terse TERSE] [--server-url SERVER_URL]
                   ...
                   [--threads THREADS] [--trace-downloads TRACE_DOWNLOADS]

...
class NetdotAPIDataclass(CSVDataclass):
    ...
    NETDOT_TABLE_NAME: ClassVar[str] = None  # Optional -- will use class name if not provided
    ...
    def _display(self, display_full_objects=False):
    ...
    def as_table_row(self, select_columns=None, display_full_objects=False) -> Tuple[str, ...]:
        table_row = list()
    ...
    @classmethod
    def _table_name(cls):
        return cls.NETDOT_TABLE_NAME or cls.__name__

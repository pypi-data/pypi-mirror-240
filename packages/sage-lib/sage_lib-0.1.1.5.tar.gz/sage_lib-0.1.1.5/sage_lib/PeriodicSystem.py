...
class PeriodicSystem(AtomPositionManager):
    ...
    def cellDuplication(self, factor:np.array=np.array([2,2,2], dtype=np.int64)):
...
'''
path = '/home/akaris/Documents/code/Physics/VASP/v6.1/files/dataset/CoFeNiOOH_jingzhu/surf_NiFe_4H_4OH/ORR'
...
print(ap.latticeParameters)
print(ap.pbc)

ap.exportAsPOSCAR(path+'/POSCAR_cubic')

...
class CareQuery:
    ...
    def careEncounter(self, 
        ...
        if min_date == None:
            temp = date.today() - timedelta(days=60)
    ...
    def careVisit(self, 
        ...
        # create care query data object
        visit = CareQueryData(data, features = self.glossary.feature_detail("JOURNEY_TABLE"),show = show)
    ...
    def nppesDetail(self,
        ...
        # normalize code digit input
        short_zip = cqu.codeNorm(short_zip, n = 5, punct = False)
...
if __name__ == '__main__':
    ...
    query = cq.procDetail(proc_category=['anesthesia'], proc_subcategory=['medicine - pulmonary'])

...
if not TYPE_CHECKING:
    ibaseparam = _load_me("func_adl_servicex_xaodr24.ROOT.Math.ibaseparam")
    ioptions = _load_me("func_adl_servicex_xaodr24.ROOT.Math.ioptions")
    minimizer = _load_me("func_adl_servicex_xaodr24.ROOT.Math.minimizer")
    minimizeroptions = _load_me("func_adl_servicex_xaodr24.ROOT.Math.minimizeroptions")
    trandomengine = _load_me("func_adl_servicex_xaodr24.ROOT.Math.trandomengine")
else:
    from . import ibaseparam
    from . import ioptions
    from . import minimizer
    from . import minimizeroptions
    from . import trandomengine

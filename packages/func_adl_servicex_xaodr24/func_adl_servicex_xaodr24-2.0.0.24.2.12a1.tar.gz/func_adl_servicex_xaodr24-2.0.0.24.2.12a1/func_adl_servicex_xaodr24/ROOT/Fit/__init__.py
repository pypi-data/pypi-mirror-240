...
if not TYPE_CHECKING:
    bindata = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.bindata")
    datarange = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.datarange")
    fitconfig = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.fitconfig")
    fitdata = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.fitdata")
    fitresult = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.fitresult")
    parametersettings = _load_me("func_adl_servicex_xaodr24.ROOT.Fit.parametersettings")
else:
    from . import bindata

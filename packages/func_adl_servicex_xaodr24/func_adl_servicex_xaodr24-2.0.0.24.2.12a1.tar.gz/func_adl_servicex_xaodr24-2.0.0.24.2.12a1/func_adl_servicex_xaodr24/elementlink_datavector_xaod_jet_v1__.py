...
class ElementLink_DataVector_xAOD_Jet_v1__:
    ...
    def getConstituents(self) -> func_adl_servicex_xaodr24.xAOD.jetconstituentvector.JetConstituentVector:
        "A method"
        ...
    ...
    def rawConstituent(self, i: int) -> func_adl_servicex_xaodr24.xAOD.iparticle.IParticle:
        "A method"
        ...

    def constituentLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_iparticle___.vector_ElementLink_DataVector_xAOD_IParticle___:
        "A method"
        ...
    ...
    @func_adl_parameterized_call(lambda s, a, param_1: func_adl_servicex_xaodr24.type_support.cpp_generic_1arg_callback('getAttribute', s, a, param_1))
    @property
    def getAttribute(self) -> func_adl_servicex_xaodr24.type_support.index_type_forwarder[str]:
        "A method"
        ...

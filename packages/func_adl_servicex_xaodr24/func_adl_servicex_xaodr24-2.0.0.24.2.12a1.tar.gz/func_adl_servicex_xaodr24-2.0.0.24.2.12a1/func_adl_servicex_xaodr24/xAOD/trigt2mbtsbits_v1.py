...
class TrigT2MbtsBits_v1:
    ...
    def triggerEnergies(self) -> func_adl_servicex_xaodr24.vector_float_.vector_float_:
        "A method"
        ...

    def triggerTimes(self) -> func_adl_servicex_xaodr24.vector_float_.vector_float_:
        "A method"
        ...

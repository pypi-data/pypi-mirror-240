...
class CompositeParticle_v1:
    ...
    def p(self, partIndices: vector_int_) -> float:
        "A method"
        ...

    def weight(self, varNames: vector_str_, partIndices: vector_int_) -> float:
        "A method"
        ...

    def missingET(self) -> func_adl_servicex_xaodr24.xAOD.missinget_v1.MissingET_v1:
        "A method"
        ...

    def contains(self, met: MissingET_v1) -> bool:
        "A method"
        ...
    ...
    def part(self, index: int) -> func_adl_servicex_xaodr24.xAOD.iparticle.IParticle:
        "A method"
        ...

    def partLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_iparticle__.ElementLink_DataVector_xAOD_IParticle__:
        "A method"
        ...

    def partLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_iparticle___.vector_ElementLink_DataVector_xAOD_IParticle___:
        "A method"
        ...

    def compPart(self, partIndices: vector_int_, otherPartIndices: vector_int_, updateFourMom: bool) -> func_adl_servicex_xaodr24.xAOD.compositeparticle_v1.CompositeParticle_v1:
        "A method"
        ...

    def photon(self, index: int) -> func_adl_servicex_xaodr24.xAOD.photon_v1.Photon_v1:
        "A method"
        ...

    def electron(self, index: int) -> func_adl_servicex_xaodr24.xAOD.electron_v1.Electron_v1:
        "A method"
        ...

    def muon(self, index: int) -> func_adl_servicex_xaodr24.xAOD.muon_v1.Muon_v1:
        "A method"
        ...

    def tau(self, index: int) -> func_adl_servicex_xaodr24.xAOD.taujet_v3.TauJet_v3:
        "A method"
        ...

    def jet(self, index: int) -> func_adl_servicex_xaodr24.xAOD.jet_v1.Jet_v1:
        "A method"
        ...

    def truthPart(self, index: int) -> func_adl_servicex_xaodr24.xAOD.truthparticle_v1.TruthParticle_v1:
        "A method"
        ...

    def containsOther(self, part: IParticle) -> bool:
        "A method"
        ...
    ...
    def otherPart(self, index: int) -> func_adl_servicex_xaodr24.xAOD.iparticle.IParticle:
        "A method"
        ...

    def otherPartLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_iparticle__.ElementLink_DataVector_xAOD_IParticle__:
        "A method"
        ...

    def otherPartLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_iparticle___.vector_ElementLink_DataVector_xAOD_IParticle___:
        "A method"
        ...

    def otherCompPart(self, index: int) -> func_adl_servicex_xaodr24.xAOD.compositeparticle_v1.CompositeParticle_v1:
        "A method"
        ...

    def otherPhoton(self, index: int) -> func_adl_servicex_xaodr24.xAOD.photon_v1.Photon_v1:
        "A method"
        ...

    def otherElectron(self, index: int) -> func_adl_servicex_xaodr24.xAOD.electron_v1.Electron_v1:
        "A method"
        ...

    def otherMuon(self, index: int) -> func_adl_servicex_xaodr24.xAOD.muon_v1.Muon_v1:
        "A method"
        ...

    def otherTau(self, index: int) -> func_adl_servicex_xaodr24.xAOD.taujet_v3.TauJet_v3:
        "A method"
        ...

    def otherJet(self, index: int) -> func_adl_servicex_xaodr24.xAOD.jet_v1.Jet_v1:
        "A method"
        ...

    def otherTruthPart(self, index: int) -> func_adl_servicex_xaodr24.xAOD.truthparticle_v1.TruthParticle_v1:
        "A method"
        ...

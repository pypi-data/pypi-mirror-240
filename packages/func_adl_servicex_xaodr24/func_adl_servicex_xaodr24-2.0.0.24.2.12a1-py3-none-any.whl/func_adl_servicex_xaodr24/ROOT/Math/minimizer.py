...
class Minimizer:
    ...
    def VariableName(self, ivar: int) -> func_adl_servicex_xaodr24.str.str:
        "A method"
        ...
    ...
    def Options(self) -> func_adl_servicex_xaodr24.ROOT.Math.minimizeroptions.MinimizerOptions:
        "A method"
        ...

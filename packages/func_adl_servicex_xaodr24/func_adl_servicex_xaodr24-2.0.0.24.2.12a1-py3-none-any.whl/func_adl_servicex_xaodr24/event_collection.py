...
class Event:
    ...
    def BTaggings(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.btagging_v1.BTagging_v1]:
        ...

    def BTagVertices(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.btagvertex_v1.BTagVertex_v1]:
        ...

    def TrigRingerRingss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigringerrings_v2.TrigRingerRings_v2]:
        ...

    def TrigRNNOutputs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigrnnoutput_v2.TrigRNNOutput_v2]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'jet_collection'))
    def Jets(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jet_v1.Jet_v1]:
        ...

    def L2CombinedMuons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.l2combinedmuon_v1.L2CombinedMuon_v1]:
        ...

    def L2StandAloneMuons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.l2standalonemuon_v2.L2StandAloneMuon_v2]:
        ...

    def L2IsoMuons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.l2isomuon_v1.L2IsoMuon_v1]:
        ...

    def Egammas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.egamma_v1.Egamma_v1]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'electron_collection'))
    def Electrons(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.electron_v1.Electron_v1]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'photon_collection'))
    def Photons(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.photon_v1.Photon_v1]:
        ...

    def UncalibratedMeasurements(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.uncalibratedmeasurement_v1.UncalibratedMeasurement_v1]:
        ...

    def CompositeParticles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.compositeparticle_v1.CompositeParticle_v1]:
        ...

    def Particles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.particle_v1.Particle_v1]:
        ...

    def LumiBlockRanges(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.lumiblockrange_v1.LumiBlockRange_v1]:
        ...

    def BCMRawDatas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.bcmrawdata_v1.BCMRawData_v1]:
        ...

    def TrigEMClusters(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigemcluster_v1.TrigEMCluster_v1]:
        ...

    def TrigCaloClusters(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigcalocluster_v1.TrigCaloCluster_v1]:
        ...

    def TrigBphyss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigbphys_v1.TrigBphys_v1]:
        ...

    def CaloRingss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.calorings_v1.CaloRings_v1]:
        ...

    def RingSets(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.ringset_v1.RingSet_v1]:
        ...

    def RingSetConfs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.ringsetconf_v1.RingSetConf_v1]:
        ...

    def TrigMissingETs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigmissinget_v1.TrigMissingET_v1]:
        ...

    def CMXJetHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxjethits_v1.CMXJetHits_v1]:
        ...

    def CPMHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cpmhits_v1.CPMHits_v1]:
        ...

    def CPMRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cpmroi_v1.CPMRoI_v1]:
        ...

    def CMMEtSumss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmmetsums_v1.CMMEtSums_v1]:
        ...

    def CMXEtSumss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxetsums_v1.CMXEtSums_v1]:
        ...

    def JetElements(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jetelement_v2.JetElement_v2]:
        ...

    def JEMTobRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jemtobroi_v1.JEMTobRoI_v1]:
        ...

    def jFexTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfextower_v1.jFexTower_v1]:
        ...

    def gFexTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.gfextower_v1.gFexTower_v1]:
        ...

    def CMXJetTobs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxjettob_v1.CMXJetTob_v1]:
        ...

    def RODHeaders(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.rodheader_v2.RODHeader_v2]:
        ...

    def CMXCPTobs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxcptob_v1.CMXCPTob_v1]:
        ...

    def CPMTobRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cpmtobroi_v1.CPMTobRoI_v1]:
        ...

    def CPMTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cpmtower_v2.CPMTower_v2]:
        ...

    def TriggerTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.triggertower_v2.TriggerTower_v2]:
        ...

    def CMMCPHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmmcphits_v1.CMMCPHits_v1]:
        ...

    def eFexTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.efextower_v1.eFexTower_v1]:
        ...

    def JEMHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jemhits_v1.JEMHits_v1]:
        ...

    def CMXCPHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxcphits_v1.CMXCPHits_v1]:
        ...

    def CMXRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmxroi_v1.CMXRoI_v1]:
        ...

    def JEMRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jemroi_v1.JEMRoI_v1]:
        ...

    def CMMJetHitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cmmjethits_v1.CMMJetHits_v1]:
        ...

    def JEMEtSumss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jemetsums_v2.JEMEtSums_v2]:
        ...

    def L1TopoRawDatas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.l1toporawdata_v1.L1TopoRawData_v1]:
        ...

    def TrackParticleClusterAssociations(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackparticleclusterassociation_v1.TrackParticleClusterAssociation_v1]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'tau_collection'))
    def TauJets(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.taujet_v3.TauJet_v3]:
        ...

    def DiTauJets(self, calibration: str = 'NOSYS', working_point: str = 'Tight') -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.ditaujet_v1.DiTauJet_v1]:
        ...

    def TauTracks(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.tautrack_v1.TauTrack_v1]:
        ...

    def TruthVertices(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.truthvertex_v1.TruthVertex_v1]:
        ...

    def TruthEvents(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.truthevent_v1.TruthEvent_v1]:
        ...

    def TruthParticles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.truthparticle_v1.TruthParticle_v1]:
        ...

    def TruthPileupEvents(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.truthpileupevent_v1.TruthPileupEvent_v1]:
        ...

    def TruthEventBases(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trutheventbase_v1.TruthEventBase_v1]:
        ...

    def TruthMetaDatas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.truthmetadata_v1.TruthMetaData_v1]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'met_collection'))
    def MissingET(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.missinget_v1.MissingET_v1]:
        ...

    def AFPDatas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afpdata_v1.AFPData_v1]:
        ...

    def AFPToFHits(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afptofhit_v1.AFPToFHit_v1]:
        ...

    def ZdcModules(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.zdcmodule_v1.ZdcModule_v1]:
        ...

    def AFPProtons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afpproton_v1.AFPProton_v1]:
        ...

    def ForwardEventInfos(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.forwardeventinfo_v1.ForwardEventInfo_v1]:
        ...

    def ALFADatas(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.alfadata_v1.ALFAData_v1]:
        ...

    def MBTSModules(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.mbtsmodule_v1.MBTSModule_v1]:
        ...

    def AFPTracks(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afptrack_v2.AFPTrack_v2]:
        ...

    def AFPSiHits(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afpsihit_v2.AFPSiHit_v2]:
        ...

    def AFPSiHitsClusters(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afpsihitscluster_v1.AFPSiHitsCluster_v1]:
        ...

    def AFPVertexs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afpvertex_v1.AFPVertex_v1]:
        ...

    def AFPToFTracks(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.afptoftrack_v1.AFPToFTrack_v1]:
        ...

    def EventInfos(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.eventinfo_v1.EventInfo_v1]:
        ...

    def MuonSegments(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.muonsegment_v1.MuonSegment_v1]:
        ...

    def SlowMuons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.slowmuon_v1.SlowMuon_v1]:
        ...

    @func_adl_callback(lambda s, a: func_adl_servicex_xaodr24.calibration_support.fixup_collection_call(s, a, 'muon_collection'))
    def Muons(self, collection: Optional[str] = None, calibrate: Optional[bool] = True) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.muon_v1.Muon_v1]:
        ...

    def HIEventShapes(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.hieventshape_v2.HIEventShape_v2]:
        ...

    def IParticles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.iparticle.IParticle]:
        ...

    def TrigPhotons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigphoton_v1.TrigPhoton_v1]:
        ...

    def TrigElectrons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigelectron_v1.TrigElectron_v1]:
        ...

    def KLFitterResults(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.klfitterresult.KLFitterResult]:
        ...

    def SystematicEvents(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.systematicevent.SystematicEvent]:
        ...

    def PseudoTopResults(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.pseudotopresult.PseudoTopResult]:
        ...

    def TrackStateValidations(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackstatevalidation_v1.TrackStateValidation_v1]:
        ...

    def SCTRawHitValidations(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.sctrawhitvalidation_v1.SCTRawHitValidation_v1]:
        ...

    def TrackParameterss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackparameters_v1.TrackParameters_v1]:
        ...

    def TrackMeasurementValidations(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackmeasurementvalidation_v1.TrackMeasurementValidation_v1]:
        ...

    def TrackMeasurements(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackmeasurement_v1.TrackMeasurement_v1]:
        ...

    def TrackStates(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackstate_v1.TrackState_v1]:
        ...

    def Vertices(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.vertex_v1.Vertex_v1]:
        ...

    def NeutralParticles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.neutralparticle_v1.NeutralParticle_v1]:
        ...

    def TrackJacobians(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackjacobian_v1.TrackJacobian_v1]:
        ...

    def TrackParticles(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackparticle_v1.TrackParticle_v1]:
        ...

    def L1TopoSimResultss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.l1toposimresults_v1.L1TopoSimResults_v1]:
        ...

    def jFexFwdElRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfexfwdelroi_v1.jFexFwdElRoI_v1]:
        ...

    def gFexJetRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.gfexjetroi_v1.gFexJetRoI_v1]:
        ...

    def jFexSumETRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfexsumetroi_v1.jFexSumETRoI_v1]:
        ...

    def MuonRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.muonroi_v1.MuonRoI_v1]:
        ...

    def EmTauRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.emtauroi_v2.EmTauRoI_v2]:
        ...

    def JetRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jetroi_v2.JetRoI_v2]:
        ...

    def jFexLRJetRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfexlrjetroi_v1.jFexLRJetRoI_v1]:
        ...

    def jFexSRJetRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfexsrjetroi_v1.jFexSRJetRoI_v1]:
        ...

    def BunchConfs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.bunchconf_v1.BunchConf_v1]:
        ...

    def eFexEMRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.efexemroi_v1.eFexEMRoI_v1]:
        ...

    def TrigComposites(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigcomposite_v1.TrigComposite_v1]:
        ...

    def jFexTauRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfextauroi_v1.jFexTauRoI_v1]:
        ...

    def jFexMETRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.jfexmetroi_v1.jFexMETRoI_v1]:
        ...

    def TriggerMenuJsons(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.triggermenujson_v1.TriggerMenuJson_v1]:
        ...

    def TriggerMenus(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.triggermenu_v1.TriggerMenu_v1]:
        ...

    def eFexTauRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.efextauroi_v1.eFexTauRoI_v1]:
        ...

    def gFexGlobalRoIs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.gfexglobalroi_v1.gFexGlobalRoI_v1]:
        ...

    def TrigPassBitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigpassbits_v1.TrigPassBits_v1]:
        ...

    def CutBookkeepers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.cutbookkeeper_v1.CutBookkeeper_v1]:
        ...

    def PFOs(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.pfo_v1.PFO_v1]:
        ...

    def TrackCaloClusters(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trackcalocluster_v1.TrackCaloCluster_v1]:
        ...

    def TrigSpacePointCountss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigspacepointcounts_v1.TrigSpacePointCounts_v1]:
        ...

    def TrigVertexCountss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigvertexcounts_v1.TrigVertexCounts_v1]:
        ...

    def TrigHisto2Ds(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trighisto2d_v1.TrigHisto2D_v1]:
        ...

    def TrigTrackCountss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigtrackcounts_v1.TrigTrackCounts_v1]:
        ...

    def TrigT2ZdcSignalss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigt2zdcsignals_v1.TrigT2ZdcSignals_v1]:
        ...

    def TrigT2MbtsBitss(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.trigt2mbtsbits_v1.TrigT2MbtsBits_v1]:
        ...

    def CaloTowers(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.calotower_v1.CaloTower_v1]:
        ...

    def CaloClusters(self, name: str) -> func_adl_servicex_xaodr24.FADLStream[func_adl_servicex_xaodr24.xAOD.calocluster_v1.CaloCluster_v1]:
        ...

    def EventInfo(self, name: str) -> func_adl_servicex_xaodr24.xAOD.eventinfo_v1.EventInfo_v1:
        ...

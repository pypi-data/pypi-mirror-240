...
class Electron_v1:
    ...
    def trackParticle(self, index: int) -> func_adl_servicex_xaodr24.xAOD.trackparticle_v1.TrackParticle_v1:
        "A method"
        ...

    def trackParticleLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_trackparticle_v1__.ElementLink_DataVector_xAOD_TrackParticle_v1__:
        "A method"
        ...

    def trackParticleLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_trackparticle_v1___.vector_ElementLink_DataVector_xAOD_TrackParticle_v1___:
        "A method"
        ...
    ...
    def caloCluster(self, index: int) -> func_adl_servicex_xaodr24.xAOD.calocluster_v1.CaloCluster_v1:
        "A method"
        ...

    def caloClusterLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_calocluster_v1__.ElementLink_DataVector_xAOD_CaloCluster_v1__:
        "A method"
        ...

    def caloClusterLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_calocluster_v1___.vector_ElementLink_DataVector_xAOD_CaloCluster_v1___:
        "A method"
        ...

    def ambiguousObject(self) -> func_adl_servicex_xaodr24.xAOD.egamma_v1.Egamma_v1:
        "A method"
        ...

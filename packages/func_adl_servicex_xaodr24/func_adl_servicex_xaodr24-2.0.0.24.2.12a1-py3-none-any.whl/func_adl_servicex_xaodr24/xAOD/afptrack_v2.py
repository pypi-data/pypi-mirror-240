...
class AFPTrack_v2:
    ...
    def clusters(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_afpsihitscluster_v1___.vector_ElementLink_DataVector_xAOD_AFPSiHitsCluster_v1___:
        "A method"
        ...

...
class Photon_v1:
    ...
    def vertex(self, index: int) -> func_adl_servicex_xaodr24.xAOD.vertex_v1.Vertex_v1:
        "A method"
        ...

    def vertexLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_vertex_v1__.ElementLink_DataVector_xAOD_Vertex_v1__:
        "A method"
        ...

    def vertexLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_vertex_v1___.vector_ElementLink_DataVector_xAOD_Vertex_v1___:
        "A method"
        ...

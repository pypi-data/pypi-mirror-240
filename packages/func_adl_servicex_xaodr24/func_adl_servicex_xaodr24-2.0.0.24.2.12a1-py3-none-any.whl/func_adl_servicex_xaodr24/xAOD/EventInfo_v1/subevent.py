...
class SubEvent:
    ...
    def typeName(self) -> func_adl_servicex_xaodr24.str.str:
        "A method"
        ...

    def link(self) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_eventinfo_v1__.ElementLink_DataVector_xAOD_EventInfo_v1__:
        "A method"
        ...

    def ptr(self) -> func_adl_servicex_xaodr24.xAOD.eventinfo_v1.EventInfo_v1:
        "A method"
        ...

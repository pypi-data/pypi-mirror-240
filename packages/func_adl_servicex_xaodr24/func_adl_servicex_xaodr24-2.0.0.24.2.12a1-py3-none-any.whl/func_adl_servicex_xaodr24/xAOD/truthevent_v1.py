...
class TruthEvent_v1:
    ...
    def weights(self) -> func_adl_servicex_xaodr24.vector_float_.vector_float_:
        "A method"
        ...
    ...
    def pdfInfo(self) -> func_adl_servicex_xaodr24.xAOD.TruthEvent_v1.pdfinfo.PdfInfo:
        "A method"
        ...

    def signalProcessVertex(self) -> func_adl_servicex_xaodr24.xAOD.truthvertex_v1.TruthVertex_v1:
        "A method"
        ...

    def signalProcessVertexLink(self) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_truthvertex_v1__.ElementLink_DataVector_xAOD_TruthVertex_v1__:
        "A method"
        ...

    def beamParticle1Link(self) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_truthparticle_v1__.ElementLink_DataVector_xAOD_TruthParticle_v1__:
        "A method"
        ...

    def beamParticle2Link(self) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_truthparticle_v1__.ElementLink_DataVector_xAOD_TruthParticle_v1__:
        "A method"
        ...

    def truthParticleLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_truthparticle_v1___.vector_ElementLink_DataVector_xAOD_TruthParticle_v1___:
        "A method"
        ...
    ...
    def truthParticleLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_truthparticle_v1__.ElementLink_DataVector_xAOD_TruthParticle_v1__:
        "A method"
        ...

    def truthParticle(self, index: int) -> func_adl_servicex_xaodr24.xAOD.truthparticle_v1.TruthParticle_v1:
        "A method"
        ...

    def truthVertexLinks(self) -> func_adl_servicex_xaodr24.vector_elementlink_datavector_xaod_truthvertex_v1___.vector_ElementLink_DataVector_xAOD_TruthVertex_v1___:
        "A method"
        ...
    ...
    def truthVertexLink(self, index: int) -> func_adl_servicex_xaodr24.elementlink_datavector_xaod_truthvertex_v1__.ElementLink_DataVector_xAOD_TruthVertex_v1__:
        "A method"
        ...

    def truthVertex(self, index: int) -> func_adl_servicex_xaodr24.xAOD.truthvertex_v1.TruthVertex_v1:
        "A method"
        ...

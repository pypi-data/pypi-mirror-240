...
from shyft.time_series import GeoGridSpec, UtcPeriod, time
...
class GeoGridTsRepository(GeoTsRepository):
    """
    Interface for GeoTsRepository (Geo Located Timeseries) objects with variables, grid projection and time period
    ...
    def shyft_cs(self):
        """
        Returns PROJ.4 string specifying shyft coordinate reference system (CRS)
        """
        raise NotImplementedError(
            f"Interface property 'shyft_cs' not implemented for repository {self.__class__.__name__}.")
    ...
    def variables(self) -> List[str]:
        ...
        """
        raise NotImplementedError(
            f"Interface property 'variables' not implemented for repository {self.__class__.__name__}.")

    @property
    @abstractmethod
    def grid_spec(self) -> GeoGridSpec:
        """
        Returns the grid spec of the data
        """
        raise NotImplementedError(
            f"Interface property 'grid_spec' not implemented for repository {self.__class__.__name__}.")

    @property
    @abstractmethod
    def data_period(self) -> UtcPeriod:
        """
        Returns the time period the data
        """
        raise NotImplementedError(
            f"Interface property 'data_period' not implemented for repository {self.__class__.__name__}.")

    @property
    @abstractmethod
    def start_times(self) -> List[time]:
        """
        Returns the start times of the data
        """
        raise NotImplementedError(
            f"Interface property 'start_times' not implemented for repository {self.__class__.__name__}.")

...
from shyft.hydrology.orchestration import simulator
#from shyft import api
from shyft.hydrology import KLING_GUPTA,NASH_SUTCLIFFE,RMSE,TargetSpecificationVector,TargetSpecificationPts,TsTransform
from shyft.time_series import (UtcPeriod, TimeSeries, IntVector, TsFactory)
from shyft.hydrology.repository.interfaces import TsStoreItem
from shyft.hydrology.repository.interfaces import TimeseriesStore
...
class ConfigCalibrator(simulator.DefaultSimulator):
    ...
    def save_calibrated_model(self, optim_param, outfile=None):
        ...
        model_dict = yaml.load(open(model_file), Loader=yaml.FullLoader)  # nosec
        model_params = {}

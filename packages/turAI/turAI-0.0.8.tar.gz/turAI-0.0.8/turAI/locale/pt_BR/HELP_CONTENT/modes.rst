...
*Ferramentas → Opções → Geral* permite alternar a interface de usuário do turAI para um dos três modos disponíveis.
...
* O menu Exibir ganha um item extra *Tela cheia* que coloca turAI em tela cheia.

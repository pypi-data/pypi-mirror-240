...
from turAI import turAI_USER_DIR, codeview, get_workbench, ui_utils
from turAI.base_file_browser import BaseLocalFileBrowser
from turAI.languages import tr
from turAI.plugins.coloring import SyntaxColorer
from turAI.ui_utils import CommonDialog, lookup_style_option
...
class ReplayerFileBrowser(BaseLocalFileBrowser):
    def __init__(self, master, log_frame):
        ...
        user_logs_path = os.path.join(turAI_USER_DIR, "user_logs")

...
from turAI.ui_utils import asksaveasfilename
from turAI.workbench import WorkbenchEvent
...
def _get_log_dir():
    return os.path.join(turAI_USER_DIR, "user_logs")
...
def export():
    ...
    filename = asksaveasfilename(
        ...
        initialfile=time.strftime("turAIUsageLogs_%Y-%m-%d.zip"),

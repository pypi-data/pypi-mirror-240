...
from turAI import turAI_USER_DIR, get_workbench, ui_utils
from turAI.languages import tr
from turAI.tktextext import EnhancedText, TextFrame
from turAI.ui_utils import TextMenu
...
class NotesView(TextFrame):
    def __init__(self, master):
        self.filename = os.path.join(turAI_USER_DIR, "user_notes.txt")
        super().__init__(
        ...
        if not os.path.isfile(self.filename):
            self.text.insert(
                ...
                tr(
                    ...
                    + "and loaded when you open turAI next time.\n\n"

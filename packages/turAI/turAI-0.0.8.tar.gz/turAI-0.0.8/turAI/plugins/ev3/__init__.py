...
from turAI.misc_utils import running_on_windows
from turAI.plugins.micropython import (
    SshMicroPythonConfigPage,
    SshMicroPythonProxy,
    add_micropython_backend,
)
from turAI.ui_utils import create_url_label, ems_to_pixels


class EV3MicroPythonProxy(SshMicroPythonProxy):
    def _get_launcher_with_args(self):
        import turAI.plugins.ev3.ev3_back
        ...
        cmd = [
            turAI.plugins.ev3.ev3_back.__file__,
            repr(args),
        ]
        return cmd

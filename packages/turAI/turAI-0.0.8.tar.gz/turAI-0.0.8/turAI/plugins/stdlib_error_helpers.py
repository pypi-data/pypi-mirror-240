...
from turAI import assistance
from turAI.assistance import (
    ErrorHelper,
...
class AttributeErrorHelper(ErrorHelper):
    def __init__(self, error_info):
        ...
        if len(names) != 2:
            ...
            # https://github.com/turAI/turAI/issues/1535
...
class OSErrorHelper(ErrorHelper):
    ...
    def get_kill_process_instructions(self):
        s = (
            ...
            + " then enter following system command into turAI's Shell:\n\n"
        )

...
from turAI import get_workbench, tktextext, ui_utils
from turAI.codeview import CodeView
from turAI.config_ui import ConfigurationPage
from turAI.languages import tr
from turAI.shell import BaseShellText
from turAI.ui_utils import create_string_var, scrollbar_style
...
class ThemeAndFontConfigurationPage(ConfigurationPage):
    ...
    def _init_previews(self):
        ...
        ttk.Label(
            self,
            text=tr("NB! Some style elements change only after restarting turAI!"),

...
from turAI import get_runner, get_shell, get_workbench, ui_utils
from turAI.base_file_browser import (
    HIDDEN_FILES_OPTION,
...
from turAI.misc_utils import running_on_mac_os, running_on_windows, sizeof_fmt
from turAI.running import InlineCommandDialog, construct_cd_command
from turAI.ui_utils import lookup_style_option
...
def load_plugin() -> None:
    ...
    for ext in [
        ...
        get_workbench().set_default(get_file_handler_conf_key(ext), "turAI")

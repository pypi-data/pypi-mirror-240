...
from turAI import get_workbench, roughparse, tktextext, ui_utils
from turAI.common import TextRange
from turAI.tktextext import EnhancedText
from turAI.ui_utils import EnhancedTextWithLogging, ask_string, scrollbar_style
...
class CodeViewText(EnhancedTextWithLogging, SyntaxText):
    ...
    def on_secondary_click(self, event=None):
        ...
        try:
            from turAI.plugins.debugger import get_current_debugger

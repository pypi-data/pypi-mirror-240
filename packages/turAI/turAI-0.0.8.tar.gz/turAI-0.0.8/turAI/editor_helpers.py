...
from turAI import get_workbench
from turAI.codeview import CodeViewText, SyntaxText, get_syntax_options_for_tag
from turAI.common import SignatureInfo, SignatureParameter
from turAI.editors import Editor
from turAI.misc_utils import running_on_mac_os
from turAI.shell import ShellText
from turAI.tktextext import TextFrame
from turAI.ui_utils import get_tk_version_info
...
class EditorInfoBox(tk.Toplevel):
    ...
    def _workbench_focus_out(self, event=None) -> None:
        ...
        # Need to close when another app or a turAI's dialog appears

...
from turAI.base_file_browser import ask_backend_path, choose_node_for_file_operations
from turAI.codeview import BinaryFileException, CodeView, CodeViewText
...
from turAI.custom_notebook import CustomNotebook, CustomNotebookTab
from turAI.languages import tr
from turAI.misc_utils import running_on_mac_os, running_on_windows
from turAI.tktextext import rebind_control_a
        ...
        if self._filename is not None and not ask_filename:
            ...
            if self.containing_notebook.get_editor(save_filename) is not None:
                messagebox.showerror(
                    tr("File is open"),
                    tr(
                        "This file is already open in turAI.\n\n"

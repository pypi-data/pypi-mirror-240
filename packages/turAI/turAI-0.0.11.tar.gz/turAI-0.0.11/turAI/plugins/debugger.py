...
from turAI.codeview import CodeView, SyntaxText, get_syntax_options_for_tag
from turAI.common import DebuggerCommand, InlineCommand
from turAI.custom_notebook import CustomNotebook
from turAI.languages import tr
from turAI.memory import VariablesFrame
from turAI.misc_utils import running_on_mac_os, running_on_rpi, shorten_repr
from turAI.tktextext import TextFrame
from turAI.ui_utils import CommonDialog, get_hyperlink_cursor, get_tk_version_info, select_sequence
...
def run_preferred_debug_command():
    ...
    if preferred_debugger == "faster":
        ...
        from turAI.plugins.birdseye_frontend import debug_with_birdseye

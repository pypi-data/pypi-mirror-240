...
from turAI.plugins.microbit import MicrobitFlashingDialog
from turAI.plugins.micropython.esptool_dialog import try_launch_esptool_dialog
from turAI.plugins.micropython.mp_front import (
...
class CircuitPythonProxy(BareMetalMicroPythonProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import turAI.plugins.circuitpython.cirpy_back

        return turAI.plugins.circuitpython.cirpy_back.__file__

...
When you are editing *my_program.py* and press F5, turAI constructs a magic command
``%Run my_program.py`` and sends it to the shell, which asks turAI's back-end to run
that script.

...
from turAI import get_runner, get_shell, get_workbench
from turAI.common import ImmediateCommand, ToplevelCommand
from turAI.plugins.backend_config_page import BaseSshProxyConfigPage, get_ssh_password
...
class SshCPythonProxy(SubprocessProxy):
    ...
    def get_pip_gui_class(self):
        from turAI.plugins.cpython_ssh.cps_pip_gui import SshCPythonPipDialog

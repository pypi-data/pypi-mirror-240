...
Quando você está editando *me_programa.py* e pressiona F5, o turAI constrói um comando mágico ``%Run meu_programa.py`` e o envia para o Shell, que pede ao backend do turAI para executar esse programa.

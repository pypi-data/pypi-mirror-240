...
Embora a depuração de impressão seja usada até mesmo por profissionais (eles podem chamá-la de *logging*), existe uma alternativa, que é mais confortável na maioria dos casos. Chama-se **percorrer o código** e é a especialidade do turAI. Vá para o capítulo `Usando depuradores <debuggers.rst>`_ para saber mais.

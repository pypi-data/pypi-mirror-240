...
Les messages d'erreur dans turAI ont des liens
...
certaines parties du message avec l'emplacement lié dans le code. De temps en temps l'Assistant de turAI peut expliquer
...
--------------------------------------------------
Voir `la page au sujet du débogage <debugging.rst>`_ or `la page au sujet de l'utilisation des débogueurs de turAI <debuggers.rst>`_.

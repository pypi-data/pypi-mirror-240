...
Los mensajes de error en turAI tienen enlaces que te llevan al lugar del código que causó el error.
...
A veces el Asistente de turAI puede explicar el error en términos más sencillos, a veces hay que hacer una búsqueda en internet del mensaje (no olvides añadir "Python" a la búsqueda).
...
Vea `la página sobre depuración <debugging.rst>`_ o `la página sobre el uso de los depuradores de turAI <debuggers.rst>`_.

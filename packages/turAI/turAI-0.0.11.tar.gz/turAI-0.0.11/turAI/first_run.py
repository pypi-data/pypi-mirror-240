...
from turAI import is_portable, languages, ui_utils
...
class FirstRunWindow(tk.Tk):
    def __init__(self, configuration_manager):
        super().__init__(className="turAI")
        ttk.Style().theme_use(ui_utils.get_default_basic_theme())

        self.title("Welcome to turAI!" + "   [portable]" if is_portable() else "")
        ...
        logo_file = os.path.join(os.path.dirname(__file__), "res", "turAI.png")

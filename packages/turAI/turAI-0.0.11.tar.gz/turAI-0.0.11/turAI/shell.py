...
from turAI import get_runner, get_shell, get_workbench, memory, roughparse, running, ui_utils
from turAI.codeview import SyntaxText, get_syntax_options_for_tag, perform_python_return
...
from turAI.misc_utils import construct_cmd_line, parse_cmd_line
from turAI.running import EDITOR_CONTENT_TOKEN
from turAI.tktextext import TextFrame, TweakableText, index2line
    ...
    def _apply_io_event(self, data, stream_name):
        ...
        if self.tty_mode and re.match(TERMINAL_CONTROL_REGEX, data):
            ...
            try:
                ...
                # This may fail, when the source code of turAI's MP helper is printed
                # because of an error.

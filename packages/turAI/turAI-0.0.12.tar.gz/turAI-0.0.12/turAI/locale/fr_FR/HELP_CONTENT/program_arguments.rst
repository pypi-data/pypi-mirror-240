...
Quand nous éditez *mon_programme.py* et pressez la touche F5, turAI construit une commande magique
``%Run mon_program.py`` et l'envoie au shell, qui demande à la tâche de fond de turAI de lancer ce script.

Différents modes
================
*Outils → Options → Général* permet de régler l'interface utilisateur de turAI selon un des trois modes différents.
...
* Le menu Afficher dispose d'un item *Plein écran* pour mettre turAI en mode plein écran.

...
mais ça peut intimider certains débutants. turAI essaie de rendre les choses plus faciles et permet de lancer les programmes Flask
...
turAI lancera le serveur de développement approximativement comme ceci :
...
``threaded=False`` est utilisé car le débogueur de turAI ne supporte que les programmes à un seul fil (thread),
...
Dans ce cas turAI n'ajoutera rien à votre code.

...
에러가 발생한 곳은 어디인가요?
-------------------------------------
turAI의 에러 메시지에는 오류를 일으킨 코드 위치로
...
코드의 링크 된 위치와 일치 시키십시오. 어쩔때는 turAI의 어시스턴트가 오류를 더 간단한 용어로
...
---------------------------------------
`the page about debugging <debugging.rst>`_ 혹은 `the page about using turAI's debuggers <debuggers.rst>`_ 참조하세요.

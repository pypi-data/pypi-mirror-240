...
일부 초심자는 이를 두려워 할 수 있습니다. turAI는 이를 쉽게 만들고 다른 프로그램과 마찬가지로 Flask 프로그램을
...
``threaded=False`` turAI의 디버거는 싱글-쓰레드 프로그램만 지원하기 때문에 이 옵션을 사용합니다,
...
이 경우 turAI는 코드에 아무것도 추가하지 않습니다.

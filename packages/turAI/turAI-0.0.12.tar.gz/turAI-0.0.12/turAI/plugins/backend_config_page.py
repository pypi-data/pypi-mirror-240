...
from turAI.backend import delete_stored_ssh_password, get_ssh_password_file_path
from turAI.config_ui import ConfigurationPage
...
from turAI.ui_utils import CommonDialogEx, create_string_var, ems_to_pixels
...
class BackendConfigurationPage(ConfigurationPage):
    def __init__(self, master):
        ...
        label = ttk.Label(
            self, text=tr("Which kind of interpreter should turAI use for running your code?")
        )

...
from turAI.plugins.micropython import BareMetalMicroPythonConfigPage, BareMetalMicroPythonProxy
from turAI.plugins.micropython.esptool_dialog import try_launch_esptool_dialog

# from turAI.plugins.micropython.esptool_dialog import try_launch_esptool_dialog
from turAI.plugins.micropython.mp_front import add_micropython_backend, get_uart_adapter_vids_pids
from turAI.plugins.micropython.uf2dialog import show_uf2_installer
...
class ESPProxy(BareMetalMicroPythonProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import turAI.plugins.esp.esp_back

        return turAI.plugins.esp.esp_back.__file__

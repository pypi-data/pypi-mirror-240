...
from turAI.common import UserError
from turAI.misc_utils import get_win_volume_name, list_volumes
from turAI.plugins.micropython.base_flashing_dialog import (
    BaseFlashingDialog,
    TargetInfo,
    family_code_to_name,
)
from turAI.plugins.micropython.mp_front import list_serial_ports
...
class Uf2FlashingDialog(BaseFlashingDialog):
    ...
    def get_variants_url(self) -> str:
        return f"https://raw.githubusercontent.com/turAI/turAI/master/data/{self.firmware_name.lower()}-variants-uf2.json"

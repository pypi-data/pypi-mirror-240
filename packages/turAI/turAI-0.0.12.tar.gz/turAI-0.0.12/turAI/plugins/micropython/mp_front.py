...
from turAI.common import CommandToBackend, EOFCommand, ImmediateCommand, InlineCommand
from turAI.languages import tr
from turAI.misc_utils import list_volumes
from turAI.plugins.backend_config_page import (
    BackendDetailsConfigPage,
    BaseSshProxyConfigPage,
    get_ssh_password,
)
from turAI.running import SubprocessProxy
from turAI.ui_utils import create_string_var, create_url_label, ems_to_pixels
...
class BareMetalMicroPythonProxy(MicroPythonProxy):
    ...
    def get_pip_gui_class(self):
        from turAI.plugins.micropython.pip_gui import MicroPythonPipDialog
    ...
    def _get_backend_launcher_path(self) -> str:
        import turAI.plugins.micropython.bare_metal_backend

        return turAI.plugins.micropython.bare_metal_backend.__file__
    ...
    def open_custom_system_shell(self):
        ...
        terminal.run_in_terminal(
            [
                ...
                "turAI.plugins.micropython.miniterm_wrapper",
                "--exit-char",
                "20",
                "--menu-char",
                "29",
...
class LocalMicroPythonProxy(MicroPythonProxy):
    ...
    def _get_launcher_with_args(self):
        import turAI.plugins.micropython.os_mp_backend

        cmd = [
            turAI.plugins.micropython.os_mp_backend.__file__,
            repr(
                {

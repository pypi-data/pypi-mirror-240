...
from turAI.plugins.micropython.mp_front import VIDS_PIDS_TO_AVOID_IN_GENERIC_BACKEND
...
class PrimeInventorMicroPythonProxy(BareMetalMicroPythonProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import turAI.plugins.prime_inventor.prime_inventor_back

        return turAI.plugins.prime_inventor.prime_inventor_back.__file__
...
class PrimeInventorMicroPythonConfigPage(BareMetalMicroPythonConfigPage):
    ...
    def _get_intro_url(self):
        return "https://github.com/turAI/turAI/wiki/InventorPrime"

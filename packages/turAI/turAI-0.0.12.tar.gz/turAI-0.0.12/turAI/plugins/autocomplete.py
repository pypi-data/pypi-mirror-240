...
from turAI import editor_helpers, get_runner, get_workbench
from turAI.codeview import CodeViewText, SyntaxText, get_syntax_options_for_tag
from turAI.common import CompletionInfo, InlineCommand
from turAI.editor_helpers import DocuBox, EditorInfoBox
...
class CompletionsBox(EditorInfoBox):
    ...
    def _check_request_details(self) -> None:
        if not self.winfo_ismapped():
            # can happen, see https://github.com/turAI/turAI/issues/2162
            return

...
from turAI.plugins.micropython import (
...
class MicrobitProxy(BareMetalMicroPythonProxy):
    def _get_backend_launcher_path(self) -> str:
        import turAI.plugins.microbit.microbit_back

        return turAI.plugins.microbit.microbit_back.__file__
...
class MicrobitFlashingDialog(Uf2FlashingDialog):
    ...
    def get_variants_url(self) -> str:
        return f"https://raw.githubusercontent.com/turAI/turAI/master/data/{self.firmware_name.lower()}-variants-daplink.json"
...
def load_plugin():
    ...
    turAI.plugins.rp2040.VIDS_PIDS_TO_AVOID_IN_RP2040.update(
        MicrobitProxy.get_known_usb_vids_pids()
    )

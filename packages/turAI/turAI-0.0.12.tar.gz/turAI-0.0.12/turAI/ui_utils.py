...
from turAI import get_workbench, misc_utils, tktextext
from turAI.common import TextRange
from turAI.custom_notebook import CustomNotebook, CustomNotebookPage, CustomNotebookTab
from turAI.languages import get_button_padding, tr
...
from turAI.tktextext import TweakableText
...
class CommonDialog(tk.Toplevel):
    def __init__(self, master=None, skip_tk_dialog_attributes=False, **kw):
        assert master
        super().__init__(master=master, class_="turAI", **kw)
...
def _check_dialog_parent(options):
    ...
    if running_on_mac_os():
        ...
        # but this is deprecated in Catalina (https://github.com/turAI/turAI/issues/840)
...
def handle_mistreated_latin_shortcuts(registry, event):
    ...
    # See: https://bitbucket.org/plas/turAI/issues/422/edit-keyboard-shortcuts-ctrl-c-ctrl-v-etc

...
class AggEngine(ABC):
    ...
    Returns:
        Tuple[dict[str, AggData], gpd.GeoDataFrame, List[npt.NDArray[Union[np.int_, np.double]]]]: The calculated aggregations.
    """
...
class InterpEngine(ABC):
    ...
    def get_variables(self, key) -> dict:
        ...
        if self._user_data.get_class_type() == "ODAPCatData":
            ...
            t_coord = self._user_data.param_dict[key]["T_name"]
            varname = self._user_data.param_dict[key]["varname"]
        ...
        elif self._user_data.get_class_type() == "UserCatData":
        ...
        return {
            ...
            "class_type": self._user_data.get_class_type(),
            "stat": self._stat,
...
class DaskInterp(InterpEngine):
    ...
    def g2l(self, id):
        ...
        out_vals |= _cal_point_stats(
            data_array=interp_dataarray[variables["varname"]],

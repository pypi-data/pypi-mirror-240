...
class GetStreamKeyRequest(Utils.RequestBaseClass):
    ...
    scope = Scope.Channel.Read.StreamKey
...
class GetStreamsResponse(Utils.PageinationMixin, Utils.ResponseBaseClass):
        def __init__(self) -> None:
...
class GetFollowedStreamsResponse(Utils.PageinationMixin, Utils.ResponseBaseClass):
        def __init__(self) -> None:
            super().__init__(Stream)
...
class GetStreamMarkersResponse(Utils.PageinationMixin, Utils.ResponseBaseClass):
        def __init__(self) -> None:
            super().__init__(Mark)

        ...
        for train_index, test_index in kf.split(self.x_data, self.y_data):
            ...
            try:
                for noise_amount in NOISE_LEVELS:
                    ...
                    train_gen, val_gen = get_train_generator(self.x_data, self.y_data, noise_amount, train_index, self.class_mode, self.input_shape)
                    ...
                    for noise_amount_testing in NOISE_LEVELS:
                        test_gen = get_test_generator(self.x_data, self.y_data, noise_amount_testing, test_index, self.class_mode, self.input_shape)

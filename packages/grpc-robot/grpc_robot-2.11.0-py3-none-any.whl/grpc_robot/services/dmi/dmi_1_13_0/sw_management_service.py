...
class NativeSoftwareManagementService(Service):
    ...
    @keyword
    @is_connected
    def sw_management_service_upload_debug_info(self, param_dict, **kwargs):
        return self._grpc_helper(self.stub.UploadDebugInfo, sw_management_service_pb2.UploadDebugInfoRequest, param_dict, **kwargs)

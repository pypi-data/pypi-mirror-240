...
class GrpcDmiRobot(GrpcRobot):
    """
    This library is intended to support different Protocol Buffer definitions. Precondition is that python files
    ...
    | dmi               | device-management-interface | 1.2.1               | grpc_robot.Dmi |
    | dmi               | device-management-interface | 1.4.0               | grpc_robot.Dmi |
    | dmi               | device-management-interface | 1.13.0              | grpc_robot.Dmi |
    | dmi               | device-management-interface | 1.13.1              | grpc_robot.Dmi |
    | dmi               | device-management-interface | 1.16.0              | grpc_robot.Dmi |
    """

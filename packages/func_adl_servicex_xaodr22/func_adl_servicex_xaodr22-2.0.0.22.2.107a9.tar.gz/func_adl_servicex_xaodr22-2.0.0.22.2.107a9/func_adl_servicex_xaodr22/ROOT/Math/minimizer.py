...
class Minimizer:
    ...
    def VariableName(self, ivar: int) -> func_adl_servicex_xaodr22.str.str:
        "A method"
        ...
    ...
    def Options(self) -> func_adl_servicex_xaodr22.ROOT.Math.minimizeroptions.MinimizerOptions:
        "A method"
        ...

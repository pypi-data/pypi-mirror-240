...
from quant1x.qmt import __author__
...
setuptools.setup(
    ...
    packages=setuptools.find_packages(include=["qmt", "qmt.*"]),
    include_package_data=True,
    install_requires=requirements,
    license="MIT license",
    zip_safe=False,
    keywords="quant1x qmt",
    entry_points={
        "console_scripts": [
            "quant1x-qmt=quant1x.qmt.__main__:main",
            "quant1x-proxy=quant1x.proxy:main",
        ]
    },
    classifiers=[

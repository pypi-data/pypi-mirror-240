...
from ultron.sentry.Math.Accumulators.IAccumulators cimport Log10
from ultron.sentry.Math.Accumulators.IAccumulators cimport Log2
...
from ultron.sentry.Math.Accumulators.IAccumulators cimport Relu
from ultron.sentry.Math.Accumulators.IAccumulators cimport SigLog10Abs
from ultron.sentry.Math.Accumulators.IAccumulators cimport SigLog2Abs
from ultron.sentry.Math.Accumulators.IAccumulators cimport Frac
from ultron.sentry.Math.Accumulators.IAccumulators cimport SigLogAbs
from ultron.sentry.Math.Accumulators.IAccumulators cimport SigSqrtAbs
...
cdef class SecurityLog2ValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecurityLog2ValueHolder, self).__init__(holderType=Log2,
                                                     x=x)

cdef class SecurityLog10ValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecurityLog10ValueHolder, self).__init__(holderType=Log10,
                                                     x=x)
...
cdef class SecurityFracValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecurityFracValueHolder, self).__init__(holderType=Frac,
                                                    x=x)

cdef class SecuritySigLog2AbsValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecuritySigLog2AbsValueHolder, self).__init__(holderType=SigLog2Abs,
                                                    x=x)

cdef class SecuritySigLog10AbsValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecuritySigLog10AbsValueHolder, self).__init__(holderType=SigLog10Abs,
                                                    x=x)

cdef class SecuritySigLogAbsValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecuritySigLogAbsValueHolder, self).__init__(holderType=SigLogAbs,
                                                    x=x)

cdef class SecuritySigSqrtAbsValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecuritySigSqrtAbsValueHolder, self).__init__(holderType=SigSqrtAbs,
                                                    x=x)
...
cdef class SecurityReluValueHolder(SecurityStatelessSingleValueHolder):
    def __init__(self, x):
        super(SecurityReluValueHolder, self).__init__(holderType=Relu,
                                                       x=x)

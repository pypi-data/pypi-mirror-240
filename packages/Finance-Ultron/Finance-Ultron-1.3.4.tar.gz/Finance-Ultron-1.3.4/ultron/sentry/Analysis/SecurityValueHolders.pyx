...
from ultron.sentry.Math.Accumulators.StatefulAccumulators cimport WAverage
...
cdef class SecurityValueHolder(object):
    ...
    def __mod__(self, right):
        return SecurityModedValueHolder(self, right)
...
cdef class SecurityModedValueHolder(SecurityCombinedValueHolder):
    def __init__(self, left, right):
        super(SecurityModedValueHolder, self).__init__(
            left, right, operator.mod)
...
cdef class SecurityWAverageValueHolder(SecuritySingleValueHolder):
    def __init__(self, window, x):
        super(SecurityWAverageValueHolder, self).__init__(window, WAverage, x)

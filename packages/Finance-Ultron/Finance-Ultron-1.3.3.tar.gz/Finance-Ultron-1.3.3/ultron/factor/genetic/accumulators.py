...
class Accumulators(object):
    ...
    def __init__(self):
        self._accumulators_pool = {
            1: SecurityCurrentValueHolder,
            2: SecurityDiffValueHolder,
            3: SecuritySignValueHolder,
            4: SecurityExpValueHolder,
            5: SecurityLogValueHolder,
            6: SecuritySqrtValueHolder,
            7: SecurityAbsValueHolder,
            8: SecurityNormInvValueHolder,
            9: SecurityCeilValueHolder,
            10: SecurityFloorValueHolder,
            11: SecurityRoundValueHolder,
            12: SecurityRoundValueHolder,
            13: CSRankedSecurityValueHolder,
            14: CSZScoreSecurityValueHolder,
            15: CSPercentileSecurityValueHolder,
            16: SecuritySigmoidValueHolder,
            17: SecurityTanhValueHolder
        }
        ...
        self._cross_pool = {
            1: CSResidueSecurityValueHolder,
            2: SecurityAddedValueHolder,
            3: SecuritySubbedValueHolder,
            4: SecurityMultipliedValueHolder,
            5: SecurityDividedValueHolder,
            6: SecurityLtOperatorValueHolder,
            7: SecurityLeOperatorValueHolder,
            8: SecurityGtOperatorValueHolder,
            9: SecurityGeOperatorValueHolder,
            10: SecurityEqOperatorValueHolder,
            11: SecurityNeOperatorValueHolder,
            12: SecurityAndOperatorValueHolder,
    ...
    def transform(self, expression, is_formula=False):
        ...
        for i in range(len(var_group)):
            if i == 0:
                ...
                is_acc = True
                formula = self._accumulators_pool[int(
                    var_group[i])].__name__ + '(' + formula + ')'
        if not is_acc:
            formula = self._accumulators_pool[1].__name__ + '(' + formula + ')'
    ...
    def calc_new_factor(self, mutated_cross_columns, factor_data):
        ...
        for columns in mutated_cross_columns:
            sub_data = eval(columns).transform(factor_data,
                                               name=str(columns),
                                               category_field='code',
                                               dropna=False)

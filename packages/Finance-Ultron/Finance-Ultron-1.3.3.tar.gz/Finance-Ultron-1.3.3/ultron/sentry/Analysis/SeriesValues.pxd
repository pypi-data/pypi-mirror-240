...
cdef class SeriesValues(object):
    ...
    cpdef SeriesValues demean(self, SeriesValues groups=*)
    ...
    cpdef SeriesValues winsorize(self, int nums_stds, SeriesValues groups=*)
    cpdef SeriesValues softmax(self, SeriesValues groups=*)
    cpdef SeriesValues unit(self)

    cpdef SeriesValues mean(self, SeriesValues groups=*)
    cpdef SeriesValues std(self, SeriesValues groups=*)
    cpdef SeriesValues skew(self, SeriesValues groups=*)
    cpdef SeriesValues sum(self, SeriesValues groups=*)

...
from ultron.sentry.Math.Accumulators.StatefulAccumulators import MovingMeanResidue
from ultron.sentry.Math.Accumulators.StatefulAccumulators import MovingConVariance
from ultron.sentry.Math.Accumulators.StatefulAccumulators import MovingCoef
from ultron.sentry.Math.Accumulators.StatefulAccumulators import MovingRSquared
...
__all__ = [
    "Exp", "Log", "Sqrt", "Sign", "Negative", "Abs", "Pow", "Acos", "Acosh",
    "Asin", "Asinh", "NormInv", "Current", "Latest", "Sign", "Diff",
    "SimpleReturn", "LogReturn", "PositivePart", "NegativePart", "Max",
    "Maximum", "Min", "Minimum", "Sum", "Average", "XAverage", "MACD",
    "Variance", "Shift", "Delta", "IIF", "Identity", "MovingAverage",
    "MovingDecay", "MovingPositiveAverage", "MovingNegativeAverage",
    "MovingPositiveDifferenceAverage", "MovingNegativeDifferenceAverage",
    "MovingRSI", "MovingSum", "MovingCountedPositive", "MovingCountedNegative",
    "MovingNegativeVariance", "MovingCorrelation", "MovingMax", "MovingArgMax",
    "MovingMin", "MovingArgMin", "MovingRank", "MovingQuantile",
    "MovingAllTrue", "MovingAnyTrue", "MovingVariance",
    "MovingStandardDeviation", "MovingLogReturn", "MovingResidue","MovingMeanResidue",
    "MovingCoef", "MovingRSquared","MovingSharp", "MovingSortino", "MovingDrawdown",
    "MovingMaxDrawdown", "Product", "MovingProduct","MovingConVariance"
]

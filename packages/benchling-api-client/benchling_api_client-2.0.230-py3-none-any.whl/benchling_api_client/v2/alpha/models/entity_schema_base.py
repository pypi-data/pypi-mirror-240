...
T = TypeVar("T", bound="EntitySchemaBase")
...
class EntitySchemaBase:
    ...
    def __repr__(self):
        ...
        return "EntitySchemaBase({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        entity_schema_base.additional_properties = d
        return entity_schema_base

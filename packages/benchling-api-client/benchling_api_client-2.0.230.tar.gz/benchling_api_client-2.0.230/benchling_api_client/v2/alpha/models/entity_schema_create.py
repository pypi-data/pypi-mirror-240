...
T = TypeVar("T", bound="EntitySchemaCreate")


@attr.s(auto_attribs=True, repr=False)
class EntitySchemaCreate:
    """  """

    _auth_parent_option: Union[Unset, EntitySchemaBaseAuthParentOption] = UNSET
    _collaborators: Union[Unset, List[Collaborator]] = UNSET
    ...
    def __repr__(self):
        ...
        fields.append("collaborators={}".format(repr(self._collaborators)))
        ...
        return "EntitySchemaCreate({})".format(", ".join(fields))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        collaborators: Union[Unset, List[Any]] = UNSET
        if not isinstance(self._collaborators, Unset):
            collaborators = []
            for collaborators_item_data in self._collaborators:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_collaborators() -> Union[Unset, List[Collaborator]]:
            collaborators = []
            _collaborators = d.pop("collaborators")
            for collaborators_item_data in _collaborators or []:
                collaborators_item = Collaborator.from_dict(collaborators_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            collaborators = cast(Union[Unset, List[Collaborator]], UNSET)
        ...
        entity_schema_create.additional_properties = d
        return entity_schema_create
    ...
    def collaborators(self) -> List[Collaborator]:
        if isinstance(self._collaborators, Unset):
            raise NotPresentError(self, "collaborators")
        return self._collaborators

    @collaborators.setter
    def collaborators(self, value: List[Collaborator]) -> None:
        self._collaborators = value

    @collaborators.deleter
    def collaborators(self) -> None:
        self._collaborators = UNSET

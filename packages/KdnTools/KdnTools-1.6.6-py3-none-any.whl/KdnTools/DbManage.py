...
from .User import User  # Make sure to import User from the correct location

class DbManage:
    def __init__(self, db_location):
        self.db_name = db_location
        self.conn = self.connect_db()
        self.conn.row_factory = sq.Row  # Set row factory to return rows as dictionaries
        self.Ctext = User.Ctext  # Assuming these are provided by the User class
        self.Choice = User.Choice  # Assuming these are provided by the User class
    ...
    def DbUse(self, subject_name, table):
        self.create_table(table, {})  # Change the second argument as needed

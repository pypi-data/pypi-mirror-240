...
class Tools:
    ...
    class DatabaseManager:
        ...
        def remove_data(self, table_name, condition):
            ...
            if cursor.rowcount == 0:
                ...
                print(f"{cursor.rowcount} row(s) deleted from the {table_name}.")
    ...
    class RandNumber:
        ...
        def __str__(self):
            return str(self.rand_number(self.num1, self.num2))

    def __init__(self, db_location):
        self.tools_instance = self


"""
python setup.py sdist bdist_wheel
twine upload dist/*
pip install --update KdnTools
"""
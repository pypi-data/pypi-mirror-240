...
from .rfile import FileBytes, read_file
...
class REmail(object):
    ...
    def send_email(
        ...
        for file_name, file_source in attachment.items():
            ...
            ### Bytes.
            if file_source.__class__ == bytes:
                file_bytes = file_source

            ### Path.
            elif file_source.__class__ == str:
                file_bytes = read_file(file_source)

            ### IO.
            elif isinstance(file_source, BufferedIOBase):
                file_bytes = file_source.read()

            ### Raise.
            else:
                throw(TypeError, file_source)

...
class BasePanoramaResource:
    ...
    def __init__(self,
        ...
        if not host.startswith('http'):
            host = 'https://' + host
        self._client = client
        self._name = '{}/{}'.format(resource_type, resource)
        self._url = '{}/restapi/{}/{}/{}'.format(host, version, resource_type,
                                                 resource)
...
class PanoramaResource(BasePanoramaResource):
    ...
    def get(self,
        ...
        def func(params):
            ...
            res = self._client.get(self._url,
                                   params=params,
                                   headers=headers,
                                   data=data,
                                   verify=verify)
        ...
        if len(device_group) > 1:
            ...
            data = [record for res in data for record in res]
            return data
...
class GroupedResources:
    ...
    def _grouped(self, method, *args, **kwargs):
        params_list = [(getattr(r, method), args, kwargs)
...
class PanoramaPanoramaResourceType(PanoramaResourceType):
    ...
    def __init__(self, client, domain, version='v10.1'):
        ...
        def resource(name):
            return BasePanoramaResource(client,
                                        domain,
                                        resource_type,
                                        name,
                                        version=version)
...
class PanoramaObjectsResourceType(PanoramaResourceType):
    ...
    def __init__(self, client, domain, version='v10.1'):
        ...
        def resource(name):
            return PanoramaResource(client,
                                    domain,
                                    resource_type,
                                    name,
                                    version=version)
        ...
        self.CustomVulnerabilitySignatures = resource(
        ...
        self.AuthenticationEnforcements = resource(
            'AuthenticationEnforcements')
        self.DecryptionProfiles = resource('DecryptionProfiles')
        self.DecryptionForwardingProfiles = resource(
...
class PanoramaPoliciesResourceType(PanoramaResourceType):
    ...
    def __init__(self, client, domain, version='v10.1'):
        ...
        self.SecurityRules = GroupedResources(self.SecurityPreRules,
        ...
        self.PolicyBasedForwardingPreRules = resource(
            'PolicyBasedForwardingPreRules')
        self.PolicyBasedForwardingPostRules = resource(
        ...
        self.DecryptionRules = GroupedResources(self.DecryptionPreRules,
        ...
        self.TunnelInspectionRules = GroupedResources(
            self.TunnelInspectionPreRules, self.TunnelInspectionPostRules)
        self.ApplicationOverridePreRules = resource(
            'ApplicationOverridePreRules')
        self.ApplicationOverridePostRules = resource(
        ...
        self.AuthenticationRules = GroupedResources(
            self.AuthenticationPreRules, self.AuthenticationPostRules)
        ...
        self.SDWANRules = GroupedResources(self.SDWANPreRules,
                                           self.SDWANPostRules)
...
class PanoramaNetworkResourceType(PanoramaResourceType):
    ...
    def __init__(self, client, domain, version='v10.1'):
        ...
        self.AggregateEthernetInterfaces = resource(
        ...
        self.GlobalProtectGatewayMDMServers = resource(
            'GlobalProtectGatewayMDMServers')
        self.GlobalProtectClientlessApps = resource(
        ...
        self.ZoneProtectionNetworkProfiles = resource(

...
PANORAMA_ERRORS = {
    ...
    3:
    'Bad request. The caller specified an invalid parameter.',
    ...
    6:
    'Conflict. The entity that the caller attempted to create already exists.',
    ...
    9: ('Failed precondition. The operation was rejected because the system'
    ...
    16: ('Unauthorized. The request does not have valid authentication'

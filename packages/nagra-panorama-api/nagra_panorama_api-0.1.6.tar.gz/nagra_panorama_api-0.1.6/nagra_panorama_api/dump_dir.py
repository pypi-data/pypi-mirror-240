    ...
    return [
        {
            ...
            'securityRules',
            'pre-data':
            client.policies.SecurityPreRules.get(device_group=device_group,
                                                 inherited=False),
            'post-data':
            client.policies.SecurityPostRules.get(device_group=device_group,
                                                  inherited=False),
        },
        {
            'rule_type':
            ...
            'nat',
            'pre-data':
            client.policies.NATPreRules.get(device_group=device_group,
                                            inherited=False),
            'post-data':
            client.policies.NATPostRules.get(device_group=device_group,
                                             inherited=False),
        },
        {
            'rule_type':
            ...
            'pb',
            'pre-data':
            client.policies.PolicyBasedForwardingPreRules.get(
                device_group=device_group, inherited=False),
            'post-data':
            client.policies.PolicyBasedForwardingPostRules.get(
                device_group=device_group, inherited=False),
        },
        {
            'rule_type':
            ...
            'appover',
            'pre-data':
            client.policies.ApplicationOverridePreRules.get(
                device_group=device_group, inherited=False),
            'post-data':
            client.policies.ApplicationOverridePostRules.get(
                device_group=device_group, inherited=False),
        },
    ]

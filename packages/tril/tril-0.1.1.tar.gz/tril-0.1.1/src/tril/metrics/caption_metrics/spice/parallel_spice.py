...
def init_java():
    ...
    rl4lm_cache_home = os.path.expanduser(
        os.getenv(
            "RL4LM_HOME", os.path.join(os.getenv("XDG_CACHE_HOME", "~/.cache"), "rl4lm")
        )
    )

    default_cache_path = os.path.join(rl4lm_cache_home, "metrics")

...
function GetOperqation(Operation)
	...
	elseif Op == "GetKV" or Op == "GetKVs"  then
		if Obj == "" then
			Operation=string.format('GetTags(%s)\n',Obj)
		else
			Operation=string.format('GetTagVal("%s")\n',Obj)
		end
	elseif Op == "ClearTag" or  Op == "ClearKV" then
		if Obj == "" then
			Operation=string.format('ClearTag(%s)\n',Obj)
		else
			Operation=string.format('ClearTag("%s")\n',Obj)
		end
	elseif Op == "GetTags" or  Op == "GetKeys" then
		Operation=string.format('GetTags()\n')
	...
	elseif Op == "SetMax" then
		Operation=string.format('SetMax(%s)\n',Obj)
	elseif Op == "Lua" then
		if Obj == "" then
			Obj ="$Q"
		end
		...
		Operation=string.format('Handle%d=Context(Handle%d,%d)\n',HandleNo,HandleNo-1,30)
	end
	HandleNo=HandleNo+1
	return Operation
end

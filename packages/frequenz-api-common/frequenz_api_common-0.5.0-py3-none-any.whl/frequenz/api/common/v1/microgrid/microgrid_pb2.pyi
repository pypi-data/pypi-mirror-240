...
class Microgrid(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_timestamp", b"create_timestamp", "delivery_area", b"delivery_area", "location", b"location"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_timestamp", b"create_timestamp", "delivery_area", b"delivery_area", "enterprise_id", b"enterprise_id", "id", b"id", "location", b"location", "name", b"name", "status", b"status"]) -> None: ...

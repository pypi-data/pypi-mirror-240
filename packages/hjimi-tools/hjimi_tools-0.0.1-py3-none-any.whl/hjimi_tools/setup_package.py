...
class PackageSetup:
    ...
    def setup_package(self):
        ...
        self.create_file(os.path.join(package_dir, '__init__.py'))
...
"""
        self.create_file(os.path.join(self.package_name, 'pyproject.toml'), pyproject_content)

        # Create README.md file
        self.create_file(os.path.join(self.package_name, 'README.md'), f'# {self.package_name}\n')

        # Create LICENSE file
        self.create_file(os.path.join(self.package_name, 'LICENSE'), 'MIT License\n')

        # Create requirements.txt file
        self.create_file(os.path.join(self.package_name, 'requirements.txt'))

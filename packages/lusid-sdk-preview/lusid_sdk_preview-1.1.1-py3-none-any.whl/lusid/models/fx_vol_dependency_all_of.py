...
class FxVolDependencyAllOf(object):
    ...
    def __init__(self, domestic_currency=None, foreign_currency=None, vol_type=None, date=None, dependency_type=None, local_vars_configuration=None):  # noqa: E501
        """FxVolDependencyAllOf - a model defined in OpenAPI"
    ...
    def domestic_currency(self):
        """Gets the domestic_currency of this FxVolDependencyAllOf.  # noqa: E501

        DomesticCurrency is the first currency in a currency pair quote e.g. eur-gbp, eur is the domestic currency.  # noqa: E501

        :return: The domestic_currency of this FxVolDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def domestic_currency(self, domestic_currency):
        """Sets the domestic_currency of this FxVolDependencyAllOf.

        DomesticCurrency is the first currency in a currency pair quote e.g. eur-gbp, eur is the domestic currency.  # noqa: E501

        :param domestic_currency: The domestic_currency of this FxVolDependencyAllOf.  # noqa: E501
        :type domestic_currency: str
        """
    ...
    def foreign_currency(self):
        """Gets the foreign_currency of this FxVolDependencyAllOf.  # noqa: E501

        ForeignCurrency is the second currency in a currency pair quote e.g. eur-gbp, gbp is the foreign currency.  # noqa: E501

        :return: The foreign_currency of this FxVolDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def foreign_currency(self, foreign_currency):
        """Sets the foreign_currency of this FxVolDependencyAllOf.

        ForeignCurrency is the second currency in a currency pair quote e.g. eur-gbp, gbp is the foreign currency.  # noqa: E501

        :param foreign_currency: The foreign_currency of this FxVolDependencyAllOf.  # noqa: E501
        :type foreign_currency: str
        """
    ...
    @property
    def vol_type(self):
        """Gets the vol_type of this FxVolDependencyAllOf.  # noqa: E501

        Volatility type e.g. \"LN\" and \"N\" for log-normal and normal volatility.  # noqa: E501

        :return: The vol_type of this FxVolDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def vol_type(self, vol_type):
        """Sets the vol_type of this FxVolDependencyAllOf.

        Volatility type e.g. \"LN\" and \"N\" for log-normal and normal volatility.  # noqa: E501

        :param vol_type: The vol_type of this FxVolDependencyAllOf.  # noqa: E501
        :type vol_type: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this FxVolDependencyAllOf.  # noqa: E501
        ...
        :return: The date of this FxVolDependencyAllOf.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this FxVolDependencyAllOf.

        The effectiveDate of the entity that this is a dependency for.  Unless there is an obvious date this should be, like for a historic reset, then this is the valuation date.  # noqa: E501

        :param date: The date of this FxVolDependencyAllOf.  # noqa: E501
        :type date: datetime
        """
    ...
    def dependency_type(self):
        """Gets the dependency_type of this FxVolDependencyAllOf.  # noqa: E501
        ...
        :return: The dependency_type of this FxVolDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_type(self, dependency_type):
        """Sets the dependency_type of this FxVolDependencyAllOf.

        The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor, CalendarDependency, InflationFixingDependency  # noqa: E501

        :param dependency_type: The dependency_type of this FxVolDependencyAllOf.  # noqa: E501
        :type dependency_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FxVolDependencyAllOf):
            return False

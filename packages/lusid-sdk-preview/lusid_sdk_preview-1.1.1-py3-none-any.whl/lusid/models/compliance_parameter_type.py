...
class ComplianceParameterType(object):
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ComplianceParameterType - a model defined in OpenAPI"
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComplianceParameterType):
            return False

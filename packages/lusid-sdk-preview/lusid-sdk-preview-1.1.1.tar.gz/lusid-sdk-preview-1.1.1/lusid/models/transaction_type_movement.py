...
class TransactionTypeMovement(object):
    ...
    attribute_map = {
        ...
        'settlement_date_override': 'settlementDateOverride'
    }
    ...
    required_map = {
        ...
        'settlement_date_override': 'optional'
    }

    def __init__(self, movement_types=None, side=None, direction=None, properties=None, mappings=None, name=None, movement_options=None, settlement_date_override=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param settlement_date_override:  Optional property key that must be in the Transaction domain when specified. When the movement is processed and the transaction has this property set to a valid date, then the property value will override the SettlementDate of the transaction.
        :type settlement_date_override: str
        ...
        self._settlement_date_override = None
        ...
        self.settlement_date_override = settlement_date_override
    ...
    def movement_types(self, movement_types):
        ...
        if (self.local_vars_configuration.client_side_validation and
                movement_types is not None and len(movement_types) < 1):
            raise ValueError("Invalid value for `movement_types`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def mappings(self, mappings):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                mappings is not None and len(mappings) > 5000):
            raise ValueError("Invalid value for `mappings`, number of items must be less than or equal to `5000`")  # noqa: E501
    ...
    def movement_options(self):
        """Gets the movement_options of this TransactionTypeMovement.  # noqa: E501
        ...
        :return: The movement_options of this TransactionTypeMovement.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def movement_options(self, movement_options):
        """Sets the movement_options of this TransactionTypeMovement.

        Allows extra specifications for the movement. The only option currently available is 'DirectAdjustment'. A movement type of 'StockMovement' with an option of 'DirectAdjusment' will allow you to adjust the unitsof a holding without affecting its cost base. You will, therefore, be able to reflect the impact of a stock split by loading a Transaction.  # noqa: E501

        :param movement_options: The movement_options of this TransactionTypeMovement.  # noqa: E501
        :type movement_options: list[str]
        """
    ...
    @property
    def settlement_date_override(self):
        """Gets the settlement_date_override of this TransactionTypeMovement.  # noqa: E501

        Optional property key that must be in the Transaction domain when specified. When the movement is processed and the transaction has this property set to a valid date, then the property value will override the SettlementDate of the transaction.  # noqa: E501

        :return: The settlement_date_override of this TransactionTypeMovement.  # noqa: E501
        :rtype: str
        """
        return self._settlement_date_override

    @settlement_date_override.setter
    def settlement_date_override(self, settlement_date_override):
        """Sets the settlement_date_override of this TransactionTypeMovement.

        Optional property key that must be in the Transaction domain when specified. When the movement is processed and the transaction has this property set to a valid date, then the property value will override the SettlementDate of the transaction.  # noqa: E501

        :param settlement_date_override: The settlement_date_override of this TransactionTypeMovement.  # noqa: E501
        :type settlement_date_override: str
        """

        self._settlement_date_override = settlement_date_override

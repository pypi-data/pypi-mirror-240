...
class CashDividendEvent(object):
    ...
    def __init__(self, gross_amount=None, payment_date=None, record_date=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """CashDividendEvent - a model defined in OpenAPI"
    ...
    def gross_amount(self):
        """Gets the gross_amount of this CashDividendEvent.  # noqa: E501

        The before tax amount for each share held being paid out to shareholders.  # noqa: E501

        :return: The gross_amount of this CashDividendEvent.  # noqa: E501
        :rtype: float
        """
    ...
    def gross_amount(self, gross_amount):
        """Sets the gross_amount of this CashDividendEvent.

        The before tax amount for each share held being paid out to shareholders.  # noqa: E501

        :param gross_amount: The gross_amount of this CashDividendEvent.  # noqa: E501
        :type gross_amount: float
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this CashDividendEvent.  # noqa: E501

        The date the company pays out dividends to shareholders.  # noqa: E501

        :return: The payment_date of this CashDividendEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this CashDividendEvent.

        The date the company pays out dividends to shareholders.  # noqa: E501

        :param payment_date: The payment_date of this CashDividendEvent.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    def record_date(self):
        """Gets the record_date of this CashDividendEvent.  # noqa: E501

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :return: The record_date of this CashDividendEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def record_date(self, record_date):
        """Sets the record_date of this CashDividendEvent.

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :param record_date: The record_date of this CashDividendEvent.  # noqa: E501
        :type record_date: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this CashDividendEvent.  # noqa: E501
        ...
        :return: The instrument_event_type of this CashDividendEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this CashDividendEvent.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this CashDividendEvent.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CashDividendEvent):
            return False

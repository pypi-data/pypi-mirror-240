...
class TransactionReconciliationRequestV2(object):
    ...
    def __init__(self, left=None, right=None, left_to_right_mapping=None, comparison_rules=None, preserve_keys=None, local_vars_configuration=None):  # noqa: E501
        """TransactionReconciliationRequestV2 - a model defined in OpenAPI"
        
        :param left:  (required)
        :type left: lusid.AggregatedTransactionsRequest
        :param right:  (required)
        :type right: lusid.AggregatedTransactionsRequest
    ...
    @property
    def left(self):
        """Gets the left of this TransactionReconciliationRequestV2.  # noqa: E501


        :return: The left of this TransactionReconciliationRequestV2.  # noqa: E501
        :rtype: lusid.AggregatedTransactionsRequest
        """
        return self._left

    @left.setter
    def left(self, left):
        """Sets the left of this TransactionReconciliationRequestV2.


        :param left: The left of this TransactionReconciliationRequestV2.  # noqa: E501
        :type left: lusid.AggregatedTransactionsRequest
        """
    ...
    @property
    def right(self):
        """Gets the right of this TransactionReconciliationRequestV2.  # noqa: E501


        :return: The right of this TransactionReconciliationRequestV2.  # noqa: E501
        :rtype: lusid.AggregatedTransactionsRequest
        """
        return self._right
    ...
    def right(self, right):
        """Sets the right of this TransactionReconciliationRequestV2.


        :param right: The right of this TransactionReconciliationRequestV2.  # noqa: E501
        :type right: lusid.AggregatedTransactionsRequest
        """
    ...
    def left_to_right_mapping(self):
        """Gets the left_to_right_mapping of this TransactionReconciliationRequestV2.  # noqa: E501

        The mapping from property keys requested by left aggregation to property keys on right hand side  # noqa: E501

        :return: The left_to_right_mapping of this TransactionReconciliationRequestV2.  # noqa: E501
    ...
    def left_to_right_mapping(self, left_to_right_mapping):
        """Sets the left_to_right_mapping of this TransactionReconciliationRequestV2.

        The mapping from property keys requested by left aggregation to property keys on right hand side  # noqa: E501

        :param left_to_right_mapping: The left_to_right_mapping of this TransactionReconciliationRequestV2.  # noqa: E501
        :type left_to_right_mapping: list[lusid.ReconciliationLeftRightAddressKeyPair]
        """
    ...
    def comparison_rules(self):
        """Gets the comparison_rules of this TransactionReconciliationRequestV2.  # noqa: E501

        The set of rules to be used in comparing values. These are the rules that determine what constitutes a match.  The simplest is obviously an exact one-for-one comparison, but tolerances on numerical or date time values and  case-insensitive string comparison are supported amongst other types.  # noqa: E501

        :return: The comparison_rules of this TransactionReconciliationRequestV2.  # noqa: E501
    ...
    def comparison_rules(self, comparison_rules):
        """Sets the comparison_rules of this TransactionReconciliationRequestV2.

        The set of rules to be used in comparing values. These are the rules that determine what constitutes a match.  The simplest is obviously an exact one-for-one comparison, but tolerances on numerical or date time values and  case-insensitive string comparison are supported amongst other types.  # noqa: E501

        :param comparison_rules: The comparison_rules of this TransactionReconciliationRequestV2.  # noqa: E501
        :type comparison_rules: list[lusid.ReconciliationRule]
        """
    ...
    def preserve_keys(self):
        """Gets the preserve_keys of this TransactionReconciliationRequestV2.  # noqa: E501
        ...
        :return: The preserve_keys of this TransactionReconciliationRequestV2.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def preserve_keys(self, preserve_keys):
        """Sets the preserve_keys of this TransactionReconciliationRequestV2.

        List of keys to preserve (from rhs) in the diff. Used in conjunction with filtering/grouping.  If two values are equal, for a given key then the value is elided from the results. Setting it here  will preserve it (takes the values from the RHS and puts it into the line by line results).  # noqa: E501

        :param preserve_keys: The preserve_keys of this TransactionReconciliationRequestV2.  # noqa: E501
        :type preserve_keys: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionReconciliationRequestV2):
            return False

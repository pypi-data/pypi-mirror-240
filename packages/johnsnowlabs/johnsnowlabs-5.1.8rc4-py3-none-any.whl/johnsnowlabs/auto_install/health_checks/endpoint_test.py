...
def run_test_v2():
    ...
    nlp.deploy_endpoint("tokenize", True, True)
    df = nlp.query_endpoint("tokenize", "Hello World")
...
if __name__ == "__main__":
    ...
    dbutils.library.installPyPI("johnsnowlabs_for_databricks_by_ckl==5.1.8rc7")
    # run_test_v2()
    # run_test()

...
:LastEditTime: 2023-10-16 14:49:36
...
class CryptoHelper:
    ...
    @classmethod
    def get_dir_hash(cls, dir_path,hashfunc="md5",excluded_files=None,ignore_hidden=False,followlinks=False,excluded_extensions=None,include_paths=False):
        """
        :description: 计算目录哈希值
        :param path
        :return 目录哈希值

...
# == /media/ssd/Programming/pycomex/pycomex/examples/03_analysing.analysis ==
@experiment.analysis
def analysis(e):
...
# == /media/ssd/Programming/pycomex/pycomex/examples/04_inheritance.analysis ==
@experiment.analysis
def analysis(e):

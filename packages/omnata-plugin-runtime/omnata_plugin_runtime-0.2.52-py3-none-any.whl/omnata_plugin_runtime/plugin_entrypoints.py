...
class PluginEntrypoint:
    ...
    def sync(self, sync_request: Dict):
        ...
        connection_parameters.snowflake = self._snowflake  # pylint: disable=protected-access
        ...
        if request.sync_direction == "outbound":
            ...
            parameters.snowflake = self._snowflake
            if request.oauth_secret_name is not None:
    ...
    def api_limits(self,
        ...
        connection_parameters.snowflake = self._snowflake
        if oauth_secret_name is not None:

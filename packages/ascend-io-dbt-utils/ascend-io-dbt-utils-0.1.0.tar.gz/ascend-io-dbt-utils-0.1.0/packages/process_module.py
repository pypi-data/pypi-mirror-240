...
def update_sql_cmd(manifest_file, hostname, data_service, dataflow):
    ...
    for node_str in nodes:
        ...
        try:
            ...
            transform_body.view.operator.spark_function.executable.code.source.inline = _translate_sql(_get_compiled_sql(manifest=manifest, node_str=node_str), dependencies[node_str])

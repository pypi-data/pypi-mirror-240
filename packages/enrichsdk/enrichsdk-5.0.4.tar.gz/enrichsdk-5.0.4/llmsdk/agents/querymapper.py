...
class LLMQueryMapper(BaseLLMAgent):
    """
...
You will be presented with a user's query and a set of {num_choices} possible matching pieces of text.
The text choices will be presented as successive pairs of:
TEXT: text
ID: identifier

Your task is to respond with the ID of the MOST RELEVANT piece of text that matches the query.

Respond with ONLY the ID of the text as a json dictionary as follows:
{output_format}

If the user's query is not relevant to any of the text choices, respond with an empty string. DO NOT MAKE SOMETHING UP.
...
if __name__ == "__main__":
    ...
    # test query set
    queries = [
        "what is the trend of traffic over the previous three months going from vietname to ghana?",
        "show me traffic growth from england to india past three months?",
        ...
        "summarize the business highlights for the quarter",

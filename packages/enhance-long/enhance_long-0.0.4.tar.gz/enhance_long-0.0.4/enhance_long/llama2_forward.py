...
'''
 ...
 Date         : 2023-11-09 11:29:21
 LastEditTime : 2023-11-09 11:34:55
...
def forward_logn_train(
    ...
    logn_list = [
        math.log(i, q_len) for i in range(1, q_len+1)
    ]
...
def forward_logn_predict(
    ...
    # attn use logn scale:
        # if training_flag:
        #     logn_list = [math.log(i, LLAMA2_MAX_LENGTH) for i in range(1, q_len+1)]
        # else:
    logn_list = [
        math.log(i, LLAMA2_MAX_LENGTH) if i > LLAMA2_MAX_LENGTH else 1
...
def replace_llama2_attn_with_flash_attn_attn():
    transformers.models.llama.modeling_llama.LlamaModel._prepare_decoder_attention_mask = _prepare_decoder_attention_mask
    transformers.models.llama.modeling_llama.LlamaAttention.forward = forward


def replace_llama2_attn_with_flash_attn_and_logn_attn_predict():
    transformers.models.llama.modeling_llama.LlamaModel._prepare_decoder_attention_mask = _prepare_decoder_attention_mask
    transformers.models.llama.modeling_llama.LlamaAttention.forward = forward_logn_predict

    
    
def replace_llama2_attn_with_flash_attn_and_logn_attn_train():
    transformers.models.llama.modeling_llama.LlamaModel._prepare_decoder_attention_mask = _prepare_decoder_attention_mask
    transformers.models.llama.modeling_llama.LlamaAttention.forward = forward_logn_train
...
class MySQLClient(AsyncContextManager):
    ...
    async def _execute(self, query: str, args: MYSQL_EXECUTE_ARGUMENTS_TYPE = None) -> Cursor:
        ...
        global MYSQL_RETRY_COUNT, MYSQL_RETRY_ERROR

        async for times in AsyncCirculatory(max_times=MYSQL_RETRY_COUNT):
            ...
            except MYSQL_RETRY_ERROR as err:

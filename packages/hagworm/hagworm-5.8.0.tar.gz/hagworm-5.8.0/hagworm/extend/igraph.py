...
VERTEX_PARAMETER_TYPE = Union[Vertex, str, int]
...
class Graph:
    ...
    def init_edges(self, edges: List[Tuple[VERTEX_PARAMETER_TYPE, VERTEX_PARAMETER_TYPE]]):

        self._graph.add_edges(edges)

    def get_edge(self, source: VERTEX_PARAMETER_TYPE, target: VERTEX_PARAMETER_TYPE) -> Union[Edge, None]:

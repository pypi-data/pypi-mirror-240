...
PDFFIGURES2_PATH = os.environ.get('PDFFIGURES2_PATH')
if PDFFIGURES2_PATH is None:
    raise Exception('The PDFFIGURES2_PATH environment variable is not set. Please set it to the location of the pdffigures2 library.')

PDF_DIR = os.path.join(PDFFIGURES2_PATH, "pdf_dir/")
PDF_FILE = os.path.join(PDF_DIR, "main.pdf")

"""CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
PDF_DIR = os.path.join(CURRENT_DIR, "pdffigures2", "pdf_dir/")
PDF_FILE = os.path.join(PDF_DIR, "main.pdf")
PDFFIGURES2_PATH = CURRENT_DIR + "/pdffigures2/"""

def process_pdf(pdf, openai_api_key, google_id, google_bucket):
    """
    control flow of app
    """
    global OPENAI_API_KEY, GOOGLE_ID, GOOGLE_BUCKET

...
def load_df_pd(fpath: str,
    ...
    max_chunk, kwargs = get_update_kwargs('max_chunk', np.inf, kwargs, func_update=False)
    random_choice, kwargs = get_update_kwargs('random_choice', False, kwargs, func_update=False)
    max_iter, kwargs = get_update_kwargs('max_iter', 10000, kwargs, func_update=False)

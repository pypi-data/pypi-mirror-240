...
def app(
    ...
    if path is not None:
        # TODO: Use Warnings instead and standardize deprecation messages
        log.info("WARNING: The app path argument is deprecated. Please remove.\n")
...
def task(
    ...
    for arg in deprecated_args:
        if deprecated_args[arg] is not None:
            # TODO: Use Warnings instead and standardize deprecation messages
            log.info(f"WARNING: The task {arg} argument is deprecated. Please remove.\n")

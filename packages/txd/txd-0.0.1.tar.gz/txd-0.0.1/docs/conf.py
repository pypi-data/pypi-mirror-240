...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("txd")
...
html_title = "txd"
# html_favicon = "../logo/txd-favicon-color.png"
# html_logo = "../logo/txd-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://txd.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/txd",
    "repo_name": "bernardodionisi/txd",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/txd",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/txd/",
        },
    ],
    "edit_uri": "",
...
#     member for member in dir(txd.Array) if inspect.isdatadescriptor(getattr(type(txd.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(txd._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(txd._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(txd.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(txd._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(txd.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(txd.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(txd._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(txd._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(txd._domains._meta.ArrayMeta, p)
#     delattr(txd._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(txd.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(txd._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(txd._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)

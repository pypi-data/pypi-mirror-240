...
# TODO: add types
def retry_on_exception(exception: Type[Exception], n: int):
...
class ArraylakeHttpClient:
    ...
    @retry_on_exception(httpx.RemoteProtocolError, 3)  # type: ignore  # TODO we need to type retry_on_exception first

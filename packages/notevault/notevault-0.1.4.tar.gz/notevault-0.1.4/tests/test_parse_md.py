...
from notevault.parse_md import parse_section, extract_section_html

schema = load_schema("tests/resources/schema.yaml")
document_structure = schema["DocumentStructure"]
model_spec = schema["Model"]

with open("tests/resources/daily_meeting.md", "r") as file:
    md_text = file.read()

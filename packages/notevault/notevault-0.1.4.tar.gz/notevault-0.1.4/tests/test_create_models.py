...
from notevault.create_models import pydantic_type_to_sqlalchemy_type, convert_instance_pydantic_to_sqlalchemy
...
def test_pydantic_type_to_sqlalchemy_type(pydantic_type, expected_type):
    assert pydantic_type_to_sqlalchemy_type(pydantic_type) == expected_type

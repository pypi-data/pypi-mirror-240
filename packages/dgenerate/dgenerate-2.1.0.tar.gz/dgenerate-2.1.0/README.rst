.. |Documentation Status| image:: https://readthedocs.org/projects/dgenerate/badge/?version=v2.1.0
   :target: http://dgenerate.readthedocs.io/en/v2.1.0/
...
For library documentation visit `readthedocs <http://dgenerate.readthedocs.io/en/v2.1.0/>`_.
...
.. code-block:: text
    ...
    options:
      ...
      -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                            ...
                            [https://dgenerate.readthedocs.io/en/v2.1.0/dgenerate_submodules.html#dgenerate.p
      ...
      -pmc EXPR [EXPR ...], --pipeline-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            Syntax See: [https://dgenerate.readthedocs.io/en/v2.1.0/dgenerate_submodules.html
      ...
      -vmc EXPR [EXPR ...], --vae-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            /en/v2.1.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.VAE_CACHE_MEMORY_C
                            ONSTRAINTS]
...
.. code-block:: bash
    ...
    pipx install dgenerate==2.1.0 ^
    --pip-args "--extra-index-url https://download.pytorch.org/whl/cu118/"

    # You can install without pipx into your own environment like so

    pip install dgenerate==2.1.0 --extra-index-url https://download.pytorch.org/whl/cu118/
...
.. code-block:: bash
    ...
    pipx install dgenerate[flax]==2.1.0 \
    --pip-args "--extra-index-url https://download.pytorch.org/whl/cu118/ \
    -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html"

    # You can install without pipx into your own environment like so

    pip3 install dgenerate==2.1.0 --extra-index-url https://download.pytorch.org/whl/cu118/
 ...
 * `my-image-seed.png <https://raw.githubusercontent.com/Teriks/dgenerate/v2.1.0/examples/media/dog-on-bench.png>`_
 * `my-mask-image.png <https://raw.githubusercontent.com/Teriks/dgenerate/v2.1.0/examples/media/dog-on-bench-mask.png>`_
...
These examples use: `vermeer_canny_edged.png <https://raw.githubusercontent.com/Teriks/dgenerate/v2.1.0/examples/media/vermeer_canny_edged.png>`_
...
This image of a `horse <https://raw.githubusercontent.com/Teriks/dgenerate/v2.1.0/examples/media/horse2.jpeg>`_
...
in the `"plugins/image_preprocessor" <https://github.com/Teriks/dgenerate/tree/v2.1.0/examples/plugins/image_preprocessor>`_
folder of the examples folder.

The source code for the built in `canny <https://github.com/Teriks/dgenerate/blob/v2.1.0/dgenerate/preprocessors/canny.py>`_ preprocessor,
the `openpose <https://github.com/Teriks/dgenerate/blob/v2.1.0/dgenerate/preprocessors/openpose.py>`_ preprocessor, and the simple
`pillow image operations <https://github.com/Teriks/dgenerate/blob/v2.1.0/dgenerate/preprocessors/imageops.py>`_ preprocessors can also
...
The image used in the example below is this `low resolution cat <https://raw.githubusercontent.com/Teriks/dgenerate/v2.1.0/examples/media/low_res_cat.png>`_

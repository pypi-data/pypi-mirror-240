...
#        return self.phase_host["composition"]
    ...
    def parse_phases(self,filename_phases_in="inpydecs_phases.csv",elemsList_in="host"):
    ...
    def __init__(self,elemsList_in="host",input_paths=["./"]):
        fnin="NONE"
        ...
        if "/" in fnin:
            ...
            self.filename_root=""
        self.parse_phases(fnin,elemsList_in)

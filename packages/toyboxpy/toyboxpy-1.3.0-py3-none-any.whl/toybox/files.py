...
class Files:
    ...
    def generateReadMeFileIn(cls, folder: str):
        with open(os.path.join(folder, 'README.md'), 'w') as out_file:
            ...
            out_file.write('\n')
            out_file.write('Please [install](https://codeberg.org/DidierMalenfant/toybox.py#installation) **toybox.py** in order to modify or update the content of this folder.\n')

...
from plotly.express import defaults as px_defaults
from plotly.express import bar, box, density_heatmap, histogram, line, pie, scatter, sunburst, timeline
...
from sberpm.metrics._activity_metric import ActivityMetric
from sberpm.metrics._id_metric import IdMetric
from sberpm.metrics._trace_metric import TraceMetric
from sberpm.metrics._transition_metric import TransitionMetric
from sberpm.metrics._user_metric import UserMetric
...
class ChartPainter:
    ...
    def sankey(
        ...
        **kwargs: optional
        ...
        t = DataFrame(TransitionMetric(dh).count()).reset_index()
    ...
    def hist_activity_of_dur(
        ...
        if top:
            ...
            for act in longest_stages.index:
                ...
                list_v = [round(avg_or_median * i / 5.0, round_n) for i in range(1, 10)]
                tmp_data[dh.duration_column][tmp_data[dh.duration_column] > list_v[-1]] = (
                    list_v[-1] + list_v[0] / 2
                )
            ...
            fig = histogram(
                dh.data,
                x=dh.duration_column,
                histfunc="count",
                color=dh.activity_column,
                nbins=10,

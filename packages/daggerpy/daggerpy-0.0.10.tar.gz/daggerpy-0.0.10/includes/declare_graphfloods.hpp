...
declare_graphflood(py::module& m, std::string typestr)
{
	py::class_<Graphflood2<int,
		...
		.def(py::init<Connector8<int, double>&, int&, Hermes<int, double>&, ParamBag<int, double>& >())
		.def("init",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::init)
		.def("compute_entry_points_from_P",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::compute_entry_points_from_P)
		.def("run_subgraphflood",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::run_subgraphflood)
		.def("fillrun_subgraphflood",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::fillrun_subgraphflood)
		.def("anarun_subgraphflood",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::anarun_subgraphflood)
		.def("diffuse_topo",
			&Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::diffuse_topo)
		...
		.def("run_subgraphflood_expA",
				 &Graphflood2<int,
											...
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::run_subgraphflood_expA)
		.def("set_uniform_P",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::set_uniform_P)
		.def("set_Qw_input_points",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::
		...
		.def("set_dt",
				 &Graphflood2<int,
											...
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::set_dt)
		.def("initial_fill",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::initial_fill)
		.def("get_dt",
				 &Graphflood2<int,
											double,
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::get_dt)
		...
		.def("_quick_slipos_from_point",
				 &Graphflood2<int,
											...
											Connector8<int, double>,
											int,
											Hermes<int, double>, ParamBag<int, double> >::_quick_slipos_from_point)

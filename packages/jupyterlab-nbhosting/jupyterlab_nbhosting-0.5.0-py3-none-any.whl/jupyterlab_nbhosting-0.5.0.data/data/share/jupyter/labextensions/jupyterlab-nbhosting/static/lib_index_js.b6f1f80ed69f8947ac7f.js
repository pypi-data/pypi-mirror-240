...
const plugin = {
    ...
    activate: (app, palette, settingRegistry) => {
        ...
        const share_static_version = async (arg) => {
            ...
            try {
                // xxx restore 2 lines and remove the hardcoded url
                // const response = await fetch(share_url)
                // const jsonData = await response.json()
                const jsonData = {
                    url_path: 'https://nbhosting.inria.fr/some/hardwired/url',
                };
                let message;
                if ('error' in jsonData) {
                    ...
                    message = (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "nb" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "nbh-dialog" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "nbh-dialog" }, "Note that sharing the same notebook several times overwrites the same snapshot")));
                }
                //
                (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.showDialog)({
                    ...
                    if (answer.button.accept) {
                        console.log(`copying ${jsonData.url_path}`);
                        copyToClipboard({ value: jsonData.url_path });
                    }
                });
            }
            catch (error) {
        ...
        const show_student_id = (arg) => {
            ...
            (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.showDialog)({
                ...
                body: (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                    "please copy and paste your id",
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "nbh-student-id" }, student),
                    "when you report an issue with the platform")),
                buttons: [
                    {
                        label: 'Copy to Clipboard',
                        caption: 'Copy to Clipboard',
...
//# sourceMappingURL=lib_index_js.b6f1f80ed69f8947ac7f.js.map
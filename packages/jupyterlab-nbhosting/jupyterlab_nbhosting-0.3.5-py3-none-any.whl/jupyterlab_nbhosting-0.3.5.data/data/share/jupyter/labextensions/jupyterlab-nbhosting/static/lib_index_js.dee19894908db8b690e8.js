...
const plugin = {
    ...
    activate: (app, palette, notebookTracker, settingRegistry) => {
        ...
        palette.addItem({ command, category });
        notebookTracker; // fooling ts
        // notebookTracker.widgetAdded.connect((_, panel) => {
        console.log("jupyterlab-nbhosting: toggling the header");
        // hide the header
        const result = app.commands.execute('application:toggle-header');
...
//# sourceMappingURL=lib_index_js.dee19894908db8b690e8.js.map
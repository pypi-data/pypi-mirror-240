...
class Cluster(DistributedCluster, Generic[IsAsynchronous]):
    ...
    def __init__(
        ...
        *,
        ...
        worker_cpu: int | list[int] | None = None,
        worker_memory: str | list[str] | None = None,
        worker_disk_size: int | str | None = None,
        worker_disk_throughput: int | None = None,
        worker_gpu: int | bool | None = None,
        worker_gpu_type: str | None = None,
        scheduler_options: dict | None = None,
        scheduler_vm_types: list | None = None,
        scheduler_cpu: int | list[int] | None = None,
        scheduler_memory: str | list[str] | None = None,
        ...
        backend_options: AWSOptions | GCPOptions | None = None,  # intentionally not in the docstring yet
        show_widget: bool = True,
        custom_widget: ClusterWidget | None = None,
        configure_logging: bool | None = None,
        wait_for_workers: int | (float | bool) | None = None,
        package_sync: bool | list[str] = False,
...
If that does not solve your issue, please contact support@coiled.io."""
    ...
    def sync(
        ...
        *args,
        asynchronous: Sync | Literal[None] = None,
    ...
    def sync(
        ...
        func: Callable[..., Awaitable[_T]],
        *args,
        asynchronous: bool | Literal[None] = None,
        callback_timeout=None,
        **kwargs,
    ...
    def close(self: ClusterSyncAsync, force_shutdown: bool = False) -> None | Awaitable[None]:
        """
        Close the cluster.
        """
    ...
    def shutdown(self: ClusterSyncAsync) -> None | Awaitable[None]:
        """
    ...
    def scale(self: ClusterSyncAsync, n: int) -> Awaitable[None] | None:
    ...
    @track_context
    async def scale_down(self, workers: set, reason: str | None = None) -> None:
        if not self.cluster_id:
            raise ValueError("No cluster available to scale!")
    ...
    def get_logs(self: ClusterSyncAsync, scheduler: bool = True, workers: bool = True) -> dict | Awaitable[dict]:

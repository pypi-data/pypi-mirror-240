...
class Function:
    ...
    def __init__(self, function, cluster_kwargs, keepalive, environ, local: bool = False, name: str | None = None):
    ...
    @property
    def cluster(self) -> coiled.Cluster | dask.distributed.LocalCluster:
        with _lock:
            try:
...
def function(
    *,
    ...
    vm_type: str | list[str] | None = None,
    cpu: int | list[int] | None = None,
    memory: str | list[str] | None = None,
    gpu: bool | None = None,

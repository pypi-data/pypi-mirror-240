...
def open_ssh(address: str, key: str, jump_to_address: str | None = None, host_command: str | None = None):
...
def add_key_to_agent(address: str, key: str, t: int | None = None, delete: bool = False) -> bool:
...
def ssh_shell(address: str, jump_to_address: str | None = None, host_command: str | None = None):
    if jump_to_address:

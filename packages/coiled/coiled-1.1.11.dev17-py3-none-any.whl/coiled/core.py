...
class Cloud(Generic[IsAsynchronous]):
    ...
    def list_api_tokens(
        self: Cloud[Async] | Cloud[Sync], include_inactive: bool = False
    ) -> Awaitable[dict[str, dict]] | dict[str, dict]:
    ...
    def create_software_environment(
        ...
        *,
        account: str | None = None,
        conda: list | (CondaEnvSchema | (str | pathlib.Path)) | None = None,
        pip: list | (str | pathlib.Path) | None = None,
    ...
    def create_software_environment(
        ...
        *,
        ...
        architecture: ArchitectureTypesEnum = ArchitectureTypesEnum.X86_64,
        region_name: str | None = None,
    ) -> Awaitable[SoftwareEnvironmentAlias | None] | SoftwareEnvironmentAlias | None:
        return self._sync(
    ...
    async def _create_software_environment(
        ...
        *,
        account: str | None = None,
        conda: CondaEnvSchema | (str | (pathlib.Path | (list | None))) = None,
        pip: list[str] | (str | (pathlib.Path | None)) = None,
        container: str | None = None,
        log_output=sys.stdout,
        force_rebuild: bool = False,
        use_entrypoint: bool = True,
    ...
    async def _fetch_software_build(self, senv_build_id: int, account: str | None = None):
        account = account or self.default_account
    ...
    async def _depaginate(
        func: Callable[..., Awaitable[tuple[dict, bool | str | None]]],
        *args,
        **kwargs,
    ) -> dict:
        results_all = {}
    ...
    @track_context
    async def _list_software_environments(self, account: str | None = None) -> dict:
        return await self._depaginate_v2(self._list_software_environments_page_v2, account=account)

    @track_context
    async def _list_software_environments_page_v2(self, offset: int, account: str | None = None) -> tuple[dict, int]:
        account = account or self.default_account
        response = await self._do_request(
            "GET",
    ...
    @track_context
    async def _list_software_environments_page(self, page: int, account: str | None = None) -> tuple[dict, str | None]:
        account = account or self.default_account
        response = await self._do_request(
            "GET",
    ...
    async def _list_instance_types(
        ...
        min_memory: int | str | float | None = None,
        cores: int | list[int] | None = None,
        memory: int | (float | (str | (list[int] | (list[str] | list[float])))) | None = None,
    ...
    async def _list_instance_types_page(
        ...
        min_memory: int | str | float | None = None,
        cores: int | list[int] | None = None,
        memory: int | str | float | list[int] | list[str] | list[float] | None = None,
        gpus: int | list[int] | None = None,
        backend: str | None = None,
        arch: Literal["x86_64", "arm64"] | None = None,
    ) -> tuple[dict, str | None]:
    ...
    @track_context
    async def _delete_software_environment(self, name: str, account: str | None = None) -> None:
        context_account = account
    ...
    def list_instance_types(
        ...
        min_cores: int | None,
        min_gpus: int | None,
        min_memory: int | str | float | None,
        cores: int | list[int] | None,
        memory: int | str | float | list[int] | list[str] | list[float] | None,
    ...
    def list_instance_types(
        ...
        gpus: int | list[int] | None = None,
        arch: Literal["x86_64", "arm64"] | None = None,
    ) -> Awaitable[dict[str, VmType]] | dict[str, VmType]:
        return self._sync(
    ...
    @track_context
    async def _get_software_info(self, name: str, account: str | None = None) -> dict:
    ...
    async def _get_software_spec(self, pk: str, account: str | None = None) -> dict:
        account = account or self.default_account
        response = await self._do_request(
            "GET",
    ...
    def list_core_usage(self: CloudSyncAsync, account: str | None = None) -> Awaitable[dict] | dict:
    ...
    def get_notifications(
        ...
        level: int | str = logging.NOTSET,
        event_type: str | None = None,
    ) -> Awaitable[list[dict] | None] | list[dict] | None:
        # TODO: warn
        return self._sync(
    ...
    def list_user_information(self: CloudSyncAsync) -> Awaitable[dict] | dict:
    ...
    def health_check(self: CloudSyncAsync) -> Awaitable[dict] | dict:
...
@delete_docstring
def delete_software_environment(name, account: str | None = None):
    with Cloud() as cloud:
...
def get_software_info(name: str, account: str | None = None) -> dict:
    """Retrieve solved spec for a Coiled software environment
...
def get_notifications(
    ...
    limit: int = 100,
    level: int | str = logging.NOTSET,
    event_type: event_type_list | None = None,
) -> list[dict] | None:
